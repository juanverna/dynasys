...
DEFINE FRAME F-Main
     btn_aprobar AT ROW 1.24 COL 2
     btn_rechazar AT ROW 2.43 COL 2
     btn_revertir AT ROW 3.86 COL 2
     v-observacion AT ROW 5.29 COL 2.2 NO-LABEL
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    THEN DO:
        ASSIGN
            btn_aprobar:SENSITIVE = LOOKUP(Ped_header.cdg_estado, "O1/O2/OA/OC/OL/OV/D1/D2/D3/D4/D5/HH", "/") <> 0
            btn_rechazar:SENSITIVE = LOOKUP(Ped_header.cdg_estado, "O1/O2/OA/OC/OL/OV/D1/D2/D3/D4/D5/HH", "/") <> 0
            btn_revertir:SENSITIVE = LOOKUP(Ped_header.cdg_estado, "IR/AM/AA", "/") <> 0.
    END.
    ELSE DO:
        ASSIGN
