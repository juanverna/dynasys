...
&Scoped-define INTERNAL-TABLES T-Rem_detalle Articulo T-Rem_header
...
&Scoped-define FIELDS-IN-QUERY-DEFAULT-FRAME T-Rem_header.tip_comprob ~
T-Rem_header.nro_comprob T-Rem_header.mes T-Rem_header.ano ~
T-Rem_header.fecha T-Rem_header.nro_ocm T-Rem_header.fecha_ocm ~
T-Rem_header.clausula_dolar T-Rem_header.cambio_dolar T-Rem_header.cambio ~
...
T-Rem_header.ano T-Rem_header.fecha T-Rem_header.clausula_dolar ~
T-Rem_header.cambio_dolar T-Rem_header.leyenda_cc 
...
&Scoped-define TABLES-IN-QUERY-DEFAULT-FRAME T-Rem_header
&Scoped-define FIRST-TABLE-IN-QUERY-DEFAULT-FRAME T-Rem_header


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS T-Rem_header.tip_comprob ~
T-Rem_header.nro_comprob T-Rem_header.mes T-Rem_header.ano ~
T-Rem_header.fecha T-Rem_header.clausula_dolar T-Rem_header.cambio_dolar ~
T-Rem_header.leyenda_cc 
...
v-cdg_imputacion BROWSE-1 
&Scoped-Define DISPLAYED-FIELDS T-Rem_header.tip_comprob ~
T-Rem_header.nro_comprob T-Rem_header.mes T-Rem_header.ano ~
T-Rem_header.fecha T-Rem_header.nro_ocm T-Rem_header.fecha_ocm ~
T-Rem_header.clausula_dolar T-Rem_header.cambio_dolar T-Rem_header.cambio ~
T-Rem_header.leyenda_cc 
...
&Scoped-Define DISPLAYED-OBJECTS v-pto_venta v-pto_venta2 v-anulado ~
v-comprobante v-cdg_cliente v-dsc_cliente v-cdg_domicilio v-dsc_domicilio ~
v-cdg_condicion_impos v-dsc_condicion_impos v-cdg_condicion_venta ~
v-dsc_condicion_venta v-cdg_moneda v-dsc_moneda v-tip_factura v-prf_factura ~
v-nro_factura v-cdg_imputacion v-cdg_deposito v-dsc_deposito v-cdg_vendedor ~
v-dsc_vendedor v-cdg_lista_precios v-dsc_lista_precios v-cdg_articulo 
...
DEFINE VARIABLE v-pto_venta2 AS INTEGER FORMAT "9999":U INITIAL 0 
     VIEW-AS FILL-IN NATIVE 
     SIZE 7 BY 1
     BGCOLOR 15 FGCOLOR 9 FONT 6 NO-UNDO.
...
DEFINE FRAME DEFAULT-FRAME
     ...
     T-Rem_header.nro_comprob AT ROW 3.62 COL 29 COLON-ALIGNED NO-LABEL
          ...
          SIZE 16 BY 1
          BGCOLOR 7 FGCOLOR 15 
     v-pto_venta2 AT ROW 3.62 COL 49 COLON-ALIGNED NO-LABEL
     ...
     T-Rem_header.ano AT ROW 3.62 COL 74 COLON-ALIGNED NO-LABEL
          ...
          SIZE 7 BY 1
          BGCOLOR 15 FGCOLOR 9 
     v-anulado AT ROW 3.62 COL 103 COLON-ALIGNED NO-LABEL
     ...
     T-Rem_header.fecha AT ROW 4.81 COL 143 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 13 BY 1
          BGCOLOR 15 FGCOLOR 9 
     v-cdg_domicilio AT ROW 6 COL 13 COLON-ALIGNED
     v-dsc_domicilio AT ROW 6 COL 29 COLON-ALIGNED NO-LABEL
     T-Rem_header.nro_ocm AT ROW 6 COL 113 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 13 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Rem_header.fecha_ocm AT ROW 6 COL 143 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 13 BY 1
          BGCOLOR 15 FGCOLOR 9 
     v-cdg_condicion_impos AT ROW 7.19 COL 13 COLON-ALIGNED
     v-dsc_condicion_impos AT ROW 7.19 COL 29 COLON-ALIGNED NO-LABEL
     T-Rem_header.clausula_dolar AT ROW 7.43 COL 139
          VIEW-AS TOGGLE-BOX
          SIZE 19 BY .81
     v-cdg_condicion_venta AT ROW 8.38 COL 13 COLON-ALIGNED
     v-dsc_condicion_venta AT ROW 8.38 COL 29 COLON-ALIGNED NO-LABEL
     T-Rem_header.cambio_dolar AT ROW 8.38 COL 137 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 18.8 BY 1
          BGCOLOR 15 FGCOLOR 9 
     v-cdg_moneda AT ROW 9.57 COL 13 COLON-ALIGNED
     v-dsc_moneda AT ROW 9.57 COL 29 COLON-ALIGNED NO-LABEL
     T-Rem_header.cambio AT ROW 9.57 COL 95 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 13 BY 1
          BGCOLOR 15 FGCOLOR 9 
     v-tip_factura AT ROW 9.57 COL 127 COLON-ALIGNED
     v-prf_factura AT ROW 9.57 COL 134 COLON-ALIGNED NO-LABEL
     v-nro_factura AT ROW 9.57 COL 143 COLON-ALIGNED NO-LABEL
     v-cdg_imputacion AT ROW 10.76 COL 13 COLON-ALIGNED
     v-cdg_deposito AT ROW 10.76 COL 95 COLON-ALIGNED
     v-dsc_deposito AT ROW 10.76 COL 109 COLON-ALIGNED NO-LABEL
     v-cdg_vendedor AT ROW 11.95 COL 13 COLON-ALIGNED
     v-dsc_vendedor AT ROW 11.95 COL 29 COLON-ALIGNED NO-LABEL
     v-cdg_lista_precios AT ROW 11.95 COL 95 COLON-ALIGNED
     v-dsc_lista_precios AT ROW 11.95 COL 109 COLON-ALIGNED NO-LABEL
...
DEFINE FRAME DEFAULT-FRAME
     T-Rem_header.leyenda_cc AT ROW 13.14 COL 13 COLON-ALIGNED
          LABEL "Obs."
          VIEW-AS FILL-IN NATIVE 
          SIZE 143 BY 1
          BGCOLOR 15 FGCOLOR 9 
     v-cdg_articulo AT ROW 14.81 COL 13 COLON-ALIGNED
     btn_porclasificacion AT ROW 14.81 COL 38
     btn_verbonificaciones AT ROW 14.81 COL 59
     btn_verimputacion AT ROW 14.81 COL 127
     btn_nominar AT ROW 14.81 COL 143
     BROWSE-1 AT ROW 16.24 COL 3
     RECT-2 AT ROW 1.29 COL 3
     RECT-3 AT ROW 1.24 COL 139
     RECT-4 AT ROW 3.38 COL 3
     RECT-5 AT ROW 14.57 COL 3
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 160 BY 27.38.
...
/* SETTINGS FOR FRAME DEFAULT-FRAME
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-1 btn_nominar DEFAULT-FRAME */
...
/* SETTINGS FOR FILL-IN v-pto_venta IN FRAME DEFAULT-FRAME
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN v-pto_venta2 IN FRAME DEFAULT-FRAME
   NO-ENABLE                                                            */
...
DO:
    ...
    THEN DO:
         ...
         END.
         ELSE MESSAGE "No se puede anular, el remito ha salido o posee un evento realizado" 
            VIEW-AS ALERT-BOX MESSAGE TITLE "Aviso".
    END.
...
DO:
  ...
  RUN d-seleccionar_remito.w (OUTPUT rid_remito).
  IF rid_remito <> ?
  THEN DO:
...
DO:
   ...
   DEFINE VARIABLE puso_ok AS LOGICAL.
   RUN c-edttexto.w ( INPUT-OUTPUT T-Rem_header.observacion,
...
DO:
  ...
  THEN DO:
      ...
      RUN d-seleccionar_compdespacho.w (INPUT titulo_window, INPUT lista_estados, INPUT Tipocomprobante.tip_comprob, OUTPUT rid_remito).         
...
&Scoped-define SELF-NAME v-pto_venta2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-pto_venta2 C-Win
ON ENTRY OF v-pto_venta2 IN FRAME DEFAULT-FRAME
DO:
  v-pto_venta-org = INPUT FRAME {&FRAME-NAME} v-pto_venta.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-pto_venta2 C-Win
ON LEAVE OF v-pto_venta2 IN FRAME DEFAULT-FRAME
DO:
...
/*  IF INPUT FRAME {&FRAME-NAME} v-pto_venta <> v-pto_venta-org
  ...
  END.  */
    DO:
   IF modo <> MD_READONLY  /* MD_ALTA  MD_MULTIPLE  MD_DEFINIDA    MD_RELACION   MD_READONLY MD_CAMBIO MD_ANULACION MD_EMISION */ THEN DO:
      IF INPUT FRAME {&FRAME-NAME} v-pto_venta <> v-pto_venta-org
      THEN DO:
           IF NOT CAN-FIND(Punto-venta WHERE Punto-venta.cdg_empresa  = T-rem_header.cdg_empresa 
                                         AND Punto-venta.cdg_puntovta = INPUT FRAME {&FRAME-NAME} v-pto_venta)
...
/* v-cdg_imputacion:LIST-ITEM-PAIRS IN FRAME {&FRAME-NAME} = "". */
   ...
   x-listas = "".
   x-primero = ?.
   FOR EACH Comprobante_concepto OF Tipocomprobante WHERE Comprobante_concepto.cdg_empresa = Empresa.cdg_empresa, 
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY v-pto_venta v-pto_venta2 v-anulado v-comprobante v-cdg_cliente 
          ...
          v-cdg_moneda v-dsc_moneda v-tip_factura v-prf_factura v-nro_factura 
          v-cdg_imputacion v-cdg_deposito v-dsc_deposito v-cdg_vendedor 
          v-dsc_vendedor v-cdg_lista_precios v-dsc_lista_precios v-cdg_articulo 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  IF AVAILABLE T-Rem_header THEN 
    DISPLAY T-Rem_header.tip_comprob T-Rem_header.nro_comprob T-Rem_header.mes 
          T-Rem_header.ano T-Rem_header.fecha T-Rem_header.nro_ocm 
          T-Rem_header.fecha_ocm T-Rem_header.clausula_dolar 
          T-Rem_header.cambio_dolar T-Rem_header.cambio T-Rem_header.leyenda_cc 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE RECT-2 RECT-3 RECT-4 RECT-5 Btn_salir T-Rem_header.tip_comprob 
         T-Rem_header.nro_comprob T-Rem_header.mes T-Rem_header.ano 
         T-Rem_header.fecha T-Rem_header.clausula_dolar 
         T-Rem_header.cambio_dolar v-cdg_imputacion T-Rem_header.leyenda_cc 
         BROWSE-1 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
            ...
            CASE modo:
                ...
                THEN DO:
                     ASSIGN
                        ...
                        /*v-pto_venta:SENSITIVE        = NOT Tipocomprobante.autonumerado*/
...
------------------------------------------------------------------------------*/
    ...
    DO TRANSACTION:
       ...
       RUN emitir_compdespacho.p (  INPUT TABLE T-Rem_header,
