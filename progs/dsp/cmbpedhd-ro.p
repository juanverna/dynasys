/*=================================================================================*/
/*  RESTARUA AL ESTADO ORIGINAL LOS PEDIDOS QUE HAN SALIDO DE 'RETENIDOS POR CRE-  */
/*  DITO '. SE CREA UN PROGRAMA PARA CADA ESTADO PARA PODER CONTROLAR LOS CAMBIOS  */
/*  DE ESTADO DENTRO DEL SISTEMA GENERAL DE SEGURIDAD.                             */
/*=================================================================================*/
...
DO TRANSACTION:
   ...
   ASSIGN
        Ped_header.cdg_estado = Ped_header.org_estado.

   FOR EACH Ped_detalle OF Ped_header EXCLUSIVE-LOCK:

        Ped_detalle.cdg_estado = Ped_header.cdg_estado.
        CREATE Hst_pedido.
        ASSIGN Hst_pedido.cdg_estado         = Ped_header.cdg_estado
