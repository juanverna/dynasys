...
ON END-ERROR OF W-Win /* Remitos x fecha */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Remitos x fecha */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/DSP" "Remitos por Fecha"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsremitos_xfecha.p ( INPUT des_cliente,
                                INPUT has_cliente,
                                INPUT des_fecha,
                                INPUT has_fecha
                               ).
