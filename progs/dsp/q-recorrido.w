...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Recorrido WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Recorrido
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Recorrido
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "sic.Recorrido Where sic.Deposito ..."
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  DEFINE INPUT PARAMETER rid-recorrido AS ROWID.
  
  REPOSITION {&QUERY-NAME} TO ROWID rid-recorrido.
  GET NEXT {&QUERY-NAME}.
