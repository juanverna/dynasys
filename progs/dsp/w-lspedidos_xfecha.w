...
DEFINE FRAME F-Main
     ...
     "  Estado de los pedidos a listar:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 10.96 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de clientes a listar:" VIEW-AS TEXT
...
ON END-ERROR OF W-Win /* Pedidos x Fecha */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Pedidos x Fecha */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cliente ( 3.69 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-estado ( 12.04 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/DSP" "Pedidos x Fecha"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lspedidos_xfecha.p ( INPUT des_cliente,
                                INPUT has_cliente,
                                INPUT des_fecha,
                                INPUT has_fecha,
