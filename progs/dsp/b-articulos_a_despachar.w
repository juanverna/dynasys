...
&Scoped-define INTERNAL-TABLES Ped_detalle Articulo Partida
...
Partida.cdg_partida Articulo.descripcion Ped_detalle.cantidad ~
Ped_detalle.cantidad_ult 
...
&Scoped-define QUERY-STRING-br_table FOR EACH Ped_detalle OF Ped_header WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      ...
      EACH Partida OF Ped_detalle NO-LOCK ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Ped_detalle OF Ped_header WHERE ~{&KEY-PHRASE} NO-LOCK, ~
    ...
    BY Articulo.cdg_articulo ~
       BY Partida.cdg_partida.
&Scoped-define TABLES-IN-QUERY-br_table Ped_detalle Articulo Partida
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Articulo.cdg_articulo FORMAT "X(12)":U WIDTH 11.2
      Partida.cdg_partida FORMAT "X(8)":U WIDTH 9.2
      Articulo.descripcion FORMAT "X(39)":U WIDTH 63.2
      Ped_detalle.cantidad COLUMN-LABEL "Cantidad!Pedida" FORMAT "->>>,>>>,>>9.99":U
      Ped_detalle.cantidad_ult FORMAT "->>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 123 BY 10.71
         BGCOLOR 15 FGCOLOR 9 FONT 4
         TITLE BGCOLOR 15 FGCOLOR 9 "Articulos Solicitados".
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "sic.Ped_detalle OF sic.Ped_header,sic.Articulo OF sic.Ped_detalle,sic.Partida OF sic.Ped_detalle"
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = ",,"
     _OrdList          = "sic.Articulo.cdg_articulo|yes,sic.Partida.cdg_partida|yes"
     _FldNameList[1]   > sic.Articulo.cdg_articulo
"Articulo.cdg_articulo" ? ? "character" ? ? ? ? ? ? no ? no no "11.2" yes no no "U" "" ""
     _FldNameList[2]   > sic.Partida.cdg_partida
"Partida.cdg_partida" ? ? "character" ? ? ? ? ? ? no ? no no "9.2" yes no no "U" "" ""
     _FldNameList[3]   > sic.Articulo.descripcion
"Articulo.descripcion" ? "X(39)" "character" ? ? ? ? ? ? no ? no no "63.2" yes no no "U" "" ""
     _FldNameList[4]   > sic.Ped_detalle.cantidad
"Ped_detalle.cantidad" "Cantidad!Pedida" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   = sic.Ped_detalle.cantidad_ult
