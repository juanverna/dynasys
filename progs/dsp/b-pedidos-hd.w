...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Ped_header WHERE ~{&KEY-PHRASE} NO-LOCK ~
    BY Ped_header.tip_comprob ~
       BY Ped_header.nro_comprob DESCENDING INDEXED-REPOSITION.
...
&Scoped-Define ENABLED-OBJECTS que_tipo que_numero br_table 
&Scoped-Define DISPLAYED-OBJECTS que_tipo que_numero 
...
DEFINE VARIABLE que_tipo AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN NATIVE 
     SIZE 3 BY .75
     BGCOLOR 14 FGCOLOR 12 FONT 4 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Ped_header.tip_comprob COLUMN-LABEL "Tip!Ped."
      Ped_header.nro_comprob COLUMN-LABEL "Número!Pedido."
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 13 BY 10.25
...
DEFINE FRAME F-Main
     que_tipo AT ROW 1.25 COL 2 NO-LABEL
     que_numero AT ROW 1.25 COL 6 NO-LABEL
     br_table AT ROW 2.25 COL 1
...
/* BROWSE-TAB br_table que_numero F-Main */
ASSIGN 
       FRAME F-Main:SCROLLABLE       = FALSE
       FRAME F-Main:HIDDEN           = TRUE.

/* SETTINGS FOR FILL-IN que_numero IN FRAME F-Main
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN que_tipo IN FRAME F-Main
   ALIGN-L                                                              */
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "sic.Ped_header"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE"
     _OrdList          = "sic.Ped_header.tip_comprob|yes,sic.Ped_header.nro_comprob|no"
     _FldNameList[1]   > sic.Ped_header.tip_comprob
"tip_comprob" "Tip!Ped." ? "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   > sic.Ped_header.nro_comprob
"nro_comprob" "Número!Pedido." ? "integer" ? ? ? ? ? ? no ?
