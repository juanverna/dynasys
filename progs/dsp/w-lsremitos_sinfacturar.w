...
DEFINE FRAME F-Main
     v-estado AT ROW 11 COL 12 COLON-ALIGNED NO-LABEL
...
ON END-ERROR OF W-Win /* Remitos Pendientes de Facturación */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Remitos Pendientes de Facturación */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 13.43 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/DSP" "Remitos Pendientes de Facturación"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsremitos_sinfacturar.p ( INPUT des_cliente,
                                     INPUT has_cliente,
                                     INPUT des_fecha,
                                     INPUT has_fecha
                                    ).
