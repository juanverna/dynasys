...
ON END-ERROR OF W-Win /* Recorridos de entrega */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Recorridos de entrega */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Recorridos de entrega */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-recorridos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-recorridos ).
       RUN set-position IN h_b-recorridos ( 2.08 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.12 , 15.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-recorrido.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-recorrido ).
       RUN set-position IN h_v-recorrido ( 2.35 , 23.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.46 , 69.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 16.35 , 23.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 1.77 , 69.00 ) NO-ERROR.
