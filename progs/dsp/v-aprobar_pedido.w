...
FUNCTION fnpuede RETURNS LOGICAL
  ( INPUT p-cdg_inicial AS CHARACTER, 
    ...
    INPUT p-cdg_empresa AS CHARACTER, 
 ...
 DEFINE VARIABLE v-btn_agerencia  AS LOGICAL.           
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    THEN DO:
        ...
        v-btn_aprobar = fnpuede( INPUT Ped_header.cdg_estado, INPUT "AA", INPUT Ped_header.cdg_empresa, INPUT Ped_header.fecha).
        v-btn_rechazar = fnpuede( INPUT Ped_header.cdg_estado, INPUT "IR", INPUT Ped_header.cdg_empresa, INPUT Ped_header.fecha).
        v-btn_anular = fnpuede( INPUT Ped_header.cdg_estado, INPUT "ZZ", INPUT Ped_header.cdg_empresa, INPUT Ped_header.fecha).
        v-btn_acomercial = fnpuede( INPUT Ped_header.cdg_estado, INPUT "IC", INPUT Ped_header.cdg_empresa, INPUT Ped_header.fecha).
        v-btn_agerencia =  fnpuede( INPUT Ped_header.cdg_estado, INPUT "GE", INPUT Ped_header.cdg_empresa, INPUT Ped_header.fecha).

        ASSIGN
            btn_aprobar:SENSITIVE    =  v-btn_aprobar
            btn_rechazar:SENSITIVE   =  v-btn_rechazar
            btn_anular:SENSITIVE     =  v-btn_anular
            btn_acomercial:SENSITIVE =  v-btn_acomercial
            btn_agerencia:SENSITIVE  =  v-btn_agerencia.
...
FUNCTION fnpuede RETURNS LOGICAL
  ...
  FIND FIRST Autoriza_transaccion OF Usuario
           WHERE Autoriza_transaccion.cdg_empresa        = p-cdg_empresa
