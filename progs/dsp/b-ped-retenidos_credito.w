...
&Scoped-Define ENABLED-OBJECTS br_table btn_renovar v-estados RECT-6 
...
DEFINE VARIABLE v-estados AS CHARACTER INITIAL "O1/O2/OA/OC/OD/OF/OL/OV/D1/D2/D3/D4/D5" 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Retenidos", "O1/O2/OA/OC/OD/OF/OL/OV/D1/D2/D3/D4/D5/HH",
"Aprobados", "AM/AA",
"Rechazados", "IR",
"Todos", "O1/O2/OA/OC/OL/OVD1/D2/D3/D4/D5/AM/IR/AA/HH"
     SIZE 73.4 BY 1
     FONT 4 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Cliente.nom_cliente FORMAT "X(31)":U
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 108 BY 9.14
         BGCOLOR 11 FGCOLOR 9 FONT 4
         TITLE BGCOLOR 11 FGCOLOR 9 "Pedidos Retenidos por Situación Crediticia".
...
DEFINE FRAME F-Main
     ...
     btn_renovar AT ROW 10.67 COL 2.6
     v-estados AT ROW 10.71 COL 28.6 NO-LABEL
     RECT-6 AT ROW 10.43 COL 1
...
"Cliente.nom_cliente" ? "X(31)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* Pedidos Retenidos por Situación Crediticia */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* Pedidos Retenidos por Situación Crediticia */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* Pedidos Retenidos por Situación Crediticia */
DO:
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
   ...
   v-estados = "O1/O2/OA/OC/OD/OF/OL/OV/D1/D2/D3/D4/D5/HH".
