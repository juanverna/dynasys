...
Cliente.direccion Cliente.fecha_alta Cliente.credito_maximo ~
Cliente.telefonos 
...
DEFINE FRAME F-Main
     Cliente.cdg_cliente AT ROW 2.86 COL 9 COLON-ALIGNED
          LABEL "Código"
          VIEW-AS FILL-IN NATIVE 
          SIZE 19 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Cliente.nom_cliente AT ROW 2.86 COL 29.2 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN NATIVE 
          SIZE 49.4 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Cliente.direccion AT ROW 4.19 COL 9.2 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 49.8 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Cliente.fecha_alta AT ROW 4.24 COL 65.4 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 13 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Cliente.credito_maximo AT ROW 5.52 COL 64 COLON-ALIGNED
          LABEL "Créd.maximo"
          VIEW-AS FILL-IN NATIVE 
          SIZE 14.4 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Cliente.telefonos AT ROW 5.57 COL 9.6 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 39.4 BY 1
          BGCOLOR 15 FGCOLOR 9 
     RECT-7 AT ROW 2.43 COL 1
     RECT-8 AT ROW 1 COL 1
     "Datos del Cliente a Informar del Rechazo" VIEW-AS TEXT
          SIZE 50 BY .52 AT ROW 1.29 COL 16.4
          FGCOLOR 9 FONT 6
