...
&Scoped-Define ENABLED-OBJECTS BUTTON-5 BUTTON-6 br_table RECT-23 
...
DEFINE VARIABLE v-ocupado AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 48 BY 1
     BGCOLOR 12 FGCOLOR 14 FONT 6 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Ped_header.cdg_empresa FORMAT "X(8)":U
      ...
      Cliente.nom_cliente FORMAT "X(31)":U WIDTH 38.4
      ...
      Ped_header.estado FORMAT "X(1)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS MULTIPLE SIZE 112 BY 9.52
         BGCOLOR 11 FGCOLOR 9 FONT 4
         TITLE BGCOLOR 11 FGCOLOR 9 "Pedidos Pendientes de Impresión".


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME F-Main
     BUTTON-5 AT ROW 1.24 COL 2
     BUTTON-6 AT ROW 1.24 COL 23
     v-ocupado AT ROW 1.24 COL 62 COLON-ALIGNED NO-LABEL
...
/* SETTINGS FOR FILL-IN v-ocupado IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       v-ocupado:HIDDEN IN FRAME F-Main           = TRUE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "Ped_header.cdg_estado = ""AA""
 AND Ped_header.estado = ""E"""
...
"Cliente.nom_cliente" ? "X(31)" "character" ? ? ? ? ? ? no ? no no "38.4" yes no no "U" "" ""
...
"Ped_header.nro_comprob" "Número!Pedido" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[9]   = sic.Ped_header.estado
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* Pedidos Pendientes de Impresión */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* Pedidos Pendientes de Impresión */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* Pedidos Pendientes de Impresión */
DO:
  /* This ADM trigger code must be preserved in order to notify other
     objects when the browser's current row changes. */
  {src/adm/template/brschnge.i}

/*   IF AVAILABLE Ped_header THEN                                                                       */
...
DO:
  ...
  RUN imprimir_pedidos.
  {&OPEN-QUERY-{&BROWSE-NAME}}
  v-ocupado = "".
  v-ocupado:VISIBLE IN FRAME {&FRAME-NAME} = NO.
...
ON CHOOSE OF BUTTON-6 IN FRAME F-Main /* Consultar */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE imprimir_pedidos B-table-Win 
