...
DEFINE FRAME F-Main
     ...
     "  Rango de fechas de los movimientos:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 6.91 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
ON END-ERROR OF W-Win /* Remitos Facturados */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Remitos Facturados */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 12.43 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/DSP" "Remitos Facturados"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsremitos_facturados.p ( INPUT des_cliente,
                                    INPUT has_cliente,
                                    INPUT des_fecha,
                                    INPUT has_fecha
                                   ).
