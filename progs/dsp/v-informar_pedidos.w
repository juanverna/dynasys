...
&Scoped-Define ENABLED-OBJECTS btn_informar btn_revertir v-observacion ~
RECT-4 
...
DEFINE FRAME F-Main
     btn_informar AT ROW 1.33 COL 3
     btn_revertir AT ROW 2.81 COL 3
     v-observacion AT ROW 4.81 COL 2 NO-LABEL
...
&Scoped-define SELF-NAME btn_informar
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn_informar V-table-Win
ON CHOOSE OF btn_informar IN FRAME F-Main /* Informado */
DO:
     {tgbtcambped-hd.i "CMBPEDHD-RE"}
END.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    THEN DO:
        ASSIGN
            btn_informar:SENSITIVE = LOOKUP(Ped_header.cdg_estado, "IR", "/") <> 0
            btn_revertir:SENSITIVE = LOOKUP(Ped_header.cdg_estado, "RE", "/") <> 0.
    END.
    ELSE DO:
        ASSIGN
            btn_informar:SENSITIVE = NO
