...
DEFINE FRAME F-Main
     v-estado AT ROW 17.65 COL 12 COLON-ALIGNED NO-LABEL
     RECT-1 AT ROW 13.65 COL 14
     "  Estado de los pedidos a listar:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 6.65 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de fechas de entrega de los pedidos:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 2.62 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Lista de empresas a considerar:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 10.42 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
ON END-ERROR OF W-Win /* Reporte de estado de pedidos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Reporte de estado de pedidos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 3.65 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-estado ( 7.69 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-empresas ( 11.54 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.88 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/DSP" "Reporte de estado de pedidos"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsestadopedidos.p ( INPUT des_fecha,
                               INPUT has_fecha,
