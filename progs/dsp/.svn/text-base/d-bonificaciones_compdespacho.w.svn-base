...
&Scoped-define QUERY-STRING-BROWSE-8 FOR EACH T-Rem_header-bon NO-LOCK, ~
...
DEFINE FRAME Dialog-Frame
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "Bonificaciones del presente comprobante".
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Bonificaciones del presente comprobante */
DO:
