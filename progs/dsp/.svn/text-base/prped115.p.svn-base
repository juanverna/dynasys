...
DO TRANSACTION:
    ...
    /*
    OUTPUT STREAM Formulario TO "c:\sic-temp\pedido115.xpr" CONVERT TARGET "iso8859-1".
    

    MESSAGE "empieza a bajar datos "
        VIEW-AS ALERT-BOX INFO BUTTONS OK.
    */

    OUTPUT STREAM Formulario TO VALUE("c:\sic-temp\pedido115.xpr")  CONVERT TARGET "iso8859-1".
    ...
    /*
    MESSAGE "hola gaston ...son las " STRING(TIME,"HH:MM:SS") " version 2"
        VIEW-AS ALERT-BOX INFO BUTTONS OK.
    */

    OS-COPY VALUE("c:\sic-temp\pedido115.xpr")
            VALUE("f:\watch\in\pd" + STRING(Ped_header.nro_comprob,"99999999") + "-" + 
                  STRING(n_hoja,"999") + ".xpr" ).
    /*
    MESSAGE "Error:" OS-ERROR
        VIEW-AS ALERT-BOX INFO BUTTONS OK.
    */  
    /*
    FILE-INFO:File-NAME = "c:\sic-temp\pedido115.xpr".    
...
*/
    ...
    RUN escribir ( INPUT "07,70", INPUT "PEDIDOS DE CLIENTES", INPUT 14, INPUT YES). 
    ...
    THEN DO:
         ...
         RUN escribir ( INPUT "51,115", INPUT "Oferta:" + Oferta.dsc_oferta, INPUT 10, INPUT YES).
    END.
    ...
    /*
    RUN escribir ( ch_linea(det0 + 1,-1)  + ",128", INPUT "Precio", INPUT 8, INPUT NO).
    */
...
PROCEDURE forma:
    ...
    FOR EACH Ped_detalle OF Ped_header, Articulo OF Ped_detalle,
        ...
        /*
        RUN escribenumero ( ch_linea(det0,linea0)  + ",117", INPUT STRING(Ped_detalle.precio,"->>>>9.9999"), INPUT 8, INPUT NO). 
        */
