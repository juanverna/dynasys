...
&Scoped-Define ENABLED-OBJECTS btn_cumplir btn_anular v-observacion RECT-4 
...
DEFINE FRAME F-Main
     btn_cumplir AT ROW 1.5 COL 3
     btn_anular AT ROW 2.77 COL 3
     v-observacion AT ROW 5.77 COL 2 NO-LABEL
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn_cumplir V-table-Win
