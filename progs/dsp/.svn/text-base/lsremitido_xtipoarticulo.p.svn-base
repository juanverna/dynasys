...
DEFINE FRAME frm-titulo HEADER
    que_empresa 
    "Total Remitido por Tipo de Artículo" AT 40
...
DEFINE FRAME frm-listado
    ...
    Unidad.abrevia FORMAT "x(5)"          COLUMN-LABEL "Unidad!Medida"
    t-p-granel               COLUMN-LABEL "Granel!Remitido"
    Unidad.abrevia FORMAT "x(5)"          COLUMN-LABEL "Unidad!Medida"
    WITH WIDTH 150 DOWN CENTERED USE-TEXT STREAM-IO.
