...
ON END-ERROR OF W-Win /* Pedidos x Vendedor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Pedidos x Vendedor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/DSP" "Pedidos x Vendedor"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lspedidos_xvendedor.p ( INPUT des_vendedor,
                                   INPUT has_vendedor,
                                   INPUT des_fecha,
                                   INPUT has_fecha,
