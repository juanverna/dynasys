...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Ped_header Cliente Deposito
&Scoped-define FIRST-EXTERNAL-TABLE Ped_header


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Ped_header, Cliente, Deposito.
...
Articulo.cdg_articulo Partida.cdg_partida Articulo.descripcion 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Partida.cdg_partida
      Articulo.descripcion FORMAT "X(31)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 60 BY 10.77
...
/* Settings for THIS-PROCEDURE
   Type: SmartBrowser
   External Tables: sic.Ped_header,sic.Cliente,sic.Deposito
   Allow: Basic,Browse
   Frames: 1
...
"Ped_detalle.nro_linea" "Nro!Linea" ? "integer" ? ? ? ? ? ? no ?
     ...
     _FldNameList[3]   = sic.Partida.cdg_partida
     _FldNameList[4]   > sic.Articulo.descripcion
"Articulo.descripcion" ? "X(31)" "character" ? ? ? ? ? ? no ?
