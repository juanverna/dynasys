...
ON END-ERROR OF W-Win /* Pedidos x Articulo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Pedidos x Articulo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-articulo ( 5.19 , 25.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 9.52 , 25.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-estado ( 13.57 , 25.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 19.05 , 25.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/DSP" "Pedidos x Articulo"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lspedidos_xarticulo.p ( INPUT des_articulo,
                                   INPUT has_articulo,
                                   INPUT des_fecha,
                                   INPUT has_fecha,
