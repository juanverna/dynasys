...
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 Ped_header.cdg_empresa Ped_header.tip_comprob Ped_header.prf_comprob Ped_header.nro_comprob Ped_header.estado Ped_header.fecha Ped_header.imp_total Cliente.cdg_cliente Cliente.nom_cliente   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2   
&Scoped-define FIELD-PAIRS-IN-QUERY-BROWSE-2
&Scoped-define SELF-NAME BROWSE-2
&Scoped-define OPEN-QUERY-BROWSE-2    IF por_cliente    THEN DO:       OPEN QUERY {&SELF-NAME}            FOR EACH Ped_header                           WHERE CAN-DO(lista_tipos, ~
      ...
      Ped_header.estado), ~
                                       FIRST Cliente OF Ped_header.    END.    ELSE DO:       OPEN QUERY {&SELF-NAME}            FOR EACH Ped_header                           WHERE CAN-DO(lista_tipos, ~
...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-9 Btn_OK Btn_Cancel por_cliente ~
v-des_fecha v-has_fecha v-cdg_cliente BROWSE-2 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 D-Dialog _FREEFORM
  QUERY BROWSE-2 DISPLAY
      Ped_header.cdg_empresa COLUMN-LABEL "Em-!presa" FORMAT "X(3)"
      ...
      Cliente.nom_cliente    COLUMN-LABEL "Razón!Social" FORMAT "X(44)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-2
   ...
   THEN DO:
      OPEN QUERY {&SELF-NAME}
           FOR EACH Ped_header
                          WHERE CAN-DO(lista_tipos,Ped_header.tip_comprob)
...
------------------------------------------------------------------------------*/
  DISPLAY por_cliente v-des_fecha v-has_fecha v-cdg_cliente v-nombre 
      WITH FRAME D-Dialog.
  ENABLE RECT-1 RECT-9 Btn_OK Btn_Cancel por_cliente v-des_fecha v-has_fecha 
