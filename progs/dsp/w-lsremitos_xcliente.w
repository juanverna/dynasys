...
ON END-ERROR OF W-Win /* Remitos x Cliente */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Remitos x Cliente */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/DSP" "Remitos por Cliente"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsremitos_xcliente.p ( INPUT des_cliente,
                                  INPUT has_cliente,
                                  INPUT des_fecha,
                                  INPUT has_fecha
                                 ).
