...
&Scoped-Define ENABLED-OBJECTS btn_aprobar btn_rechazar RECT-4 
...
DEFINE FRAME F-Main
     btn_aprobar AT ROW 1.48 COL 3
     btn_rechazar AT ROW 2.91 COL 3
     v-observacion AT ROW 4.1 COL 27 NO-LABEL
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    THEN DO:
        ASSIGN
            btn_aprobar:SENSITIVE = LOOKUP(Ped_header.cdg_estado, "IN", "/") <> 0
            btn_rechazar:SENSITIVE = LOOKUP(Ped_header.cdg_estado, "IN", "/") <> 0.
