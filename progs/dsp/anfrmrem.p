...
FORM
   ...
   WITH FRAME frm-rango SIDE-LABELS CENTERED ROW 3 FGCOLOR 0 /*f-fg_c*/ BGCOLOR 8 /*f-bg_c*/
        VIEW-AS DIALOG-BOX THREE-D TITLE "Anulación de formularios de remitos" FONT 6.
...
DO:
  ...
  END.
  ELSE DO:
     que_parametro = "PREM" + STRING(pto_venta,"9999").
     FIND Parametro 
...
DO:
  ...
  DO j = 1 TO cantidad_formas:
     ...
     CREATE Rem_header.
     ASSIGN Rem_header.fecha       = fecha_anulacion
            Rem_header.cdg_empresa = Empresa.cdg_empresa
            Rem_header.tip_comprob = tip_forma
            Rem_header.prf_comprob = pto_venta
            Rem_header.nro_comprob = des_forma + j - 1
            Rem_header.origen      = "A"
            Rem_header.anulado     = YES
            Rem_header.nro_remito  = NEXT-VALUE(proxima_transaccion).
  END.
