...
DEFINE FRAME F-Main
     ...
     "  Archivo de salida para los resultados:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 13.38 COL 15
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Empresas a considerar en el listado:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 9.88 COL 15
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Estado de los pedidos a listar:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 6.12 COL 15
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de fechas de los movimientos:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 2.08 COL 15
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Exportación de Datos de Pedidos a Excel"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Exportación de Datos de Pedidos a Excel */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Exportación de Datos de Pedidos a Excel */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 3.15 , 15.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-estado ( 7.19 , 15.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-empresas ( 10.96 , 15.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.88 , 89.00 ) */
       ...
       RUN set-position IN h_v-rng-archivo ( 14.46 , 15.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.88 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
   ...
   RUN poner_nombre_archivo IN h_v-rng-archivo ( INPUT "c:\sic-temp\pedidos.txt").
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/DSP" "Exportación de Datos de Pedidos a Excel"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN exportar_pedidos.p ( INPUT des_fecha,
                                INPUT has_fecha,
