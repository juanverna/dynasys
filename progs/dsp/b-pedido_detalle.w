...
Ped_detalle.granel Ped_detalle.cdg_estado 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Ped_detalle.nro_linea COLUMN-LABEL "Nro.!Linea"
      Articulo.cdg_articulo
      Articulo.descripcion COLUMN-LABEL "Descripción!Artículo"
      Ped_detalle.cantidad COLUMN-LABEL "Cantidad!Pedida"
      Ped_detalle.granel COLUMN-LABEL "Kilaje!Pedido"
      Ped_detalle.cdg_estado COLUMN-LABEL "Código!Estado"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 66 BY 6.72
         BGCOLOR 11 FGCOLOR 9 FONT 4
         TITLE BGCOLOR 11 FGCOLOR 9 "Detalle de Articulos a Enviar".
...
"Ped_detalle.nro_linea" "Nro.!Linea" ? "integer" ? ? ? ? ? ? no ?
...
"Ped_detalle.cantidad" "Cantidad!Pedida" ? "decimal" ? ? ? ? ? ? no ?
     _FldNameList[5]   > sic.Ped_detalle.granel
"Ped_detalle.granel" "Kilaje!Pedido" ? "decimal" ? ? ? ? ? ? no ?
     _FldNameList[6]   > sic.Ped_detalle.cdg_estado
"Ped_detalle.cdg_estado" "Código!Estado" ? "character" ? ? ? ? ? ? no ?
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* Detalle de Articulos a Enviar */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* Detalle de Articulos a Enviar */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* Detalle de Articulos a Enviar */
DO:
