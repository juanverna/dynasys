...
DEFINE VARIABLE h_b-tipotarea AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-tipotareas AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Mantenimiento de Tipos de Tareas"
         HEIGHT             = 11.67
         WIDTH              = 137.6
         MAX-HEIGHT         = 25.33
         MAX-WIDTH          = 137.6
...
ON END-ERROR OF W-Win /* Mantenimiento de Tipos de Tareas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Mantenimiento de Tipos de Tareas */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Mantenimiento de Tipos de Tareas */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-tipotarea.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tipotarea ).
       RUN set-position IN h_b-tipotarea ( 1.48 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-tipotarea ( 9.52 , 45.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-tipotareas.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-tipotareas ).
       RUN set-position IN h_v-tipotareas ( 1.48 , 51.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.38 , 81.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 9.29 , 58.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 1.62 , 69.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-tipotareas. */
       RUN add-link IN adm-broker-hdl ( h_b-tipotarea , 'Record':U , h_v-tipotareas ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-tipotareas ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-tipotareas ,
             h_b-tipotarea , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-tipotareas , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Tipos de Tareas"}
