...
DEFINE VARIABLE h_b-proyecto AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-proyecto AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Mantenimiento de Proyectos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Mantenimiento de Proyectos */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Mantenimiento de Proyectos */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-proyecto.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-proyecto ).
       RUN set-position IN h_v-proyecto ( 1.52 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.19 , 89.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-proyecto.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-proyecto ).
       RUN set-position IN h_b-proyecto ( 8.29 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-proyecto ( 9.38 , 67.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 8.38 , 74.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 9.29 , 13.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-proyecto. */
       RUN add-link IN adm-broker-hdl ( h_b-proyecto , 'Record':U , h_v-proyecto ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-proyecto ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-proyecto ,
             h_v-proyecto , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_b-proyecto , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Proyectos"}
