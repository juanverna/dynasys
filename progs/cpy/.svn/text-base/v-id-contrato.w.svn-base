...
Contrato_hd.prf_contrato Contrato_hd.num_contrato Contrato_hd.titulo ~
Cliente.cdg_cliente Cliente.direccion 
&Scoped-define DISPLAYED-TABLES Contrato_hd Cliente
&Scoped-define FIRST-DISPLAYED-TABLE Contrato_hd
&Scoped-define SECOND-DISPLAYED-TABLE Cliente
...
DEFINE FRAME F-Main
     Contrato_hd.tip_contrato AT ROW 1.48 COL 9 COLON-ALIGNED
          LABEL "Contrato"
          VIEW-AS FILL-IN NATIVE 
          SIZE 7 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Contrato_hd.prf_contrato AT ROW 1.48 COL 17 COLON-ALIGNED
          LABEL "-"
          VIEW-AS FILL-IN NATIVE 
          SIZE 8 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Contrato_hd.num_contrato AT ROW 1.48 COL 26.2
          LABEL "-"
          VIEW-AS FILL-IN NATIVE 
          SIZE 13 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Contrato_hd.titulo AT ROW 1.48 COL 40 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN NATIVE 
          SIZE 54 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Cliente.cdg_cliente AT ROW 2.67 COL 9 COLON-ALIGNED
          LABEL "Cliente"
          VIEW-AS FILL-IN NATIVE 
          SIZE 13.6 BY 1
     Cliente.direccion AT ROW 2.67 COL 24 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN NATIVE 
          SIZE 70 BY 1
...
/* SETTINGS FOR FILL-IN Cliente.direccion IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       Cliente.direccion:READ-ONLY IN FRAME F-Main        = TRUE.
