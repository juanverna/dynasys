...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Contrato_hd WHERE ~{&KEY-PHRASE} ~
      AND Contrato_hd.nro_contrato = 43249 ~
 NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Contrato_hd WHERE ~{&KEY-PHRASE} ~
      AND Contrato_hd.nro_contrato = 43249 ~
 NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "sic.Contrato_hd.nro_contrato = 43249
"
