...
Contrato_dt.anticipo Contrato_dt.detallada 
...
DEFINE FRAME F-Main
     v-cdg_articulo AT ROW 1.24 COL 12 COLON-ALIGNED
     v-dsc_articulo AT ROW 1.24 COL 32 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     Contrato_dt.cantidad AT ROW 2.43 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 19 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Contrato_dt.precio AT ROW 2.43 COL 49 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 18.8 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Contrato_dt.anticipo AT ROW 3.62 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 19 BY 1 TOOLTIP "Anticipo es en valor monetario o es un porcentaje si esta precedido por %"
          BGCOLOR 15 FGCOLOR 9 
     Contrato_dt.detallada AT ROW 5.52 COL 1 NO-LABEL
          VIEW-AS EDITOR SCROLLBAR-VERTICAL
          SIZE 105 BY 2.86 TOOLTIP "Detallada puede utilizar &MES &ANO &CUOTA &DECUOTA"
...
DO:
/*   &SCOPED-DEFINE PONER-TABLA RUN poner_articulo.*/
