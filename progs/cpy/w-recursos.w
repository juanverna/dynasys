...
DEFINE VARIABLE h_b-recursos AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b-recurso_habilidad AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-recurso AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-recurso_habilidad AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     RECT-7 AT ROW 11.24 COL 56 WIDGET-ID 2
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-recursos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-recursos ).
       RUN set-position IN h_b-recursos ( 1.24 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-recursos ( 19.05 , 48.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-recurso ).
       RUN set-position IN h_v-recurso ( 1.24 , 56.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.52 , 62.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 1.24 , 121.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 9.52 , 11.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-recurso_habilidad.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-recurso_habilidad ).
       RUN set-position IN h_b-recurso_habilidad ( 11.48 , 59.00 ) NO-ERROR.
       RUN set-size IN h_b-recurso_habilidad ( 8.57 , 32.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-recurso_habilidad.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-recurso_habilidad ).
       RUN set-position IN h_v-recurso_habilidad ( 11.48 , 94.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.14 , 37.80 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updspa-2 ).
       RUN set-position IN h_p-updspa-2 ( 18.14 , 94.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa-2 ( 1.76 , 37.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-recurso. */
       RUN add-link IN adm-broker-hdl ( h_b-recursos , 'Record':U , h_v-recurso ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-recurso ).

       /* Links to SmartBrowser h_b-recurso_habilidad. */
       RUN add-link IN adm-broker-hdl ( h_b-recursos , 'Record':U , h_b-recurso_habilidad ).

       /* Links to SmartViewer h_v-recurso_habilidad. */
       RUN add-link IN adm-broker-hdl ( h_b-recurso_habilidad , 'Record':U , h_v-recurso_habilidad ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa-2 , 'TableIO':U , h_v-recurso_habilidad ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-recurso ,
             h_b-recursos , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-recurso , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-recurso_habilidad ,
             h_p-updspa , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-recurso_habilidad ,
             h_b-recurso_habilidad , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa-2 ,
             h_v-recurso_habilidad , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Recursos"}
