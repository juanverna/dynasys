...
&Scoped-Define ENABLED-FIELDS Tarea.email Tarea.cdg_cargo Tarea.Visualizar ~
Tarea.cdg_recurso Tarea.prioridad Tarea.cdg_proyecto Tarea.nro_predecesora ~
...
Bhistoria 
&Scoped-Define DISPLAYED-FIELDS Tarea.nro_persona Tarea.email ~
Tarea.cdg_cargo Tarea.Visualizar Tarea.comunicarsepor Tarea.cdg_recurso ~
Tarea.prioridad Tarea.nro_tarea Tarea.cdg_proyecto Tarea.nro_predecesora ~
Tarea.fecha_alta Tarea.hora_alta 
...
v-cdg_cliente rpersona te-1 vte-1 te-2 vte-2 te-3 vte-3 te-4 vte-4 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD dametipo V-table-Win 
FUNCTION dametipo RETURNS CHARACTER
...
DEFINE VARIABLE rpersona AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS COMBO-BOX INNER-LINES 3
     LIST-ITEM-PAIRS "Cliente","CLIEN",
                     "Admin","ADMIN",
                     "No ALTA","NOALTA"
     DROP-DOWN-LIST
     SIZE 16 BY 1
...
DEFINE VARIABLE v-dsc_administrador AS CHARACTER FORMAT "X(60)" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 91 BY 1
...
DEFINE FRAME sF-Main
     v-cdg_administrador AT ROW 1 COL 26 COLON-ALIGNED WIDGET-ID 92
     v-dsc_administrador AT ROW 1 COL 44 COLON-ALIGNED NO-LABEL WIDGET-ID 84
     v-cdg_cliente AT ROW 1.05 COL 5 COLON-ALIGNED WIDGET-ID 2
     bVer AT ROW 1.05 COL 138.6 WIDGET-ID 86
     Tarea.nro_persona AT ROW 2.19 COL 116 NO-LABEL WIDGET-ID 70
          VIEW-AS FILL-IN 
          SIZE 8 BY 1
     rpersona AT ROW 2.19 COL 126 COLON-ALIGNED NO-LABEL WIDGET-ID 76
     te-1 AT ROW 3.33 COL 1.2 COLON-ALIGNED NO-LABEL WIDGET-ID 54
     vte-1 AT ROW 3.33 COL 17.8 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     BUTTON-6 AT ROW 3.38 COL 57.6 WIDGET-ID 96
     Tarea.email AT ROW 3.38 COL 73.2 COLON-ALIGNED WIDGET-ID 52 FORMAT "X(100)"
          VIEW-AS FILL-IN NATIVE 
          SIZE 61 BY 1 TOOLTIP "Email particular"
          BGCOLOR 15 FGCOLOR 9 
     BUTTON-11 AT ROW 4.33 COL 57.6 WIDGET-ID 106
     te-2 AT ROW 4.38 COL 1.2 COLON-ALIGNED NO-LABEL WIDGET-ID 56
     vte-2 AT ROW 4.38 COL 17.8 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     Tarea.cdg_cargo AT ROW 4.38 COL 73.2 COLON-ALIGNED WIDGET-ID 66
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEM-PAIRS "Item 1","Item 1"
          DROP-DOWN-LIST
          SIZE 25 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Tarea.Visualizar AT ROW 5 COL 111 COLON-ALIGNED WIDGET-ID 90
          VIEW-AS FILL-IN NATIVE 
          SIZE 34.6 BY 1 TOOLTIP "Fecha y Hora de visualizacion de la tarea"
          BGCOLOR 15 FGCOLOR 9 
     Tarea.comunicarsepor AT ROW 5.38 COL 73.2 COLON-ALIGNED WIDGET-ID 14
          LABEL "Contactarse"
          VIEW-AS COMBO-BOX 
     ...
     vte-3 AT ROW 5.43 COL 18 COLON-ALIGNED NO-LABEL WIDGET-ID 60
     BUTTON-12 AT ROW 5.43 COL 57.4 WIDGET-ID 108
     te-4 AT ROW 6.43 COL 1.2 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     vte-4 AT ROW 6.43 COL 17.8 COLON-ALIGNED NO-LABEL WIDGET-ID 62
     BUTTON-13 AT ROW 6.43 COL 57.4 WIDGET-ID 110
     Tarea.cdg_recurso AT ROW 6.48 COL 73.2 COLON-ALIGNED WIDGET-ID 44
          LABEL "Se Encarga"
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEM-PAIRS "Item 1","Item 1"
          DROP-DOWN-LIST
          SIZE 25 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Tarea.prioridad AT ROW 6.48 COL 111 COLON-ALIGNED WIDGET-ID 8
          LABEL "PR"
          VIEW-AS COMBO-BOX INNER-LINES 5
          ...
          BGCOLOR 15 FGCOLOR 9 
     Tarea.nro_tarea AT ROW 7.62 COL 9 COLON-ALIGNED
          LABEL "Número"
          VIEW-AS FILL-IN NATIVE 
          SIZE 14 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Tarea.cdg_proyecto AT ROW 7.62 COL 34.2 COLON-ALIGNED WIDGET-ID 28
          LABEL "Proyecto"
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEM-PAIRS "Item 1","Item 1"
          DROP-DOWN-LIST
...
DEFINE FRAME sF-Main
     Bhistoria AT ROW 7.62 COL 133 WIDGET-ID 78
     Tarea.nro_predecesora AT ROW 7.67 COL 112 COLON-ALIGNED WIDGET-ID 80
          VIEW-AS FILL-IN 
          SIZE 10.4 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Tarea.fecha_alta AT ROW 7.91 COL 68 COLON-ALIGNED WIDGET-ID 38
           VIEW-AS TEXT 
          SIZE 10 BY .62
     Tarea.hora_alta AT ROW 7.91 COL 80 COLON-ALIGNED WIDGET-ID 40
          LABEL ":"
           VIEW-AS TEXT 
          SIZE 11 BY .62
...
/* SETTINGS FOR COMBO-BOX Tarea.cdg_proyecto IN FRAME sF-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR COMBO-BOX Tarea.cdg_recurso IN FRAME sF-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR COMBO-BOX Tarea.comunicarsepor IN FRAME sF-Main
   NO-ENABLE EXP-LABEL                                                  */
/* SETTINGS FOR FILL-IN Tarea.email IN FRAME sF-Main
   EXP-FORMAT                                                           */
/* SETTINGS FOR FILL-IN Tarea.hora_alta IN FRAME sF-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN Tarea.nro_persona IN FRAME sF-Main
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       Tarea.nro_persona:HIDDEN IN FRAME sF-Main           = TRUE
       Tarea.nro_persona:READ-ONLY IN FRAME sF-Main        = TRUE.

ASSIGN 
       Tarea.nro_predecesora:READ-ONLY IN FRAME sF-Main        = TRUE.

/* SETTINGS FOR FILL-IN Tarea.nro_tarea IN FRAME sF-Main
   NO-ENABLE EXP-LABEL                                                  */
/* SETTINGS FOR COMBO-BOX Tarea.prioridad IN FRAME sF-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR COMBO-BOX rpersona IN FRAME sF-Main
   NO-ENABLE                                                            */
...
/* SETTINGS FOR FILL-IN v-cdg_cliente IN FRAME sF-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN v-dsc_administrador IN FRAME sF-Main
   NO-ENABLE                                                            */
ASSIGN 
       v-dsc_administrador:READ-ONLY IN FRAME sF-Main        = TRUE.
...
&Scoped-define SELF-NAME Bhistoria
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Bhistoria V-table-Win
ON CHOOSE OF Bhistoria IN FRAME sF-Main /* Historico */
DO:
  IF NOT VALID-HANDLE(hhistorico) THEN DO:
      RUN w-busc-tarea.w PERSISTENT SET hhistorico.
      RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , "Record":U , hhistorico ).
      RUN dispatch IN hhistorico ( "initialize").
  END.
END.
...
DO:
  ...
  IF cliente.nro_admin <> 0 
      THEN DO:
  FIND badminis WHERE badminis.nro_cliente = cliente.nro_admin NO-LOCK NO-ERROR.
...
ON LEAVE OF Tarea.email IN FRAME sF-Main /* E-mail */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-cdg_administrador V-table-Win
ON VALUE-CHANGED OF v-cdg_administrador IN FRAME sF-Main /* Admin */
DO:
  ASSIGN v-cdg_administrador.
  IF v-cdg_administrador = "---" THEN do:
                RELEASE administrador.
                rpersona:SCREEN-VALUE = "NOALTA".
  END.
  ELSE
  FIND administrador WHERE administrador.cdg_cliente = v-cdg_administrador NO-LOCK NO-ERROR.
  v-cdg_administrador:SCREEN-VALUE IN FRAME {&FRAME-NAME}= IF AVAILABLE administrador THEN administrador.cdg_cliente ELSE "---".
  v-dsc_administrador:SCREEN-VALUE IN FRAME {&FRAME-NAME}= IF AVAILABLE administrador THEN administrador.nom_cliente ELSE "No registrado".
  RUN inicia_contacto.
END.
...
&Scoped-define SELF-NAME Tarea.Visualizar
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Tarea.Visualizar V-table-Win
ON MOUSE-MENU-CLICK OF Tarea.Visualizar IN FRAME sF-Main /* Visualizar */
DO:
    {selfecha.i}
END.
...
DEFINE INPUT PARAM p AS ROWID.
    FIND cliente WHERE ROWID(cliente) = p.
    RUN poner_cliente.
    RUN poner_contacto.
END PROCEDURE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE cambio_tipo V-table-Win 
PROCEDURE cambio_tipo :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
DEFINE INPUT PARAMETER p LIKE tarea.cdg_tipotarea.
RUN inicia_recursos.
END PROCEDURE.
...
OCXFile = SEARCH( "v-tarea-red1.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "v-tarea-red1.wrx":U SKIP(1)
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    tarea.cdg_cargo:SENSITIVE = yy.
    v-cdg_cliente:SENSITIVE IN FRAME {&FRAME-NAME} = yy.
    rpersona:SENSITIVE = yy.
    chCtrlFrame:CSComboBox:ENABLED = yy.
    v-cdg_administrador:SENSITIVE = yy.
/*    IF AVAILABLE tarea THEN
       v-cdg_administrador:SENSITIVE = tarea.nro_administrador = 0 AND yy.
    ELSE 
       v-cdg_administrador:SENSITIVE = yy.*/
END.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      END.
      tarea.cdg_cargo:LIST-ITEM-PAIRS = lista .
...
DO WITH FRAME {&FRAME-NAME}:
    ...
    IF AVAILABLE cliente THEN DO:
     IF cliente.nro_cliente <> cliente.nro_admin THEN DO:
...
IF AVAILABLE tarea THEN DO:
        IF tarea.reportado_por <> "" THEN DO:
           chCtrlFrame:CSComboBox:FindString(tarea.reportado_por).
           RUN poner_contacto.
        END.
/*chCtrlFrame:CSComboBox:TEXT = IF AVAILABLE tarea THEN tarea.reportado_por ELSE "".*/
        ELSE DO: /*si no aparece nadie como reportado usar el preferido y sino el primero*/
         IF preferido <> "" THEN DO:   
               ...
               chCtrlFrame:CSComboBox:FindString( persona.nombre + "!CLIEN|" ).
               RUN poner_contacto.
         END.
         ELSE DO:
         IF preferidoadmin <> "" THEN DO:   
               FIND persona WHERE persona.nro_persona = INT(preferidoadmin).
               chCtrlFrame:CSComboBox:FindString( persona.nombre + "|ADMIN|" ).
               RUN poner_contacto.
         END.
         END.
        END.
...
DEFINE VAR solog AS CHARACTER NO-UNDO.
...
FIND tipo_tarea WHERE tipo_tarea.cdg_tipotarea = dametipo() NO-LOCK NO-ERROR.
...
IF AVAILABLE tipo_tarea THEN DO:
  ...
  FOR EACH Recurso BY Recurso.interno DESCENDING :
        ...
        DO i = 1 TO NUM-ENTRIES(recurso.habilidades):
            soloh = soloh +  "," + entry(1,ENTRY(i,recurso.habilidades),"@") NO-ERROR.
            solog = solog +  "," + entry(2,ENTRY(i,recurso.habilidades),"@") NO-ERROR.
        END.
        IF CAN-DO(SUBSTRING(soloh,2), dametipo() ) THEN DO:
           CREATE tt.
           ASSIGN tt.cdg_recurso = recurso.cdg_recurso
                  tt.nom_recurso = Recurso.nom_recurso.
                  IF LOOKUP( SUBSTRING(soloh,2) , dametipo() ) <> 0 THEN
                      tt.grado = int(ENTRY(LOOKUP(SUBSTRING(soloh,2),dametipo()),SUBSTRING(solog,2))).
                  ELSE
                      tt.grado = int(ENTRY(1,SUBSTRING(solog,2))).
        END.
  END. 
...
END.
Tarea.cdg_recurso:LIST-ITEM-PAIRS IN FRAME {&FRAME-NAME} = SUBSTRING(x-lista,2).
...
RUN dispatch IN THIS-PROCEDURE ( INPUT 'add-record':U ) .
  ...
  tarea.cdg_proyecto:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "G".
  tarea.cdg_cargo:SCREEN-VALUE IN FRAME {&FRAME-NAME} = " ".
  tarea.visualizar:SCREEN-VALUE IN FRAME {&FRAME-NAME} = STRING(TODAY).
  v-cdg_cliente:SCREEN-VALUE = "".
   v-dsc_administrador:SCREEN-VALUE = "".
   v-cdg_administrador:SCREEN-VALUE = "---".
  ...
  tarea.cdg_cargo:SCREEN-VALUE = "".
  DO i = 1 TO 4:
          thandle("te-" + STRING(i,"9")):SCREEN-VALUE = "".
...
DEFINE VAR pvisualizar LIKE tarea.visualizar.
DEFINE VAR dformat AS CHAR NO-UNDO.
pvisualizar = tarea.visualizar.
  /* Code placed here will execute PRIOR to standard behavior. */
  IF tarea.visualizar:INPUT-VALUE IN FRAME {&FRAME-NAME} = ? THEN DO: 
      MESSAGE "Valor invalido para la fecha visualizacion" VIEW-AS ALERT-BOX ERROR.
      RETURN ERROR.
  END.
  IF tarea.visualizar:INPUT-VALUE IN FRAME {&FRAME-NAME}> TODAY + 210 THEN DO:
        MESSAGE "No se puede posdatar mas alla del " + string(TODAY + 210) VIEW-AS ALERT-BOX ERROR.
        RETURN ERROR.
  END.

  ASSIGN FRAME {&FRAME-NAME} rpersona.
  IF v-cdg_cliente:SCREEN-VALUE <> "" THEN DO:
      ...
      THEN DO:
          ...
          RETURN ERROR.
      END.
      IF vte-1:SCREEN-VALUE = "" AND
          vte-2:SCREEN-VALUE = "" AND
          vte-3:SCREEN-VALUE = "" AND
          vte-4:SCREEN-VALUE = "" THEN DO:
          MESSAGE "Indique al menos un telefono de contacto" VIEW-AS ALERT-BOX ERROR.
          RETURN ERROR.
      END.
      
      IF tarea.cdg_cargo:SCREEN-VALUE = " " OR tarea.cdg_cargo:SCREEN-VALUE = "" THEN DO:
...
END.
  ...
  THEN DO:
      MESSAGE "No indicó el quien se encarga de la tarea"
  ...
  IF NEW Tarea THEN DO:
    ASSIGN tarea.nro_persona
           tarea.nro_predecesora.
    END.
    tarea.nro_cliente = IF v-cdg_cliente:SCREEN-VALUE = "" THEN 0 ELSE cliente.nro_cliente.
    FIND administrador WHERE administrador.cdg_cliente = v-cdg_administrador NO-LOCK NO-ERROR.
    tarea.nro_administrador = IF AVAILABLE administrador THEN administrador.nro_cliente ELSE 0.


tarea.telefonos = "".
DO i = 1 TO 4:
    tarea.telefonos = tarea.telefonos + "|" +
                                 STRING(thandle("te-" + STRING(i,"9")):SCREEN-VALUE ) +
                                 "!" +
                                 STRING(thandle("vte-" + STRING(i,"9")):SCREEN-VALUE ).
END.
tarea.reportado_por = chCtrlFrame:CSComboBox:TEXT.
tarea.telefonos = SUBSTRING(tarea.telefonos,2 ).

IF tarea.nro_cliente <> 0 THEN DO:
    IF tarea.nro_persona = 0 AND rpersona <> "NOALTA"  THEN DO:
        /*crear la persona*/
        CREATE persona.
        ASSIGN  
            Persona.numeros_telefono = tarea.telefonos
            Persona.nro_persona = NEXT-VALUE(proxima_persona)
            Persona.nombre = Tarea.reportado_por
            Persona.hora_grab = TIME
            Persona.fecha_grab = TODAY
            Persona.email = tarea.email.
        CREATE cliente-contacto.
        ASSIGN  Cliente-contacto.cdg_cargo = tarea.cdg_cargo
            Cliente-contacto.des_fecha = TODAY
            Cliente-contacto.has_fecha = 1/1/2999
            Cliente-contacto.nro_cliente = ( IF rpersona = "ADMIN" THEN tarea.nro_administrador ELSE tarea.nro_cliente )
            Cliente-contacto.nro_domicilio = 1
            Cliente-contacto.nro_persona = persona.nro_persona.
    END.
    ELSE DO:
        IF tarea.nro_persona <> 0 THEN DO:
            FIND persona WHERE persona.nro_persona = tarea.nro_persona NO-ERROR.
            IF NOT AVAILABLE persona THEN DO:
                MESSAGE "Error interno al actualizar persona" SKIP
                    "El registro quedo mal grabado" skip
                    "Avise a sistemas" VIEW-AS ALERT-BOX ERROR.
                RETURN ERROR.
            END.
            ASSIGN 
                Persona.numeros_telefono = tarea.telefonos
                ...
                Persona.fecha_grab = TODAY
                Persona.email = tarea.email.
                FIND cliente-contacto WHERE Cliente-contacto.nro_cliente = ( IF rpersona = "ADMIN" THEN tarea.nro_administrador ELSE tarea.nro_cliente ) AND
                Cliente-contacto.nro_persona = persona.nro_persona NO-ERROR.
                IF NOT AVAILABLE cliente-contacto THEN DO:
                        MESSAGE "Error interno no se encuentra el cliente-contacto" skip
                                "previamente no se puede proseguir" VIEW-AS ALERT-BOX ERROR.
                        RETURN ERROR.
                END.
                ASSIGN 
                    Cliente-contacto.cdg_cargo = tarea.cdg_cargo.
        END.
    END.
END.
IF NEW Tarea
...
END.
IF pvisualizar <> tarea.visualizar THEN DO:
...
END.
IF tarea.nro_predecesora = tarea.nro_tarea THEN
    tarea.nro_predecesora = 0.
IF Tarea.nro_predecesora <> 0 THEN DO:
    FIND btarea WHERE tarea.nro_tarea = tarea.nro_predecesora.
    ASSIGN btarea.estado = "Z". 
END.
...
IF AVAILABLE cliente THEN DO:
  FIND badm WHERE badm.nro_cliente = cliente.nro_admin NO-LOCK NO-ERROR.
...
DEFINE VAR auxtel AS CHAR NO-UNDO.
    ...
    IF chCtrlFrame:CSComboBox:VALUE <> "" THEN DO:
            tarea.nro_persona:SCREEN-VALUE IN FRAME {&FRAME-NAME}= entry(4,chCtrlFrame:CSComboBox:value,"|").
            tarea.cdg_cargo:SCREEN-VALUE = entry(3,chCtrlFrame:CSComboBox:value,"|").
            FIND persona WHERE persona.nro_persona = tarea.nro_persona:INPUT-VALUE NO-LOCK.
            ...
            DO i = 1 TO 4:
             ...
             END.
            END.
            tarea.email:SCREEN-VALUE = persona.email.
            /*rpersona:LIST-ITEM-PAIRS = "Cliente,CLIEN,Admin,ADMIN".*/
            rpersona:SCREEN-VALUE = entry(2,chCtrlFrame:CSComboBox:value,"|").
    END.
    ELSE do:
        tarea.nro_persona:SCREEN-VALUE IN FRAME {&FRAME-NAME}= "0" .
        /*rpersona:LIST-ITEM-PAIRS = "No ALTA,NOALTA" .*/
        IF v-cdg_cliente:SCREEN-VALUE IN FRAME {&FRAME-NAME} <> "0" THEN
               /*rpersona:LIST-ITEM-PAIRS = rpersona:LIST-ITEM-PAIRS + ",Cliente,CLIEN,Admin,ADMIN".*/
        rpersona:SCREEN-VALUE = "NOALTA".
    END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE predecesora V-table-Win 
PROCEDURE predecesora :
/*------------------------------------------------------------------------------
  Purpose:     Pone como predecesora una tarea al grabar tiene que 
  cambiar el estado de la predecesora y la vigente.
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
DEFINE INPUT PARAMETER p AS INT.
MESSAGE "LLEGO" p.
tarea.nro_predecesora:SCREEN-VALUE IN FRAME {&FRAME-NAME} = STRING(p).
END PROCEDURE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION dametipo V-table-Win 
FUNCTION dametipo RETURNS CHARACTER
  ( /* parameter-definitions */ ) :
/*------------------------------------------------------------------------------
  Purpose: retorna el tipo de tarea que se esta tratando 
    Notes:  
------------------------------------------------------------------------------*/
DEFINE VAR aux AS CHAR NO-UNDO.
DEFINE VAR hproc AS WIDGET-HANDLE.
DEFINE VAR hcproc AS CHARACTER.
RUN get-link-handle IN adm-broker-hdl
      ( INPUT THIS-PROCEDURE,
        INPUT "partner-source",
        OUTPUT hcproc ) NO-ERROR.
 
 hproc = WIDGET-HANDLE(hcproc).
 IF VALID-HANDLE(hproc) THEN
  RUN dametipo IN hproc ( OUTPUT aux ).
  RETURN aux.   /* Function return value. */
