...
DEFINE VARIABLE h_b-parterareas AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Mantenimiento de Partes de Tareas"
         HEIGHT             = 20.86
         WIDTH              = 112.8
         MAX-HEIGHT         = 21.29
         MAX-WIDTH          = 114.2
...
ON END-ERROR OF W-Win /* Mantenimiento de Partes de Tareas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Mantenimiento de Partes de Tareas */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Mantenimiento de Partes de Tareas */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-parterareas.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-parterareas ).
       RUN set-position IN h_b-parterareas ( 1.29 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-parterareas ( 8.86 , 64.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Partes de Tareas"}
