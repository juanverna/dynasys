...
&Scoped-define DATA-FIELD-DEFS "drepschtabla.i"

/* Name of designated FRAME-NAME and/or first browse and/or first query */
&Scoped-define FRAME-NAME F-Main

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS RowObject.Tabla RowObject.TablaMEsquema ~
RowObject.Descripcion 
&Scoped-define ENABLED-TABLES RowObject
&Scoped-define FIRST-ENABLED-TABLE RowObject
&Scoped-Define ENABLED-OBJECTS RECT-1 
&Scoped-Define DISPLAYED-FIELDS RowObject.Tabla RowObject.TablaMEsquema ~
RowObject.Descripcion 
...
DEFINE FRAME F-Main
     RowObject.Tabla AT ROW 1.24 COL 20.8 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 66 BY 1
     RowObject.TablaMEsquema AT ROW 2.24 COL 20.8 COLON-ALIGNED WIDGET-ID 6
          LABEL "Nombre M. Esquema"
          VIEW-AS FILL-IN 
          SIZE 66 BY 1
     RowObject.Descripcion AT ROW 3.33 COL 22.8 NO-LABEL WIDGET-ID 8
...
/* SETTINGS FOR FILL-IN RowObject.TablaMEsquema IN FRAME F-Main
   EXP-LABEL                                                            */
