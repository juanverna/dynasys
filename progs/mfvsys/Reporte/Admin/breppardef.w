...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.Nombre rowObject.Tipo ~
rowObject.Valor 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      rowObject.Nombre FORMAT "x(15)":U
      rowObject.Tipo FORMAT "x(12)":U
      rowObject.Valor FORMAT "x(25)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.Nombre
     _FldNameList[2]   = _<SDO>.rowObject.Tipo
     _FldNameList[3]   = _<SDO>.rowObject.Valor
