...
&Scoped-Define ENABLED-OBJECTS v-codigo RECT-8 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-codigo V-table-Win
...
DO:
    ...
    h = WIDGET-HANDLE(c).
    IF VALID-HANDLE(h)
        THEN RUN reposicionar_query IN h ( INPUT v-codigo ).
