...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Rutaproceso Lineaproceso
&Scoped-define FIRST-EXTERNAL-TABLE Rutaproceso


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Rutaproceso, Lineaproceso.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Rutaproceso.num_orden 
&Scoped-define ENABLED-TABLES Rutaproceso
&Scoped-define FIRST-ENABLED-TABLE Rutaproceso
&Scoped-Define ENABLED-OBJECTS RECT-9 
&Scoped-Define DISPLAYED-FIELDS Rutaproceso.num_orden 
&Scoped-define DISPLAYED-TABLES Rutaproceso
&Scoped-define FIRST-DISPLAYED-TABLE Rutaproceso
...
DEFINE FRAME F-Main
     v-cdg_operacionfabrica AT ROW 1.48 COL 12 COLON-ALIGNED
     v-dsc_operacionfabrica AT ROW 1.48 COL 29 COLON-ALIGNED NO-LABEL
     Rutaproceso.num_orden AT ROW 1.48 COL 87 COLON-ALIGNED
          LABEL "Orden"
          VIEW-AS FILL-IN NATIVE 
          SIZE 16 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: sic.Rutaproceso,sic.Lineaproceso
...
/* SETTINGS FOR FILL-IN Rutaproceso.num_orden IN FRAME F-Main
   EXP-LABEL                                                            */
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
   ...
   &SCOPED-DEFINE TABLA-MAESTRA  Rutaproceso

   {validartabla.i "Operacionfabrica" "cdg_operacion" "dsc_operacion" "CLIE008"} 
  ...
  /* Code placed here will execute AFTER standard behavior.    */
   ...
   Rutaproceso.nro_lineaproceso = Lineaproceso.nro_lineaproceso.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE Rutaproceso
  THEN DO:

        &SCOPED-DEFINE TABLA-MAESTRA  Rutaproceso
     
        {displaytabla.i "Operacionfabrica" "cdg_operacion" "cdg_operacion" "nro_operacion" "nro_operacion"} 
