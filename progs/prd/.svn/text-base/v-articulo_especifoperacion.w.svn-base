...
&Scoped-Define ENABLED-FIELDS Especif_operarticulo.num_orden ~
Especif_operarticulo.valor_especificacion ~
...
&Scoped-Define DISPLAYED-FIELDS Especif_operarticulo.num_orden ~
Especif_operarticulo.valor_especificacion ~
Especif_operarticulo.valor_deseado Especif_operarticulo.valor_minimo ~
Especif_operarticulo.valor_maximo Especif_operarticulo.observacion 
...
DEFINE FRAME F-Main
     ...
     Especif_operarticulo.num_orden AT ROW 2.43 COL 91 COLON-ALIGNED
          LABEL "Orden" FORMAT ">>>>>9"
          VIEW-AS FILL-IN NATIVE 
          SIZE 10 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Especif_operarticulo.valor_especificacion AT ROW 5.05 COL 22 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 25 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Especif_operarticulo.valor_deseado AT ROW 5.05 COL 76 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 25 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Especif_operarticulo.valor_minimo AT ROW 6.24 COL 22 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 25 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Especif_operarticulo.valor_maximo AT ROW 6.24 COL 76 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 25 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Especif_operarticulo.observacion AT ROW 7.67 COL 5 NO-LABEL
...
/* SETTINGS FOR FILL-IN Especif_operarticulo.num_orden IN FRAME F-Main
