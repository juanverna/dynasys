...
FOR EACH Rutaproceso OF Lineaproceso NO-LOCK, Operacionfabrica OF Rutaproceso NO-LOCK:
    ...
    THEN DO:
        ...
        FOR EACH Formula_articulo 
            WHERE Formula_articulo.nro_art_compuesto = Articulo.nro_articulo
              AND Formula_articulo.nro_operacion = Rutaproceso.nro_operacion,
            ...
            IF CAN-FIND(FIRST Formula_articulo 
                        WHERE Formula_articulo.nro_art_compuesto = Componente.nro_articulo)
            THEN DO:
                RUN generar_rutaproceso.p ( INPUT Componente.nro_articulo,
