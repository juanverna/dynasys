...
DEFINE VARIABLE h_b-formula_articulo AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Formulaciones' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-formula_articulo.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-formula_articulo ).
       RUN set-position IN h_b-formula_articulo ( 4.81 , 37.00 ) NO-ERROR.
       RUN set-size IN h_b-formula_articulo ( 12.14 , 104.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-formula_articulo ( 17.43 , 37.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 23.38 , 37.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_b-formula_articulo. */
       RUN add-link IN adm-broker-hdl ( h_b-articulo , 'Record':U , h_b-formula_articulo ).

       /* Links to SmartViewer h_v-formula_articulo. */
       RUN add-link IN adm-broker-hdl ( h_b-formula_articulo , 'Record':U , h_v-formula_articulo ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-formula_articulo ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/INV" "Mantenimiento de Formulas de Articulos"}
