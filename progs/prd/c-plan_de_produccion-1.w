...
&Scoped-Define DISPLAYED-OBJECTS v-anulado v-pto_venta v-cdg_area ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BRW-DETALLE C-Win _STRUCTURED
  QUERY BRW-DETALLE NO-LOCK DISPLAY
      ...
      T-Planprod_dt.observacion COLUMN-LABEL "Observación!de Detalle" FORMAT "X(50)":U
            WIDTH 36.6 COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
  ENABLE
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 157 BY 16.43
...
DEFINE FRAME DEFAULT-FRAME
     ...
     T-Planprod_hd.tip_comprob AT ROW 3.86 COL 11 COLON-ALIGNED
          LABEL "Plan"
          VIEW-AS FILL-IN NATIVE 
          SIZE 8.6 BY 1
          BGCOLOR 7 FGCOLOR 15 
     T-Planprod_hd.prf_comprob AT ROW 3.86 COL 21 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN NATIVE 
          SIZE 7.6 BY 1
          BGCOLOR 7 FGCOLOR 15 
     T-Planprod_hd.nro_comprob AT ROW 3.86 COL 30 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN NATIVE 
          SIZE 13.2 BY 1
          BGCOLOR 7 FGCOLOR 15 
     v-anulado AT ROW 3.86 COL 44 COLON-ALIGNED NO-LABEL
     v-pto_venta AT ROW 3.86 COL 67 COLON-ALIGNED NO-LABEL
     T-Planprod_hd.fecha_inicio AT ROW 3.86 COL 94 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 17 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Planprod_hd.fecha_final AT ROW 3.86 COL 139 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 17 BY 1
          BGCOLOR 15 FGCOLOR 9 
     ...
     v-dsc_empleado AT ROW 5.05 COL 113 COLON-ALIGNED NO-LABEL
     v-cdg_articulo AT ROW 7.67 COL 2 NO-LABEL
     T-Planprod_hd.leyenda AT ROW 7.67 COL 25 NO-LABEL
          VIEW-AS EDITOR SCROLLBAR-VERTICAL
          SIZE 133 BY 4
          BGCOLOR 15 FGCOLOR 9 
     BRW-DETALLE AT ROW 11.95 COL 1
...
"T-Planprod_dt.observacion" "Observación!de Detalle" "X(50)" "character" 11 9 ? ? ? ? yes ? no no "36.6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BRW-DETALLE */
&ANALYZE-RESUME
...
DO:
  ...
  CASE modo:
     ...
     WHEN MD_MULTIPLE      
     THEN DO:
          titulo_window = "Selección de Planes de Producción".
          lista_estados = "*".
     END.
     ...
     WHEN MD_READONLY      
     THEN DO:
          titulo_window = "Selección Planes de Producción".
          lista_estados = "*".
     END.
     WHEN MD_CAMBIO        
     THEN DO:
  ...
  RUN d-selplaprod.w (INPUT titulo_window, INPUT lista_estados, INPUT Tipocomprobante.tip_comprob, INPUT-OUTPUT rid_planprod).
  IF rid_planprod <> ?
  THEN DO:
     FIND Planprod_hd WHERE ROWID(Planprod_hd) = rid_planprod NO-LOCK.
...
------------------------------------------------------------------------------*/
  ...
  DO TRANSACTION:
      ...
      ASSIGN T-Planprod_hd.nro_usuario    = Usuario.nro_usuario 
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY v-anulado v-pto_venta v-cdg_area v-dsc_area v-cdg_empleado 
...
------------------------------------------------------------------------------*/
    ...
    DO TRANSACTION:
       ...
       v-prox_docum = "PPRO" + STRING(v-pto_venta,"9999").
       ...
       BUFFER-COPY T-Planprod_hd TO Planprod_hd
           ASSIGN  Planprod_hd.nro_planprod   = NEXT-VALUE(proximo_planprod)
                   Planprod_hd.ultima_linea = 0
                   Planprod_hd.tip_comprob  = "PP" /*v-tip_comprob */
                   Planprod_hd.prf_comprob  = v-pto_venta
                   Planprod_hd.nro_comprob  = Parametro.valor_n
       ...
       /*       
       RUN emitir_pedido.p ( ROWID(Planprod_hd)).       
       v-ultimo_pedido = Planprod_hd.nro_comprob.
       v-ultimo_estado = Planprod_hd.cdg_estado.
...
------------------------------------------------------------------------------*/
  ...
  RUN titulo_window ("Planes de Producción").
