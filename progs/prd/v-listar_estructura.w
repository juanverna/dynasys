...
&Scoped-Define ENABLED-FIELDS Articulo.nro_articulo 
...
&Scoped-Define DISPLAYED-FIELDS Articulo.nro_articulo 
...
DEFINE FRAME F-Main
     ...
     Articulo.nro_articulo AT ROW 1.24 COL 2 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 4 BY 1
...
ASSIGN 
       Articulo.nro_articulo:HIDDEN IN FRAME F-Main           = TRUE.
...
ON CHOOSE OF BUTTON-1 IN FRAME F-Main /* Listar */
DO:
  DEFINE VARIABLE nivel_maximo AS INTEGER.
  IF AVAILABLE Articulo 
  THEN DO:
      RUN imprimir_rutaarticulo.p ( INPUT ROWID(Articulo)).
  END.
END.
