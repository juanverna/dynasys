...
DEFINE VARIABLE h_b-especificaciones AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-especificacion AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Especificaciones */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Especificaciones */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Especificaciones */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-especificaciones.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-especificaciones ).
       RUN set-position IN h_b-especificaciones ( 1.24 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-especificaciones ( 23.81 , 19.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-especificacion.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-especificacion ).
       RUN set-position IN h_v-especificacion ( 1.24 , 24.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.91 , 80.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa-2 ).
       RUN set-position IN h_p-updspa-2 ( 9.10 , 24.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa-2 ( 2.14 , 80.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-especificacion. */
       RUN add-link IN adm-broker-hdl ( h_b-especificaciones , 'Record':U , h_v-especificacion ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa-2 , 'TableIO':U , h_v-especificacion ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-especificacion ,
             h_b-especificaciones , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa-2 ,
             h_v-especificacion , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/PRD" "Especificaciones"}
...
*/
 ...
 IF VALID-HANDLE(h_b-especificaciones) THEN RUN set-sensitivo IN h_b-especificaciones ( INPUT p-operacion = "HABILITAR" ).
