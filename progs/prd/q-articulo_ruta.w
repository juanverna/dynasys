...
&Scoped-define INTERNAL-TABLES Tipo_articulo Lineaproceso

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH Tipo_articulo OF Articulo WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH Lineaproceso OF Tipo_articulo NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Tipo_articulo OF Articulo WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH Lineaproceso OF Tipo_articulo NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Tipo_articulo Lineaproceso
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Tipo_articulo
&Scoped-define SECOND-TABLE-IN-QUERY-Query-Main Lineaproceso
...
nro_lineaproceso||y|sic.Tipo_articulo.nro_lineaproceso
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nro_comprador,nro_lineaproceso,cdg_tipoart"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "sic.Tipo_articulo OF sic.Articulo,sic.Lineaproceso OF sic.Tipo_articulo"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "nro_lineaproceso" "Tipo_articulo" "nro_lineaproceso"}
