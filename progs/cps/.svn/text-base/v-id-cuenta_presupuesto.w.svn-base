...
&Scoped-Define ENABLED-FIELDS Ctapsp.cdg_ctapsp Ctapsp.nombre_cps 
&Scoped-define ENABLED-TABLES Ctapsp
&Scoped-define FIRST-ENABLED-TABLE Ctapsp
&Scoped-Define ENABLED-OBJECTS RECT-6 
&Scoped-Define DISPLAYED-FIELDS Ctapsp.cdg_ctapsp Ctapsp.nombre_cps 
...
DEFINE FRAME F-Main
     Ctapsp.cdg_ctapsp AT ROW 1.52 COL 9 COLON-ALIGNED
          LABEL "Cuenta"
          VIEW-AS FILL-IN NATIVE 
          SIZE 12.8 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Ctapsp.nombre_cps AT ROW 1.52 COL 23 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN NATIVE 
          SIZE 52 BY 1
          BGCOLOR 15 FGCOLOR 9 
...
/* SETTINGS FOR FILL-IN Ctapsp.cdg_ctapsp IN FRAME F-Main
   EXP-LABEL                                                            */
