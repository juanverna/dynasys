...
&Scoped-define INTERNAL-TABLES Ctapsp

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Ctapsp.cdg_ctapsp 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH Ctapsp WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Ctapsp WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table Ctapsp
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Ctapsp
...
<FOREIGN-KEYS>
nro_ctapsp||y|sic.Ctapsp.nro_ctapsp
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Ctapsp.cdg_ctapsp FORMAT "X(10)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > sic.Ctapsp.cdg_ctapsp
"Ctapsp.cdg_ctapsp" ? "X(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "nro_ctapsp" "Ctapsp" "nro_ctapsp"}
