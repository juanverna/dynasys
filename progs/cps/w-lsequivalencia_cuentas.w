...
DEFINE FRAME F-Main
     v-estado AT ROW 20.57 COL 28 COLON-ALIGNED NO-LABEL
     "  Rango de cuentas de Presupuesto:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 7.19 COL 30
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-ctapsp ( 8.52 , 30.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 22.19 , 30.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsequivalencia_cuentas.p ( INPUT  des_ctapsp,
                                      INPUT  has_ctapsp).
