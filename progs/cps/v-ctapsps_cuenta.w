...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Ctapsp Ctapsp-cuenta
&Scoped-define FIRST-EXTERNAL-TABLE Ctapsp


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Ctapsp, Ctapsp-cuenta.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Ctapsp-cuenta.nro_ctapsp 
&Scoped-define ENABLED-TABLES Ctapsp-cuenta
&Scoped-define FIRST-ENABLED-TABLE Ctapsp-cuenta
...
DEFINE FRAME F-Main
     Ctapsp-cuenta.nro_ctapsp AT ROW 1.29 COL 67 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8.6 BY 1
     v-cdg_cuenta AT ROW 1.48 COL 15 COLON-ALIGNED
     v-dsc_cuenta AT ROW 1.48 COL 30 COLON-ALIGNED NO-LABEL
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: sic.Ctapsp,sic.Ctapsp-cuenta
...
/* SETTINGS FOR FILL-IN Ctapsp-cuenta.nro_ctapsp IN FRAME F-Main
   NO-DISPLAY                                                           */
ASSIGN 
       Ctapsp-cuenta.nro_ctapsp:HIDDEN IN FRAME F-Main           = TRUE.
...
ON MOUSE-SELECT-DBLCLICK OF v-cdg_cuenta IN FRAME F-Main /* Cuenta Real */
OR "." OF v-cdg_cuenta IN FRAME {&FRAME-NAME}
OR MOUSE-MENU-DOWN OF v-cdg_cuenta IN FRAME {&FRAME-NAME}
DO:

  &SCOPED-DEFINE ROWID_TABLA    rid_ventas
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-cdg_cuenta V-table-Win
ON RETURN OF v-cdg_cuenta IN FRAME F-Main /* Cuenta Real */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "Ctapsp-cuenta"}
  ...
  {src/adm/template/row-find.i "Ctapsp-cuenta"}
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
   ...
   &SCOPED-DEFINE TABLA-MAESTRA  Ctapsp-cuenta
  ...
  /* Code placed here will execute AFTER standard behavior.    */
   ...
   &UNDEFINE TABLA-MAESTRA
    ...
    Ctapsp-cuenta.nro_ctapsp = Ctapsp.nro_ctapsp.
