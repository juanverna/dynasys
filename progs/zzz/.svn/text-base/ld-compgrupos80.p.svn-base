...
IF V-EMPRESA = "A"
THEN DO:
     INPUT STREAM Grupos    FROM "c:\desa\sic\r3.0\db\interfazu\grcat".
END.
ELSE DO:
     INPUT STREAM Grupos    FROM "c:\desa\sic\r3.0\db\interfroj\grcat".
END.
...
REPEAT:
    ...
    FIND Grupofam WHERE Grupofam.cdg_grupofam = V-CODGRUPO + "G"
