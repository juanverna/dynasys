...
PROCEDURE forma:
    ...
    RUN escribenumero( INPUT "100,130",  INPUT STRING(23564.78,"->,>>>,>>9.99"), tam, YES).
    RUN escribenumero( INPUT "104,130",  INPUT STRING(    1.45,"->,>>>,>>9.99"), tam, YES).
    RUN escribenumero( INPUT "108,130",  INPUT STRING(  564.11,"->,>>>,>>9.99"), tam, YES).
    RUN escribenumero( INPUT "112,130",  INPUT STRING(  789.65,"->,>>>,>>9.99"), tam, YES).
    RUN escribenumero( INPUT "116,130",  INPUT STRING(  209.00,"->,>>>,>>9.99"), tam, YES).
