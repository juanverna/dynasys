...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Entregas previstas por Fecha/Articulo"
         HEIGHT             = 22.76
         WIDTH              = 132
         MAX-HEIGHT         = 27.33
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Entregas previstas por Fecha/Articulo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Entregas previstas por Fecha/Articulo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-lst-estados ( 11.00 , 41.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/COM" "Entregas previstas por Fecha/Articulo"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsocompra_xfecha.p ( INPUT des_fecha,
                                INPUT has_fecha).
