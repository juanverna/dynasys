/*=================================================================================*/
/*                                                                                 */
/*  GENERA LAS O/COMPRA DE LOS DISTINTOS PROVEEDORES ADJUDICADOS EN UN CONCURSO    */
/*                                                                                 */
/*=================================================================================*/

DEFINE INPUT PARAMETER que_concurso  AS ROWID.
...
DO TRANSACTION:
    ...
    FIND Concurso_precios WHERE ROWID(Concurso_precios) = que_concurso EXCLUSIVE-LOCK.

    FOR EACH Concurso_item OF Concurso_precios EXCLUSIVE-LOCK, 
             FIRST Articulo OF Concurso_item NO-LOCK,
             EACH  Concurso_cotiza EXCLUSIVE-LOCK
                   WHERE Concurso_cotiza.nro_concurso = Concurso_item.nro_concurso
                     AND Concurso_cotiza.nro_articulo = Concurso_item.nro_articulo
                     AND Concurso_cotiza.st_item = "A",
             FIRST Proveedor NO-LOCK OF Concurso_cotiza 
...
PROCEDURE CREAR_DETALLE:
   ...
   ASSIGN Ocm_detalle.nro_ocompra         = Ocm_header.nro_ocompra 
          ...
          Ocm_detalle.nro_Articulo        = Articulo.nro_articulo
          Ocm_detalle.a_granel            = Articulo.a_granel
