...
DEFINE FRAME F-Main
     v-estado AT ROW 15.29 COL 13 COLON-ALIGNED NO-LABEL
     "  Listar movimientos del período:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 4.81 COL 15
          BGCOLOR 5 FGCOLOR 15 FONT 6
     " Considerar el siguiente rango de códigos:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 9.1 COL 15
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Entregas previstas por Articulo/Fecha"
         HEIGHT             = 22.76
         WIDTH              = 132
         MAX-HEIGHT         = 27.33
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Entregas previstas por Articulo/Fecha */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Entregas previstas por Articulo/Fecha */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 5.91 , 15.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-articulo ( 10.29 , 15.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 16.71 , 15.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/COM" "Entregas previstas por Articulo y Partida"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsocompra_xarticulo_partida.p ( INPUT des_codart,
                                           INPUT has_codart,
                                           INPUT des_fecha,
                                           INPUT has_fecha).
