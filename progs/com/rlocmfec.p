...
/*   {SCRNGART.I}
   ...
   WITH FRAME frm-rango SIDE-LABELS CENTERED ROW 2 FGCOLOR f-fg_c BGCOLOR f-bg_c
        TITLE "Ordenes de Compra por fecha" FONT 8 THREE-D KEEP-TAB-ORDER.

/*=================================================================================*/
/*                      T R I G G E R S    D E    U S U A R I O                    */
/*=================================================================================*/

{TGRESULT.I "lsocmfec.txt" "port" }
/*{VERANART.I }*/
...
DO:
  ...
  RUN LSOCMFEC.P ( INPUT des_fecha, 
                   INPUT has_fecha,
                   INPUT disp_out).
...
nom_funcion = "Reportes de O/Compra por Fecha".
nom_menu = "COMPRAS".
