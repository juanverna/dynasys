...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Concurso_cotiza WHERE TRUE /* Join to Concurso_item incomplete */ ~
      AND Concurso_cotiza.nro_concurso = Concurso_item.nro_concurso ~
 AND Concurso_cotiza.nro_articulo = Concurso_item.nro_articulo ~
 AND Concurso_cotiza.st_item = "A" NO-LOCK, ~
      EACH Proveedor OF Concurso_cotiza NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Concurso_cotiza Proveedor
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Concurso_cotiza
