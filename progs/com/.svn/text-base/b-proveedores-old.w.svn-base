...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Proveedor NO-LOCK ~
    BY Proveedor.nombre INDEXED-REPOSITION.
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cdg_articulo,nro_articulo,descripcion,nro_familia,cdg_tipoart,cdg_umed"':U).
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 42 BY 11.25
...
DEFINE FRAME F-Main
     v-que_proveedor AT ROW 1.25 COL 6 COLON-ALIGNED
...
/* Query rebuild information for BROWSE br_table
     ...
     _OrdList          = "sic.Proveedor.nombre|yes"
