...
&Scoped-Define ENABLED-FIELDS Concurso_item.cantidad 
&Scoped-define FIELD-PAIRS~
 ~{&FP1}cantidad ~{&FP2}cantidad ~{&FP3}
&Scoped-define ENABLED-TABLES Concurso_item
&Scoped-define FIRST-ENABLED-TABLE Concurso_item
&Scoped-Define ENABLED-OBJECTS RECT-6 
&Scoped-Define DISPLAYED-FIELDS Concurso_item.cantidad 
...
DEFINE FRAME F-Main
     Concurso_item.cantidad AT ROW 1.27 COL 23 COLON-ALIGNED
...
/* SETTINGS FOR FILL-IN Concurso_item.cantidad IN FRAME F-Main
   EXP-LABEL                                                            */
