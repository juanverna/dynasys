...
FOR EACH B-Rem_detalle_prv OF {1}Rem_header_prv, Articulo OF B-Rem_detalle_prv,
    ...
    FIND {1}Sub_detalle_inv 
         WHERE {1}Sub_detalle_inv.nro_proveedor  = {1}Rem_header_prv.nro_proveedor
           ...
           AND {1}Sub_detalle_inv.nro_entidad    = B-Rem_detalle_prv.nro_entidad
           AND {1}Sub_detalle_inv.nro_obra       = B-Rem_detalle_prv.nro_obra
    ...
    THEN DO:
       ...
       ASSIGN
              ...
              {1}Sub_detalle_inv.nro_entidad    = B-Rem_detalle_prv.nro_entidad
              {1}Sub_detalle_inv.nro_obra       = B-Rem_detalle_prv.nro_obra
              {1}Sub_detalle_inv.tipo           = 2.
    END.

    {1}Sub_detalle_inv.valor = {1}Sub_detalle_inv.valor +
        ( IF B-Rem_detalle_prv.a_granel 
             THEN ROUND( B-Rem_detalle_prv.precio * B-Rem_detalle_prv.granel   , 2 )
             ELSE ROUND( B-Rem_detalle_prv.precio * B-Rem_detalle_prv.cantidad , 2 ) ).
...
{1}Rem_header_prv.imp_total = {1}Rem_header_prv.imp_neto.
     ...
     /* Crea el ultimo renglon de subdiario con un debito a la cuenta del encabezado */
