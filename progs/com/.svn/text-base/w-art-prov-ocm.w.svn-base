...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "SIC/INV Rel 2.4 - Consulta de ARTICULO-PROVEEDOR"
         HEIGHT             = 17.19
         WIDTH              = 88.89
         MAX-HEIGHT         = 18
         MAX-WIDTH          = 88.89
...
ON END-ERROR OF W-Win /* SIC/INV Rel 2.4 - Consulta de ARTICULO-PROVEEDOR */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* SIC/INV Rel 2.4 - Consulta de ARTICULO-PROVEEDOR */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-articulos ( 1.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.00 , 43.00 ) */
       ...
       RUN set-position IN h_b-provs-artic-ocm ( 1.75 , 47.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.00 , 41.00 ) */
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-provs-artic-ocm ,
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/COM" "Consulta de Relación ARTICULO-PROVEEDOR"}
