...
FOR EACH Fac_header 
    ...
    IF fac_header.fecha_impresion <> ?  THEN DO:
        ...
        IF ldeuda <> ? THEN DO:
            rok = TEMP-TABLE XTTDEUDA:READ-XML("LONGCHAR",ldeuda,"EMPTY",?,?) NO-ERROR.
            FOR EACH XTTDEUDA:
                ...
                WHERE cta_cte.nro_cliente = fac_header.nro_cliente
                  ...
                  AND cta_cte.fecha_vencimiento <= fac_header.fecha - 5 :
                     ...
                     ASSIGN XTTDEUDA.nro_factura = fac_header.nro_factura
                            ...
                            totdeuda =  totdeuda + XTTDEUDA.imp_total.
            END.
            FIND FIRST XTTDEUDA NO-LOCK NO-ERROR.
    ...
    IF fac_header.cod_docu = "NO" THEN 
        ASSIGN ttheader.cod_docu = ""
               ttheader.cuit = "".
...
RUN prfab234eMR.p( "FA" ,3,1,1, "P", output sal).
*/
