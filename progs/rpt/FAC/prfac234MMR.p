...
FOR EACH Fac_header 
    ...
    AND (( p-timpre = 1 AND fac_header.impreso = "S" ) OR ( p-timpre = 0 AND fac_header.impreso <> "S" )) :
    ...
    END.
    CREATE ttheader.
    BUFFER-COPY fac_header TO ttheader.
