...
ON + OF des_registro IN FRAME F-Main /* Caja */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL des_registro V-table-Win
ON MOUSE-MENU-DOWN OF des_registro IN FRAME F-Main /* Caja */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL des_registro V-table-Win
ON RETURN OF des_registro IN FRAME F-Main /* Caja */
DO:
    {findempresa.i}
...
{findempresa.i}
  ...
  DO WITH FRAME {&FRAME-NAME}:
        ...
        FIND caja WHERE Caja.cdg_caja = des_registro NO-LOCK NO-ERROR.
        IF AVAILABLE Caja 
        THEN DO:
            IF NOT CAN-DO(Caja.lista_usuarios,Usuario.cdg_usuario)
            THEN DO:
        ...
        END.
        ELSE do:
            MESSAGE "Caja no encontrada"VIEW-AS ALERT-BOX ERROR.
                error_rango = YES.
        END.
