...
&Scoped-Define ENABLED-OBJECTS RECT-1 v-cdg_caja v-cdg_cuenta_bancaria ~
v-fecha_deposito v-totdeposito v-referencia Btn_OK Btn_Cancel 
...
DEFINE FRAME Dialog-Frame
     ...
     "                    EXTRACCCION DE EFECTIVO" VIEW-AS TEXT
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "Registro de extracciones de efectivo"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Registro de extracciones de efectivo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-1 v-cdg_caja v-cdg_cuenta_bancaria v-fecha_deposito v-totdeposito 
         v-referencia Btn_OK Btn_Cancel 
      WITH FRAME Dialog-Frame.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE extraer_efectivo Dialog-Frame 
PROCEDURE extraer_efectivo :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
    ...
    DO TRANSACTION:
        ...
        ASSIGN Caj_header.fecha           = v-fecha_deposito
               ...
               Caj_header.observacion     = "Extracción Bancaria"
       ...
       ASSIGN Cta_cte_bco.tip_comprob     = Caj_header.tip_comprob
              ...
              Cta_cte_bco.debito          = v-totdeposito
 ...
 END. /* De la transaccion de extracción */
 
 MESSAGE "Comprobante " v-comprobante
         VIEW-AS ALERT-BOX MESSAGE TITLE "Extracción registrada". 
