...
DEFINE FRAME F-Main
     v-estado AT ROW 20.52 COL 11 COLON-ALIGNED NO-LABEL
     "   Indique el rango de clientes a considerar" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 1.81 COL 13
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "   Indique el/los estados de los valores a listar" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 10.05 COL 13
          BGCOLOR 5 FGCOLOR 15 FONT 6
     ...
     "   Indique si desea el listado consolidado o solo para la empresa actual" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 16.52 COL 12.8
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Reporte de Valores X Cliente"
         HEIGHT             = 25.81
         WIDTH              = 123
         MAX-HEIGHT         = 25.81
         MAX-WIDTH          = 127.2
...
ON END-ERROR OF W-Win /* Reporte de Valores X Cliente */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Reporte de Valores X Cliente */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cliente ( 2.86 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-estadovalores ( 11.24 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-consolidado ( 17.81 , 13.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 22.14 , 13.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/TES" "Reporte de Valores x Cliente"}
...
------------------------------------------------------------------------------*/
  ...
  RUN dar_rango IN h_v-rng-cliente ( OUTPUT des_codigo, 
                                     OUTPUT has_codigo, 
                                     OUTPUT des_nombre, 
                                     OUTPUT has_nombre, 
                                     OUTPUT ver_por,
  ...
  */
  ...
  THEN DO:
    ...
    RUN lsvaloresxcliente.p (   INPUT ver_por,
                                INPUT des_codigo,
                                INPUT has_codigo,
                                INPUT des_nombre,
                                INPUT has_nombre,
