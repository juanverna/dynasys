...
DEFINE VARIABLE h_q-caja AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-id-caja AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN add-link IN adm-broker-hdl ( h_q-caja , 'Record':U , h_b-valores_cedidos ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-id-caja ).
       RUN set-position IN h_v-id-caja ( 1.24 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.62 , 63.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '//server_merino/dynasys/r3.5/progs_user/q-caja.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-caja ).
       RUN set-position IN h_q-caja ( 1.71 , 81.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.43 , 9.00 ) */

       /* Links to SmartQuery h_q-caja. */
       RUN add-link IN adm-broker-hdl ( h_v-id-caja , 'Posicionar':U , h_q-caja ).
