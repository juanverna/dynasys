...
DEFINE INPUT  PARAMETER p-rid_movcaja AS ROWID.
...
DO TRANSACTION:
    ...
    FIND Caj_header WHERE ROWID(Caj_header) = p-rid_movcaja EXCLUSIVE-LOCK.
    FIND Asn_header 
        WHERE Asn_header.tabla_comprobante = "Caj_header" 
          AND Asn_header.nro_idcabecera = Caj_header.nro_transaccion
    ...
    THEN DO:
        ...
        Caj_header.estado = "A".
        {borrarasiento.i} /* Borra el asiento contable correspondiente */
    END.
