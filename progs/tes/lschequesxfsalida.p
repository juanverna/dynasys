/*=================================================================================*/
/*                         CHEQUES x FECHA DE EGRESO                               */
/*=================================================================================*/

&GLOBAL-DEFINE TITULO-LS    Cheques por Fecha de Egreso
&GLOBAL-DEFINE CORTE-POR    Cheque.fecha_salida
...
&GLOBAL-DEFINE CORTE-FR     Cheque.fecha_salida   COLUMN-LABEL "Fecha!Egreso"
