...
&Scoped-Define ENABLED-OBJECTS v-ver_resum v-gen_asiento v-ver_movim ~
v-lis_fecha v-fecha_contable RECT-1 RECT-2 
...
DEFINE FRAME F-Main
     ...
     v-ver_resum AT ROW 1.29 COL 36
     v-gen_asiento AT ROW 1.29 COL 83 NO-LABEL
     v-ver_movim AT ROW 2.1 COL 36
     v-has_ptovta AT ROW 2.62 COL 16 COLON-ALIGNED
     v-lis_fecha AT ROW 2.86 COL 36
     v-lista_tipos AT ROW 3.67 COL 16 COLON-ALIGNED
     v-fecha_contable AT ROW 3.67 COL 81 COLON-ALIGNED
     RECT-1 AT ROW 1 COL 1
     RECT-2 AT ROW 1 COL 75
...
/* SETTINGS FOR FILL-IN v-des_ptovta IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN v-has_ptovta IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN v-lista_tipos IN FRAME F-Main
   NO-ENABLE                                                            */
