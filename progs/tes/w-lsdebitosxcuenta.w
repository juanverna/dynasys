...
DEFINE FRAME F-Main
     ...
     "   Indique el rango de fechas de los movimientos" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 7.19 COL 13
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Débitos x Cuenta Bancaria"
         HEIGHT             = 22.33
         WIDTH              = 123.4
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 128
...
ON END-ERROR OF W-Win /* Débitos x Cuenta Bancaria */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Débitos x Cuenta Bancaria */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/TES" "Débitos x Cuenta Bancaria"}
...
------------------------------------------------------------------------------*/
  ...
  IF NOT hay_error THEN DO:
     ...
     RUN lsdebitosxcuenta.p ( INPUT  que_cuenta,
                              INPUT  des_fecha,
                              INPUT  has_fecha).
