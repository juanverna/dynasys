...
ON END-ERROR OF W-Win /* Ingresos por Fecha */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Ingresos por Fecha */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/TES" "Ingresos por Fecha"}
...
------------------------------------------------------------------------------*/
  ...
  IF NOT hay_error THEN DO:
    ...
    RUN lsingresos.p ( INPUT  que_caja,
                       INPUT  des_fecha,
                       INPUT  has_fecha,
                       INPUT  todos_mov,
                       INPUT  consolidado).
