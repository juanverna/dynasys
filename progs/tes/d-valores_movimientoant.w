...
T-Caj_header.importe T-Caj_header.observacion T-Caj_header.ingreso 
...
&Scoped-Define ENABLED-OBJECTS Btn_salir btn_valores BROWSE-8 RECT-7 RECT-8 ~
RECT-9 
...
&Scoped-Define DISPLAYED-OBJECTS v-tipomov v-cdg_caja v-dsc_caja ~
v-cdg_rubro imp_no_imp 
...
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 142 BY 16.1
         BGCOLOR 15 FGCOLOR 9 
         TITLE BGCOLOR 15 FGCOLOR 9 "Composición del presente movimiento" EXPANDABLE.
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-8 imp_no_imp Dialog-Frame */
ASSIGN 
...
"Rubro.cdg_rubro" "Código!Rubro" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > sic.Rubro.nombre
"Rubro.nombre" "Descripción!Rubro" ? "character" ? ? ? ? ? ? no ? no no "47.8" yes no no "U" "" ""
     _FldNameList[3]   > Temp-Tables.T-Caj_detalle.importe
"T-Caj_detalle.importe" "Importe!Rubro" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > Temp-Tables.T-Caj_detalle.tipo_mov
"T-Caj_detalle.tipo_mov" "I!E" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > Temp-Tables.T-Caj_detalle.observacion
"T-Caj_detalle.observacion" "Observacion!Asocida" "X(49)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-8 */
&ANALYZE-RESUME
...
/*
        ...
        FOR EACH Caj_header-bon:
            DELETE Caj_header-bon.
        END.
...
DO:
  ...
  RUN selrubro.p ( INPUT-OUTPUT rid_rubro, 
                   INPUT YES ).
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY v-tipomov v-cdg_caja v-dsc_caja v-cdg_rubro imp_no_imp 
  ...
  IF AVAILABLE T-Caj_header THEN 
    DISPLAY T-Caj_header.tip_comprob T-Caj_header.prf_comprob 
          ...
          T-Caj_header.observacion T-Caj_header.ingreso 
      WITH FRAME Dialog-Frame.
  ENABLE T-Caj_header.fecha T-Caj_header.observacion Btn_salir btn_valores 
         BROWSE-8 RECT-7 RECT-8 RECT-9 
      WITH FRAME Dialog-Frame.
