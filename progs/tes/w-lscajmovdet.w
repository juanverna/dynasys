...
DEFINE FRAME F-Main
     v-estado AT ROW 15.29 COL 11 COLON-ALIGNED NO-LABEL
     "   Indique el rango de fechas de los movimientos" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 5.57 COL 13
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "   Indique si desea ver arrastrar saldos y el listado consolidado" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 10.67 COL 13
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
ON END-ERROR OF W-Win /* Reporte detallado de Movimientos de Caja */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Reporte detallado de Movimientos de Caja */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-esp-caja ).
       RUN set-position IN h_v-esp-caja ( 2.86 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 7.00 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-arrastrar_saldos ( 11.95 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-consolidado ( 11.95 , 71.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 42.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 16.86 , 13.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/TES" "Reporte Detallado de Movimientos de Caja"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE que_caja         LIKE Caja.cdg_caja NO-UNDO.
  ...
  IF NOT hay_error THEN DO:
    ...
    RUN lscajmovdet.p ( INPUT  que_caja,
                        INPUT  des_fecha,
                        INPUT  des_hora,
                        INPUT  has_fecha,
                        INPUT  has_hora,
