...
DEFINE FRAME F-Main
     ...
     "   Indique el rango de fechas de los movimientos" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 4.33 COL 13
...
ON END-ERROR OF W-Win /* Asientos de Banco */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Asientos de Banco */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 5.57 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-par-asiento ( 10.52 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 19.05 , 13.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/TES" "Generación de Asientos de Banco"}
