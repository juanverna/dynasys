...
DEFINE VARIABLE h_b-caja AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-caja AS HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Cajas */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Cajas */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-caja ).
       RUN set-position IN h_v-caja ( 1.24 , 20.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.33 , 113.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-caja ).
       RUN set-position IN h_b-caja ( 1.29 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-caja ( 19.67 , 14.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 15.29 , 20.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.14 , 113.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-caja. */
       RUN add-link IN adm-broker-hdl ( h_b-caja , 'Record':U , h_v-caja ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-caja ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-caja ,
             h_v-caja , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/TES" "Mantenimiento de Cajas"}
