...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Cobrador WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Cobrador WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Cobrador
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Cobrador
...
<FOREIGN-KEYS>
denominacion_cta|y|y|Cuenta_bancaria.denominacion_cta
cdg_cuenta_ban||y|Cuenta_bancaria.cdg_cuenta_ban
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "denominacion_cta",
     Keys-Supplied = "denominacion_cta,cdg_cuenta_ban"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "sic.Cobrador OF sic.Rendicion_hd"
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'denominacion_cta':U THEN DO:
       &Scope KEY-PHRASE Cuenta_bancaria.denominacion_cta eq key-value
       {&OPEN-QUERY-{&QUERY-NAME}}
    END. /* denominacion_cta */
    OTHERWISE DO:
...
------------------------------------------------------------------------------*/
  ...
  DEFINE INPUT PARAMETER rid-deposito AS ROWID.
  
  REPOSITION {&QUERY-NAME} TO ROWID rid-deposito.
  GET NEXT {&QUERY-NAME}.
