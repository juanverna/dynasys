...
DEFINE VARIABLE h_v-tp-mov AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Asientos Bancarios */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Asientos Bancarios */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-tp-mov ).
       RUN set-position IN h_v-tp-mov ( 7.19 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.88 , 42.00 ) */
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-tp-mov ,
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/TES" "Generación de Asientos Bancarios"}
...
------------------------------------------------------------------------------*/
  ...
  RUN dar_rango IN h_v-tp-mov  ( OUTPUT tipo_movm,
                                 OUTPUT error_rango ).
  IF error_rango 
  THEN DO:
  ...
  IF NOT hay_error THEN DO:
    ...
    RUN LSASNBCO.P ( INPUT des_fecha,
                     INPUT has_fecha,
                     INPUT tipo_movm,
                     INPUT gen_asiento,
