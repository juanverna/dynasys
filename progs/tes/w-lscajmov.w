...
DEFINE FRAME F-Main
     v-estado AT ROW 14.95 COL 11 COLON-ALIGNED NO-LABEL
     "   Indique si desea arrastrar saldos y el listado consolidado" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 10.33 COL 13
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Reporte Resumido de Movimientos"
         HEIGHT             = 24.91
         WIDTH              = 120.8
         MAX-HEIGHT         = 24.91
         MAX-WIDTH          = 127.2
...
ON END-ERROR OF W-Win /* Reporte Resumido de Movimientos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Reporte Resumido de Movimientos */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-esp-caja ).
       RUN set-position IN h_v-esp-caja ( 3.14 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 7.43 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-arrastrar_saldos ( 11.62 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-consolidado ( 11.62 , 71.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 42.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 16.29 , 13.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE arrastrar_saldos        AS LOGICAL NO-UNDO.
