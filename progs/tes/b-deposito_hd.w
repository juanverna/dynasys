...
{findempresa.i}
  ...
  DEFINE VAR v-total_deposito AS DECIMAL FORMAT "->>>>>>>>>9.99".
...
Cuenta_bancaria.denominacion_cta valor_deposito() @ v-total_deposito ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD valor_deposito B-table-Win 
FUNCTION valor_deposito RETURNS DECIMAL
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Cuenta_bancaria.denominacion_cta COLUMN-LABEL "Denominación!Cuenta" FORMAT "X(25)":U
            WIDTH 33.8
      valor_deposito() @ v-total_deposito COLUMN-LABEL "Importe!Depositado" FORMAT ">>>>>9.99":U
...
"valor_deposito() @ v-total_deposito" "Importe!Depositado" ">>>>>9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION valor_deposito B-table-Win 
FUNCTION valor_deposito RETURNS DECIMAL
...
------------------------------------------------------------------------------*/
  ...
  RETURN  v-total_deposito.   /* Function return value. */
