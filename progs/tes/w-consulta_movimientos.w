...
DEFINE VARIABLE h_b-movimientos_caja AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Consulta de Movimientos de Caja"
         HEIGHT             = 23.95
         WIDTH              = 126.6
         MAX-HEIGHT         = 26.52
         MAX-WIDTH          = 145.4
...
ON END-ERROR OF W-Win /* Consulta de Movimientos de Caja */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Consulta de Movimientos de Caja */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Consulta de Movimientos de Caja */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-movimientos_caja.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = fecha':U ,
             OUTPUT h_b-movimientos_caja ).
       RUN set-position IN h_b-movimientos_caja ( 3.14 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-movimientos_caja ( 21.43 , 121.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-caja ).
       RUN set-position IN h_q-caja ( 1.24 , 72.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.43 , 11.00 ) */

       /* Links to SmartBrowser h_b-movimientos_caja. */
       RUN add-link IN adm-broker-hdl ( h_q-caja , 'Record':U , h_b-movimientos_caja ).

       /* Links to SmartQuery h_q-caja. */
       RUN add-link IN adm-broker-hdl ( h_v-id-caja , 'Posicionar':U , h_q-caja ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-movimientos_caja ,
             h_v-id-caja , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/TES" "Consulta de Movimientos de Caja"}
