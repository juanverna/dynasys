...
DEFINE VARIABLE h_b-cheques_depositados AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Acreditación de Cheques Emitidos"
         HEIGHT             = 25.71
         WIDTH              = 158.6
         MAX-HEIGHT         = 25.71
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Acreditación de Cheques Emitidos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Acreditación de Cheques Emitidos */
DO:
  ...
  THEN DO:
    ...
    IF NOT txn_activa
    THEN DO: 
          RUN desmarcar_todos IN h_b-cheques_depositados.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Acreditación de Cheques Emitidos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-cuenta_banco ( 1.48 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-cuenta_banco ( 5.71 , 157.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-cheques_depositados.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cheques_depositados ).
       RUN set-position IN h_b-cheques_depositados ( 7.43 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-cheques_depositados ( 18.33 , 157.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-cheques_depositados. */
       RUN add-link IN adm-broker-hdl ( h_b-cuenta_banco , 'Record':U , h_b-cheques_depositados ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-cheques_depositados ,
