...
DEFINE VARIABLE que_cheque LIKE Cheque.nro_cheque.
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Cheque WHERE ~{&KEY-PHRASE} ~
      AND Cheque.nro_cheque = que_cheque NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Cheque WHERE ~{&KEY-PHRASE} ~
      AND Cheque.nro_cheque = que_cheque NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Cheque
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Cheque
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "Cheque.nro_cheque = que_cheque"
...
------------------------------------------------------------------------------*/
  ...
  DEFINE INPUT PARAMETER p-cheque LIKE Cheque.nro_cheque.
