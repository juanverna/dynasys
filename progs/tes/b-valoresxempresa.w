...
&Scoped-define QUERY-STRING-br_table FOR EACH Valor OF Empresa WHERE ~{&KEY-PHRASE} NO-LOCK ~
    BY Valor.numero_cheque INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Valor OF Empresa WHERE ~{&KEY-PHRASE} NO-LOCK ~
    BY Valor.numero_cheque INDEXED-REPOSITION.
...
&Scoped-Define ENABLED-OBJECTS v-codigo br_table RECT-4 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Valor.numero_cheque COLUMN-LABEL "Número!Cheque" FORMAT ">>>>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 12 BY 16.42
...
DO:
  ...
  &SCOPED-DEFINE SELECCION          SELCHEQU.P
  ...
  THEN DO:
    ...
    FIND FIRST {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} 
         WHERE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.{&CODIGO} >= v-codigo 
           AND {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.cdg_empresa = Empresa.cdg_empresa 
    ...
    IF NOT AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} 
       THEN FIND LAST {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} 
                 WHERE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.cdg_empresa = Empresa.cdg_empresa 
                    USE-INDEX por_numero NO-LOCK.
