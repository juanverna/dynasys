...
&Scoped-define INTERNAL-TABLES Banco

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Banco.cdg_banco 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH Banco WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Banco WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table Banco
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Banco
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Banco.cdg_banco COLUMN-LABEL "Código!Banco" FORMAT "9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 17 BY 22.86
         BGCOLOR 11 FGCOLOR 9 FONT 4 ROW-HEIGHT-CHARS .57 EXPANDABLE.
...
"cdg_banco" "Código!Banco" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
DO:
  ...
  &SCOPED-DEFINE CODIGO cdg_Banco
