...
DEFINE FRAME F-Main
     Cuenta_bancaria.cdg_cuenta_ban AT ROW 1.5 COL 9 COLON-ALIGNED
          LABEL "Cuenta"
          VIEW-AS FILL-IN 
          SIZE 6 BY .75
          BGCOLOR 15 FGCOLOR 12 FONT 4
     Cuenta_bancaria.denominacion_cta AT ROW 1.5 COL 16 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 36.33 BY .75
          BGCOLOR 7 FGCOLOR 15 FONT 4
     RECT-1 AT ROW 1.25 COL 4
...
/* SETTINGS FOR FILL-IN Cuenta_bancaria.cdg_cuenta_ban IN FRAME F-Main
   EXP-LABEL                                                            */
