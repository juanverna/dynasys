...
ON END-ERROR OF W-Win /* Pagos por Fecha */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Pagos por Fecha */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-esp-caja ).
       RUN set-position IN h_v-esp-caja ( 2.88 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-anulaciones ( 11.77 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-consolidado ( 11.77 , 60.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 42.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/TES" "Pagos por Fecha"}
