...
DEFIN VARIABLE que_sector AS CHARACTER.
{parlocales.i}
{dfvarimp.i}
{WGLISTAR.I}
{findsector.I}
...
DEFINE FRAME frm-titulo HEADER
        que_empresa
        "Valores por Cliente y Fecha de Acreditación" AT 52
...
PROCEDURE LISTAR:
  ...
  DO WHILE AVAILABLE Cliente:
     ...
     FOR EACH Valor NO-LOCK OF Cliente 
         WHERE ( Valor.cdg_empresa = Empresa.cdg_empresa OR v-consolidado )
          ...
          BREAK BY Cliente.cdg_cliente BY Valor.fecha_acredita WITH FRAME frm-listado:
