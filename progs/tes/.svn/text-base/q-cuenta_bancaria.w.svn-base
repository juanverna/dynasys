...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Cuenta_bancaria WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Cuenta_bancaria
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Cuenta_bancaria
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "Cuenta_bancaria"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Design-Parent    is WINDOW q-tables @ ( 1.08 , 9.72 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
