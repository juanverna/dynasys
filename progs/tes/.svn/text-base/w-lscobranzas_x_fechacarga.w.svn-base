...
DEFINE FRAME F-Main
     v-estado AT ROW 22.38 COL 28 COLON-ALIGNED NO-LABEL
     "  Lista de empresas a considerar:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 18.1 COL 30
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Moneda de los movimientos a listar:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 10.29 COL 30
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Cobradores a listar:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 5.76 COL 30
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de fechas de carga de los movimientos:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 14.05 COL 30
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "   Indique la caja cuyos movimientos desean listarse" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 1.71 COL 30
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Cobranzas por fecha de carga"
         HEIGHT             = 27.33
         WIDTH              = 160
         MAX-HEIGHT         = 27.67
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Cobranzas por fecha de carga */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Cobranzas por fecha de carga */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-esp-caja ).
       RUN set-position IN h_v-esp-caja ( 2.91 , 30.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-cobrador ( 6.95 , 30.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-esp-moneda ( 11.38 , 30.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-rng-fechas ( 15.14 , 30.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-lst-empresas ( 19.19 , 30.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 23.76 , 30.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXC" "Cobranzas por Fecha de Carga"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lscobranzas_x_fechacarga.p ( INPUT v-lista_empresas,
                                        INPUT que_caja,
                                        INPUT des_cobrador,
                                        INPUT has_cobrador,
                                        INPUT que_moneda, 
