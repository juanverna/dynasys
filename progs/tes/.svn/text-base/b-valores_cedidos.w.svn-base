...
&Scoped-define QUERY-STRING-br_table FOR EACH Valor OF Proveedor WHERE ~{&KEY-PHRASE} ~
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Valor OF Proveedor WHERE ~{&KEY-PHRASE} ~
      AND Valor.fecha_deposito >= v-des_fecha ~
 AND Valor.fecha_deposito <= v-has_fecha ~
 AND Valor.cdg_empresa = que_empresa ~
 AND Valor.estado = "10" NO-LOCK ~
...
&Scoped-Define ENABLED-OBJECTS v-des_fecha v-has_fecha v-fecha_acreditacion ~
v-cantcheques v-totdeposito btn_acreditar btn_rechazar btn_seltodos ~
btn_desmarcar btn_verlog btn_listar btn_comprobante br_table RECT-2 RECT-3 ~
RECT-4 RECT-5 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 110 BY 15.1
...
DEFINE FRAME F-Main
     v-des_fecha AT ROW 1.29 COL 15 COLON-ALIGNED
     v-has_fecha AT ROW 1.29 COL 33 COLON-ALIGNED
     v-fecha_acreditacion AT ROW 1.29 COL 64 COLON-ALIGNED
     v-cantcheques AT ROW 1.29 COL 86 COLON-ALIGNED
     v-totdeposito AT ROW 1.29 COL 94 COLON-ALIGNED
     btn_acreditar AT ROW 3.14 COL 2
     btn_rechazar AT ROW 3.14 COL 17
     btn_seltodos AT ROW 3.14 COL 37
     btn_desmarcar AT ROW 3.14 COL 52
     btn_verlog AT ROW 3.14 COL 67
     btn_listar AT ROW 3.14 COL 82
     btn_comprobante AT ROW 3.14 COL 97
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "sic.Valor OF sic.Proveedor"
