...
&Scoped-Define ENABLED-OBJECTS que_rendicion 
&Scoped-Define DISPLAYED-OBJECTS que_rendicion 
...
DEFINE VARIABLE que_rendicion AS CHARACTER FORMAT "X(256)":U 
     LABEL "Rendición" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME DEFAULT-FRAME
     que_rendicion
          &IF '{&WINDOW-SYSTEM}' = 'TTY':U &THEN AT ROW 3 COL 12 COLON-ALIGNED
          &ELSE AT ROW 3 COL 12 COLON-ALIGNED &ENDIF
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW TERMINAL-SIMULATION ASSIGN
         HIDDEN             = YES
         TITLE              = "Aceptacion de Rendiciones"
         HEIGHT             = 20.99
         WIDTH              = 80.38
         MAX-HEIGHT         = 20.99
         MAX-WIDTH          = 80.38
