...
&Scoped-define INTERNAL-TABLES Caja

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Caja.cdg_caja 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH Caja WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Caja WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table Caja
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Caja
...
<FOREIGN-KEYS>
nombre|y|y|sic.Caja.nombre
cdg_caja||y|sic.Caja.cdg_caja
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "nombre",
     Keys-Supplied = "nombre,cdg_caja"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Caja.cdg_caja COLUMN-LABEL "Código!Caja" FORMAT ">>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 11 BY 17.52
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > sic.Caja.cdg_caja
"Caja.cdg_caja" "Código!Caja" ">>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
DO:
  ...
  &SCOPED-DEFINE ROWID_TABLA        rid_caja
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'nombre':U THEN DO:
       &Scope KEY-PHRASE Caja.nombre eq key-value
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "nombre" "Caja" "nombre"}
  {src/adm/template/sndkycas.i "cdg_caja" "Caja" "cdg_caja"}
