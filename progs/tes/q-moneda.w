...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Moneda WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Moneda
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Moneda
...
/* END WINDOW DEFINITION */
                                                                        */
&ANALYZE-RESUME
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _XFTR "SmartQueryWizard" q-tables _INLINE
