...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Cuenta_bancaria ~
      WHERE NOT Cuenta_bancaria.ficticia NO-LOCK ~
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Options          = "NO-LOCK"
     _OrdList          = "sic.Cuenta_bancaria.cdg_cuenta_ban|yes"
     _Where[1]         = "NOT Cuenta_bancaria.ficticia"
     _Design-Parent    is WINDOW q-tables @ ( 1.16 , 9.89 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  /* ADM-ROW-AVAILABLE does nothing because there are no External
     Tables specified for this SmartQuery.
