...
DO:
  ...
  THEN DO:
    ...
    IF NOT txn_activa
    THEN DO: 
/*           RUN desmarcar_todos IN h_b-valores_cedidos_caja. */
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-id-caja ).
       RUN set-position IN h_v-id-caja ( 3.14 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-caja ).
       RUN set-position IN h_q-caja ( 3.38 , 78.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.67 , 11.00 ) */
