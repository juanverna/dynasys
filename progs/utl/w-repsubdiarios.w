  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-rptsbd ).
       RUN set-position IN h_b-rptsbd ( 1.00 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-rptsbd ( 10.76 , 39.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rptsbd ).
       RUN set-position IN h_v-rptsbd ( 1.00 , 43.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.76 , 53.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 1.00 , 97.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 10.76 , 16.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-colcta ).
       RUN set-position IN h_v-colcta ( 11.71 , 52.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.05 , 61.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-colcta ).
       RUN set-position IN h_b-colcta ( 11.95 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-colcta ( 9.43 , 47.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updspa-2 ).
       RUN set-position IN h_p-updspa-2 ( 18.86 , 53.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa-2 ( 2.14 , 61.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-rptsbd. */
       RUN add-link IN adm-broker-hdl ( h_b-rptsbd , 'Record':U , h_v-rptsbd ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-rptsbd ).

       /* Links to SmartViewer h_v-colcta. */
       RUN add-link IN adm-broker-hdl ( h_b-colcta , 'Record':U , h_v-colcta ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa-2 , 'TableIO':U , h_v-colcta ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/UTL" "Definicion de Columnas de subdiario"}
