...
DEFINE VARIABLE h_b-provincias AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-provincias AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Mantenimiento de Provincias"
         HEIGHT             = 22.62
         WIDTH              = 125.2
         MAX-HEIGHT         = 26.43
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF W-Win /* Mantenimiento de Provincias */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Mantenimiento de Provincias */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Mantenimiento de Provincias */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-provincias.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-provincias ).
       RUN set-position IN h_b-provincias ( 1.29 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-provincias ( 20.48 , 15.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-provincias.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-provincias ).
       RUN set-position IN h_v-provincias ( 1.29 , 23.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.67 , 76.80 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 12.57 , 23.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.14 , 77.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-provincias. */
       RUN add-link IN adm-broker-hdl ( h_b-provincias , 'Record':U , h_v-provincias ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-provincias ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-provincias ,
             h_b-provincias , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-provincias , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/UTL" "Mantenimiento de Provincias"}
