...
&Scoped-Define ENABLED-OBJECTS RECT-5 v-archivo v-has_fecha btn_proceso ~
Btn_OK 
...
DEFINE FRAME Dialog-Frame
     ...
     SPACE(15.55) SKIP(0.84)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Importa Interface de Partidas"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Importa Interface de Partidas */
DO:
...
DO:
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    DO ON ERROR UNDO Actualizacion, LEAVE Actualizacion:
        ...
        v-estado:SCREEN-VALUE = "Cargando Interface PARTIDAS ...".
        v-estado:BGCOLOR = 12.
        RUN importapartidas.p ( INPUT v-has_fecha, 
                                INPUT v-has_fecha, 
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-5 v-archivo v-has_fecha btn_proceso Btn_OK 
      WITH FRAME Dialog-Frame.
