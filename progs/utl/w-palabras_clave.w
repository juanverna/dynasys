...
DEFINE VARIABLE h_b-palabras_clave AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updsav AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-palabra_clave AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Mantenimiento de palabras clave"
         HEIGHT             = 26.62
         WIDTH              = 82.6
         MAX-HEIGHT         = 26.62
         MAX-WIDTH          = 159.6
...
ON END-ERROR OF W-Win /* Mantenimiento de palabras clave */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Mantenimiento de palabras clave */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Mantenimiento de palabras clave */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-palabras_clave.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-palabras_clave ).
       RUN set-position IN h_b-palabras_clave ( 2.19 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-palabras_clave ( 18.57 , 71.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-palabra_clave.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-palabra_clave ).
       RUN set-position IN h_v-palabra_clave ( 21.00 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.10 , 71.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav ).
       RUN set-position IN h_p-updsav ( 24.33 , 5.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav ( 1.76 , 71.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-palabra_clave. */
       RUN add-link IN adm-broker-hdl ( h_b-palabras_clave , 'Record':U , h_v-palabra_clave ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_v-palabra_clave ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-palabra_clave ,
             h_b-palabras_clave , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updsav ,
             h_v-palabra_clave , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/UTL" "Mantenimiento de palabras clave"}
