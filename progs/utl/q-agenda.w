...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Agenda WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Agenda
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Agenda
...
<FOREIGN-KEYS>
dsc_agenda|y|y|Agenda.dsc_agenda
cdg_agenda||y|Agenda.cdg_agenda
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "dsc_agenda",
     Keys-Supplied = "dsc_agenda,cdg_agenda,nro_entidad"':U).
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'dsc_agenda':U THEN DO:
       &Scope KEY-PHRASE Agenda.dsc_agenda eq key-value
...
------------------------------------------------------------------------------*/
  ...
  DEFINE INPUT PARAMETER rid-agenda AS ROWID.
  
  REPOSITION {&QUERY-NAME} TO ROWID rid-agenda.
  GET NEXT {&QUERY-NAME}.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "dsc_agenda" "Agenda" "dsc_agenda"}
