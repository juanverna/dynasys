...
DEFINE VARIABLE h_b-modulo AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-modulo AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-modulo ).
       RUN set-position IN h_v-modulo ( 1.27 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.23 , 46.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 1.27 , 52.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 17.23 , 23.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-modulo ).
       RUN set-position IN h_b-modulo ( 5.04 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.46 , 46.00 ) */

       /* Links to SmartViewer h_v-modulo. */
       RUN add-link IN adm-broker-hdl ( h_b-modulo , 'Record':U , h_v-modulo ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-modulo ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-modulo ,
             Btn_Done:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-modulo , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-modulo ,
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/UTL" "Mantenimiento de Módulos"}
