...
DEFINE VARIABLE h_b-cargos_persona AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updsav AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-cargo_persona AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Mantenimiento de cargos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Mantenimiento de cargos */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Mantenimiento de cargos */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-cargos_persona.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cargos_persona ).
       RUN set-position IN h_b-cargos_persona ( 1.71 , 9.00 ) NO-ERROR.
       RUN set-size IN h_b-cargos_persona ( 18.57 , 65.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-cargo_persona.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-cargo_persona ).
       RUN set-position IN h_v-cargo_persona ( 20.52 , 9.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.05 , 65.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updsav ).
       RUN set-position IN h_p-updsav ( 24.81 , 9.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav ( 1.76 , 65.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-cargo_persona. */
       RUN add-link IN adm-broker-hdl ( h_b-cargos_persona , 'Record':U , h_v-cargo_persona ).
       RUN add-link IN adm-broker-hdl ( h_p-updsav , 'TableIO':U , h_v-cargo_persona ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-cargo_persona ,
             h_b-cargos_persona , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updsav ,
             h_v-cargo_persona , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/UTL" "Mantenimiento de cargos"}
