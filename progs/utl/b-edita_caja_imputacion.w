...
&Scoped-define INTERNAL-TABLES Caja-imputacion Cuenta Entidad
...
Entidad.cdg_entidad Entidad.dsc_entidad Caja-imputacion.valor 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH Caja-imputacion WHERE ~{&KEY-PHRASE} ~
      AND Caja-imputacion.nro_transaccion = Caj_header.nro_transaccion NO-LOCK, ~
      EACH Cuenta OF Caja-imputacion NO-LOCK, ~
      EACH Entidad OF Caja-imputacion OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Caja-imputacion WHERE ~{&KEY-PHRASE} ~
      AND Caja-imputacion.nro_transaccion = Caj_header.nro_transaccion NO-LOCK, ~
      EACH Cuenta OF Caja-imputacion NO-LOCK, ~
      EACH Entidad OF Caja-imputacion OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table Caja-imputacion Cuenta Entidad
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Caja-imputacion
...
<FOREIGN-KEYS>
nro_transaccion||y|sic.Caja-imputacion.nro_transaccion
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Entidad.dsc_entidad FORMAT "X(50)":U WIDTH 46.8
      Caja-imputacion.valor FORMAT "->>>>>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 118 BY 6.71
         TITLE "Contrapartida del Movimiento de caja".
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "sic.Caja-imputacion,sic.Cuenta OF sic.Caja-imputacion,sic.Entidad OF sic.Caja-imputacion"
...
"Entidad.dsc_entidad" ? ? "character" ? ? ? ? ? ? no ? no no "46.8" yes no no "U" "" ""
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* Contrapartida del Movimiento de caja */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* Contrapartida del Movimiento de caja */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* Contrapartida del Movimiento de caja */
DO:
