...
&Scoped-define INTERNAL-TABLES Area Deposito Solicitante

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Area OF Rqs_header WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH Deposito OF Rqs_header NO-LOCK, ~
      EACH Solicitante OF Rqs_header NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Area Deposito Solicitante
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Area
...
<FOREIGN-KEYS>
denominacion||y|sic.Area.denominacion
cdg_area||y|sic.Area.cdg_area
nro_area||y|sic.Area.nro_area
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "denominacion,cdg_area,nro_area,nro_entidad"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "sic.Area OF sic.Rqs_header,sic.Deposito OF sic.Rqs_header,sic.Solicitante OF sic.Rqs_header"
