...
&Scoped-define INTERNAL-TABLES Rqs_detalle
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Rqs_detalle OF Rqs_header WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table Rqs_detalle
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Rqs_detalle.nro_linea COLUMN-LABEL "Nro!Linea" FORMAT ">>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 9 BY 11.05
         BGCOLOR 11 FGCOLOR 9 FONT 4
         TITLE BGCOLOR 11 FGCOLOR 9 "Detalle" EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "sic.Rqs_detalle OF sic.Rqs_header"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > sic.Rqs_detalle.nro_linea
"Rqs_detalle.nro_linea" "Nro!Linea" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* Detalle */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* Detalle */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* Detalle */
DO:
