...
&Scoped-Define ENABLED-FIELDS Area.cdg_area Area.denominacion 
...
DEFINE FRAME F-Main
     Area.cdg_area AT ROW 1.29 COL 6 COLON-ALIGNED
          LABEL "Area"
          VIEW-AS FILL-IN NATIVE 
          SIZE 12 BY 1
          BGCOLOR 11 FGCOLOR 9 FONT 4
     Area.denominacion AT ROW 1.29 COL 19 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 36.2 BY 1
