...
&Scoped-Define ENABLED-FIELDS Usuario.nombre Usuario.cdg_usuario 
&Scoped-define ENABLED-TABLES Usuario
&Scoped-define FIRST-ENABLED-TABLE Usuario
&Scoped-Define ENABLED-OBJECTS RECT-8 
&Scoped-Define DISPLAYED-FIELDS Usuario.nombre Usuario.cdg_usuario 
...
DEFINE FRAME F-Main
     Usuario.nombre AT ROW 1.24 COL 16 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 68 BY 1
          BGCOLOR 11 FGCOLOR 9 
     Usuario.cdg_usuario AT ROW 1.29 COL 1 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12.8 BY 1
          BGCOLOR 11 FGCOLOR 9 
