...
DEFINE VARIABLE h_b-tipoembarque AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-tipoembarque AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Tipos de Embarque */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tipos de Embarque */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Tipos de Embarque */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-tipoembarque.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tipoembarque ).
       RUN set-position IN h_b-tipoembarque ( 1.27 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.92 , 43.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-tipoembarque.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-tipoembarque ).
       RUN set-position IN h_v-tipoembarque ( 1.27 , 48.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 5.58 , 48.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.42 , 65.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-tipoembarque. */
       RUN add-link IN adm-broker-hdl ( h_b-tipoembarque , 'Record':U , h_v-tipoembarque ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-tipoembarque ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-tipoembarque ,
             h_b-tipoembarque , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-tipoembarque , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Tipos de Embarque"}
