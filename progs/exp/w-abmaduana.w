...
DEFINE VARIABLE h_b-aduana AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-aduana AS HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Aduana */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Aduana */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-aduana ).
       RUN set-position IN h_b-aduana ( 1.00 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.92 , 38.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-aduana ).
       RUN set-position IN h_v-aduana ( 1.27 , 49.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-aduana. */
       RUN add-link IN adm-broker-hdl ( h_b-aduana , 'Record':U , h_v-aduana ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-aduana ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-aduana ,
             h_b-aduana , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Aduana"}
