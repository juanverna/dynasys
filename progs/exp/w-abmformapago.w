...
DEFINE VARIABLE h_b-formapago AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-formapago AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Formas de Pago */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Formas de Pago */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Formas de Pago */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-formapago.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-formapago ).
       RUN set-position IN h_b-formapago ( 1.00 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-formapago ( 6.67 , 47.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-formapago.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-formapago ).
       RUN set-position IN h_v-formapago ( 1.00 , 54.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.24 , 59.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 5.05 , 54.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.43 , 59.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-formapago. */
       RUN add-link IN adm-broker-hdl ( h_b-formapago , 'Record':U , h_v-formapago ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-formapago ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-formapago ,
             h_b-formapago , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-formapago , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Formas de Pago"}
