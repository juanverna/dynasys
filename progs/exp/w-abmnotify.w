...
DEFINE VARIABLE h_b-notify AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-notify AS HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Notify */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Notify */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-notify ).
       RUN set-position IN h_b-notify ( 1.00 , 1.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-notify ).
       RUN set-position IN h_v-notify ( 1.00 , 47.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.15 , 68.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 10.96 , 47.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.42 , 68.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-notify. */
       RUN add-link IN adm-broker-hdl ( h_b-notify , 'Record':U , h_v-notify ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-notify ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-notify ,
             h_b-notify , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Notify"}
