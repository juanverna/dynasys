...
DEFINE VARIABLE h_b-consignatarios AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-consignatarios AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Consignatarios */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Consignatarios */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Consignatarios */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'exp/b-consignatarios.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-consignatarios ).
       RUN set-position IN h_b-consignatarios ( 1.27 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.92 , 42.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'exp/v-consignatarios.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-consignatarios ).
       RUN set-position IN h_v-consignatarios ( 1.27 , 47.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.00 , 66.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 9.62 , 49.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.42 , 64.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-consignatarios. */
       RUN add-link IN adm-broker-hdl ( h_b-consignatarios , 'Record':U , h_v-consignatarios ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-consignatarios ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-consignatarios ,
             h_b-consignatarios , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-consignatarios , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Consignatarios"}
