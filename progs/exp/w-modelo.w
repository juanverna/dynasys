...
DEFINE VARIABLE h_b-listas_de_precios AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Listas de Precios */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Listas de Precios */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Listas de Precios */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'fac/b-listas_de_precios.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-listas_de_precios ).
       RUN set-position IN h_b-listas_de_precios ( 1.27 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.92 , 46.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'fac/v-lista_de_precios.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-lista_de_precios ).
       RUN set-position IN h_v-lista_de_precios ( 1.27 , 49.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.50 , 64.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 5.58 , 49.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.42 , 64.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-lista_de_precios. */
       RUN add-link IN adm-broker-hdl ( h_b-listas_de_precios , 'Record':U , h_v-lista_de_precios ).
