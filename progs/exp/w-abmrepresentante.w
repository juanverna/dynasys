...
DEFINE VARIABLE h_b-representante AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-representante AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Representantes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Representantes */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Representantes */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-representante.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-representante ).
       RUN set-position IN h_b-representante ( 1.27 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.92 , 45.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-representante.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-representante ).
       RUN set-position IN h_v-representante ( 1.27 , 49.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.50 , 65.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 12.85 , 50.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.42 , 64.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-representante. */
       RUN add-link IN adm-broker-hdl ( h_b-representante , 'Record':U , h_v-representante ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-representante ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-representante ,
             h_b-representante , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-representante , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Representantes"}
