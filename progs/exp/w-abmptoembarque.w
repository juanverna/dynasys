...
DEFINE VARIABLE h_b-ptoembarque AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-ptoembarque AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Puerto de Embaque */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Puerto de Embaque */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Puerto de Embaque */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-ptoembarque.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-ptoembarque ).
       RUN set-position IN h_v-ptoembarque ( 1.00 , 49.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.50 , 64.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-ptoembarque.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-ptoembarque ).
       RUN set-position IN h_b-ptoembarque ( 1.27 , 4.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-ptoembarque. */
       RUN add-link IN adm-broker-hdl ( h_b-ptoembarque , 'Record':U , h_v-ptoembarque ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-ptoembarque ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-ptoembarque ,
             h_v-ptoembarque , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_b-ptoembarque , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Puertos de Embarque"}
