...
DEFINE VARIABLE h_b-despachante AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-despachante AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Despachantes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Despachantes */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Despachantes */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-despachante.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-despachante ).
       RUN set-position IN h_b-despachante ( 1.00 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.92 , 44.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-despachante.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-despachante ).
       RUN set-position IN h_v-despachante ( 1.27 , 49.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.73 , 66.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 8.54 , 49.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.42 , 66.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-despachante. */
       RUN add-link IN adm-broker-hdl ( h_b-despachante , 'Record':U , h_v-despachante ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-despachante ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-despachante ,
             h_b-despachante , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-despachante , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Despachantes"}
