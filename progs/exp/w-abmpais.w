...
DEFINE VARIABLE h_b-pais AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-pais AS HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* País */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-pais ).
       RUN set-position IN h_b-pais ( 1.54 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-pais ).
       RUN set-position IN h_v-pais ( 1.54 , 49.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-pais. */
       RUN add-link IN adm-broker-hdl ( h_b-pais , 'Record':U , h_v-pais ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-pais ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-pais ,
             h_b-pais , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Países"}
