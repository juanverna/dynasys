...
DEFINE VARIABLE h_b-insumo AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-insumo AS HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Insumo */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Insumo */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-insumo ).
       RUN set-position IN h_b-insumo ( 1.54 , 3.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-insumo ).
       RUN set-position IN h_v-insumo ( 1.54 , 50.29 ) NO-ERROR.
       /* Size in UIB:  ( 6.19 , 64.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 8.54 , 50.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.42 , 64.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-insumo. */
       RUN add-link IN adm-broker-hdl ( h_b-insumo , 'Record':U , h_v-insumo ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-insumo ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-insumo ,
             h_b-insumo , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Insumo"}
