...
DEFINE VARIABLE h_b-marcalateral AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-marcalateral AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Marcas Laterales */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Marcas Laterales */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Marcas Laterales */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-marcalateral.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-marcalateral ).
       RUN set-position IN h_b-marcalateral ( 1.54 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.92 , 46.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-marcalateral.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-marcalateral ).
       RUN set-position IN h_v-marcalateral ( 1.54 , 50.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 5.58 , 50.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.42 , 64.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-marcalateral. */
       RUN add-link IN adm-broker-hdl ( h_b-marcalateral , 'Record':U , h_v-marcalateral ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-marcalateral ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-marcalateral ,
             h_b-marcalateral , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-marcalateral , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Marcas Laterales"}
