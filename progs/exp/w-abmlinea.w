...
DEFINE VARIABLE h_b-linea AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-linea AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Mantenimiento de Línea */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Mantenimiento de Línea */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Mantenimiento de Línea */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-linea ).
       RUN set-position IN h_b-linea ( 1.27 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-linea ).
       RUN set-position IN h_v-linea ( 1.27 , 49.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-linea. */
       RUN add-link IN adm-broker-hdl ( h_b-linea , 'Record':U , h_v-linea ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-linea ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-linea ,
             h_b-linea , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Línea"}
