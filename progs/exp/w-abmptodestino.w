...
DEFINE VARIABLE h_b-ptodestino AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-ptodestino AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Puertos de Destino */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Puertos de Destino */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Puertos de Destino */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-ptodestino.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-ptodestino ).
       RUN set-position IN h_b-ptodestino ( 1.27 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.92 , 43.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-ptodestino.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-ptodestino ).
       RUN set-position IN h_v-ptodestino ( 1.27 , 49.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-ptodestino. */
       RUN add-link IN adm-broker-hdl ( h_b-ptodestino , 'Record':U , h_v-ptodestino ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-ptodestino ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-ptodestino ,
             h_b-ptodestino , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-ptodestino , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Puertos de Destino"}
