...
DEFINE VARIABLE h_b-marcatapa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-marcatapa AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Marca de Tapa */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Marca de Tapa */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Marca de Tapa */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-marcatapa.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-marcatapa ).
       RUN set-position IN h_b-marcatapa ( 2.08 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.92 , 50.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-marcatapa.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-marcatapa ).
       RUN set-position IN h_v-marcatapa ( 2.08 , 55.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.96 , 59.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 5.58 , 55.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.42 , 59.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-marcatapa. */
       RUN add-link IN adm-broker-hdl ( h_b-marcatapa , 'Record':U , h_v-marcatapa ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-marcatapa ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-marcatapa ,
             h_b-marcatapa , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-marcatapa , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Marcas de Tapa"}
