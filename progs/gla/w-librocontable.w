...
DEFINE VARIABLE h_b-librocontable AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-librocontable AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Mantenimiento de Libros Contables"
         HEIGHT             = 26.76
         WIDTH              = 160
         MAX-HEIGHT         = 26.76
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Mantenimiento de Libros Contables */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Mantenimiento de Libros Contables */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Mantenimiento de Libros Contables */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-librocontable.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-librocontable ).
       RUN set-position IN h_b-librocontable ( 1.24 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-librocontable ( 20.48 , 16.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-librocontable.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-librocontable ).
       RUN set-position IN h_v-librocontable ( 1.24 , 21.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.24 , 92.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 6.95 , 21.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.14 , 92.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-librocontable. */
       RUN add-link IN adm-broker-hdl ( h_b-librocontable , 'Record':U , h_v-librocontable ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-librocontable ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-librocontable ,
             h_b-librocontable , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-librocontable , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Mantenimiento de Libros Contables"}
