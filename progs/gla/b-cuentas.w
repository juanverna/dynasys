...
&Scoped-define INTERNAL-TABLES Cuenta

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Cuenta.cdg_cuenta 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH Cuenta WHERE ~{&KEY-PHRASE} ~
      AND Cuenta.lista_empresas CONTAINS que_empresa NO-LOCK ~
    BY Cuenta.cdg_cuenta
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Cuenta WHERE ~{&KEY-PHRASE} ~
      AND Cuenta.lista_empresas CONTAINS que_empresa NO-LOCK ~
    BY Cuenta.cdg_cuenta.
&Scoped-define TABLES-IN-QUERY-br_table Cuenta
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Cuenta
...
<FOREIGN-KEYS>
nro_cuenta||y|sic.Cuenta.nro_cuenta
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 15 BY 21.05
...
/* Query rebuild information for BROWSE br_table
     ...
     _OrdList          = "sic.Cuenta.cdg_cuenta|yes"
     _Where[1]         = "Cuenta.lista_empresas CONTAINS que_empresa"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "nro_cuenta" "Cuenta" "nro_cuenta"}
