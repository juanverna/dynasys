...
DEFINE BUFFER B-Clase FOR Clase_de_Entidad.
DEFINE BUFFER Clase FOR Clase_de_Entidad.
...
DEFINE FRAME Dialog-Frame
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         FONT 4
         TITLE "Selección de Clasificación de Entidades Contables"
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: B-Clase B "?" ? sic Clase_de_Entidad
      TABLE: Clase B "?" ? sic Clase_de_Entidad
   END-TABLES.
 */
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Selección de Clasificación de Entidades Contables */
DO:
