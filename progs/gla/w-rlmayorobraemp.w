...
DEFINE FRAME F-Main
     v-estado AT ROW 20.05 COL 12 COLON-ALIGNED NO-LABEL
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Emisión de Libro Mayor de Obras Por Empresa"
         HEIGHT             = 22.67
         WIDTH              = 114.2
         MAX-HEIGHT         = 26.33
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Emisión de Libro Mayor de Obras Por Empresa */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Emisión de Libro Mayor de Obras Por Empresa */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng-obra ).
       RUN set-position IN h_v-rng-obra ( 2.10 , 14.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 21.24 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 90.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Emisión de Libro Mayor de Obras por Empresa"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsmayorobraemp.p ( INPUT lista_empresas,
                              INPUT des_obra,
                              INPUT has_obra,
                              INPUT des_fecha,
                              INPUT has_fecha,
