...
DEFINE VARIABLE h_b-gruposbdu AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-grupobdu AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Mantenimiento de Grupos de Bienes de Uso"
         HEIGHT             = 21.24
         WIDTH              = 114.2
         MAX-HEIGHT         = 21.24
         MAX-WIDTH          = 114.2
...
ON END-ERROR OF W-Win /* Mantenimiento de Grupos de Bienes de Uso */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Mantenimiento de Grupos de Bienes de Uso */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Mantenimiento de Grupos de Bienes de Uso */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-gruposbdu.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-gruposbdu ).
       RUN set-position IN h_b-gruposbdu ( 1.29 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-gruposbdu ( 20.48 , 14.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-grupobdu.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-grupobdu ).
       RUN set-position IN h_v-grupobdu ( 1.29 , 17.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.14 , 72.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 7.19 , 17.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 1.76 , 72.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-grupobdu. */
       RUN add-link IN adm-broker-hdl ( h_b-gruposbdu , 'Record':U , h_v-grupobdu ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-grupobdu ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-grupobdu ,
             h_b-gruposbdu , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-grupobdu , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Mantenimiento de Grupos de Bienes de Uso"}
