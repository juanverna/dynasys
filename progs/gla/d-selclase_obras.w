...
DEFINE BUFFER B-Clase FOR Clase_de_Obra.
DEFINE BUFFER Clase FOR Clase_de_Obra.
...
DEFINE FRAME Dialog-Frame
     ...
     SPACE(2.19) SKIP(0.23)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 4
         TITLE "Selección de Clasificación de Obras Contables"
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: B-Clase B "?" ? sic Clase_de_Obra
      TABLE: Clase B "?" ? sic Clase_de_Obra
   END-TABLES.
 */
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Selección de Clasificación de Obras Contables */
DO:
