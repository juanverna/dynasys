...
&IF DEFINED(UIB_is_Running) NE 0
&THEN
DEFINE VARIABLE p-cdg_impuesto LIKE Impuesto.cdg_impuesto.
DEFINE VARIABLE p-ok AS LOGICAL.
&ELSE
DEFINE OUTPUT PARAMETER p-cdg_impuesto LIKE Impuesto.cdg_impuesto.
...
&Scoped-define INTERNAL-TABLES Impuesto

/* Definitions for BROWSE BROWSE-2                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 Impuesto.cdg_impuesto Impuesto.nombre   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2   
&Scoped-define SELF-NAME BROWSE-2
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH Impuesto
&Scoped-define OPEN-QUERY-BROWSE-2 OPEN QUERY {&SELF-NAME}             FOR EACH Impuesto.
&Scoped-define TABLES-IN-QUERY-BROWSE-2 Impuesto
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-2 Impuesto
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 D-Dialog _FREEFORM
  QUERY BROWSE-2 DISPLAY
      ...
      Impuesto.nombre       COLUMN-LABEL "Nombre!Impuesto" FORMAT "X(35)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 62 BY 11.14
         BGCOLOR 15 FGCOLOR 9 
         TITLE BGCOLOR 15 FGCOLOR 9 "Seleccione un impuesto" EXPANDABLE.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME D-Dialog
     BROWSE-2 AT ROW 1.95 COL 4
     Btn_OK AT ROW 14.1 COL 4
     Btn_Cancel AT ROW 14.1 COL 50
     RECT-10 AT ROW 1.29 COL 2
     SPACE(1.39) SKIP(0.32)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Seleccion de Impuestos"
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Seleccion de Impuestos */
DO:  
...
ON MOUSE-SELECT-DBLCLICK OF BROWSE-2 IN FRAME D-Dialog /* Seleccione un impuesto */
...
DO:
  ...
  p-ok = YES.
  p-cdg_impuesto = Impuesto.cdg_impuesto.
