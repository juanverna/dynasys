...
DEFINE VARIABLE h_b-obras AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-obra AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Mantenimiento de Obras Contables"
         HEIGHT             = 26.76
         WIDTH              = 160
         MAX-HEIGHT         = 26.76
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Mantenimiento de Obras Contables */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Mantenimiento de Obras Contables */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Mantenimiento de Obras Contables */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-obra ).
       RUN set-position IN h_v-obra ( 1.24 , 24.00 ) NO-ERROR.
       /* Size in UIB:  ( 16.67 , 84.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-obras ).
       RUN set-position IN h_b-obras ( 1.29 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-obras ( 20.48 , 16.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 19.57 , 24.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.14 , 84.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-obra. */
       RUN add-link IN adm-broker-hdl ( h_b-obras , 'Record':U , h_v-obra ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-obra ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-obras ,
             h_v-obra , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Mantenimiento de Obras Contables"}
