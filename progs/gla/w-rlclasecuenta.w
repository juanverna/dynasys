...
DEFINE VARIABLE h_v-par-clasecue AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     "  Parámetros generales del listado:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 6.38 COL 14
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Plan de Cuentas Clasificado"
         HEIGHT             = 22.14
         WIDTH              = 123
         MAX-HEIGHT         = 22.14
         MAX-WIDTH          = 123
...
ON END-ERROR OF W-Win /* Plan de Cuentas Clasificado */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Plan de Cuentas Clasificado */
DO:
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Layout = ,
                     Create-On-Add = No':U ,
             OUTPUT h_v-par-clasecue ).
       RUN set-position IN h_v-par-clasecue ( 7.71 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.14 , 100.00 ) */
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-par-clasecue ,
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Plan de Cuentas Clasificado"}
...
------------------------------------------------------------------------------*/
  ...
  RUN dar_rango IN h_v-par-clasecue (  OUTPUT lin_pagina,
                                       OUTPUT lis_fecha,
                                       OUTPUT error_rango).
