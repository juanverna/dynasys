...
&Scoped-define INTERNAL-TABLES Asn_header

/* Definitions for BROWSE BROWSE-3                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-3 Asn_header.fecha ~
Asn_header.tip_comprob Asn_header.prf_comprob Asn_header.nro_comprob ~
Asn_header.cdg_sigla-sic Asn_header.posteo Asn_header.origen ~
Asn_header.leyenda 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-3 
&Scoped-define QUERY-STRING-BROWSE-3 FOR EACH Asn_header ~
      WHERE Asn_header.cdg_empresa = que_empresa ~
 AND Asn_header.fecha <= v-has_fecha ~
 AND Asn_header.fecha >= v-des_fecha NO-LOCK
&Scoped-define OPEN-QUERY-BROWSE-3 OPEN QUERY BROWSE-3 FOR EACH Asn_header ~
      WHERE Asn_header.cdg_empresa = que_empresa ~
 AND Asn_header.fecha <= v-has_fecha ~
 AND Asn_header.fecha >= v-des_fecha NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-3 Asn_header
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-3 Asn_header
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-3 D-Dialog _STRUCTURED
  QUERY BROWSE-3 DISPLAY
      Asn_header.fecha COLUMN-LABEL "Fecha!Asiento" FORMAT "99/99/99":U
      Asn_header.tip_comprob FORMAT "X(3)":U
      Asn_header.prf_comprob FORMAT "9999":U
      Asn_header.nro_comprob COLUMN-LABEL "Número!Asiento" FORMAT ">>>>>>9":U
      Asn_header.cdg_sigla-sic FORMAT "X(3)":U
      Asn_header.posteo FORMAT "X(1)":U
      Asn_header.origen FORMAT "X(1)":U
      Asn_header.leyenda COLUMN-LABEL "Leyenda!Asiento" FORMAT "X(50)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 98 BY 11.57.
...
DEFINE FRAME D-Dialog
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "Seleccion de Asientos Contables"
...
/* Query rebuild information for BROWSE BROWSE-3
     _TblList          = "sic.Asn_header"
     _Where[1]         = "Asn_header.cdg_empresa = que_empresa
 AND Asn_header.fecha <= v-has_fecha
 AND Asn_header.fecha >= v-des_fecha"
     _FldNameList[1]   > sic.Asn_header.fecha
"fecha" "Fecha!Asiento" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
"nro_comprob" "Número!Asiento" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   = sic.Asn_header.cdg_sigla-sic
     _FldNameList[6]   = sic.Asn_header.posteo
     _FldNameList[7]   = sic.Asn_header.origen
     _FldNameList[8]   > sic.Asn_header.leyenda
"leyenda" "Leyenda!Asiento" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-3 */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Seleccion de Asientos Contables */
DO:  
