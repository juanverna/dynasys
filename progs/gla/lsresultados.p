/*=================================================================================*/
/*                        IMPRIME UN CUADRO DE RESULTADOS DADO                     */
/*=================================================================================*/
...
DEFINE FRAME frm-titulo HEADER
    que_empresa
    tit_cuadro AT 40 
    "Página:" AT 85 PAGE-NUMBER FORMAT "ZZZ9" AT 92
    SKIP  
    fecha_lis   
    "Movimientos del "  AT 40 p-des_fecha " al "
    p-has_fecha
    hora_lis AT 85
    SKIP
    tit_moneda AT 40
    SKIP(1)
    "-----------------------------------------------------------------------------------------------" SKIP
    "Código   Descripción                                    Total           Total           Saldo  " SKIP
    "Cuenta   Cuenta                                       Débitos        Créditos           Final  " SKIP
    "-----------------------------------------------------------------------------------------------" SKIP(1)
        ...
        FOR EACH Entidad WHERE CAN-DO(Entidad.lista_empresas,Empresa.cdg_empresa):
            ...
            FIND LAST Saldos_x_cuenta OF Cuenta 
                WHERE Saldos_x_cuenta.cdg_empresa = Empresa.cdg_empresa 
                  ...
                  AND Saldos_x_cuenta.fch_saldo  <= p-has_fecha
