...
ON END-ERROR OF W-Win /* Listado de Balance */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Listado de Balance */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-que-expresion ( 4.57 , 16.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 8.76 , 16.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-par-libmayor ( 12.57 , 16.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 17.95 , 16.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Listado de Balance"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE v-nom_balance    AS CHARACTER.
  ...
  DEFINE VARIABLE x-file           AS CHARACTER.
  ...
  THEN DO:
       ...
       RUN lsbalance_grafico.p ( INPUT  des_fecha,
                                 INPUT  has_fecha,
                                 INPUT  v-cdg_moneda,
                                 INPUT  v-reexpresion, 
