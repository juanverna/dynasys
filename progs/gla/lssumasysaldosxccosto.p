...
DEFINE FRAME frm-titulo HEADER
  ...
  "Pagina:" AT 202 PAGE-NUMBER FORMAT "ZZZ9" AT 209
  SKIP  
  fecha_lis   
  "del" AT 85
  p-des_fecha
  ...
  ASSIGN
     ...
     FOR EACH Asn_detalle
          ...
          FIRST Entidad OF Asn_detalle
                WHERE Entidad.cdg_entidad <= p-has_entidad
                  AND Entidad.cdg_entidad >= p-des_entidad,
          FIRST Cuenta OF Asn_detalle
                WHERE Cuenta.cdg_cuenta <= p-has_cuenta
                  AND Cuenta.cdg_cuenta >= p-des_cuenta:

          VIEW FRAME frm-titulo.
    
          FIND FIRST T-Acumulado 
              WHERE T-Acumulado.cdg_entidad = Entidad.cdg_entidad 
                AND T-Acumulado.cdg_cuenta  = Cuenta.cdg_cuenta 
                    NO-ERROR.

          IF NOT AVAILABLE T-Acumulado
          THEN DO:
              CREATE T-Acumulado.
              ASSIGN T-Acumulado.cdg_entidad = Entidad.cdg_entidad 
                     T-Acumulado.cdg_cuenta = Cuenta.cdg_cuenta.
          END.
  ...
  FOR EACH T-Acumulado BREAK BY T-Acumulado.cdg_entidad BY T-Acumulado.cdg_cuenta:
      ...
      THEN DO:
          ...
          ASSIGN
                ...
                gen_acm_saldo_per    = gen_acm_saldo_per  + tot_acm_saldo_per 
                gen_acm_saldo_tot    = gen_acm_saldo_tot  + tot_acm_saldo_tot.
          ...
          DISPLAY   "Total Control"       @ Cuenta.nombre
                    gen_debitos_per       @ T-Acumulado.acm_debitos_per 
                    gen_creditos_per      @ T-Acumulado.acm_creditos_per 
                    gen_acm_saldo_per     @ T-Acumulado.acm_saldo_per
                    gen_debitos_tot       @ T-Acumulado.acm_debitos_tot 
                    gen_creditos_tot      @ T-Acumulado.acm_creditos_tot 
                    gen_acm_saldo_tot     @ T-Acumulado.acm_saldo_tot
                    WITH FRAME frm-movimiento.
