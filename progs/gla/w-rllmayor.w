...
ON END-ERROR OF W-Win /* Emisión de Libro Mayor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Emisión de Libro Mayor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cuenta ( 4.57 , 36.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-que-expresion ( 9.24 , 36.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 13.29 , 36.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-par-libmayor ( 17.43 , 36.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 22.48 , 36.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Emisión de Libro Mayor"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lslibro_mayor.p ( INPUT  des_fecha,
                             INPUT  has_fecha,
                             INPUT  des_cuenta,
                             INPUT  has_cuenta,
                             INPUT  lis_fecha,
