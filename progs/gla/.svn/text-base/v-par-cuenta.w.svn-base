...
DEFINE FRAME F-Main
     des_registro AT ROW 1.48 COL 21 COLON-ALIGNED
     des_nombre AT ROW 1.48 COL 35.8 COLON-ALIGNED NO-LABEL
...
ON + OF des_registro IN FRAME F-Main /* Código de Cuenta */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL des_registro V-table-Win
ON MOUSE-MENU-DOWN OF des_registro IN FRAME F-Main /* Código de Cuenta */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL des_registro V-table-Win
ON RETURN OF des_registro IN FRAME F-Main /* Código de Cuenta */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
        ...
        ASSIGN des_registro des_nombre.
