...
&Scoped-Define ENABLED-OBJECTS des_fecha v-listar v-generar RECT-1 
&Scoped-Define DISPLAYED-OBJECTS des_fecha v-listar v-generar 
...
DEFINE VARIABLE v-listar AS LOGICAL INITIAL no 
     LABEL "Listar Fecha y Hora" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME F-Main
     ...
     v-listar AT ROW 1.81 COL 40
     v-generar AT ROW 1.81 COL 68
...
------------------------------------------------------------------------------*/
  ...
  DEFINE OUTPUT PARAMETER p-listar      AS LOGICAL.
