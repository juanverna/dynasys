/*=================================================================================*/
/*                    LISTADO DE SOLICITUDES POR SECTOR                            */
/*=================================================================================*/
...
DEFINE FRAME frm-titulo HEADER
    que_empresa 
    "Listado de Solicitudes Ordenadas por Sector" AT 40
    "Página:" AT 278 PAGE-NUMBER FORMAT "9999" AT 285
    SKIP  
    fecha_lis
    "del" AT 40
    des_fecha
...
DEFINE FRAME frm-listado
    Area.denominacion                COLUMN-LABEL "Sector"
...
PROCEDURE LISTAR_TODO:
  ...
  FOR EACH Sre_header 
        ...
        DISPLAY
             Area.denominacion               WHEN FIRST-OF(Sre_header.nro_area)
...
/*              B-Empleado.nombre               WHEN FIRST-OF(Sre_header.nro_solicitud) */
             Destinatario.dsc_destinatario   WHEN FIRST-OF(Sre_header.nro_solicitud)
