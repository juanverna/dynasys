/*=================================================================================*/
/*              EMITE EL LISTADO MAYOR DE MOVIMIENTOS DE POR ENTIDAD               */
/*=================================================================================*/
...
DEFINE VARIABLE tit_entidad  AS CHARACTER FORMAT "X(70)".
...
DEFINE FRAME frm-titulo HEADER
  que_empresa
  "Libro Mayor de Entidades" AT 72 
 ...
 {dirprinfile.i}
  ...
  FOR EACH Entidad NO-LOCK
      ...
      tit_entidad = TRIM(Entidad.cdg_entidad) + "-" + Entidad.dsc_entidad + 
          IF p-reexpresion 
             THEN " - Importes en:" + Moneda.descripcion
             ELSE " - Moneda de Origen:" + Moneda.descripcion.
