...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Entidad WHERE ~{&KEY-PHRASE} NO-LOCK ~
...
<FOREIGN-KEYS>
cdg_empresa||y|sic.Entidad.cdg_empresa
dsc_entidad||y|sic.Entidad.dsc_entidad
cdg_entidad||y|sic.Entidad.cdg_entidad
nro_entidad||y|sic.Entidad.nro_entidad
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cdg_empresa,dsc_entidad,cdg_entidad,nro_entidad"':U).
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "sic.Entidad"
     _Options          = "NO-LOCK KEY-PHRASE"
     _OrdList          = "sic.Entidad.cdg_entidad|yes"
...
DO:
  ...
  &SCOPED-DEFINE CODIGO cdg_entidad
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cdg_empresa" "Entidad" "cdg_empresa"}
  {src/adm/template/sndkycas.i "dsc_entidad" "Entidad" "dsc_entidad"}
  {src/adm/template/sndkycas.i "cdg_entidad" "Entidad" "cdg_entidad"}
  {src/adm/template/sndkycas.i "nro_entidad" "Entidad" "nro_entidad"}
