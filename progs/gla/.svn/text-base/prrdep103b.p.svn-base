        ...
        THEN DO:
            ...
            */
            ...
            THEN DO:
                 ...
                 FOR EACH Registrable-transdep OF Transdep_dt, FIRST Registrable OF Registrable-transdep:
...
PROCEDURE verificar_fin_hoja:
    ...
    THEN DO:
        ...
        OUTPUT STREAM Formulario CLOSE.            
        FILE-INFO:File-NAME = "c:\sic-temp\prrdep103.xpr".
        RUN printFile( FILE-INFO:FULL-PATHNAME). /* Primera copia */
        n-hoja = n-hoja + 1.      
        OUTPUT STREAM Formulario TO "c:\sic-temp\prrdep103.xpr" CONVERT TARGET "iso8859-1".
