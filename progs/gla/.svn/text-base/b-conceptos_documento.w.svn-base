...
&Scoped-define QUERY-STRING-br_table FOR EACH Imputacion WHERE ~{&KEY-PHRASE} NO-LOCK ~
    BY Imputacion.cdg_imputacion INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Imputacion WHERE ~{&KEY-PHRASE} NO-LOCK ~
    BY Imputacion.cdg_imputacion INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table Imputacion
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Imputacion
...
<FOREIGN-KEYS>
cdg_imputacion||y|sic.Imputacion.cdg_imputacion
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cdg_imputacion"':U).
...
/* Query rebuild information for BROWSE br_table
     ...
     _OrdList          = "sic.Imputacion.cdg_imputacion|yes"
...
DO:
  ...
  &SCOPED-DEFINE SELECCION          SELCNDOC.P
  &SCOPED-DEFINE TABLA              Imputacion
  &SCOPED-DEFINE CDG_TABLA          cdg_imputacion
  &SCOPED-DEFINE DSC_TABLA          dsc_imputacion
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cdg_imputacion" "Imputacion" "cdg_imputacion"}
