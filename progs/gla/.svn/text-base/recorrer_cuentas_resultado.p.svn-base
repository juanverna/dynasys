/*=================================================================================*/
/*       RECORRE LA CLASIFICACION DE CUENTAS Y ARMA EL ESTADO DE RESULTADOS        */
/*=================================================================================*/
...
IF SUBSTRING(Clase.cdg_subclase,1,2) >= ".4" OR Clase.cdg_subclase = "" /* Perdon Backus y Von Noiman !!!! (10 a¤os en exactas para hacer esto....*/
THEN DO:
    IF Clase.cdg_clase <> ?
    THEN DO:
    ...
    THEN DO: /* No es el último nivel. Seguimos profundizando */
       ...
       DO WHILE AVAILABLE Subclase:              
          ...
          RUN recorrer_cuentas_resultado.p ( INPUT ROWID(Subclase) , 
                                             INPUT nivel,
                                             INPUT p-cdg_empresa,
             ...
             FOR EACH Libro-cuenta 
                     WHERE Libro-cuenta.cdg_librocontable = Clase.cdg_librocontable
                       ...
                       AND Libro-cuenta.cdg_empresa  = p-cdg_empresa,
                           FIRST Cuenta OF Libro-cuenta WHERE LOOKUP(Cuenta.grupo_pat,"+,-") <> 0
...
PROCEDURE CALCULAR_SALDO:
   ...
   FOR EACH Asn_detalle OF Cuenta 
      ...
      IF Asn_detalle.fecha_mayor >= p-des_fecha 
          THEN ASSIGN l-acm_debitos_per  = l-acm_debitos_per  + Asn_detalle.debito
