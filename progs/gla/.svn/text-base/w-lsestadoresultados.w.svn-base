...
ON END-ERROR OF W-Win /* Estado de Resultados */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Estado de Resultados */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Estado de Resultados"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsestadoresultados.p ( INPUT  des_fecha,
                                  INPUT  has_fecha,
                                  INPUT  v-cdg_moneda,
                                  INPUT  v-reexpresion, 
