...
DEFINE FRAME F-Main
     v-estado AT ROW 15.54 COL 12 COLON-ALIGNED NO-LABEL
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Resultados x Centro de Costo"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Resultados x Centro de Costo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Resultados x Centro de Costo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-que-cuadro ( 3.69 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-que-expresion ( 8.54 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 17.15 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Resultados x Centro de Costo"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE v-que_fecha          AS DATE.
  ...
  THEN DO:
       ...
       RUN lsresultadosxccosto.p ( INPUT  v-cdg_cuadrores,
                                   INPUT  v-que_fecha,
                                   INPUT  v-cdg_moneda,
                                   INPUT  v-reexpresion).   
