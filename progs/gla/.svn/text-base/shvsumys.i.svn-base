DEFINE {1} SHARED VARIABLE des_fecha    LIKE Asn_detalle.fecha.
DEFINE {1} SHARED VARIABLE has_fecha    LIKE Asn_detalle.fecha.
DEFINE {1} SHARED VARIABLE des_cuenta   LIKE Cuenta.cdg_cuenta   LABEL "Desde cuenta".
DEFINE {1} SHARED VARIABLE has_cuenta   LIKE Cuenta.cdg_cuenta   LABEL "Hasta cuenta".
...
DEFINE {1} SHARED VARIABLE tit_clase    LIKE Clase_de_cuenta.nombre_subclase.
