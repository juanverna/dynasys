...
DEFINE VARIABLE h_v-par_levantar AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     "  Parámetros generales del proceso:" VIEW-AS TEXT
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-par_levantar.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-par_levantar ).
       RUN set-position IN h_v-par_levantar ( 3.86 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.24 , 100.00 ) */
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-par_levantar ,
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Carga de Interface de Asientos Externos"}
...
------------------------------------------------------------------------------*/
  ...
  RUN dar_rango IN h_v-par_levantar ( OUTPUT v-cambio_pago, 
                                      OUTPUT v-salida,
                                      OUTPUT v-leyenda,
                                      OUTPUT error_rango ).
  IF error_rango 
  ...
  THEN DO:
       ...
       RUN levantar_asiento_ml.p ( INPUT v-cambio_pago,
                                   INPUT v-salida,
                                   INPUT v-leyenda ).   
