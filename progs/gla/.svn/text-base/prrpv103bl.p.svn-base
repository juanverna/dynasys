...
/*     RUN escribir ( INPUT "51,85", INPUT "[" + Proveedor.cdg_proveedor + "]", INPUT 8, INPUT NO).  */
    RUN escribir ( INPUT "30,1", INPUT Proveedor.direccion, INPUT 8, INPUT NO).
    RUN escribir ( INPUT "34,1", INPUT "(" + Proveedor.cdg_postal + ") " + Proveedor.localidad, INPUT 8, INPUT NO).
