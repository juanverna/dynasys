...
DEFINE VARIABLE h_v-par-amorbdu AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     "  Parámetros de Amortización de Bienes de Uso:" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Amortización de Bienes de Uso"
         HEIGHT             = 22.14
         WIDTH              = 114.2
         MAX-HEIGHT         = 22.14
         MAX-WIDTH          = 114.2
...
ON END-ERROR OF W-Win /* Amortización de Bienes de Uso */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Amortización de Bienes de Uso */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-par-amorbdu.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-par-amorbdu ).
       RUN set-position IN h_v-par-amorbdu ( 7.48 , 14.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-par-amorbdu ,
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Amortización de Bienes de Uso"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsamorbu.p ( INPUT des_fecha,     
                        INPUT v-lisfecha,   
                        INPUT v-generar).
