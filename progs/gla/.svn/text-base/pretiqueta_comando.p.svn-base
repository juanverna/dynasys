/*=========================================================================================*/
/*                           IMPRESION DE ETIQUETAS DE COMANDOS                            */
/*=========================================================================================*/
...
DEFINE INPUT PARAMETER p-empresa_nombre   AS CHARACTER.
DEFINE INPUT PARAMETER p-descripcion      AS CHARACTER.
...
RUN renglons.p ( INPUT p-descripcion, INPUT 40 , OUTPUT v-descripcion, INPUT "|").
...
RUN escribir ( INPUT T-Formato.posic, INPUT p-empresa_nombre, INPUT T-Formato.tfont, INPUT T-Formato.negrita).
...
RUN escribebarra ( INPUT T-Formato.posic, INPUT STRING(p-num_etiqueta,"99999999") + STRING(0,"99999999"), INPUT T-Formato.tfont, INPUT T-Formato.negrita).
...
FIND FIRST T-Formato WHERE T-Formato.kword = "nro_serie".
 IF T-Etiqueta.nro_registrable <> 0 
 THEN DO:
...
/* PUT STREAM sstream CONTROL "<PRINT=DIRECT>".  */
   PUT STREAM sstream CONTROL "<OPORTRAIT><Title=Impresion de T-Etiqueta Nro.:" + STRING(p-num_etiqueta,"99999999") + "><UNITS=mm><|2>".
