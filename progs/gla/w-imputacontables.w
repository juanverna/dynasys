...
DEFINE VARIABLE h_b-imputacontables AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-imputacontables AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-imputacontables.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-imputacontables ).
       RUN set-position IN h_b-imputacontables ( 1.48 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-imputacontables ( 22.14 , 40.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'gla/v-imputacontables.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-imputacontables ).
       RUN set-position IN h_v-imputacontables ( 1.48 , 44.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 6.24 , 44.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.14 , 77.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-imputacontables. */
       RUN add-link IN adm-broker-hdl ( h_b-imputacontables , 'Record':U , h_v-imputacontables ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-imputacontables ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-imputacontables ,
             h_b-imputacontables , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-imputacontables , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Códigos Genéricos de Imputación"}
