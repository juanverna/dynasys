...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Exportacion Masiva de Asientos"
         HEIGHT             = 22.14
         WIDTH              = 135
         MAX-HEIGHT         = 22.14
         MAX-WIDTH          = 135
...
ON END-ERROR OF W-Win /* Exportacion Masiva de Asientos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Exportacion Masiva de Asientos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 3.19 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-que-modulo ( 7.67 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-rng-archivo ( 12.67 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Exportación Masiva de Asientos"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsexportacion_asientos.p ( INPUT des_fecha,     
                                      INPUT has_fecha,
                                      INPUT que_modulo,
                                      INPUT que_archivo).
