...
&Scoped-define INTERNAL-TABLES Imputacion_difcambios

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH Imputacion_difcambios OF Moneda WHERE ~{&KEY-PHRASE} ~
      AND Imputacion_difcambios.cdg_empresa = que_empresa NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Imputacion_difcambios OF Moneda WHERE ~{&KEY-PHRASE} ~
      AND Imputacion_difcambios.cdg_empresa = que_empresa NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Imputacion_difcambios
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Imputacion_difcambios
...
<FOREIGN-KEYS>
nro_cuenta||y|sic.Imputacion_difcambios.nro_cuenta
cdg_empresa||y|sic.Imputacion_difcambios.cdg_empresa
nro_moneda||y|sic.Imputacion_difcambios.nro_moneda
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nro_cuenta,cdg_empresa,nro_moneda"':U).
...
DEFINE QUERY Query-Main FOR 
      Imputacion_difcambios SCROLLING.
&ANALYZE-RESUME
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "sic.Imputacion_difcambios OF sic.Moneda"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "Imputacion_difcambios.cdg_empresa = que_empresa"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "nro_cuenta" "Imputacion_difcambios" "nro_cuenta"}
  {src/adm/template/sndkycas.i "cdg_empresa" "Imputacion_difcambios" "cdg_empresa"}
  {src/adm/template/sndkycas.i "nro_moneda" "Imputacion_difcambios" "nro_moneda"}
