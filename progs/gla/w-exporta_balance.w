...
DEFINE FRAME F-Main
     v-estado AT ROW 17.67 COL 8 COLON-ALIGNED NO-LABEL
     "     Archivo en que se genera la salida" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 6.91 COL 10
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-archivo ( 8.14 , 10.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/GLA" "Exportación de Balance a EXCEL"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN exporta_balance.p ( INPUT v-archivo ).
