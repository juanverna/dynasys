...
&Scoped-Define ENABLED-OBJECTS fd b_ayuda 
...
DEFINE FRAME F-Main
     ...
     fd AT ROW 3.38 COL 23.6 COLON-ALIGNED WIDGET-ID 10
     b_ayuda AT ROW 5.76 COL 53 WIDGET-ID 2
     "Fecha proxima cobranza" VIEW-AS TEXT
          SIZE 26 BY 1.19 AT ROW 1.24 COL 21
...
ON MOUSE-MENU-CLICK OF fd IN FRAME F-Main /* Fecha */
DO:
   {selfecha.i}
END.
