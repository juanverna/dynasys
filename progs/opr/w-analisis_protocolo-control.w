...
DEFINE VARIABLE h_b-analisis_protocolo-2 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-analisis_protocolo-2 ).
       RUN set-position IN h_b-analisis_protocolo-2 ( 1.48 , 2.80 ) NO-ERROR.
       RUN set-size IN h_b-analisis_protocolo-2 ( 10.95 , 153.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-analisis_protocolo-control.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-analisis_protocolo ).
       RUN set-position IN h_v-analisis_protocolo ( 12.67 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.91 , 128.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 16.48 , 42.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 1.76 , 65.00 ) NO-ERROR.

       /* Links to SmartV8Viewer h_v-analisis_protocolo. */
       RUN add-link IN adm-broker-hdl ( h_b-analisis_protocolo-2 , 'Record':U , h_v-analisis_protocolo ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-analisis_protocolo ,
             h_b-analisis_protocolo-2 , 'AFTER':U ).
