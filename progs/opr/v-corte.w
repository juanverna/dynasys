...
DO:
  MESSAGE "Suma a la fecha del dia para calcular el corte de la deuda vencida" skip
          "segun la fecha de vencimiento de la factura " SKIP 
          "Si cae en un dia habil sera el dia siguiente"
...
ON LEAVE OF Fd IN FRAME F-Main /* Fecha de corte */
DO:
    ASSIGN fd.
