...
DEFINE VARIABLE h_b-categmono AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-categmono AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-categmono.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-categmono ).
       RUN set-position IN h_b-categmono ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-categmono ( 12.62 , 16.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-categmono.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-categmono ).
       RUN set-position IN h_v-categmono ( 2.91 , 30.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 42.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 11.71 , 18.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 1.76 , 65.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-categmono. */
       RUN add-link IN adm-broker-hdl ( h_b-categmono , 'Record':U , h_v-categmono ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-categmono ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-categmono ,
             h_b-categmono , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-categmono , 'AFTER':U ).
    END. /* Page 0 */
