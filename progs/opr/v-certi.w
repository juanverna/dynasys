...
DEFINE VARIABLE v-certi AS CHARACTER FORMAT "X":U 
     LABEL "Certificado" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEM-PAIRS "Nada","*",
                     "Recibo","RE",
                     "Orden Trabajo","OT"
     DROP-DOWN-LIST
     SIZE 38 BY 1 TOOLTIP "Tipo de certificado" NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     v-certi AT ROW 2.91 COL 22 COLON-ALIGNED WIDGET-ID 40
...
/* SETTINGS FOR COMBO-BOX v-certi IN FRAME F-Main
   NO-ENABLE                                                            */
