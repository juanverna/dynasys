...
&Scoped-Define ENABLED-OBJECTS RECT-18 bAgenda BUTTON-11 Bp1 Bp2 BAnalisis ~
BDia 
...
DEFINE FRAME F-Main
     ...
     Bp1 AT ROW 11.29 COL 146 WIDGET-ID 40
     Bp2 AT ROW 12.48 COL 146 WIDGET-ID 42
     BAnalisis AT ROW 13.67 COL 146 WIDGET-ID 44
     BDia AT ROW 14.86 COL 146 WIDGET-ID 46
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-capacidad ( 1.00 , 44.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-eventos_recursos ( 11.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-eventos_recursos ( 5.48 , 143.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_p-soloedita ( 16.48 , 146.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-evento-2 ).
       RUN set-position IN h_v-evento-2 ( 16.71 , 1.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_b-eventocli ( 16.95 , 1.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_b-eventos_analisis-2 ( 17.19 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_p-excel-2 ).
       RUN set-position IN h_p-excel-2 ( 17.19 , 142.00 ) NO-ERROR.
    ...
    WHEN 4 THEN DO:
       ...
       RUN set-position IN h_v-agenda_dia ( 11.00 , 1.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ENABLE RECT-18 bAgenda BUTTON-11 Bp1 Bp2 BAnalisis BDia 
