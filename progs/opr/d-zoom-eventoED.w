...
DEFINE FRAME D-Dialog
     SPACE(146.61) SKIP(13.30)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Zoom Evento" WIDGET-ID 100.
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Zoom Evento */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-evento-2 ).
       RUN set-position IN h_v-evento-2 ( 1.24 , 3.00 ) NO-ERROR.
       ...
       RUN set-position IN h_p-soloedita ( 12.52 , 47.00 ) NO-ERROR.
       RUN set-size IN h_p-soloedita ( 1.57 , 66.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-evento ).
       RUN set-position IN h_q-evento ( 5.29 , 1.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  DYNAMIC-FUNCTION("pevento" IN  h_q-evento , pevento ). 
...
------------------------------------------------------------------------------*/
 ...
 {&WINDOW-NAME}:TITLE = "Zoom Evento - " + titulo.
