...
DEFINE VAR listaconf AS CHAR INITIAL "Llamar a cliente por telefono,TE,Avisar a la administracion,AD,Enviar Email al cliente,EM".
...
&Scoped-Define DISPLAYED-OBJECTS Cb 
...
DEFINE FRAME F-Main
     ...
     Cb AT ROW 3.38 COL 7 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     b_ayuda AT ROW 5.76 COL 53 WIDGET-ID 2
     "Medio de Confirmacion de Evento a realizar" VIEW-AS TEXT
...
DO:
  MESSAGE "Indica como se confirma el" skip
          "dia de la realizacion del evento" skip
          "En caso de no existir NO se realizara la confirmacion" 
          SKIP
          "Esto no tiene nada que ver con el proceso de avisos"
...
IF AVAILABLE contrato_restriccion  THEN DO:
    cb:SCREEN-VALUE IN FRAME {&FRAME-NAME} = entry(1,contrato_restriccion.valor,"|") NO-ERROR.
