...
DEFINE VARIABLE v-certi AS LOGICAL INITIAL yes 
     LABEL "No Chequea Encargado" 
     VIEW-AS TOGGLE-BOX
     SIZE 39 BY .81 TOOLTIP "Marquelo si no chequeara" NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE cliente_restriccion THEN DO:
            v-certi:SCREEN-VALUE IN FRAME {&FRAME-NAME} = cliente_restriccion.valor NO-ERROR.
  END.
  /* Code placed here will execute AFTER standard behavior.    */
