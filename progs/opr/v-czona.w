...
&Scoped-Define DISPLAYED-OBJECTS czona 
...
DEFINE VARIABLE czona AS CHARACTER FORMAT "X(256)":U 
     LABEL "Zona" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME F-Main
     ...
     czona AT ROW 2.91 COL 9 COLON-ALIGNED
...
/* SETTINGS FOR FILL-IN czona IN FRAME F-Main
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  ...
  czona:SENSITIVE IN FRAME {&FRAME-NAME} = FALSE.
...
IF AVAILABLE contrato_restriccion  THEN
     czona:SCREEN-VALUE IN FRAME {&FRAME-NAME} = contrato_restriccion.valor.
...
------------------------------------------------------------------------------*/
 ...
 czona:SENSITIVE IN FRAME {&FRAME-NAME} = TRUE.
  /* Code placed here will execute AFTER standard behavior.    */
...
------------------------------------------------------------------------------*/
  ...
  RETURN czona:SCREEN-VALUE IN FRAME {&FRAME-NAME}.   /* Function return value. */
