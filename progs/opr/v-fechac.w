...
DEFINE FRAME F-Main
     ...
     conf AT ROW 2.91 COL 27 NO-LABEL WIDGET-ID 6
     b_ayuda AT ROW 5.76 COL 53 WIDGET-ID 2
     "Debe pedirse la proxima fecha al pasar la cobranza" VIEW-AS TEXT
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
/*control de que no sea sab dom o feriado*/
...
IF AVAILABLE cliente_restriccion  THEN DO:
    conf:SCREEN-VALUE IN FRAME {&FRAME-NAME} = entry(1,cliente_restriccion.valor,"|") NO-ERROR.
