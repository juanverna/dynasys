...
DEFINE FRAME F-Main
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 164 BY 31.24 WIDGET-ID 100.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Recepcion|Observacion|Contactos|Edilicio' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 8.14 , 2.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 24.05 , 147.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-evento ).
       RUN set-position IN h_v-evento ( 9.81 , 6.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_b-cliente_contacto ( 11.71 , 4.00 ) NO-ERROR.
