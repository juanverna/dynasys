...
DEFINE VAR nrotipo AS CHAR NO-UNDO INITIAL "*".
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Capacidades de los Recursos"
         HEIGHT             = 16.05
         WIDTH              = 142
         MAX-HEIGHT         = 27.33
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Capacidades de los Recursos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON PARENT-WINDOW-CLOSE OF W-Win /* Capacidades de los Recursos */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Capacidades de los Recursos */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-recurso ).
       RUN set-position IN h_b-recurso ( 1.71 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-recurso ( 14.71 , 49.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'opr/v-capacidad.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-capacidad ).
       RUN set-position IN h_v-capacidad ( 1.95 , 53.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.52 , 88.00 ) */
