...
&Scoped-Define ENABLED-OBJECTS cletraprefijo fdesde fhasta BUTTON-1 
&Scoped-Define DISPLAYED-OBJECTS cletraprefijo fdesde fhasta 
...
DEFINE VARIABLE cletraprefijo AS CHARACTER FORMAT "X(256)":U 
     LABEL "LetraPrefijo" 
     VIEW-AS FILL-IN 
     SIZE 14 BY 1 NO-UNDO.

DEFINE VARIABLE fdesde AS INTEGER FORMAT ">>>>>>9":U INITIAL 0 
     LABEL "Certificado Desde" 
     VIEW-AS FILL-IN 
     SIZE 14 BY 1 NO-UNDO.

DEFINE VARIABLE fhasta AS INTEGER FORMAT ">>>>>>9":U INITIAL 0 
     LABEL "Hasta" 
     VIEW-AS FILL-IN 
     SIZE 14 BY 1 NO-UNDO.
...
DEFINE FRAME F-Main
     cletraprefijo AT ROW 3.48 COL 19.8 COLON-ALIGNED WIDGET-ID 10
     fdesde AT ROW 5.1 COL 20 COLON-ALIGNED WIDGET-ID 4
     fhasta AT ROW 5.1 COL 53 COLON-ALIGNED WIDGET-ID 2
     BUTTON-1 AT ROW 6.57 COL 29 WIDGET-ID 8
     "   Impresion de certificados COPIA para ser presentados MCBA" VIEW-AS TEXT
          SIZE 70 BY 1.67 AT ROW 1.24 COL 2 WIDGET-ID 6
...
DO:
  ASSIGN FRAME {&FRAME-NAME} fdesde fhasta cletraprefijo.
  RUN presentacion_certificados_MCBA.p( fdesde , fhasta , cletraprefijo ).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY cletraprefijo fdesde fhasta 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE cletraprefijo fdesde fhasta BUTTON-1 
      WITH FRAME F-Main IN WINDOW W-Win.
