...
DEFINE VARIABLE h_b-clientesmanual AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b-eventocli-2 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-clientesmanual.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-clientesmanual ).
       RUN set-position IN h_b-clientesmanual ( 1.24 , 8.00 ) NO-ERROR.
       RUN set-size IN h_b-clientesmanual ( 8.38 , 146.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-eventocli.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-eventocli-2 ).
       RUN set-position IN h_b-eventocli-2 ( 10.52 , 8.00 ) NO-ERROR.
       RUN set-size IN h_b-eventocli-2 ( 6.71 , 145.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-evento ).
       RUN set-position IN h_v-evento ( 18.14 , 9.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.67 , 143.40 ) */

       /* Links to SmartBrowser h_b-eventocli-2. */
       RUN add-link IN adm-broker-hdl ( h_b-clientesmanual , 'Record':U , h_b-eventocli-2 ).

       /* Links to SmartViewer h_v-evento. */
       RUN add-link IN adm-broker-hdl ( h_b-eventocli-2 , 'Record':U , h_v-evento ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-eventocli-2 ,
             h_b-clientesmanual , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-evento ,
             h_b-eventocli-2 , 'AFTER':U ).
    END. /* Page 0 */
