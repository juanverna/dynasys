...
&Scoped-define FIELDS-IN-QUERY-br_table Contrato_hd.nro_cliente ~
Contrato_hd.num_contrato 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH Contrato_hd WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Contrato_hd WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
RUN set-attribute-list (
    'Keys-Accepted = "nro_cliente,nro_obra",
     Keys-Supplied = "nro_cliente,nro_obra,nombre,nro_area,cdg_banco,cdg_condiva,nro_cndventa,cdg_consignatario,nro_contrato,cdg_postal,cdg_empresa,cdg_formapago,cdg_lista,nro_moneda,cdg_planta,nro_plazo,cdg_provincia,nro_remito,cdg_solicitante,num_sucursal,cdg_embarque,nro_usuario,nro_vendedor,cdg_zonag"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Contrato_hd.nro_cliente FORMAT ">>>>>9":U
      Contrato_hd.num_contrato FORMAT "ZZZZZZZ9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = sic.Contrato_hd.nro_cliente
     _FldNameList[2]   = sic.Contrato_hd.num_contrato
