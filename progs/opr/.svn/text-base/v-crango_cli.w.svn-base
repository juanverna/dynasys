...
IF AVAILABLE cliente_restriccion  THEN DO:
    fd:SCREEN-VALUE IN FRAME {&FRAME-NAME} = entry(1,cliente_restriccion.valor,"|") NO-ERROR.
    fh:SCREEN-VALUE IN FRAME {&FRAME-NAME} = entry(2,cliente_restriccion.valor,"|") NO-ERROR.
END.
