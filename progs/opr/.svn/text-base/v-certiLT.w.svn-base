...
DEFINE VARIABLE v-certi AS CHARACTER FORMAT "X(256)":U INITIAL "MCBA" 
     LABEL "Tipo" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "MCBA","PAULISTA" 
     DROP-DOWN-LIST
     SIZE 16 BY 1 TOOLTIP "Tipo de certificado default MCBA" NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     v-certi AT ROW 4.1 COL 23 COLON-ALIGNED WIDGET-ID 42
     BUTTON-14 AT ROW 6 COL 54.8 WIDGET-ID 38
     "    Tipo de certificado" VIEW-AS TEXT
          SIZE 23 BY 1.43 AT ROW 2.19 COL 21 WIDGET-ID 44
