...
DEFINE FRAME F-Main
     Contrato_Restriccion.Valor AT ROW 1.24 COL 22 COLON-ALIGNED NO-LABEL WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 4 BY .29 NO-TAB-STOP 
     "Sin restricciones" VIEW-AS TEXT
          SIZE 17 BY 1.67 AT ROW 2.57 COL 26 WIDGET-ID 2
