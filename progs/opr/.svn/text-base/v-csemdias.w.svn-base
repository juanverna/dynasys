...
&Scoped-Define DISPLAYED-OBJECTS m-1 m-2 s-1 t-1 m-3 t-2 m-4 m-5 s-2 t-3 ~
...
DEFINE FRAME F-Main
     ...
     Contrato_Restriccion.Valor AT ROW 2.57 COL 37.2 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
...
IF AVAILABLE contrato_restriccion THEN DO:
    p0 = ENTRY(1,Contrato_restriccion.valor,"|") NO-ERROR.
    err =  ERROR-STATUS:ERROR.
    p1 = ENTRY(2,Contrato_restriccion.valor,"|") NO-ERROR.
    err = err OR ERROR-STATUS:ERROR.
    p2 = ENTRY(3,Contrato_restriccion.valor,"|") NO-ERROR.
    err = err OR ERROR-STATUS:ERROR.
