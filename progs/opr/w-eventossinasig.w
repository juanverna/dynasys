...
&Scoped-define INTERNAL-TABLES evento tipo_evento cliente administrador

/* Definitions for BROWSE BROWSE-4                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-4 tipo_evento.cdg_tipo_evento evento.nro_evento evento.periodo evento.recursos cliente.cdg_cliente cliente.direccion administrador.nom_cliente   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-4   
&Scoped-define SELF-NAME BROWSE-4
&Scoped-define QUERY-STRING-BROWSE-4 FOR EACH evento WHERE evento.fasignado = ? AND NOT evento.anulado AND evento.frealizado = ? AND evento.periodo <= pperiodo , ~
       FIRST tipo_evento OF evento , ~
       FIRST cliente OF evento, ~
       FIRST administrador WHERE administrador.nro_cliente = cliente.nro_admin BY tipo_evento.cdg_tipo_evento BY evento.periodo
&Scoped-define OPEN-QUERY-BROWSE-4 OPEN QUERY {&SELF-NAME} FOR EACH evento WHERE evento.fasignado = ? AND NOT evento.anulado AND evento.frealizado = ? AND evento.periodo <= pperiodo , ~
       FIRST tipo_evento OF evento , ~
       FIRST cliente OF evento, ~
       FIRST administrador WHERE administrador.nro_cliente = cliente.nro_admin BY tipo_evento.cdg_tipo_evento BY evento.periodo.
&Scoped-define TABLES-IN-QUERY-BROWSE-4 evento tipo_evento cliente ~
administrador
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-4 evento
&Scoped-define SECOND-TABLE-IN-QUERY-BROWSE-4 tipo_evento
&Scoped-define THIRD-TABLE-IN-QUERY-BROWSE-4 cliente
&Scoped-define FOURTH-TABLE-IN-QUERY-BROWSE-4 administrador
...
&Scoped-Define ENABLED-OBJECTS BUTTON-8 BROWSE-4 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 126 BY 20.48 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME F-Main
     BUTTON-8 AT ROW 1 COL 114 WIDGET-ID 6
     BROWSE-4 AT ROW 2.19 COL 3 WIDGET-ID 100
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-4 BUTTON-8 F-Main */
ASSIGN 
...
/* Query rebuild information for BROWSE BROWSE-4
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH evento WHERE evento.fasignado = ? AND NOT evento.anulado AND evento.frealizado = ? AND evento.periodo <= pperiodo ,
FIRST tipo_evento OF evento , FIRST cliente OF evento, FIRST administrador WHERE administrador.nro_cliente = cliente.nro_admin BY tipo_evento.cdg_tipo_evento BY evento.periodo.
     _END_FREEFORM
     _Query            is OPENED
*/  /* BROWSE BROWSE-4 */
&ANALYZE-RESUME
...
ON MOUSE-MENU-CLICK OF BROWSE-4 IN FRAME F-Main
DO:
