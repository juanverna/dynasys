...
DEFINE VARIABLE h_b-evento_sinrealizar AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-evento_sinrealizar.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-evento_sinrealizar ).
       RUN set-position IN h_b-evento_sinrealizar ( 1.24 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-evento_sinrealizar ( 6.76 , 146.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Recepcion|Observacion|Contactos|Edilicio' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 8.14 , 4.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 24.29 , 147.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_b-evento_sinrealizar , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-evento1.w':U ,
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?':U ,
             OUTPUT h_v-evento ).
       RUN set-position IN h_v-evento ( 9.81 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 21.91 , 114.00 ) */
       ...
       RUN set-position IN h_p-solograba-2 ( 10.05 , 127.00 ) NO-ERROR.
       RUN set-size IN h_p-solograba-2 ( 8.10 , 18.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_vo-eventos ).
       RUN set-position IN h_vo-eventos ( 18.33 , 126.80 ) NO-ERROR.
       /* Size in UIB:  ( 2.38 , 18.00 ) */

       /* Links to SmartViewer h_v-evento. */
       RUN add-link IN adm-broker-hdl ( h_b-evento_sinrealizar , 'Record':U , h_v-evento ).
       RUN add-link IN adm-broker-hdl ( h_p-solograba-2 , 'TableIO':U , h_v-evento ).

       /* Links to SmartVortex h_vo-eventos. */
       RUN add-link IN adm-broker-hdl ( h_b-evento_sinrealizar , 'Record':U , h_vo-eventos ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_b-observacion-cli ( 10.05 , 7.00 ) NO-ERROR.
       RUN set-size IN h_b-observacion-cli ( 10.62 , 139.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-observacion-cli ( 21.00 , 7.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-soloalta ).
       RUN set-position IN h_p-soloalta ( 21.00 , 136.00 ) NO-ERROR.
       RUN set-size IN h_p-soloalta ( 7.38 , 10.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-observacion-cli. */
       RUN add-link IN adm-broker-hdl ( h_b-evento_sinrealizar , 'Record':U , h_b-observacion-cli ).
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_v-dsc_unico-domicilio ( 9.81 , 20.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-cliente_contacto ( 11.71 , 6.00 ) NO-ERROR.
       RUN set-size IN h_b-cliente_contacto ( 5.00 , 143.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav ).
       RUN set-position IN h_p-updsav ( 16.95 , 138.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav ( 11.52 , 9.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-cliente_contacto ( 17.05 , 7.00 ) NO-ERROR.
       ...
       RUN set-position IN h_q-domicilio ( 8.14 , 136.00 ) NO-ERROR.
    ...
    WHEN 4 THEN DO:
       ...
       RUN set-position IN h_v-otros_datos1 ( 10.52 , 20.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 12.19 , 137.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 16.19 , 8.00 ) NO-ERROR.
       ...
       RUN set-position IN h_q-cliente_otros_datos ( 10.05 , 135.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.86 , 10.80 ) */
       ...
       RUN add-link IN adm-broker-hdl ( h_b-evento_sinrealizar , 'Record':U , h_q-cliente_otros_datos ).
...
------------------------------------------------------------------------------*/
    ...
    IF VALID-HANDLE(h_v-evento)            THEN RUN set-sensitivo IN h_v-evento          ( INPUT p-operacion = "HABILITAR" ).
    IF VALID-HANDLE(h_v-cliente_contacto)  THEN RUN set-sensitivo IN h_v-cliente_contacto ( INPUT p-operacion = "HABILITAR" ). 
    IF VALID-HANDLE(h_b-observacion-cli)   THEN RUN set-sensitivo IN h_b-observacion-cli     ( INPUT p-operacion = "HABILITAR" ). 
    IF VALID-HANDLE(h_v-otros_datos1)      THEN RUN set-sensitivo IN h_v-otros_datos1          ( INPUT p-operacion = "HABILITAR" ). 
