...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Eventos - Oblea de Fumigacion para presentacion"
         HEIGHT             = 7.05
         WIDTH              = 106.2
         MAX-HEIGHT         = 49.1
         MAX-WIDTH          = 336
...
ON END-ERROR OF W-Win /* Eventos - Oblea de Fumigacion para presentacion */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Eventos - Oblea de Fumigacion para presentacion */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Eventos - Oblea de Fumigacion para presentacion"}
...
DEFINE VAR ar01f AS INT NO-UNDO.
  ...
  THEN DO:
       ...
       OUTPUT TO c:\temp\eventooblea.csv.
       ...
       FOR EACH evento NO-LOCK WHERE evento.frealizado >= des_fecha AND 
           evento.frealizado <= has_fecha AND
       ...
       END.
       OUTPUT CLOSE.
               v-estado:SCREEN-VALUE in FRAME {&FRAME-NAME} = "Archivo c:\temp\eventooblea.csv generado".
