...
DEFINE FRAME F-Main
     ...
     "Cobra el operario" VIEW-AS TEXT
          SIZE 49 BY 1.19 TOOLTIP "El operario cobra cuando se hace el servicio" AT ROW 1.24 COL 10
...
DO:
  MESSAGE "El operario cobra y rinde la cobranza" 
