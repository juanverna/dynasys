...
DEFINE FRAME F-Main
     v-estado AT ROW 16.95 COL 9 COLON-ALIGNED NO-LABEL
     "  Rango de Zonas a Considerar:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 2.14 COL 11
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Estado de Clientes a ser listados:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 7.76 COL 11
          BGCOLOR 5 FGCOLOR 15 FONT 6
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng-zona ).
       RUN set-position IN h_v-rng-zona ( 3.71 , 11.20 ) NO-ERROR.
       ...
       RUN set-position IN h_v-que_estadocliente ( 9.10 , 11.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.86 , 100.00 ) */
