...
DEFINE FRAME F-Main
     ...
     "   Parametros y Rangos" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 3.14 COL 10
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Proceso de Reemplazo de Facturas"
         HEIGHT             = 16.62
         WIDTH              = 118.8
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 128.6
...
ON END-ERROR OF W-Win /* Proceso de Reemplazo de Facturas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Proceso de Reemplazo de Facturas */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-refacturacion ( 4.24 , 10.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 9.33 , 10.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Proceso de Reemplazo de Facturas"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE v-fch_anulacion    LIKE Fac_header.fecha.
