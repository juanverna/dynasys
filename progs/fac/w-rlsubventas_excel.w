...
DEFINE FRAME F-Main
     ...
     "  Parámetros Generales de la Exportación:" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Exportación a Excel del Subdiario de Facturación"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Exportación a Excel del Subdiario de Facturación */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Exportación a Excel del Subdiario de Facturación */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-par-ivaventas ( 8.27 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Exportación a Excel del Subdiario de Facturación"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lssubventas_excel.p ( INPUT des_fecha, 
                                 INPUT has_fecha, 
                                 INPUT des_ptovta,
                                 INPUT has_ptovta,
                                 INPUT lista_tipos,
