...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Observaciones de Clientes */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-id-cliente ( 1.00 , 26.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-observacion-cli ( 2.86 , 26.00 ) NO-ERROR.
       RUN set-size IN h_b-observacion-cli ( 13.86 , 125.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-observacion-cli ( 16.95 , 26.00 ) NO-ERROR.
       ...
       RUN set-position IN h_p-edita_solo ( 24.81 , 26.00 ) NO-ERROR.
       RUN set-size IN h_p-edita_solo ( 2.14 , 106.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-poner_consolidadas ( 24.81 , 133.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-edita_solo , 'TableIO':U , h_v-observacion-cli ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-edita_solo ,
             h_v-observacion-cli , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-poner_consolidadas ,
             h_p-edita_solo , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Observaciones de Clientes"}
