  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_q-cliente ).
       RUN set-position IN h_q-cliente ( 1.00 , 121.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-cliente ).
       RUN set-position IN h_v-cliente ( 2.67 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 21.43 , 126.00 ) */

       /* Links to SmartViewer h_v-cliente. */
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_v-cliente ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_b-domicilios ( 5.00 , 6.20 ) NO-ERROR.
       ...
       RUN set-position IN h_v-dsc_cliente ( 3.14 , 6.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-domicli ).
       RUN set-position IN h_v-domicli ( 5.05 , 21.00 ) NO-ERROR.
       /* Size in UIB:  ( 18.81 , 84.00 ) */

       /* Links to SmartBrowser h_b-domicilios. */
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_b-domicilios ).
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente-4 ( 2.91 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.67 , 98.00 ) */
       ...
       RUN set-position IN h_v-dsc_domicilio ( 4.81 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.67 , 98.00 ) */
       ...
       RUN set-position IN h_b-cliente_contacto ( 6.71 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-cliente_contacto ( 10.48 , 108.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-cliente_contacto ( 17.43 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.57 , 107.00 ) */

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('2') NO-ERROR.

       /* Links to SmartViewer h_v-dsc_cliente-4. */
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_v-dsc_cliente-4 ).
    ...
    WHEN 4 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente-2 ( 2.91 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.67 , 98.00 ) */
       ...
       RUN set-position IN h_b-bon_cliente ( 5.05 , 5.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-bon_cliente ( 11.71 , 5.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-cliente_condicion ( 15.05 , 5.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-cnd_cliente ( 21.24 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.86 , 80.00 ) */

       /* Links to SmartViewer h_v-dsc_cliente-2. */
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_v-dsc_cliente-2 ).

       /* Links to SmartBrowser h_b-bon_cliente. */
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_b-bon_cliente ).
       ...
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_b-cliente_condicion ).
    ...
    WHEN 5 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente-3 ( 3.38 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.67 , 98.00 ) */
       ...
       RUN set-position IN h_b-bon_xarticulo ( 5.29 , 4.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-bon_xarticulo ( 16.00 , 4.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_b-bon_xarticulo ).
    ...
    WHEN 6 THEN DO:
       ...
       RUN set-position IN h_v-cliente_jurisdiccion ( 2.91 , 5.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-cliente_jurisdiccion ( 9.10 , 4.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-jurisdiccion_del_cliente ( 9.10 , 68.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.10 , 57.00 ) */

       /* Links to SmartViewer h_v-cliente_jurisdiccion. */
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_v-cliente_jurisdiccion ).

       /* Links to SmartBrowser h_b-cliente_jurisdiccion. */
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_b-cliente_jurisdiccion ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Consulta de datos del cliente"}
