...
FORM
    ...
    SKIP(1)
    "Bruto" AT 100
    Fac_header.imp_bruto AT 126  FORMAT "Z,ZZZ,ZZ9.99-"
    SKIP
    "Descuento" AT 100
    v-desc AT 126  FORMAT "Z,ZZZ,ZZ9.99-"
    SKIP
    "Neto" AT 100
    Fac_header.imp_neto  AT 126  FORMAT "Z,ZZZ,ZZ9.99-"
    SKIP
    "IVA" AT 100
    prciva 
    importe_iva AT 126  FORMAT "Z,ZZZ,ZZ9.99-"
    SKIP
    "Total a Pagar" AT 100
    Fac_header.imp_total AT 126 FORMAT "Z,ZZZ,ZZ9.99-"
    SKIP(2)
...
FOR EACH Fac_detalle OF Fac_header, Articulo OF Fac_detalle NO-LOCK,
  ...
  THEN DO:
     ...
     DO j = 1 to nt_lineas:
        ...
        IF j = 1
            THEN DISPLAY Fac_detalle.cantidad WHEN Fac_detalle.cantidad <> 0
                         Articulo.cdg_articulo
                         WITH FRAME frm-detalle USE-TEXT STREAM-IO DOWN.
        
        DISPLAY  que_descripcion @ Articulo.descripcion
                 WITH FRAME frm-detalle USE-TEXT STREAM-IO DOWN.

        IF j = nt_lineas
            THEN DISPLAY  Fac_detalle.precio
                          Fac_detalle.subtotal_bruto
                 WITH FRAME frm-detalle USE-TEXT STREAM-IO DOWN.
