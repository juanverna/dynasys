  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Datos|Domicilios|Bonificacione|Bon.x Artic.|Observaciones' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.00 , 22.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-cliente ).
       RUN set-position IN h_v-cliente ( 3.86 , 26.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_b-domicilios ( 6.48 , 42.20 ) NO-ERROR.
       ...
       RUN set-position IN h_v-dsc_cliente ( 4.33 , 42.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-domicli ).
       RUN set-position IN h_v-domicli ( 6.48 , 56.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-reserbon ).
       RUN set-position IN h_v-reserbon ( 20.05 , 42.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente-2 ( 4.33 , 45.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.67 , 98.00 ) */
       ...
       RUN set-position IN h_b-bon_cliente ( 6.48 , 54.80 ) NO-ERROR.
       RUN set-size IN h_b-bon_cliente ( 6.19 , 74.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-bon_cliente ( 12.91 , 54.40 ) NO-ERROR.
       /* Size in UIB:  ( 3.10 , 74.00 ) */
       ...
       RUN set-position IN h_b-cliente_condicion ( 16.24 , 54.00 ) NO-ERROR.
       RUN set-size IN h_b-cliente_condicion ( 5.91 , 74.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-cnd_cliente ( 22.43 , 53.60 ) NO-ERROR.
       /* Size in UIB:  ( 1.67 , 74.00 ) */
    ...
    WHEN 4 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente-3 ( 4.62 , 41.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.67 , 98.00 ) */
       ...
       RUN set-position IN h_b-bon_xarticulo ( 6.86 , 41.00 ) NO-ERROR.
       RUN set-size IN h_b-bon_xarticulo ( 10.52 , 98.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-bon_xarticulo ( 17.76 , 41.00 ) NO-ERROR.
    ...
    WHEN 5 THEN DO:
       ...
       RUN set-position IN h_b-observacion-cli ( 4.33 , 29.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-observacion-cli ( 14.57 , 29.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-poner_consolidadas ( 22.19 , 136.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_v-poner_consolidadas , 'Consolidar':U , h_b-observacion-cli ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Consulta Maestro de Clientes"}
