...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Resumen de Ventas por Provincia"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Resumen de Ventas por Provincia */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Resumen de Ventas por Provincia */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Resumen de Ventas Por Provincia"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsresumenprovincia.p ( INPUT des_fecha, 
                                  INPUT has_fecha, 
                                  INPUT des_ptovta,
                                  INPUT has_ptovta,
                                  INPUT lista_tipos,
