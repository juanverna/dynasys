...
&Scoped-Define ENABLED-OBJECTS RECT-1 v-des_ptovta v-has_ptovta v-totcond ~
v-lis_fecha v-lista_tipos 
&Scoped-Define DISPLAYED-OBJECTS v-des_ptovta v-has_ptovta v-totcond ~
v-lis_fecha v-lista_tipos 
...
DEFINE VARIABLE v-totcond AS LOGICAL INITIAL yes 
     LABEL "Totales por cond IVA" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME F-Main
     ...
     v-has_ptovta AT ROW 1.29 COL 61 COLON-ALIGNED
     v-totcond AT ROW 2.67 COL 18 WIDGET-ID 2
     v-lis_fecha AT ROW 2.67 COL 63
     v-lista_tipos AT ROW 3.62 COL 16 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  ...
  DEFINE OUTPUT PARAMETER p-totcond         AS logical.
