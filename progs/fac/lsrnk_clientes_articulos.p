...
DEFINE FRAME frm-titulo HEADER
  que_empresa 
  "Ranking de Clientes y Articulos" AT 48
...
/*       Rank_cliente.importe   = Rank_cliente.importe + signo * Fac_detalle.subtotal_neto.   */
/*       Rank_articulo.subtotal = Rank_articulo.subtotal + signo * Fac_detalle.subtotal_neto. */
  ...
  FOR EACH Rank_cliente, Cliente OF Rank_cliente BY Rank_cliente.importe DESCENDING:
      ...
      THEN DO:
         ...
         FOR EACH Rank_articulo OF Cliente, Articulo OF Rank_articulo, Unidad OF Articulo,
             Unigranel WHERE Unigranel.cdg_umed = Articulo.cdg_ugranel BY Rank_articulo.subtotal DESCENDING:            
