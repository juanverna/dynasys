...
DEFINE VARIABLE h_v-dea-vendedor AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     "   Vendedor desde el que se transfieren los Clientes y el que los recibe" VIEW-AS TEXT
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-dea-vendedor.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-dea-vendedor ).
       RUN set-position IN h_v-dea-vendedor ( 3.15 , 10.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Cambio Masivo de Vendedores"}
...
------------------------------------------------------------------------------*/
  ...
  RUN dar_rango IN h_v-dea-vendedor ( OUTPUT des_vendedor, 
                                      OUTPUT has_vendedor, 
                                      OUTPUT error_rango ).
  IF error_rango 
  THEN DO:
  ...
  THEN DO:
       ...
       RUN  cambia_vendedor.p ( INPUT lista_empresas, 
                                INPUT des_vendedor, 
                                INPUT has_vendedor, 
                                INPUT des_zona, 
                                INPUT has_zona 
