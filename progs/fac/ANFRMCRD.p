...
DO:
  ...
  IF credebfc
     THEN tipos_validos = "FA,FB".
     ELSE tipos_validos = "FA,FB,CA,CB,DA,DB".
...
DO:
  ...
  DO j = 1 TO cantidad_formas:
     ...
     CREATE Fac_header.
     ASSIGN Fac_header.cdg_comprobante = "FACTUCLI"
            Fac_header.fecha           = fecha_anulacion
            Fac_header.cdg_empresa     = Empresa.cdg_empresa
            Fac_header.tip_comprob     = tip_forma
            Fac_header.prf_comprob     = pto_venta
            Fac_header.nro_comprob     = des_forma + j - 1
            Fac_header.origen          = "A"
