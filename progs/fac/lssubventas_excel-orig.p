  ...
  FOR EACH Fac_header
      ...
      THEN DO:
          ...
          FOR EACH Fac_detalle OF Fac_header:
              ...
              IF Fac_header.cdg_condiva <> 10 /* MODIFICAR AQUI */
              THEN DO:
                  OPEN QUERY q_cuenta
                  ...
                  r-acumula [ ncol ] = r-acumula [ ncol ] + Fac_detalle.subtotal_neto * signo.
                  r-acumula [    8 ] = r-acumula [    8 ] + Fac_detalle.subtotal_neto * signo.
                  ...
                  FOR EACH Fac_detalle_impuesto OF Fac_detalle,
                        Impuesto OF Fac_detalle_impuesto :
                         ...
                         r-acumula [ ncol ] = r-acumula [ ncol ] + Fac_detalle_impuesto.importe * signo. 
    
                  END.
              END.
              ELSE DO:

                  r-acumula [ 7 ] = r-acumula [ 7 ] + Fac_detalle.subtotal_neto * signo.
                  r-acumula [ 8 ] = r-acumula [ 8 ] + Fac_detalle.subtotal_neto * signo.
