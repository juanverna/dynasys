...
ON END-ERROR OF W-Win /* Subdiario de Iva Ventas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Subdiario de Iva Ventas */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Subdiario de IVA Ventas"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE totcond          AS LOGICAL.
  ...
  THEN DO:
       ...
       RUN lsivaven.p ( INPUT des_fecha, 
                        INPUT has_fecha, 
                        INPUT des_ptovta,
                        INPUT has_ptovta,
                        INPUT lista_tipos,
