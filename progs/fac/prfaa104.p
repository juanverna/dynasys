    ...
    FOR EACH Fac_detalle OF Fac_header,
        ...
        THEN DO:
            ...
            THEN DO:
                ...
                THEN DO:
                    IF Imputacion.afecta_stock 
                        THEN RUN detalle-numr ( ch_linea  + ",147", INPUT STRING(Fac_detalle.precio,"-ZZZ,ZZ9.9999"), INPUT 8, INPUT NO, INPUT "BLACK").
                    RUN detalle-numr ( ch_linea  + ",166", INPUT STRING(Fac_detalle.subtotal_bruto,"-ZZ,ZZZ,ZZ9.99"), INPUT 8, INPUT NO, INPUT "BLACK").
                END.
                ELSE DO:
                ...
                THEN DO:
                    ...
                    THEN DO:
                        ...
                        THEN DO:
                            ...
                            RUN detalle-numr ( ch_linea  + ",145", INPUT STRING(Fac_detalle.precio,"-ZZZ,ZZ9.99"), INPUT 8, INPUT NO, INPUT "BLACK").
                        END.
                        RUN detalle-numr ( ch_linea  + ",166", INPUT STRING(Fac_detalle.subtotal_bruto,"-ZZ,ZZZ,ZZ9.99"), INPUT 8, INPUT NO, INPUT "BLACK").
                    END.
                END.
...
PROCEDURE pie_datos:
    ...
    RUN escribir ( "18,16", INPUT STRING(Fac_header.imp_neto ,"-ZZ,ZZZ,ZZ9.99"), INPUT 8, INPUT YES, INPUT "BLACK").
    RUN escribir ( "18,38", INPUT STRING(0,"-ZZ,ZZZ,ZZ9.99"), INPUT 8, INPUT YES, INPUT "BLACK").
    RUN escribir ( "18,76", INPUT STRING(Fac_header.imp_neto,"-ZZ,ZZZ,ZZ9.99"), INPUT 8, INPUT YES, INPUT "BLACK").
    RUN escribir ( "18,113", INPUT STRING(Fac_header.imp_iva,"-ZZ,ZZZ,ZZ9.99"), INPUT 8, INPUT YES, INPUT "BLACK").
