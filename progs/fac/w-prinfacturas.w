...
DEFINE FRAME F-Main
     v-estado AT ROW 14.48 COL 8 COLON-ALIGNED NO-LABEL
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-facturas ( 4.24 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.24 , 100.00 ) */
       ...
       RUN set-position IN h_v-rng-impresora ( 12.05 , 10.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN prinfacturas.p ( INPUT v-tip_comprob,
                            INPUT v-prf_comprob,
