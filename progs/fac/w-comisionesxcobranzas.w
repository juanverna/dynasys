...
DEFINE FRAME F-Main
     ...
     "  Moneda de los movimientos a considerar:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 6.38 COL 14
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Liquidación de comisiones x cobranzas"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Liquidación de comisiones x cobranzas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Liquidación de comisiones x cobranzas */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-vendedor ( 3.42 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-esp-moneda ( 7.46 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
       ...
       RUN set-position IN h_v-rng-fechas ( 11.23 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Liquidación de comisiones x cobranzas"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lscomisionesxcobranzas.p ( INPUT des_vendedor,
                                      INPUT has_vendedor,
                                      INPUT des_fecha,
                                      INPUT has_fecha,
                                      INPUT que_moneda
