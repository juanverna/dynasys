...
DEFINE FRAME F-Main
     v-estado AT ROW 19.58 COL 12 COLON-ALIGNED NO-LABEL
     "  Moneda de los movimientos:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 12.58 COL 14
...
ON END-ERROR OF W-Win /* Ventas por Zona */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Ventas por Zona */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 6.12 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng-zona ).
       RUN set-position IN h_v-rng-zona ( 9.88 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
       ...
       RUN set-position IN h_v-que-moneda ( 13.65 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
       ...
       RUN set-position IN h_v-lst-empresas ( 17.42 , 14.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 20.65 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Ventas por Zona"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsventasxzona.p ( INPUT v-lista_empresas,
                             INPUT des_vendedor,
                             INPUT has_vendedor,
                             INPUT des_fecha,
                             INPUT has_fecha,
