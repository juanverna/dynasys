...
&Scoped-Define ENABLED-FIELDS Cliente.nom_cliente Cliente.cdg_cliente 
&Scoped-define ENABLED-TABLES Cliente
&Scoped-define FIRST-ENABLED-TABLE Cliente
&Scoped-Define ENABLED-OBJECTS RECT-8 crest 
&Scoped-Define DISPLAYED-FIELDS Cliente.nom_cliente Cliente.cdg_cliente 
&Scoped-define DISPLAYED-TABLES Cliente
&Scoped-define FIRST-DISPLAYED-TABLE Cliente
&Scoped-Define DISPLAYED-OBJECTS crest 
...
DEFINE FRAME F-Main
     Cliente.nom_cliente AT ROW 1.24 COL 25 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 54 BY 1
          BGCOLOR 11 FGCOLOR 9 
     crest AT ROW 1.24 COL 80.6 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     Cliente.cdg_cliente AT ROW 1.29 COL 2 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 21 BY 1
          BGCOLOR 11 FGCOLOR 9 
...
DISPLAY restcli(cliente.cdg_cliente) @ crest.
END PROCEDURE.
