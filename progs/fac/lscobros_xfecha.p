...
DEFINE FRAME frm-titulo HEADER
  que_empresa 
  "Cobranzas Efectuadas por Fecha " AT 53
...
DEFINE FRAME frm-listado-mov
  ...
  Rec_detalle.importe            COLUMN-LABEL "Importe!Aplicado"
...
PROCEDURE LISTAR:
    ...
    FOR EACH Rec_header 
        WHERE CAN-DO(v-lista_empresas,Rec_header.cdg_empresa)
          ...
          AND NOT Rec_header.anulado,
              ...
              EACH Rec_detalle OUTER-JOIN OF Rec_header 
  ...
  DO WHILE AVAILABLE Rec_header:                 
        ...
        THEN DO:
             ...
             total_aplicado = total_aplicado + Rec_detalle.importe.                                      
        END.
        ELSE DO:
  ...
  DISPLAY "TOTAL COBRADO ------------------------->" @ Cliente.nom_cliente
          ...
          total_aplicado   @ Rec_detalle.importe
        WITH FRAME frm-listado-mov.
  DOWN WITH FRAME frm-listado-mov.
