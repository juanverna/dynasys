/*=================================================================================*/
/*               IMPRESION DE NOTAS DE CREDITO DE TIPO B                           */
/*=================================================================================*/
...
OUTPUT TO VALUE(dire_tmp + "prfab110.txt") PAGE-SIZE 72.
...
OUTPUT CLOSE.
   ...
   RUN _osprint.p ( INPUT  CURRENT-WINDOW:HANDLE, /* HANDLE de la WINDOW    */
                    INPUT  dire_tmp + "prfab110.txt",           /* Archivo a imprimir     */
