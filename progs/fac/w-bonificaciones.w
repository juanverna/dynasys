...
DEFINE VARIABLE h_b-bonificaciones AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-bonificacion AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-bonificacion.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-bonificacion ).
       RUN set-position IN h_v-bonificacion ( 1.24 , 24.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.67 , 76.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-bonificaciones.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-bonificaciones ).
       RUN set-position IN h_b-bonificaciones ( 1.29 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-bonificaciones ( 20.48 , 19.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 7.43 , 24.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.14 , 76.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-bonificacion. */
       RUN add-link IN adm-broker-hdl ( h_b-bonificaciones , 'Record':U , h_v-bonificacion ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-bonificacion ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-bonificaciones ,
             h_v-bonificacion , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_b-bonificaciones , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Bonificaciones"}
