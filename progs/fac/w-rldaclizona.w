...
DEFINE FRAME F-Main
     ...
     "  Rango de Zonas a Considerar:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 8.27 COL 14
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Datos de Clientes x Vendedor/Zona"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Datos de Clientes x Vendedor/Zona */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Datos de Clientes x Vendedor/Zona */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Datos de Clientes x Vendedor/Zona"}
