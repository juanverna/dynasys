...
DEFINE FRAME frm-titulo HEADER
  que_empresa 
  "Ranking de Articulos y Clientes" AT 48
  ...
  SKIP(1)
  "------------------------------------------------------------------------------------------------------------------------------" SKIP
  "Código        Descripción                                 Importe Total   Cant. Total     Granel Total                        " SKIP
  "Articulo      Artículo                                          Vendido       Vendida          Vendido                        " SKIP
  "                                                                                                                              " SKIP
  "    Código     Razón                                                  Total            Total               Total        Precio" SKIP
  "    Cliente    Social                                              Comprado         Unidades              Granel      Promedio" SKIP
  "------------------------------------------------------------------------------------------------------------------------------" SKIP(1)
...
PROCEDURE listar:
  ...
  FOR EACH Rank_articulo, Articulo OF Rank_articulo,  
      ...
      IF det_sino AND ( Rank_articulo.importe <> 0 OR cero_sino ) 
      THEN DO:
        FOR EACH Rank_cliente OF Articulo, Cliente OF Rank_cliente BY Rank_cliente.subtotal DESCENDING:            
