...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Cliente Cliente-bonxarticulo
&Scoped-define FIRST-EXTERNAL-TABLE Cliente


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Cliente, Cliente-bonxarticulo.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Cliente-bonxarticulo.porcentaje ~
Cliente-bonxarticulo.desde_fecha Cliente-bonxarticulo.hasta_fecha 
&Scoped-define ENABLED-TABLES Cliente-bonxarticulo
&Scoped-define FIRST-ENABLED-TABLE Cliente-bonxarticulo
&Scoped-Define ENABLED-OBJECTS RECT-10 
&Scoped-Define DISPLAYED-FIELDS Cliente-bonxarticulo.porcentaje ~
Cliente-bonxarticulo.desde_fecha Cliente-bonxarticulo.hasta_fecha 
&Scoped-define DISPLAYED-TABLES Cliente-bonxarticulo
&Scoped-define FIRST-DISPLAYED-TABLE Cliente-bonxarticulo
&Scoped-Define DISPLAYED-OBJECTS v-cdg_bonificacion v-dsc_bonificacion ~
v-cdg_articulo v-dsc_articulo 
...
DEFINE VARIABLE v-cdg_articulo AS CHARACTER FORMAT "X(10)" INITIAL "0" 
     LABEL "Articulo" 
...
DEFINE VARIABLE v-dsc_articulo AS CHARACTER FORMAT "X(35)" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 62 BY 1
...
DEFINE FRAME F-Main
     v-cdg_bonificacion AT ROW 1.48 COL 16 COLON-ALIGNED
     v-dsc_bonificacion AT ROW 1.48 COL 33 COLON-ALIGNED HELP
          "Denominacion" NO-LABEL
     v-cdg_articulo AT ROW 2.67 COL 16 COLON-ALIGNED
     v-dsc_articulo AT ROW 2.67 COL 33 COLON-ALIGNED HELP
          "Denominacion" NO-LABEL
     Cliente-bonxarticulo.porcentaje AT ROW 3.86 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 16 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Cliente-bonxarticulo.desde_fecha AT ROW 3.86 COL 53 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 14 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Cliente-bonxarticulo.hasta_fecha AT ROW 3.86 COL 81 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 14 BY 1
          BGCOLOR 15 FGCOLOR 9 
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: sic.Cliente,sic.Cliente-bonxarticulo
...
ON MOUSE-SELECT-DBLCLICK OF v-cdg_articulo IN FRAME F-Main /* Articulo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-cdg_articulo V-table-Win
ON RETURN OF v-cdg_articulo IN FRAME F-Main /* Articulo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "Cliente-bonxarticulo"}
  ...
  {src/adm/template/row-find.i "Cliente-bonxarticulo"}
...
------------------------------------------------------------------------------*/
   ...
   &SCOPED-DEFINE TABLA-MAESTRA  Cliente-bonxarticulo

   {validartabla.i "Bonificacion" "cdg_bonificacion" "descripcion" "BONI001"} 
   {validartabla.i "Articulo" "cdg_articulo" "descripcion" "BONI002"} 
  ...
  /* Code placed here will execute AFTER standard behavior.    */
   ...
   ASSIGN
        Cliente-bonxarticulo.nro_cliente = Cliente.nro_cliente
        Cliente-bonxarticulo.cdg_empresa = Empresa.cdg_empresa.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE Cliente-bonxarticulo
  THEN DO:
