...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Reporte de Convenio Multilateral"
         HEIGHT             = 26.24
         WIDTH              = 160
         MAX-HEIGHT         = 26.24
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Reporte de Convenio Multilateral */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Reporte de Convenio Multilateral */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 6.14 , 29.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-par-ivaventas ( 10.48 , 29.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 17.62 , 29.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Reporte de Convenio Multilateral"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsmultilateral.p ( INPUT des_fecha, 
                              INPUT has_fecha, 
                              INPUT des_ptovta,
                              INPUT has_ptovta,
                              INPUT lista_tipos,
