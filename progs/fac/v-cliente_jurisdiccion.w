...
&Scoped-Define ENABLED-FIELDS Cliente.convenio_sino Cliente.ing_brutos ~
Cliente.cdg_condibr 
...
Cliente.convenio_sino Cliente.ing_brutos Cliente.cdg_condibr 
...
DEFINE FRAME F-Main
     Cliente.cdg_cliente AT ROW 1.24 COL 12 COLON-ALIGNED
          LABEL "Cliente"
          VIEW-AS FILL-IN NATIVE 
          SIZE 26 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Cliente.nom_cliente AT ROW 1.24 COL 39 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN NATIVE 
          SIZE 55 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Cliente.convenio_sino AT ROW 1.24 COL 98 NO-LABEL
          VIEW-AS RADIO-SET VERTICAL
          RADIO-BUTTONS 
                    "Inscripto en C.M.", yes,
"No Inscripto en C.M.", no
          SIZE 24 BY 2.38
     Cliente.ing_brutos AT ROW 2.43 COL 12 COLON-ALIGNED
          LABEL "Nro.Ing.Br."
          VIEW-AS FILL-IN NATIVE 
          SIZE 26 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Cliente.cdg_condibr AT ROW 2.43 COL 63 COLON-ALIGNED
          LABEL "Condición Ing. Brutos"
...
/* SETTINGS FOR FILL-IN Cliente.cdg_cliente IN FRAME F-Main
   NO-ENABLE EXP-LABEL                                                  */
/* SETTINGS FOR COMBO-BOX Cliente.cdg_condibr IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN Cliente.ing_brutos IN FRAME F-Main
   EXP-LABEL                                                            */
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
     {levantacombo.i &TABLA=Condicion_ingbrutos &NOMBRE=descripcion_ibr &CODIGO=cdg_condibr &OBJETO=Cliente.cdg_condibr}
  END.          
