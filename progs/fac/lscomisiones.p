...
DEFINE FRAME frm-titulo HEADER
    que_empresa 
    "Liquidación de Comisiones por Ventas" AT 46
    "Página:" AT 168 PAGE-NUMBER FORMAT "9999" AT 175
    SKIP  
    fecha_lis
    "Ventas......:" AT 46
    des_fecha
    ...
    SKIP(1)
    "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
    "Fecha      Identificación   Código   Razón                                           Importe       Comisión        Importe        Comisión  Observaciones                         " SKIP
    "Operación  del comprobante  Cliente  Social                                          Vendido       S/Ventas        Cobrado       S/Cobrado  del movimiento                        " SKIP
    "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" SKIP
            ...
            FOR EACH Rec_detalle 
                WHERE Rec_detalle.cdg_emprecancela = Fac_header.cdg_empresa 
                  ...
                  FIRST Rec_header OF Rec_detalle
                        WHERE Rec_header.fecha >= des_fecha-cobro
                          AND Rec_header.fecha <= has_fecha-cobro:
