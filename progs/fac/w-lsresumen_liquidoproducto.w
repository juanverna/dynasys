...
DEFINE VARIABLE h_v-rng_que_liquido AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     "  Rango de fechas de los movimientos:" VIEW-AS TEXT
          ...
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Estado de los comprobantes a incluir en el proceso:" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Listado resumen de Liquido Producto"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Listado resumen de Liquido Producto */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Listado resumen de Liquido Producto */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-rng_que_liquido.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng_que_liquido ).
       RUN set-position IN h_v-rng_que_liquido ( 10.96 , 14.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-rng_que_liquido ,
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Listado resumen de Liquido Producto"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE que_liquido        AS LOGICAL.
  ...
  RUN dar_rango IN h_v-rng_que_liquido ( OUTPUT que_liquido,
                                         OUTPUT error_rango ).
  IF error_rango 
  THEN DO:
       RUN ver-error-rango ( "Indicación de Comprobantes" ).
       hay_error = error_rango.
  END.     
  ...
  THEN DO:
       ...
       RUN lsresumen_liquidoproducto.p ( INPUT des_proveedor,
                                         INPUT has_proveedor,
                                         INPUT des_fecha,
                                         INPUT has_fecha,
                                         INPUT que_liquido).
