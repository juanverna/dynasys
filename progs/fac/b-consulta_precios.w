...
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table Articulo_precio.precio_cf 
...
&Scoped-Define ENABLED-OBJECTS RECT-5 btn_situar btn_listado br_table 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Articulo_precio.precio_cf FORMAT "->>,>>9.9999":U
  ENABLE
      Articulo_precio.precio_cf
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-ROW-MARKERS SEPARATORS SIZE 129 BY 14.33
...
DEFINE FRAME F-Main
     btn_situar AT ROW 1.24 COL 72
     btn_listado AT ROW 1.24 COL 89
     v-estado AT ROW 1.24 COL 103 COLON-ALIGNED NO-LABEL
...
"Articulo.descripcion" ? "X(36)" "character" ? ? ? ? ? ? no ? no no "52.8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"Articulo_precio.precio_cf" ? ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
