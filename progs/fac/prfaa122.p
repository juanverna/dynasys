...
/*     RUN escribir ( INPUT "28,105", INPUT "C.U.I.T.: ", INPUT 8, INPUT NO, INPUT "BLACK").                */
/*     RUN escribir ( INPUT "28,116", INPUT  Empresa.cuit, INPUT 8, INPUT NO, INPUT "BLACK").               */
...
PROCEDURE poner_monto_letras:
    ...
    linea0 = 0 .
    IF Moneda.es_local
        THEN RUN escribir ( INPUT TRIM(STRING(linea0,">>9")) + ",10", INPUT " " + Moneda.descripcion, INPUT 8, INPUT YES, INPUT "BLACK").
        ELSE RUN escribir ( INPUT TRIM(STRING(linea0,">>9")) + ",10", INPUT " " + Moneda.descripcion /*+ " a una razón de cambio de $" + STRING(Fac_header.cambio,">>>9.9999")*/, INPUT 8, INPUT YES, INPUT "BLACK").
