...
Cliente.horario_de_atencion Cliente.telefonos 
...
DEFINE FRAME F-Main
     Cliente.cdg_cliente AT ROW 1.19 COL 2 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 21 BY 1
          BGCOLOR 11 FGCOLOR 9 
     Cliente.nom_cliente AT ROW 1.19 COL 25 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 74 BY 1
          BGCOLOR 11 FGCOLOR 9 
     Cliente.horario_de_atencion AT ROW 2.33 COL 15.2 COLON-ALIGNED WIDGET-ID 2
          LABEL "Hor.Atención"
          VIEW-AS FILL-IN 
          SIZE 84 BY 1
          BGCOLOR 11 FGCOLOR 9 
     Cliente.telefonos AT ROW 3.38 COL 15.2 COLON-ALIGNED WIDGET-ID 4
          LABEL "Teléfonos"
          VIEW-AS FILL-IN 
          SIZE 84 BY 1
          BGCOLOR 11 FGCOLOR 9 
