...
DEFINE VARIABLE v-descuentos    AS CHARACTER FORMAT "X(40)" .
...
DEFINE VARIABLE v-comprobante   AS CHARACTER FORMAT "X(16)" INITIAL "FACTURA".
...
FORM
    ...
    SKIP(2)
    tipocomprobante.denominacion_impresa AT 68
    SKIP(2)
...
/*    Fac_header.leyenda VIEW-AS EDITOR SIZE 65 BY 3 AT 7*/
    ...
    "IMPORTANTE=========================================" AT 7
    v-descuentos AT 75 
    Fac_header.imp_descuentos AT 120 FORMAT "Z,ZZZ,ZZ9.99-"
    ...
    prciva AT 98
    Fac_header.imp_iva AT 120 FORMAT "Z,ZZZ,ZZ9.99-"
...
FORM
    ...
    WITH FRAME frm-detalle USE-TEXT STREAM-IO DOWN WIDTH 180 NO-UNDERLINE NO-LABELS. 
...
OUTPUT TO VALUE(dire_tmp + "prfaa116.txt") PAGE-SIZE 72.

/*---------------------------------------------------------------------------------*/
/*                                    ENCABEZADO                                   */
/*---------------------------------------------------------------------------------*/

IF tipocomprobante.denominacion_impresa <> "DOCUMENTO" AND tipocomprobante.denominacion_impresa <> "FACTURA"
    THEN DISPLAY tipocomprobante.denominacion_impresa WITH FRAME frm-encabezado.

DISPLAY
    Fac_header.fecha
/*     tipocomprobante.denominacion_impresa WHEN NOT denominacion_impresa = "documento" OR NOT denominacion_impresa = "factura"  */
    Fac_header.nombre
...
RUN _osprint.p ( INPUT  CURRENT-WINDOW:HANDLE, /* HANDLE de la WINDOW    */
                 INPUT  dire_tmp + "prfaa116.txt",           /* Archivo a imprimir     */
