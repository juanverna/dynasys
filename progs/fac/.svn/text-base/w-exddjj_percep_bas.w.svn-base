...
DEFINE VARIABLE h_v-que-impuesto AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     "  Impuesto a listar:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 3.42 COL 14
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Proceso de Exportación de Interface Generación de Declaracion Jurada de Percepciones"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Proceso de Exportación de Interface Generación de Declaracion Jurada de Percepciones */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Proceso de Exportación de Interface Generación de Declaracion Jurada de Percepciones */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-que-impuesto.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-que-impuesto ).
       RUN set-position IN h_v-que-impuesto ( 4.77 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Exportación de DDJJ de Percepciones Pcia. de BUENOS AIRES"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE des_impuesto       LIKE Impuesto.cdg_impuesto.
  ...
  RUN dar_rango IN h_v-que-impuesto ( OUTPUT des_impuesto,
                                       OUTPUT error_rango ).
  IF error_rango 
  THEN DO:
       RUN ver-error-rango ( "Impuestos" ).
  ...
  THEN DO:
       ...
       RUN exddjj_percep_bas.p ( INPUT des_impuesto,
                                 INPUT des_fecha,
                                 INPUT has_fecha,
                                 INPUT NO).
