...
nom_cliente||y|sic.Cliente.nom_cliente
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nro_entidad,nom_cliente,nro_administrador,cdg_cliente"':U).
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "nom_cliente" "Cliente" "nom_cliente"}
