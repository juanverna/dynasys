...
RUN recorrer_clasificacion_ventas.p ( INPUT p-des_fecha,
                                      INPUT p-has_fecha,
                                      INPUT det_sino, /* Sin detalle de clientes */
                                      INPUT cero_sino, /* No mostrar articulos sin movimiento */
                                      INPUT p-cdg_moneda,
...
DATASET dset:WRITE-XML ("FILE", xfile, TRUE,
                                     ?,"",YES,YES).
/*RUN exportToXmlDset ( "dset", string( TEMP-TABLE T-Listado:HANDLE ), xfile).*/
