...
DEFINE FRAME F-Main
     v-estado AT ROW 17.76 COL 7 COLON-ALIGNED NO-LABEL
     "  Rango de clientes a listar:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 2.43 COL 9
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de fechas de los movimientos:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 7 COL 9
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de fechas de los movimientos:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 11.33 COL 9
          BGCOLOR 5 FGCOLOR 15 FONT 6
     " Moneda en la que se expresan los importes:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 11.33 COL 9
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Facturas x fecha sin Detalle"
         HEIGHT             = 22.14
         WIDTH              = 114.2
         MAX-HEIGHT         = 27.33
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Facturas x fecha sin Detalle */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Facturas x fecha sin Detalle */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cliente ( 3.76 , 9.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 8.10 , 9.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-cotiza-moneda ( 12.43 , 9.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 19.14 , 9.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Facturas por Fecha sin Detalle"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsencabezadofactura_xfecha.p ( INPUT des_cliente,
                                          INPUT has_cliente,
                                          INPUT des_fecha,
                                          INPUT has_fecha,
                                          INPUT YES,
