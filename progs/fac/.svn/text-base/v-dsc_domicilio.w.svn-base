...
&Scoped-Define ENABLED-FIELDS Domicilio.nro_domicilio Domicilio.nombre ~
Domicilio.es_fiscal 
&Scoped-define ENABLED-TABLES Domicilio
&Scoped-define FIRST-ENABLED-TABLE Domicilio
&Scoped-Define ENABLED-OBJECTS RECT-1 
&Scoped-Define DISPLAYED-FIELDS Domicilio.nro_domicilio Domicilio.nombre ~
Domicilio.es_fiscal 
...
DEFINE FRAME F-Main
     Domicilio.nro_domicilio AT ROW 1.24 COL 2 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 12 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Domicilio.nombre AT ROW 1.24 COL 15 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 68 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Domicilio.es_fiscal AT ROW 1.24 COL 87
          VIEW-AS TOGGLE-BOX
          SIZE 11 BY .95
