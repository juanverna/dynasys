...
&Scoped-define INTERNAL-TABLES Oferta

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Oferta.cdg_oferta 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Oferta WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table Oferta
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Oferta
...
<FOREIGN-KEYS>
dsc_oferta||y|sic.Oferta.dsc_oferta
cdg_oferta||y|sic.Oferta.cdg_oferta
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "dsc_oferta,cdg_oferta"':U).
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = sic.Oferta.cdg_oferta
...
DO:
  ...
  &SCOPED-DEFINE ROWID_TABLA        rid_oferta
  &SCOPED-DEFINE SELECCION          SELOFERTA.P
  &SCOPED-DEFINE TABLA              Oferta
  &SCOPED-DEFINE CDG_TABLA          cdg_oferta
  &SCOPED-DEFINE DSC_TABLA          nom_oferta
...
DO:
  ...
  &SCOPED-DEFINE CODIGO cdg_oferta
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "dsc_oferta" "Oferta" "dsc_oferta"}
  {src/adm/template/sndkycas.i "cdg_oferta" "Oferta" "cdg_oferta"}
