...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Ranking de Clientes y Artículos"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Ranking de Clientes y Artículos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Ranking de Clientes y Artículos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Ranking de Articulos y Clientes"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsrnk_articulos_clientes.p ( INPUT des_articulo,
                                        INPUT has_articulo,
                                        INPUT des_fecha,
                                        INPUT has_fecha,
                                        INPUT YES,
