...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Proceso de Generación de Interface SICORE"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Proceso de Generación de Interface SICORE */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Proceso de Generación de Interface SICORE */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Proceso de Generación de Interface SICORE"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN gnsicore_dgi.p ( INPUT des_fecha,
                            INPUT has_fecha).
