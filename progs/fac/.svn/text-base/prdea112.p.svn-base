...
FORM
    ...
    SPACE(23) "O/Compra:" Fac_header.nro_ocm  
...
/*
    ...
    v-bonifs  AT 63
    Fac_detalle.precio  AT 85 FORMAT ">>>>>>9.99"
    Fac_detalle.subtotal_bruto AT 103 FORMAT "Z,ZZZ,ZZ9.99-"
*/
    que_cantidad AT 2
...
OUTPUT TO VALUE("c:\sic-temp\prfaa112.txt") PAGE-SIZE 72.
...
OUTPUT CLOSE.
   ...
   RUN _osprint.p ( INPUT  CURRENT-WINDOW:HANDLE, /* HANDLE de la WINDOW    */
                    INPUT  "c:\sic-temp\prfaa112.txt",           /* Archivo a imprimir     */
