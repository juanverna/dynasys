...
FORM
    ...
    v-bonifs  AT 72
    Fac_detalle.precio_cf  AT 99
    Fac_detalle.subtotal_bruto_cf AT 120 FORMAT "Z,ZZZ,ZZ9.99-"
...
OUTPUT TO VALUE(dire_tmp + "prfab116.txt") PAGE-SIZE 72.
...
FOR EACH Fac_detalle OF Fac_header 
    ...
    /*          Fac_detalle.granel
                ...
                v-bonifs
                v-subtotal @ Fac_detalle.subtotal_bruto_cf
...
OUTPUT CLOSE.
   ...
   RUN _osprint.p ( INPUT  CURRENT-WINDOW:HANDLE, /* HANDLE de la WINDOW    */
                    INPUT  dire_tmp + "prfab116.txt",           /* Archivo a imprimir     */
