...
DEFINE FRAME F-Main
     v-estado AT ROW 17.96 COL 12 COLON-ALIGNED NO-LABEL
     "  Rango de fechas de los movimientos de Cobranzas:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 13.92 COL 14
...
ON END-ERROR OF W-Win /* Liquidación de comisiones */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Liquidación de comisiones */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas-2 ( 15.00 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 19.31 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Liquidación de comisiones"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lscomisiones.p ( INPUT des_vendedor,
                            INPUT has_vendedor,
                            INPUT des_fecha,
                            INPUT has_fecha,
                            INPUT des_cobro,
