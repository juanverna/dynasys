...
DEFINE FRAME F-Main
     ...
     "  Primer rango de fechas de los movimientos:" VIEW-AS TEXT
...
ON END-ERROR OF W-Win /* Ventas por Sucursal */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Ventas por Sucursal */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-cotiza-moneda ( 12.08 , 13.86 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Ventas por Sucursal"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsventas_xsucursal.p ( INPUT des_cliente,
                                  INPUT has_cliente,
                                  INPUT des_fecha,
                                  INPUT has_fecha,
                                  INPUT p-cdg_moneda,
