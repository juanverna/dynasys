...
&Scoped-define INTERNAL-TABLES T-Fac_header-bon Bonificacion

/* Definitions for BROWSE BROWSE-8                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-8 T-Fac_header-bon.cdg_bonificacion ~
Bonificacion.descripcion T-Fac_header-bon.porcentaje ~
T-Fac_header-bon.importe 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-8 
&Scoped-define QUERY-STRING-BROWSE-8 FOR EACH T-Fac_header-bon NO-LOCK, ~
      EACH Bonificacion OF T-Fac_header-bon NO-LOCK
&Scoped-define OPEN-QUERY-BROWSE-8 OPEN QUERY BROWSE-8 FOR EACH T-Fac_header-bon NO-LOCK, ~
      EACH Bonificacion OF T-Fac_header-bon NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-8 T-Fac_header-bon Bonificacion
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-8 T-Fac_header-bon
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-8 Dialog-Frame _STRUCTURED
  QUERY BROWSE-8 NO-LOCK DISPLAY
      T-Fac_header-bon.cdg_bonificacion COLUMN-LABEL "Có-!digo" FORMAT "ZZ9":U
      Bonificacion.descripcion COLUMN-LABEL "Descripción!Bonificación" FORMAT "X(30)":U
      T-Fac_header-bon.porcentaje COLUMN-LABEL "%.!Bonificado" FORMAT "->>9.99":U
      T-Fac_header-bon.importe COLUMN-LABEL "Importe!Bonificado" FORMAT "->,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE BROWSE-8
     _TblList          = "Temp-Tables.T-Fac_header-bon,sic.Bonificacion OF Temp-Tables.T-Fac_header-bon"
     _Options          = "NO-LOCK"
     _FldNameList[1]   > Temp-Tables.T-Fac_header-bon.cdg_bonificacion
"T-Fac_header-bon.cdg_bonificacion" "Có-!digo" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
"Bonificacion.descripcion" "Descripción!Bonificación" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > Temp-Tables.T-Fac_header-bon.porcentaje
"T-Fac_header-bon.porcentaje" "%.!Bonificado" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[4]   > Temp-Tables.T-Fac_header-bon.importe
"T-Fac_header-bon.importe" "Importe!Bonificado" ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BROWSE-8 */
&ANALYZE-RESUME
...
DO:
  ...
  THEN DO:
       FIND T-Fac_header-bon 
            WHERE T-Fac_header-bon.cdg_bonificacion = v-cdg_bonificacion NO-LOCK NO-ERROR.
       IF AVAILABLE T-Fac_header-bon 
       THEN DO:
       ...
       ELSE DO:
            DO TRANSACTION:
               ...
               ASSIGN T-Fac_header-bon.cdg_bonificacion = v-cdg_bonificacion
                      T-Fac_header-bon.porcentaje       = v-porcentaje. 
            END.
