...
DEFINE FRAME F-Main
     ...
     "  Rango de fechas de cobranzas RG 151" VIEW-AS TEXT
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 3.69 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-empresas ( 8.00 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXP" "Cartas RG 151"}
...
------------------------------------------------------------------------------*/
 ...
 DEFINE VARIABLE v-lista_empresas   AS CHARACTER.
  ...
  THEN DO:
       ...
       RUN imprg151.p ( INPUT des_fecha,
                        INPUT has_fecha,
