...
DEFINE VARIABLE h_v-par-asnconceptos AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Asientos de Ventas por Concepto"
         HEIGHT             = 22.35
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.35
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Asientos de Ventas por Concepto */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Asientos de Ventas por Concepto */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-par-asnconceptos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-par-asnconceptos ).
       RUN set-position IN h_v-par-asnconceptos ( 8.00 , 14.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-par-asnconceptos ,
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Asientos de Ventas por Concepto de Documento"}
...
------------------------------------------------------------------------------*/
  ...
  RUN dar_rango IN h_v-par-asnconceptos (  OUTPUT  des_ptovta,
                                           OUTPUT  has_ptovta,
                                           OUTPUT  lista_tipos,
                                           OUTPUT  lis_fecha,
                                           OUTPUT  gen_asiento,
  ...
  THEN DO:
       ...
       RUN lsasientos_conceptos.p ( INPUT des_fecha, 
                                    INPUT has_fecha, 
                                    INPUT des_ptovta,
                                    INPUT has_ptovta,
                                    INPUT lista_tipos,
