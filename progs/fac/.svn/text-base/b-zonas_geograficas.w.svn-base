...
&Scoped-define INTERNAL-TABLES Zona_geografica

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Zona_geografica.cdg_zonag 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Zona_geografica WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table Zona_geografica
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Zona_geografica
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 11 BY 18.85
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "sic.Zona_geografica"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = sic.Zona_geografica.cdg_zonag
...
DO:
  ...
  &SCOPED-DEFINE CODIGO cdg_zonag
