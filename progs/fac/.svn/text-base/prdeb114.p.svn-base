/*=================================================================================*/
/*                 IMPRESION DE FORMULARIO DE NOTA DE DEBITO B                     */
/*=================================================================================*/
...
DO TRANSACTION:
    ...
    OUTPUT STREAM Formulario TO "c:\sic-temp\prdeb114.xpr" CONVERT TARGET "iso8859-1".
 ...
 /* PUT STREAM Formulario CONTROL '<TOOLBAR=!PRINT>'. */
    ...
    FILE-INFO:File-NAME = "c:\sic-temp\prdeb114.xpr".
...
*/    
    ...
    FOR EACH Fac_detalle OF Fac_header 
        ...
        THEN DO:
            ...
            THEN DO:
                RUN escribenumero ( ch_linea  + ",134", INPUT STRING(Fac_detalle.precio_cf,"-ZZZ,ZZ9.99"), INPUT 8, INPUT NO).
    ...
    IF LENGTH(v-descuentos) <> 0
    THEN DO:
         RUN escribir      ( INPUT "230,110", INPUT v-descuentos, INPUT 10, INPUT NO).
         RUN escribenumero ( INPUT "230,162", INPUT STRING(v-desc,"-ZZZ,ZZ9.99"), INPUT 10, INPUT NO).
    END.
