...
DEFINE VARIABLE d-comision-vendido       AS DECIMAL FORMAT "->>,>>>,>>9.99".
DEFINE VARIABLE d-comision-cobrado       AS DECIMAL FORMAT "->>,>>>,>>9.99".
...
DEFINE FRAME frm-titulo HEADER
    que_empresa 
    "Liquidación de Comisiones por Ventas" AT 38
    "Página:" AT 128 PAGE-NUMBER FORMAT "9999" AT 135
    SKIP  
    fecha_lis
    "Ventas......:" AT 38
    des_fecha
    ...
    SKIP(1)
    "------------------------------------------------------------------------------------------------------------------------------------------" SKIP
    "Fecha      Identificación   Código   Razón                                           Importe       Comisión        Importe        Comisión" SKIP
    "Operación  del comprobante  Cliente  Social                                          Vendido       S/Ventas        Cobrado       S/Cobrado" SKIP
    "------------------------------------------------------------------------------------------------------------------------------------------" SKIP
...
DEFINE FRAME frm-detalle
    ...
    d-cobrado
    d-comision-cobrado
    WITH WIDTH 270 DOWN CENTERED USE-TEXT STREAM-IO NO-LABEL.
  ...
  FOR EACH Vendedor 
      WHERE Vendedor.cdg_vendedor <= has_codigo
       ...
       THEN DO:
            ...
            DISPLAY Fac_header.fecha       WHEN Fac_header.fecha <> ant_fecha
                    que_comprobante              
                    Cliente.cdg_cliente          
                    Cliente.nom_cliente          
                    d-vendido
       ...
       THEN DO:
            ...
            UNDERLINE
                ...
                WITH FRAME frm-detalle.
            DISPLAY
                "Total " + Familia_articulo.dsc_familia @ Cliente.nom_cliente
       ...
       THEN DO:
            UNDERLINE
                ...
                WITH FRAME frm-detalle.
            DISPLAY
                "Total " + Vendedor.nombre @ Cliente.nom_cliente
    ...
    FOR EACH Rec_detalle 
        WHERE Rec_detalle.cdg_emprecancela = Fac_header.cdg_empresa 
          ...
          THEN DO:
              ...
              PUT Rec_header.tip_comprob Rec_header.prf_comprob Rec_header.nro_comprob Rec_header.fecha Rec_detalle.importe SKIP.
          END.
