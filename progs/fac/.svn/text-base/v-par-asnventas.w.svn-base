...
&Scoped-Define ENABLED-OBJECTS v-gen_asiento v-des_ptovta v-ver_resum ~
v-ver_movim v-has_ptovta v-lis_fecha v-lista_tipos v-fecha_contable RECT-1 ~
RECT-2 
&Scoped-Define DISPLAYED-OBJECTS v-gen_asiento v-des_ptovta v-ver_resum ~
...
DEFINE FRAME F-Main
     v-gen_asiento AT ROW 1.24 COL 84 NO-LABEL
     ...
     v-lista_tipos AT ROW 3.86 COL 16 COLON-ALIGNED
     v-fecha_contable AT ROW 3.86 COL 83 COLON-ALIGNED
     RECT-1 AT ROW 1 COL 1
     RECT-2 AT ROW 1 COL 77
