...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Total de ventas por Clientes"
         HEIGHT             = 23.91
         WIDTH              = 123
         MAX-HEIGHT         = 27.29
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF W-Win /* Total de ventas por Clientes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Total de ventas por Clientes */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cliente ( 3.62 , 15.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 19.33 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Total de ventas por Cliente"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN fullPath ("ventastotalxcliente", '.rpt':U, OUTPUT cFullPath).
       IF cFullPath = ? 
       THEN DO:
           RUN mensajepar.p (INPUT "ventastotalxcliente.rpt", INPUT "CREP000").
           RETURN ERROR.
       END.
...
/*      setParametro( chReport , "nodo" , primer_nodo ).
      ...
      RUN getparametro_d.p (INPUT "MINVALC" ,OUTPUT MINVALC).
      setParametro( chReport , "min_nivel", STRING( MINVALC) ).
*/      
