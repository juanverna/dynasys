...
&Scoped-Define ENABLED-FIELDS Articulo.cdg_grupoabasto 
...
DEFINE FRAME F-Main
     Articulo.cdg_articulo AT ROW 1.81 COL 14 COLON-ALIGNED
          LABEL "Artículo"
          VIEW-AS FILL-IN NATIVE 
          SIZE 16 BY .81
          BGCOLOR 7 FGCOLOR 15 
     Articulo.descripcion AT ROW 1.81 COL 31 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN NATIVE 
          SIZE 41.72 BY .81
          BGCOLOR 7 FGCOLOR 15 
     Articulo.cdg_grupoabasto AT ROW 3.42 COL 14 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
   ...
   Articulo.cdg_grupoabasto:LIST-ITEM-PAIRS IN FRAME {&FRAME-NAME} = x-lista.
