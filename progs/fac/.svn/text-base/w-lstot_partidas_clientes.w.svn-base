...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Total de Ventas por Articulo y Cliente"
         HEIGHT             = 22.14
         WIDTH              = 122.2
         MAX-HEIGHT         = 26.33
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Total de Ventas por Articulo y Cliente */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Total de Ventas por Articulo y Cliente */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-cotiza-moneda ( 12.33 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Total de Ventas por Artículo y Cliente"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lstot_partidas_clientes.p ( INPUT des_articulo,
                                       INPUT has_articulo,
                                       INPUT des_fecha,
                                       INPUT has_fecha,
                                       INPUT YES,
...
/*        v-estado:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "Ejecutando Proceso ...".                       */
/*                                                                                                       */
/*        RUN lstot_articulos_clientes.p ( INPUT des_articulo,                                           */
/*                                         INPUT has_articulo,                                           */
/*                                         INPUT des_fecha,                                              */
/*                                         INPUT has_fecha,                                              */
/*                                         INPUT YES,                                                    */
