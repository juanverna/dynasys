...
PROCEDURE cabecera_forma:
    ...
    */
    ...
    RUN escribir ( INPUT "32,105", INPUT "Ingresos Brutos(Conv.Multil.):", INPUT 8, INPUT NO, INPUT "BLACK"). 
    RUN escribir ( INPUT "36,105", INPUT "INICIO DE ACTIVIDADES:", INPUT 8, INPUT NO, INPUT "BLACK"). 
