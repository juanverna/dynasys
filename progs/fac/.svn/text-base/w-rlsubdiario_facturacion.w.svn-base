...
DEFINE FRAME F-Main
     ...
     "  Rango de Fechas de Transacciones:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 2.86 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Subdiario de Facturación"
         HEIGHT             = 19.95
         WIDTH              = 122
         MAX-HEIGHT         = 22.14
         MAX-WIDTH          = 127.2
...
ON END-ERROR OF W-Win /* Subdiario de Facturación */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Subdiario de Facturación */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Subdiario de Facturación"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE var p-totcond        AS LOGICAL.
  ...
  THEN DO:
       ...
       RUN lssubdiario_facturacion.p ( INPUT des_fecha, 
                                       INPUT has_fecha, 
                                       INPUT des_ptovta,
                                       INPUT has_ptovta,
                                       INPUT lista_tipos,
