...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cliente ( 5.19 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Reporte de Maestro de Clientes"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       IF ver_por = 2
         THEN RUN LSMAECLA.P ( INPUT des_nombre, 
                               INPUT has_nombre).
         ELSE RUN LSMAECLC.P ( INPUT des_cliente, 
                               INPUT has_cliente).
