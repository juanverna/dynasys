...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Lista_Precios WHERE ~{&KEY-PHRASE} ~
      AND CAN-DO(Lista_precios.lista_empresa,que_empresa) NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Lista_Precios WHERE ~{&KEY-PHRASE} ~
      AND CAN-DO(Lista_precios.lista_empresa,que_empresa) NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Lista_Precios
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Lista_Precios
...
<FOREIGN-KEYS>
descripcion|||sic.Lista_Precios.descripcion
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "CAN-DO(Lista_precios.lista_empresa,que_empresa)"
