...
PROCEDURE GENERA:
   ...
   FOR EACH Fac_header WHERE Fac_header.fecha >= des_fecha
      ...
      FOR EACH Fac_header_impuesto OF Fac_header, FIRST Impuesto OF Fac_header_impuesto 
           ...
           THEN base = Fac_header_impuesto.importe * Fac_header.cambio.
           ELSE base = Fac_header.imp_neto * Fac_header.cambio.
           ...
           ASSIGN SICORE.clave-1           = Cliente.cdg_cliente + "-" + string(Fac_header.nro_domicilio, "9999") + " " 
                  ...
                  SICORE.importe_p         = Fac_header_impuesto.importe * Fac_header.cambio
...
PROCEDURE BAJA:
    ...
    OS-COPY VALUE(archivo) VALUE(arch_salida).
    ...
    OUTPUT TO VALUE (arch_salida).

    OS-APPEND VALUE(archivo) VALUE(arch_salida).
