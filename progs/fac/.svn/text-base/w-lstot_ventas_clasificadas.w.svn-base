...
&Scoped-Define ENABLED-OBJECTS b-ejecutar btn_salir 
...
DEFINE FRAME F-Main
     ...
     b-ejecutar AT ROW 21.19 COL 67
     btn_salir AT ROW 21.19 COL 91
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-id-clasearticulo ( 3.62 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-cotiza-moneda ( 16.71 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lstot_ventas_clasificadas.p ( INPUT primer_nodo,
                                         INPUT des_fecha,
                                         INPUT has_fecha,
                                         INPUT YES,
                                         INPUT YES,
        ...
        IF cFullPath = ? 
        THEN DO:
            RUN mensajepar.p (INPUT "clasificacion.rpt", INPUT "CREP000").
            RETURN ERROR.
        END.
