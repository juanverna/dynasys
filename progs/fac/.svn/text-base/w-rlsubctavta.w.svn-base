...
DEFINE FRAME F-Main
     ...
     "  Rango de cuentas:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 4.23 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Imputaciones Contables de Ventas por Cuenta"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Imputaciones Contables de Ventas por Cuenta */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Imputaciones Contables de Ventas por Cuenta */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cuenta ( 5.31 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 9.88 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Imputaciones Contables de Ventas por Cuenta"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lssubctavta.p ( INPUT  des_fecha,
                           INPUT  has_fecha,
                           INPUT  des_cuenta,
                           INPUT  has_cuenta
                          ).   
