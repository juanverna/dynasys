...
DEFINE FRAME F-Main
     v-estado AT ROW 19.57 COL 12 COLON-ALIGNED NO-LABEL
     "  Rango de Fechas Altas de Clientes:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 7.38 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Indique si desea el listado consolidado o solo para la empresa actual:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 12.33 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de Vendedores a Considerar:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 2.38 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Nuevos Clientes por Vendedor"
         HEIGHT             = 22.76
         WIDTH              = 121
         MAX-HEIGHT         = 25.71
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Nuevos Clientes por Vendedor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Nuevos Clientes por Vendedor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-vendedor ( 3.43 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 8.48 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-empresas ( 13.52 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Clientes nuevos por Vendedor"}
