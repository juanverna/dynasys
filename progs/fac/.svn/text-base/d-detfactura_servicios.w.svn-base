...
DEFINE FRAME Dialog-Frame
     ...
     v-cdg_entidad AT ROW 2.67 COL 12 COLON-ALIGNED
     v-dsc_entidad AT ROW 2.67 COL 31 COLON-ALIGNED NO-LABEL
     v-cdg_obra AT ROW 3.86 COL 12 COLON-ALIGNED
     v-dsc_obra AT ROW 3.86 COL 31 COLON-ALIGNED NO-LABEL
     btn_sinobra AT ROW 3.86 COL 79
     T-Fac_detalle.cantidad AT ROW 5.29 COL 12 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 18 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_detalle.precio AT ROW 5.29 COL 41 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 18 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_detalle.precio_cf AT ROW 5.29 COL 71 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 18 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_detalle.subtotal_neto_cf AT ROW 6.48 COL 71 COLON-ALIGNED
          LABEL "Neto C.F."
          VIEW-AS FILL-IN NATIVE 
          SIZE 18 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_detalle.subtotal_neto AT ROW 6.52 COL 41 COLON-ALIGNED
          LABEL "Neto"
          VIEW-AS FILL-IN NATIVE 
          SIZE 18 BY 1
          BGCOLOR 15 FGCOLOR 9 
     incl_iva AT ROW 6.71 COL 14 WIDGET-ID 2
     T-Fac_detalle.detallada AT ROW 7.91 COL 4 NO-LABEL
          VIEW-AS EDITOR SCROLLBAR-VERTICAL
          SIZE 87 BY 6.29
          BGCOLOR 15 FGCOLOR 9 
     Btn_OK AT ROW 14.48 COL 4
     Btn_Cancel AT ROW 14.48 COL 73
     RECT-10 AT ROW 5.05 COL 2
     RECT-9 AT ROW 1.29 COL 2
     SPACE(0.85) SKIP(11.06)
...
DO:
  ASSIGN incl_iva.
  T-Fac_detalle.precio:SENSITIVE            = NOT incl_iva.
  T-Fac_detalle.precio_cf:SENSITIVE         = incl_iva.
END.
...
IF campo = "precio" THEN
        T-Fac_detalle.precio_cf = T-Fac_detalle.precio * ( 1 + que_tasa / 100).
IF campo = "precio_cf" Then     
        T-Fac_detalle.precio = T-Fac_detalle.precio_cf / ( 1 + que_tasa / 100).
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-10 RECT-9 T-Fac_detalle.cantidad T-Fac_detalle.precio 
         T-Fac_detalle.precio_cf incl_iva T-Fac_detalle.detallada Btn_OK 
         Btn_Cancel 
      WITH FRAME Dialog-Frame.
