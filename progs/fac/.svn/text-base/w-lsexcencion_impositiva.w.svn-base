...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Excenciones Impositivas x Clientes"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 27.27
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF W-Win /* Excenciones Impositivas x Clientes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Excenciones Impositivas x Clientes */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Excenciones Impositivas x Clientes"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsexcencion_impositiva.p ( INPUT des_cliente,
                                  INPUT has_cliente ).
