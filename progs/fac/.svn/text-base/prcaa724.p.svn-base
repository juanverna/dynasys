...
/*
MESSAGE "Leyenda:" Fac_header.leyenda SKIP
        "Iva:" Fac_header.imp_iva VIEW-AS ALERT-BOX MESSAGE TITLE "PRFAA724.P".
*/
FIND Empresa WHERE ROWID(Empresa) = act_empresa NO-LOCK.
v-params = "p-empresa=" + Empresa.nombre + "~n".

v-filtro = "Fac_header.nro_comprob = " + STRING(Fac_header.nro_comprob) +
            " AND Fac_header.tip_comprob = 'CA'".

RUN exreport.p (  INPUT  ".\prl\forms724.prl",            /* Librería desde la que se ejecuta */                 INPUT  "FA-724",                   /* Nombre del reporte a ejecutar    */
                  INPUT "CA-724",                        /* Nombre del reporte a ejecutar    */
