...
DEFINE FRAME F-Main
     v-estado AT ROW 22.19 COL 25 COLON-ALIGNED NO-LABEL
     "     Lista de empresas a considerar en el proceso" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 18.1 COL 27
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "     Archivo en que se genera la salida" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 14.33 COL 27
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "     Período a exportar" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 1.48 COL 27
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "     Rango de artículos a considerar" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 5.52 COL 27
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "     Rango de vendedores a considerar" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 10.05 COL 27
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Exportación de estadística de ventas"
         HEIGHT             = 26.95
         WIDTH              = 158.4
         MAX-HEIGHT         = 26.95
         MAX-WIDTH          = 158.6
...
ON END-ERROR OF W-Win /* Exportación de estadística de ventas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Exportación de estadística de ventas */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 2.57 , 27.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-articulo ( 6.71 , 27.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-vendedor ( 11.24 , 27.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.86 , 100.00 ) */
       ...
       RUN set-position IN h_v-rng-archivo ( 15.43 , 27.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-empresas ( 19.19 , 27.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 23.86 , 27.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Exportación a EXCEL de Estadística de Ventas"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN exporta_ventas.p ( INPUT des_vendedor, 
                              INPUT has_vendedor, 
                              INPUT des_codart, 
                              INPUT has_codart, 
                              INPUT des_fecha,
