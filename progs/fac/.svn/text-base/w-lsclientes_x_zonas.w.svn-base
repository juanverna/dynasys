...
DEFINE VARIABLE h_v-que_estadocliente AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     v-estado AT ROW 17.19 COL 8 COLON-ALIGNED NO-LABEL
     "  Rango de Zonas a Considerar:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 2.1 COL 11
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Estado de Clientes a ser listados:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 11.48 COL 11
          BGCOLOR 5 FGCOLOR 15 FONT 6
     " Rango de Vendedores a ser listados:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 6.95 COL 11
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Maestro de Clientes x Zona"
         HEIGHT             = 22.14
         WIDTH              = 117.8
         MAX-HEIGHT         = 22.14
         MAX-WIDTH          = 117.8
...
ON END-ERROR OF W-Win /* Maestro de Clientes x Zona */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Maestro de Clientes x Zona */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng-zona ).
       RUN set-position IN h_v-rng-zona ( 3.38 , 11.20 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-vendedor ( 8.38 , 11.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.86 , 100.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-que_estadocliente.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-que_estadocliente ).
       RUN set-position IN h_v-que_estadocliente ( 12.67 , 11.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.86 , 100.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 18.62 , 11.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-que_estadocliente ,
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Maestro de Clientes x Zona"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE v-cdg_estado        LIKE Cliente.cdg_estado.
  ...
  RUN dar_rango IN h_v-que_estadocliente  ( OUTPUT v-cdg_estado, 
                                            OUTPUT error_rango ).
  IF error_rango 
  THEN DO:
       RUN ver-error-rango ( "Estados de Clientes" ).
       hay_error = error_rango.
  END.     
  ...
  THEN DO:
       ...
       RUN lsclientes_x_zona.p ( INPUT des_zonag,
                                 INPUT has_zonag,
                                 INPUT v-cdg_estado,
                                 INPUT des_vendedor,
                                 INPUT has_vendedor).
