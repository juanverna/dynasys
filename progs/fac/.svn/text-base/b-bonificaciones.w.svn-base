...
&Scoped-define INTERNAL-TABLES Bonificacion

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Bonificacion.cdg_bonificacion 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH Bonificacion WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Bonificacion WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table Bonificacion
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Bonificacion
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Bonificacion.cdg_bonificacion COLUMN-LABEL "Código!Bonificación" FORMAT "ZZZ9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 17 BY 18.86
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "sic.Bonificacion"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > sic.Bonificacion.cdg_bonificacion
"Bonificacion.cdg_bonificacion" "Código!Bonificación" "ZZZ9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
DO:
  ...
  &SCOPED-DEFINE ROWID_TABLA        rid_bonificacion
  &SCOPED-DEFINE SELECCION          SELBONIF.P
  &SCOPED-DEFINE TABLA              Bonificacion
  &SCOPED-DEFINE CDG_TABLA          cdg_bonificacion
  &SCOPED-DEFINE DSC_TABLA          nom_bonificacion
...
DO:
  ...
  &SCOPED-DEFINE CODIGO cdg_bonificacion
