...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Total de ventas por Clientes y Artículo"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Total de ventas por Clientes y Artículo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Total de ventas por Clientes y Artículo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Total de ventas por Cliente y Artículo"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lstot_clientes_articulos.p ( INPUT des_cliente,
                                        INPUT has_cliente,
                                        INPUT des_fecha,
                                        INPUT has_fecha,
                                        INPUT YES,
