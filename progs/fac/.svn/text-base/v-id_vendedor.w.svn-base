...
DEFINE FRAME F-Main
     Vendedor.cdg_vendedor AT ROW 1.29 COL 12 COLON-ALIGNED
          LABEL "Vendedor"
          VIEW-AS FILL-IN NATIVE 
          SIZE 13 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Vendedor.nombre AT ROW 1.29 COL 26 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 75 BY 1
...
/* SETTINGS FOR FILL-IN Vendedor.cdg_vendedor IN FRAME F-Main
   NO-ENABLE EXP-LABEL                                                  */
/* SETTINGS FOR FILL-IN Vendedor.nombre IN FRAME F-Main
   NO-ENABLE                                                            */
