...
DEFINE FRAME F-Main
     v-estado AT ROW 18.5 COL 12 COLON-ALIGNED NO-LABEL
     "  Rango de fechas de los movimientos de cobranza:" VIEW-AS TEXT
     ...
     "  Vendedores a Liquidar:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 1.81 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de fechas de los movimientos de ventas:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 9.62 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Resumen de liquidación de comisiones"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Resumen de liquidación de comisiones */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Resumen de liquidación de comisiones */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-vendedor ( 2.88 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-esp-moneda ( 6.92 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
       ...
       RUN set-position IN h_v-rng-fechas ( 10.69 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
       ...
       RUN set-position IN h_v-rng-fechas-2 ( 14.46 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Resumen de liquidación resumida de comisiones"}
...
------------------------------------------------------------------------------*/
  ...
  IF error_rango 
  THEN DO:
       RUN ver-error-rango ( "Fechas de Ventas" ).
       hay_error = error_rango.
  END.     
  ...
  IF error_rango 
  THEN DO:
       RUN ver-error-rango ( "Fechas de Cobranzas" ).
       hay_error = error_rango.
  END.     
  ...
  THEN DO:
       ...
       RUN lsresumen_comisiones.p ( INPUT des_vendedor,
                                    INPUT has_vendedor,
                                    INPUT des_fecha,
                                    INPUT has_fecha,
                                    INPUT des_cobro,
