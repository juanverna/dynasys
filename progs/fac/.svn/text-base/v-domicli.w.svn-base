...
Domicilio.orden_recorrido Domicilio.telefono Domicilio.dias_entrega ~
Domicilio.email 
&Scoped-define ENABLED-TABLES Domicilio
&Scoped-define FIRST-ENABLED-TABLE Domicilio
&Scoped-Define ENABLED-OBJECTS v-cdg_zona_geografica RECT-7 
&Scoped-Define DISPLAYED-FIELDS Domicilio.nro_domicilio Domicilio.envio ~
Domicilio.factura Domicilio.retira Domicilio.nombre Domicilio.direccion ~
Domicilio.localidad Domicilio.cdg_postal Domicilio.cdg_pais ~
Domicilio.orden_recorrido Domicilio.telefono Domicilio.dias_entrega ~
Domicilio.email Domicilio.observacion 
&Scoped-define DISPLAYED-TABLES Domicilio
&Scoped-define FIRST-DISPLAYED-TABLE Domicilio
&Scoped-Define DISPLAYED-OBJECTS v-cdg_provincia v-cdg_zona_geografica ~
v-dsc_zona_geografica v-cdg_recorrido v-dsc_recorrido v-dsc_municipio ~
v-cdg_municipio 
...
DEFINE VARIABLE v-cdg_zona_geografica AS CHARACTER FORMAT "X(20)" 
     LABEL "Zona" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 21 BY 1
     BGCOLOR 15 FGCOLOR 9 .
...
DEFINE FRAME F-Main
     Domicilio.nro_domicilio AT ROW 1.48 COL 13 COLON-ALIGNED
          ...
          SIZE 10 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Domicilio.envio AT ROW 1.48 COL 28
          LABEL "Hab.Remitos"
          VIEW-AS TOGGLE-BOX
          SIZE 17 BY 1
     Domicilio.factura AT ROW 1.48 COL 46
          LABEL "Hab. Facturas"
          VIEW-AS TOGGLE-BOX
          SIZE 19 BY 1
     Domicilio.retira AT ROW 1.48 COL 66
          LABEL "Hab. Retiros"
          VIEW-AS TOGGLE-BOX
          SIZE 17 BY 1
     ...
     Domicilio.cdg_pais AT ROW 6.24 COL 62 COLON-ALIGNED
          ...
          SIZE 19 BY 1
          BGCOLOR 15 FGCOLOR 9 
     v-cdg_zona_geografica AT ROW 7.43 COL 13 COLON-ALIGNED
     ...
     Domicilio.dias_entrega AT ROW 10.76 COL 13 COLON-ALIGNED
          ...
          SIZE 68 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Domicilio.email AT ROW 11.86 COL 13 COLON-ALIGNED FORMAT "X(40)"
          VIEW-AS FILL-IN NATIVE 
          SIZE 68 BY 1
          BGCOLOR 15 FGCOLOR 9 
     ...
     v-cdg_municipio AT ROW 12.95 COL 13 COLON-ALIGNED HELP
          "Código del recorrido"
     Domicilio.observacion AT ROW 15.29 COL 2 NO-LABEL
          VIEW-AS EDITOR SCROLLBAR-VERTICAL
          SIZE 81 BY 4
          BGCOLOR 15 FGCOLOR 7 
     RECT-7 AT ROW 1 COL 1
     "   Observaciones asociadas al domicilio actual" VIEW-AS TEXT
          SIZE 81 BY 1 AT ROW 14.1 COL 2
...
/* SETTINGS FOR FILL-IN Domicilio.dias_entrega IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN Domicilio.email IN FRAME F-Main
   EXP-FORMAT                                                           */
...
/* SETTINGS FOR FILL-IN Domicilio.nro_domicilio IN FRAME F-Main
   EXP-LABEL                                                            */
/* SETTINGS FOR EDITOR Domicilio.observacion IN FRAME F-Main
   NO-ENABLE                                                            */
...
DO:
   ...
   IF puso_ok
   THEN DO:
      DISPLAY v-cdg_subclase @ v-cdg_zona_geografica
...
&Scoped-define SELF-NAME v-cdg_zona_geografica
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-cdg_zona_geografica V-table-Win
ON MOUSE-SELECT-DBLCLICK OF v-cdg_zona_geografica IN FRAME F-Main /* Zona */
OR "." OF v-cdg_zona_geografica IN FRAME {&FRAME-NAME}
OR MOUSE-MENU-DOWN OF v-cdg_zona_geografica IN FRAME {&FRAME-NAME}
DO:

   {helptabla.i "zona_geografica" "cdg_zonag" "SELZONAG.P"}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-cdg_zona_geografica V-table-Win
ON RETURN OF v-cdg_zona_geografica IN FRAME F-Main /* Zona */
DO: 
    {traducetabla.i "Zona_geografica" "cdg_zonag" "nombre"} 
END.
...
/*    {validartabla.i "municipio" "cdg_municipio" "dsc_municipio" "DOMI003"}  */
   ...
   {validartabla.i "Pais" "cdg_pais" "dsc_pais" "DOMI004"} 
   */ 
...
/*    {asignartabla.i "municipio" "cdg_municipio" "cdg_municipio" }  */
   ...
   ASSIGN FRAME {&FRAME-NAME} Domicilio.observacion.

   ASSIGN Domicilio.cdg_subclasezng = Domicilio.cdg_zonag
...
------------------------------------------------------------------------------*/
  ...
  {deshabcodigo.i "Municipio"}
   ...
   ASSIGN Domicilio.observacion:SENSITIVE IN FRAME {&FRAME-NAME} = NO.
          Domicilio.observacion:FGCOLOR IN FRAME {&FRAME-NAME} = 7.
...
------------------------------------------------------------------------------*/
  ...
  {habilcodigo.i "Municipio"}
   ...
   ASSIGN Domicilio.observacion:SENSITIVE IN FRAME {&FRAME-NAME} = YES
          Domicilio.observacion:FGCOLOR IN FRAME {&FRAME-NAME} = 9.
