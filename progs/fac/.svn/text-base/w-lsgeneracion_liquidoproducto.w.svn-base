...
DEFINE VARIABLE h_v-que-proveedor AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Proceso de Generación del Líquido Producto"
         HEIGHT             = 22.14
         WIDTH              = 114.2
         MAX-HEIGHT         = 22.14
         MAX-WIDTH          = 114.2
...
ON END-ERROR OF W-Win /* Proceso de Generación del Líquido Producto */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Proceso de Generación del Líquido Producto */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-que-proveedor.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-que-proveedor ).
       RUN set-position IN h_v-que-proveedor ( 4.76 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 10.14 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  RUN habilitar_solocyorden IN h_v-que-proveedor ( INPUT YES).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Proceso de Generación del Líquido Producto"}
...
------------------------------------------------------------------------------*/
  ...
  RUN dar_rango IN h_v-que-proveedor ( OUTPUT des_proveedor,
                                       OUTPUT error_rango ).
  IF error_rango 
  THEN DO:
  ...
  THEN DO:
       ...
       RUN lsgeneracion_liquidoproducto.p ( INPUT des_proveedor,
                                            INPUT des_fecha,
                                            INPUT has_fecha).
