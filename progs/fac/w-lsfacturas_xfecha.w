...
ON END-ERROR OF W-Win /* Facturas x fecha */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Facturas x fecha */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Facturas por Fecha"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsfacturas_xfecha.p ( INPUT des_cliente,
                                        INPUT has_cliente,
                                        INPUT des_fecha,
                                        INPUT has_fecha,
                                        INPUT YES,
