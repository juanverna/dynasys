...
DEFINE VARIABLE h_b-familia_cliente AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-familia_cliente AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-familia_cliente.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-familia_cliente ).
       RUN set-position IN h_b-familia_cliente ( 1.29 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-familia_cliente ( 20.48 , 16.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-familia_cliente.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-familia_cliente ).
       RUN set-position IN h_v-familia_cliente ( 1.29 , 21.00 ) NO-ERROR.
       /* Size in UIB:  ( 5.71 , 90.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 7.19 , 21.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.14 , 90.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-familia_cliente. */
       RUN add-link IN adm-broker-hdl ( h_b-familia_cliente , 'Record':U , h_v-familia_cliente ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-familia_cliente ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-familia_cliente ,
             h_b-familia_cliente , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-familia_cliente , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Mantenimiento de Familias de Clientes"}
...
*/
    ...
    IF VALID-HANDLE(h_b-familia_cliente)  THEN RUN set-sensitivo IN h_b-familia_cliente   ( INPUT p-operacion = "HABILITAR" ).
