...
PROCEDURE cabecera_datos:
    ...
    RUN escribir ( INPUT "6,147", INPUT Fac_header.tip_comprob + "-" + STRING(Fac_header.prf_comprob,"9999") + "-" + STRING(Fac_header.nro_comprob,"99999999"), INPUT 12, INPUT YES, INPUT "BLACK"). 
...
PROCEDURE pie_datos:
    ...
    RUN escribir ( "17,160", INPUT STRING(Fac_header.imp_total,"-ZZ,ZZZ,ZZ9.99"), INPUT 10, INPUT YES, INPUT "BLACK").
