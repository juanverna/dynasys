...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-vendedor ( 3.71 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-articulo ( 8.76 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.86 , 100.00 ) */
       ...
       RUN set-position IN h_v-rng-fechas ( 14.10 , 13.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsventasxvendedorarticulo.p ( INPUT des_vendedor, 
                                         INPUT has_vendedor, 
                                         INPUT des_codart, 
                                         INPUT has_codart, 
                                         INPUT des_fecha,
