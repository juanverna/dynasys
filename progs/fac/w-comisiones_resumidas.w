...
DEFINE FRAME F-Main
     ...
     "  Rango de fechas de los movimientos de ventas:" VIEW-AS TEXT
          ...
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de fechas de los movimientos de cobranzas:" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Liquidación resumida de comisiones"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Liquidación resumida de comisiones */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Liquidación resumida de comisiones */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas-2 ( 14.19 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Liquidación resumida de comisiones"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lscomisiones_resumidas.p ( INPUT des_vendedor,
                                      INPUT has_vendedor,
                                      INPUT des_fecha,
                                      INPUT has_fecha,
                                      INPUT des_cobro,
