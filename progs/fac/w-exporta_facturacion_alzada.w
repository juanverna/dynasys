...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Exportación de facturación a mano alzada"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Exportación de facturación a mano alzada */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Exportación de facturación a mano alzada */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Exportación de facturación a mano alzada"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN exporta_facturacion_alzada.p ( INPUT des_fecha,
                                          INPUT has_fecha).
