...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-vendedor ( 2.76 , 34.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 7.10 , 34.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng-zona ).
       RUN set-position IN h_v-rng-zona ( 11.33 , 34.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.86 , 100.00 ) */
       ...
       RUN set-position IN h_v-que-moneda ( 16.14 , 34.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-lst-empresas ( 20.43 , 34.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 24.86 , 34.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Ventas Total por Zona"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsventasxzona_total.p ( INPUT v-lista_empresas,
                                   INPUT des_vendedor,
                                   INPUT has_vendedor,
                                   INPUT des_fecha,
                                   INPUT has_fecha,
