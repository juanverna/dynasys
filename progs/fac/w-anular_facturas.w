...
DEFINE VARIABLE h_v-rng-facanular AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     v-estado AT ROW 14.46 COL 11 COLON-ALIGNED NO-LABEL
     "   Rango de facturas a anular:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 4.23 COL 13
...
ON END-ERROR OF W-Win /* Anulación de Facturas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Anulación de Facturas */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-rng-facanular.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng-facanular ).
       RUN set-position IN h_v-rng-facanular ( 5.31 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-impresora ( 12.04 , 13.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 15.81 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-rng-facanular ,
             v-estado:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-rng-impresora ,
             h_v-rng-facanular , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Anulación de Facturas"}
...
------------------------------------------------------------------------------*/
  ...
  RUN dar_rango IN h_v-rng-facanular  ( OUTPUT v-tip_comprob,
  ...
  IF error_rango 
  THEN DO:
       RUN ver-error-rango ( "Rango de Facturas" ).
  ...
  THEN DO:
       ...
       RUN anular_lote_facturas.p ( INPUT v-tip_comprob,
                                    INPUT v-prf_comprob,
...
------------------------------------------------------------------------------*/
    ...
    RUN veresult.w ( INPUT  "prinfacturas.lst" ,  /* Archivo */
