...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Vigencia_precios OF Lista_Precios WHERE ~{&KEY-PHRASE} ~
      AND Vigencia_precios.cdg_empresa = que_empresa NO-LOCK ~
    BY Vigencia_precios.fch_desde DESCENDING
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Vigencia_precios OF Lista_Precios WHERE ~{&KEY-PHRASE} ~
      AND Vigencia_precios.cdg_empresa = que_empresa NO-LOCK ~
    BY Vigencia_precios.fch_desde DESCENDING.
&Scoped-define TABLES-IN-QUERY-Query-Main Vigencia_precios
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Vigencia_precios
