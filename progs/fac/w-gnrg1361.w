...
DEFINE FRAME F-Main
     ...
     "  Rango de fechas de los movimientos:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 3.96 COL 12
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Proceso de Generación de Interface RG 1361"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Proceso de Generación de Interface RG 1361 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Proceso de Generación de Interface RG 1361 */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 5.58 , 12.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Proceso de Generación de Interface RG 1361"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsrg1361_ventas_mhsa.p ( INPUT des_fecha,
                                    INPUT has_fecha).
