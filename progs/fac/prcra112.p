...
DEFINE VARIABLE v-comprobante   AS CHARACTER FORMAT "X(12)" INITIAL "N. DE CREDITO".
...
OUTPUT TO VALUE(dire_tmp + "prcra112.txt") PAGE-SIZE 72.
...
OUTPUT CLOSE.
   ...
   RUN _osprint.p ( INPUT  CURRENT-WINDOW:HANDLE,     /* HANDLE de la WINDOW    */
                    INPUT  dire_tmp + "prcra112.txt", /* Archivo a imprimir     */
