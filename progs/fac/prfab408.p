...
DEFINE VARIABLE v-importe_bonificacion LIKE Fac_header-bon.importe.
...
DO TRANSACTION: 
    ...
    */
    ...
    THEN DO:
         ...
         PUT "IMP.DESC =".
         v-importe_bonificacion = Fac_header-bon.importe * ( 1 + prciva / 100 ).
         PUT STRING(v-importe_bonificacion,"zzzz9.99") SKIP.
    END.
    ELSE DO:
         PUT "%DESC    =0" SKIP.
    ...
    THEN DO:
            ...
            FOR EACH Fac_detalle OF Fac_header NO-LOCK, 
                ...
                v-fdprecio = Fac_detalle.precio_cf * coeficiente_detalle.
