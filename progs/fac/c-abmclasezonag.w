...
DEFINE FRAME DEFAULT-FRAME
     que_subclase AT ROW 1.27 COL 3 NO-LABEL
     que_nombre AT ROW 1.27 COL 11 COLON-ALIGNED NO-LABEL
     que_clase AT ROW 1.27 COL 56 COLON-ALIGNED NO-LABEL
     brw_clasificacion AT ROW 2.35 COL 3
     camino AT ROW 2.35 COL 58 NO-LABEL
     btn_modificar AT ROW 21.73 COL 3
     btn_eliminar AT ROW 21.73 COL 30
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Mantenimiento de Clases de Zonas Geográficas"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.19
         MAX-WIDTH          = 114.29
...
"nombre_subclasezng" "Denominacion!Subclase" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is OPENED
...
ON END-ERROR OF C-Win /* Mantenimiento de Clases de Zonas Geográficas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Mantenimiento de Clases de Zonas Geográficas */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN enable_UI.
  {setwintit.i "SIC/FAC" "Clasificación de Zonas Geográficas"}
...
------------------------------------------------------------------------------*/
/*
  IF AVAILABLE Clase_de_Zonas
     THEN rotulo = FILL(" ",l_rotulo - LENGTH(Clase_de_Zonas.rotulo_siguiente) - 1) + Clase_de_Zonas.rotulo_siguiente + ":".           ELSE rotulo = FILL(" ",l_rotulo - 1) + ":".
*/
