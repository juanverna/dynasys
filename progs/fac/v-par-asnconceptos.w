...
DEFINE VARIABLE v-lista_tipos AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     LABEL "Conceptos" 
...
ON VALUE-CHANGED OF v-lista_tipos IN FRAME F-Main /* Conceptos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DEFINE OUTPUT PARAMETER p-lista_tipos     AS INTEGER.
...
------------------------------------------------------------------------------*/
  ...
  DEFINE INPUT PARAMETER p-lista AS INTEGER.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
   ...
   x-lista = "".
   FOR EACH Comprobante_concepto, FIRST Tipocomprobante OF Comprobante_concepto WHERE Tipocomprobante.cdg_ciclocomercial = "Ventas",
       FIRST Imputacion OF Comprobante_concepto:
       x-lista = x-lista + "," + Imputacion.dsc_imputacion + "," + STRING(Imputacion.cdg_imputacion).
   END.
   v-lista_tipos:LIST-ITEM-PAIRS IN FRAME {&FRAME-NAME} = SUBSTRING(x-lista,2).

   v-lista_tipos = INTEGER(ENTRY(2,v-lista_tipos:LIST-ITEM-PAIRS,",")).
