...
DEFINE VARIABLE h_b-grupoemp AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-grupoemp AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-grupoemp.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-grupoemp ).
       RUN set-position IN h_v-grupoemp ( 1.24 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.00 , 57.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 1.24 , 62.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 20.48 , 19.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-grupoemp.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-grupoemp ).
       RUN set-position IN h_b-grupoemp ( 5.57 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-grupoemp ( 16.14 , 58.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-grupoemp. */
       RUN add-link IN adm-broker-hdl ( h_b-grupoemp , 'Record':U , h_v-grupoemp ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-grupoemp ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-grupoemp ,
             Btn_Done:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-grupoemp , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-grupoemp ,
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXC" "Mantenimiento de Grupos Empresarios"}
