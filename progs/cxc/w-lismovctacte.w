...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cliente ( 1.95 , 1.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 6.00 , 1.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst_punto-vta ( 10.05 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-rng-parctacte ( 14.57 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-que-moneda ( 17.29 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 21.57 , 1.00 ) NO-ERROR.
...
IF tipo = 1 /* Analitico */
       THEN DO:
            IF det_sino 
               THEN RUN lsdetanalitico.p ( INPUT des_cliente,
                                           INPUT has_cliente,
                                           INPUT des_nombre, 
                                           INPUT has_nombre, 
                                           INPUT ver_por,
             ...
             ELSE do:
                IF texcel THEN 
                    RUN lsresanaliticoEXCEL.p   ( INPUT des_cliente,
                                           INPUT has_cliente,
                                           INPUT des_nombre, 
                                           INPUT has_nombre, 
                                           INPUT ver_por,
                                           ...
                                           INPUT v-lista_punto-vta).
                ELSE
                    RUN lsresanalitico.p   ( INPUT des_cliente,
                                           INPUT has_cliente,
                                           INPUT des_nombre, 
                                           INPUT has_nombre, 
                                           INPUT ver_por,
       ...
       ELSE DO: /* Historico */
            ...
            IF det_sino 
               THEN RUN lsdethistorico.p ( INPUT des_cliente,
                                           INPUT has_cliente,
                                           INPUT des_nombre, 
                                           INPUT has_nombre, 
                                           INPUT ver_por,
               ...
               ELSE do:
                   IF texcel THEN
                   RUN lsreshistoricoEXCEL.p ( INPUT des_cliente,
                                           INPUT has_cliente,
                                           INPUT des_nombre, 
                                           INPUT has_nombre, 
                                           INPUT ver_por,
                                           ...
                                           INPUT v-lista_punto-vta).
                   ELSE
                                          RUN lsreshistorico.p ( INPUT des_cliente,
                                           INPUT has_cliente,
                                           INPUT des_nombre, 
                                           INPUT has_nombre, 
                                           INPUT ver_por,
