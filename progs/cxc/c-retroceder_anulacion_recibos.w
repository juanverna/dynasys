...
DEFINE FRAME DEFAULT-FRAME
     ...
     btn_hacer AT ROW 2.67 COL 43
     "  Indique el número de recibo a retroceder anulación" VIEW-AS TEXT
          SIZE 50 BY 1 AT ROW 1.24 COL 3
...
ON END-ERROR OF C-Win /* Retroceder Anulación de Recibos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Retroceder Anulación de Recibos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE v-tip_comprob v-prf_comprob v-nro_comprob btn_hacer 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
