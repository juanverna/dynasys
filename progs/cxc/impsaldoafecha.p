...
DEFINE TEMP-TABLE T-Ficha
  ...
  FIELD fecha_vencimiento      LIKE Cta_cte.fecha_vencimiento COLUMN-LABEL "Fecha!Vencmto."
  ...
  FIELD saldo_hi               LIKE Cta_cte.debito            COLUMN-LABEL "Saldo!Histórico"
...
DEFINE VARIABLE hubo_documento  AS LOGICAL.
       ...
       THEN DO: /* Facturas y N.Deb */
            ...
            FOR EACH Aplicacion_pagos 
                WHERE Aplicacion_pagos.cdg_empresa      = Cta_cte.cdg_empresa
                  ...
                  IF NOT hubo_documento
                     THEN RUN mostrar_documento.
