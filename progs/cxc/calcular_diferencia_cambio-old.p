...
/*----------------------------------------------------------------------------------------------*/
/*                 Genera la imputacion contable de los immpuestos                              */
/*----------------------------------------------------------------------------------------------*/

   FOR EACH T-Fac_header_impuesto, Impuesto OF T-Fac_header_impuesto:
       ...
       THEN DO:
            ...
            ASSIGN
                   T-Sub_detalle_vta.cdg_empresa    = T-Fac_header.cdg_empresa
