...
DEFINE FRAME F-Main
     ...
     "  Moneda de los movimientos:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 13.38 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de Fechas de Transacciones:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 5.52 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Documentos pendientes x Cobrador/Zona"
         HEIGHT             = 24.29
         WIDTH              = 126.4
         MAX-HEIGHT         = 24.29
         MAX-WIDTH          = 126.4
...
ON END-ERROR OF W-Win /* Documentos pendientes x Cobrador/Zona */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Documentos pendientes x Cobrador/Zona */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cobrador ( 2.52 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 6.57 , 14.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng-zona ).
       RUN set-position IN h_v-rng-zona ( 10.38 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.86 , 100.00 ) */
       ...
       RUN set-position IN h_v-que-moneda ( 14.33 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-lst-empresas ( 18.33 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 22.19 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lspencobsalxzona.p ( INPUT v-lista_empresas,
                                INPUT des_cobrador,
                                INPUT has_cobrador,
                                INPUT des_fecha,
                                INPUT has_fecha,
