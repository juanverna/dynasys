...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Fichas de Deuda x Cobrador/Zona"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Fichas de Deuda x Cobrador/Zona */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Fichas de Deuda x Cobrador/Zona */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cobrador ( 2.08 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-que-moneda ( 12.85 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXC" "Fichas de Deuda x Cobrador/Zona"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsfichasxcobzona.p ( INPUT v-lista_empresas,
                                INPUT des_cobrador,
                                INPUT has_cobrador,
                                INPUT des_fecha,
                                INPUT has_fecha,
