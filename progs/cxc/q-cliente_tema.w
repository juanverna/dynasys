...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Tema WHERE TRUE /* Join to Cliente incomplete */ ~
      AND Tema.cdg_tema = Cliente.cdg_cliente NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Tema
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Tema
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "sic.Tema WHERE sic.Cliente <external> ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "Tema.cdg_tema = Cliente.cdg_cliente"
