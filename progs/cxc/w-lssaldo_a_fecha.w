...
DEFINE FRAME F-Main
     ...
     "  Clientes a listar:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 2.91 COL 29
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Fecha de corte de los movimientos:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 7.19 COL 29
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Considerar movimientos de siguiente moneda:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 11.48 COL 29
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-que-fecha ( 8.38 , 29.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-que-moneda ( 12.91 , 29.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXC" "Conposicion de Saldos Analiticos a una fecha dada"}
...
------------------------------------------------------------------------------*/
  ...
  RUN dar_rango IN h_v-que-fecha    ( OUTPUT que_fecha, 
                                      OUTPUT error_rango ).
  IF error_rango 
  THEN DO:
  ...
  THEN DO:
       ...
       RUN lssaldo_a_fecha.p ( INPUT des_cliente,
                               INPUT has_cliente,
                               INPUT que_moneda,
                               INPUT que_fecha).
