...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Vencimientos x cobrar entre dos fechas"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Vencimientos x cobrar entre dos fechas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Vencimientos x cobrar entre dos fechas */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cliente ( 3.42 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXC" "Vencimientos x cobrar entre dos fechas"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsvencimientosxcob.p ( INPUT ver_por,
                                  INPUT des_cliente,
                                  INPUT des_nombre,
                                  INPUT has_cliente,
                                  INPUT has_nombre,
