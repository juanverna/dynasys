...
OUTPUT TO "./r3.0/prl/prrcb900.txt".
...
PUT "H01," + STRING(Rec_header.prf_comprob,"9999") + "-" +
             STRING(Rec_header.nro_comprob,"999999") FORMAT "X(15)" SKIP.
...
PUT "H07," + Domicilio.direccion FORMAT "X(35)" SKIP.
PUT "H08," + "(" + Domicilio.cdg_postal +  ") " + Domicilio.localidad FORMAT "X(40)" SKIP.
PUT "H09," + "Pcia. de " + Provincia.nombre FORMAT "X(25)" SKIP.
...
DO WHILE AVAILABLE Rec_detalle OR AVAILABLE Caj_detalle:
  ...
  THEN DO:
        ...
        PUT "!PAGE!" SKIP.
        OUTPUT CLOSE.
        OS-COMMAND {&SILENT} ".\r3.0\prl\proform .\prl\recibo.prn < .\prl\prrcb900.txt > .\prl\prrcb900.lst".
        OS-COMMAND {&SILENT} "copy .\r3.0\prl\prrcb900.lst prn /b".
...
OS-COMMAND {&SILENT} ".\r3.0\prl\proform .\r3.0\prl\recibo.prn < .\r3.0\prl\prrcb900.txt > .\r3.0\prl\prrcb900.lst".
OS-COMMAND {&SILENT} "copy .\r3.0\prl\prrcb900.lst prn /b".
