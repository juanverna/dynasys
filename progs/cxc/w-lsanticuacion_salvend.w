...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsanticuacion_salvend.p ( INPUT  des_vendedor,
                                     INPUT  has_vendedor,
                                     INPUT  que_moneda,
                                     INPUT  ref_fecha,
                                     INPUT  ncol_vencidas,
