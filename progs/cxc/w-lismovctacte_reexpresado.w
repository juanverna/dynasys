...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Movimientos de Cuenta Corriente Reexpresados"
         HEIGHT             = 22.14
         WIDTH              = 114.2
         MAX-HEIGHT         = 27.33
         MAX-WIDTH          = 146.2
...
ON END-ERROR OF W-Win /* Movimientos de Cuenta Corriente Reexpresados */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Movimientos de Cuenta Corriente Reexpresados */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cliente ( 3.38 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 7.43 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-parctacte ( 11.48 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXC" "Reporte de Movimientos de Cuenta Corriente Reexpresado"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       THEN DO:
            IF det_sino 
               THEN RUN lsdetanalitico_reexpresado.p ( INPUT des_cliente,
                                                       INPUT has_cliente,
                                                       INPUT des_nombre, 
                                                       INPUT has_nombre, 
                                                       INPUT ver_por,
               ...
               ELSE RUN lsresanalitico_reexpresado.p ( INPUT des_cliente,
                                           INPUT has_cliente,
                                           INPUT des_nombre, 
                                           INPUT has_nombre, 
                                           INPUT ver_por,
       ...
       ELSE DO: /* Historico */
            ...
            IF det_sino 
               THEN RUN lsdethistorico_reexpresado.p 
                                         ( INPUT des_cliente,
                                           INPUT has_cliente,
                                           INPUT des_nombre, 
                                           INPUT has_nombre, 
               ...
               ELSE RUN lsreshistorico_reexpresado.p 
                                         ( INPUT des_cliente,
                                           INPUT has_cliente,
                                           INPUT des_nombre, 
                                           INPUT has_nombre, 
