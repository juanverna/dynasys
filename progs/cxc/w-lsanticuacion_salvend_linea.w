...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Anticuación de Saldos de Clientes por Vendedor"
         HEIGHT             = 22.33
         WIDTH              = 129.4
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 129.4
...
ON END-ERROR OF W-Win /* Anticuación de Saldos de Clientes por Vendedor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Anticuación de Saldos de Clientes por Vendedor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-vendedor ( 2.62 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-par-cashflow ( 11.00 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 15.43 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXC" "Anticuación de Saldos de Clientes por Vendedor"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsanticuacion_salvend_linea.p ( INPUT  des_vendedor,
                                           INPUT  has_vendedor,
                                           INPUT  que_moneda,
                                           INPUT  ref_fecha,
                                           INPUT  ncol_vencidas,
