...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Aplicacion de Cobranzas por Fecha"
         HEIGHT             = 23.48
         WIDTH              = 119.8
         MAX-HEIGHT         = 23.48
         MAX-WIDTH          = 119.8
...
ON END-ERROR OF W-Win /* Aplicacion de Cobranzas por Fecha */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Aplicacion de Cobranzas por Fecha */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-lst-empresas ( 14.48 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsaplicacion_pagos.p ( INPUT v-lista_empresas,
                                  INPUT des_cliente,
                                  INPUT has_cliente,
                                  INPUT que_moneda, 
                                  INPUT des_fecha,
