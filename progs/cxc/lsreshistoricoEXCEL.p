...
DEFINE TEMP-TABLE lsreshistorico
...
PROCEDURE LISTAR:
  ...
  RUN pTT2XLS                                                           
    ( INPUT TEMP-TABLE lsreshistorico:DEFAULT-BUFFER-HANDLE,                    
      INPUT "C:\SIC-TEMP\lsreshistorico.XLS",                                            
      INPUT 'PageSetup:PrintGridlines=Y|PageSetup:PrintTitleRows=$1:$1' ).
  MESSAGE "Archivo C:\SIC-TEMP\lsreshistorico.XLS generado" VIEW-AS ALERT-BOX INFORMATION.
...
PROCEDURE PROCESAR_CLIENTE:
    ...
    THEN DO:
          ...
          CREATE lsreshistorico.
          ASSIGN lsreshistorico.saldo = saldo
           lsreshistorico.cdg_cliente = Cliente.cdg_cliente
           lsreshistorico.nom_cliente = Cliente.nom_cliente
           lsreshistorico.cuit = cliente.cuit.
    END.
