...
ON END-ERROR OF W-Win /* Facturas x Vendedor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Facturas x Vendedor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-vendedor ( 3.52 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 7.91 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-que-moneda ( 12.52 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-lst-empresas ( 16.24 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXC" "Ventas por Vendedor"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsfacturasxvendedor_resumido.p ( INPUT v-lista_empresas,
                                   INPUT des_vendedor,
                                   INPUT has_vendedor,
                                   INPUT des_fecha,
                                   INPUT has_fecha,
