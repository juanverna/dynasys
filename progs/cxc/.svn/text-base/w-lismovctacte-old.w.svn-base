...
DEFINE FRAME F-Main
     v-estado AT ROW 18.24 COL 27 COLON-ALIGNED NO-LABEL
     "  Parámetros generales del listado:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 10.95 COL 29
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Clientes a listar::" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 2.91 COL 29
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de fechas de los movimientos:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 7.19 COL 29
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cliente ( 4.19 , 29.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 8.24 , 29.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-parctacte ( 12.29 , 29.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-que-moneda ( 15.29 , 29.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 19.57 , 29.00 ) NO-ERROR.
  ...
  THEN DO:
       ...
       THEN DO:
            IF det_sino 
             ...
             ELSE RUN lsresanalitico.p   ( INPUT des_cliente,
                                           INPUT has_cliente,
                                           INPUT des_nombre, 
                                           INPUT has_nombre, 
                                           INPUT ver_por,
       ...
       ELSE DO: /* Historico */
            ...
            IF det_sino 
               ...
               ELSE RUN lsreshistorico.p ( INPUT des_cliente,
                                           INPUT has_cliente,
                                           INPUT des_nombre, 
                                           INPUT has_nombre, 
                                           INPUT ver_por,
