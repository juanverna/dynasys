...
&Scoped-Define ENABLED-OBJECTS v-dias_columna v-consolidado v-lat_pagos ~
v-ncol_vencidas v-ref_fecha v-lat_cobros v-ncol_futuras RECT-1 
&Scoped-Define DISPLAYED-OBJECTS v-dias_columna v-consolidado v-lat_pagos ~
v-ncol_vencidas v-ref_fecha v-lat_cobros v-ncol_futuras 
...
DEFINE FRAME F-Main
     v-dias_columna AT ROW 1.24 COL 43 COLON-ALIGNED
     v-consolidado AT ROW 1.24 COL 53
     v-lat_pagos AT ROW 1.24 COL 89 COLON-ALIGNED
     v-ncol_vencidas AT ROW 1.29 COL 16 COLON-ALIGNED
     v-ref_fecha AT ROW 2.57 COL 43 COLON-ALIGNED
     v-lat_cobros AT ROW 2.57 COL 89 COLON-ALIGNED
