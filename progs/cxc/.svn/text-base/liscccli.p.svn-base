...
/*que_archivo = DIRE_TMP + "liscccli.txt".
OUTPUT TO VALUE(que_archivo) PAGED PAGE-SIZE 72.*/
   ...
   FOR EACH Cta_cte OF Cliente 
       WHERE Cta_cte.nro_moneda = Moneda.nro_moneda
        ...
        EACH Imputacion OF Cta_cte
          BREAK BY fecha_emision WITH FRAME frm-listado:
...
PROCEDURE LISTAR_ANALITICO:
   ...
   FOR EACH Cta_cte OF Cliente 
      WHERE Cta_cte.nro_moneda = Moneda.nro_moneda
        ...
        AND Cta_cte.cdg_empresa = Empresa.cdg_empresa,
       EACH Imputacion OF Cta_cte
         BY fecha_vencimiento WITH FRAME frm-listado: 
