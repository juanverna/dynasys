...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Fichas de Deuda x Vendedor/Zona"
         HEIGHT             = 27.29
         WIDTH              = 158.4
         MAX-HEIGHT         = 27.29
         MAX-WIDTH          = 159.6
...
ON END-ERROR OF W-Win /* Fichas de Deuda x Vendedor/Zona */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Fichas de Deuda x Vendedor/Zona */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-vendedor ( 3.00 , 31.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 7.62 , 31.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng-zona ).
       RUN set-position IN h_v-rng-zona ( 11.43 , 31.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.86 , 100.00 ) */
       ...
       RUN set-position IN h_v-que-moneda ( 15.91 , 31.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-lst-empresas ( 19.62 , 31.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 23.48 , 31.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXC" "Fichas de Deuda x Vendedor/Zona"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsfichasxvendzona.p ( INPUT v-lista_empresas,
                                 INPUT des_vendedor,
                                 INPUT has_vendedor,
                                 INPUT des_fecha,
                                 INPUT has_fecha,
