...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Anticuación de Saldos Por Vendedor"
         HEIGHT             = 22.33
         WIDTH              = 114.2
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 127.2
...
ON END-ERROR OF W-Win /* Anticuación de Saldos Por Vendedor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Anticuación de Saldos Por Vendedor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXC" "Resumen de Deuda por Vendedor"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE ncol_futuras            AS INTEGER INITIAL 3.
  ...
  THEN DO:
       ...
       RUN lsanticuacion_saltotales.p ( INPUT  des_vendedor,
                                        INPUT  has_vendedor,
                                        INPUT  que_moneda,
                                        INPUT  ref_fecha,
                                        INPUT  ncol_vencidas,
