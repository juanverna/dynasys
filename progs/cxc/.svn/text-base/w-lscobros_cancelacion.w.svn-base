...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-lst-empresas ( 11.71 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXC" "Cobranzas con detalle de cancelación"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lscobros_cancelacion.p ( INPUT v-lista_empresas,
                                    INPUT des_cliente,
                                    INPUT has_cliente,
                                    INPUT des_fecha,
                                    INPUT has_fecha).
