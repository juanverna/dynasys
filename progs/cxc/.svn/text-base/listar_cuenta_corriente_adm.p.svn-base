/*=================================================================================*/
/*           EMITE EL LISTADO DE LA FICHA DE CUENTA CORRIENTE DE LOS CLIETES DE UN ADMINISTRADOR                    */
/*=================================================================================*/
...
DEFINE FRAME frm-listado
       ...
       Cta_cte.mes COLUMN-LABEL "Mes"
       Cta_cte.ano COLUMN-LABEL "Año"
...
FIND administrador WHERE ROWID(administrador) = rid_cliente.
que_cliente = administrador.cdg_cliente.
que_nombre = "Administracion " + administrador.nom_cliente.
    {dirprinfile.i}
...
PROCEDURE CALCULAR_EI:
   ...
   FOR EACH Cta_cte WHERE cta_cte.nro_administrador = administrador.nro_cliente
...
PROCEDURE LISTAR_HISTORICO:
   ...
   FOR EACH Cta_cte WHERE cta_cte.nro_administrador = administrador.nro_cliente 
       ...
       saldo = debitos - creditos.
       FIND cliente WHERE cliente.nro_cliente = cta_cte.nro_cliente NO-LOCK.
       DISPLAY   
           cliente.nom_cliente
           Cta_cte.tip_comprob
           Cta_cte.prf_comprob
...
PROCEDURE LISTAR_ANALITICO:
   ...
   FOR EACH Cta_cte WHERE cta_cte.nro_administrador = administrador.nro_cliente
       ...
       DISPLAY 
           ...
           Cta_cte.clausula_dolar
           Cta_cte.es_difcambio  
           Cta_cte.debito FORMAT "->,>>>,>>9.99"  WHEN Cta_cte.debito <> 0
           Cta_cte.credito FORMAT "->,>>>,>>9.99" WHEN Cta_cte.credito <> 0
           saldo
           WITH FRAME frm-listado.
