...
DEFINE FRAME F-Main
     ...
     "  Indique si desea el listado para todas las empresas o solo la actual:" VIEW-AS TEXT
     ...
     "  Rango de fechas de los movimientos:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 9.57 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
ON END-ERROR OF W-Win /* Estados Crediticios */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Estados Crediticios */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-esp-moneda ( 6.95 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 10.76 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-consolidado ( 15.05 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXC" "Estados Crediticios"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsestados_crediticios.p ( INPUT des_cliente,
                                     INPUT has_cliente,
                                     INPUT des_nombre,
                                     INPUT has_nombre,
                                     INPUT ver_por,
