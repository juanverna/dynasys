...
DEFINE VARIABLE saldo_inicial        AS DECIMAL FORMAT "->,>>>,>>9.99" LABEL "Tot. Deuda".
...
DEFINE VARIABLE puso_cliente         AS LOGICAL.
DEFINE VARIABLE hay_movs_empresa     AS LOGICAL.
...
DEFINE FRAME frm-titulo HEADER
  que_empresa 
  "Fichas de Deuda por Vendedor/Zona" AT 44
...
PROCEDURE LISTAR:
  ...
  DO WHILE AVAILABLE Cliente:
        ...
        FOR EACH Empresa 
            WHERE CAN-DO(v-lista_empresas,Empresa.cdg_empresa)
              AND CAN-DO (Usuario.lista_empresas,Empresa.cdg_empresa):

            hay_movs_empresa = NO.

            RUN CALCULAR_EI ( INPUT Empresa.cdg_empresa, OUTPUT debitos, OUTPUT creditos ).
            ...
            THEN DO:
                ...
                DISPLAY "S.In." + Empresa.cdg_empresa @ Imputacion.abrevia
            ...
            THEN DO:
                ...
                DISPLAY "Saldo " + Empresa.cdg_empresa  @ Cta_cte.fecha_vencimiento
                        debitos  @ Cta_cte.debito
                        creditos @ Cta_cte.credito
                        saldo
                        WITH FRAME frm-listado-mov.
