...
DEFINE FRAME F-Main
     ...
     "  Moneda de los movimientos a listar:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 5.52 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Clientes a listar:" VIEW-AS TEXT
          SIZE 90 BY .81 AT ROW 1.48 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Fecha de las cartas de reclamo:" VIEW-AS TEXT
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cliente ( 2.67 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 90.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '//milenium/desa/v9/sic/r3.5/emiliano/v-esp-moneda.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-esp-moneda ).
       RUN set-position IN h_v-esp-moneda ( 6.48 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 89.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  '//milenium/desa/v9/sic/r3.5/emiliano/v-que-fecha.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-que-fecha ).
       RUN set-position IN h_v-que-fecha ( 10.52 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lscartas_de_reclamo.p ( INPUT des_cliente,
                                   INPUT has_cliente,
                                   INPUT des_nombre,
                                   INPUT has_nombre,
                                   INPUT ver_por,
