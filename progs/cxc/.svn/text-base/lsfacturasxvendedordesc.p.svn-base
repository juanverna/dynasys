...
DEFINE FRAME frm-titulo HEADER
  que_empresa 
  "Total de Ventas por Vendedor desde Cta.Cte." AT 38
        ...
        WHERE LOOKUP(que_sector, Cliente.lista_sectores) <> 0, 
            EACH Cta_cte NO-LOCK OF Cliente 
                ...
                AND CAN-DO (Usuario.lista_empresas,Cta_cte.cdg_empresa)
                  ...
                  EACH fac_header WHERE fac_header.cdg_empresa = Cta_cte.cdg_empresa
...
/*                 v-imp_recibo WHEN ( Cta_cte.tip_comprob BEGINS "R")     
        ...
        FIND FIRST fac_header-bon OF fac_header NO-ERROR.
        IF AVAILABLE fac_header-bon THEN
