...
&Scoped-Define ENABLED-OBJECTS v-ref_fecha v-consolidado RECT-1 
&Scoped-Define DISPLAYED-OBJECTS v-ref_fecha v-consolidado 
...
DEFINE FRAME F-Main
     v-ref_fecha AT ROW 1.95 COL 17 COLON-ALIGNED
     v-consolidado AT ROW 1.95 COL 78
