...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Exportacion a excel de cta cte"
         HEIGHT             = 27.33
         WIDTH              = 160
         MAX-HEIGHT         = 27.67
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Exportacion a excel de cta cte */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Exportacion a excel de cta cte */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXC" "Exportacion a excel de cancelaciones de cta. cte."}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsexporta_cancelacion.p ( INPUT Empresa.cdg_empresa,
                                     INPUT des_cliente,
                                     INPUT has_cliente,
                                     INPUT des_fecha,
                                     INPUT has_fecha).
