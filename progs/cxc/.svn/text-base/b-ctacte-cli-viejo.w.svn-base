...
&Scoped-Define ENABLED-OBJECTS RECT-1 des_fecha ficha id_moneda btn_credito ~
btn_imprimir btn_integral has_fecha btn_compensar btn_consolidado ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Cta_cte.leyenda FORMAT "X(24)":U WIDTH 4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME F-Main
     ...
     btn_compensar AT ROW 2.43 COL 87
...
"Cta_cte.leyenda" ? "X(24)" "character" ? ? ? ? ? ? no ? no no "4" yes no no "U" "" ""
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON CTRL-SHIFT-F12 OF br_table IN FRAME F-Main /* Movimientos de Cuenta Corriente del Cliente */
DO:
  DEFINE BUFFER cc FOR cta_cte.
   DO TRANSACTION:
       FIND CURRENT Cta_cte EXCLUSIVE-LOCK.
       BUFFER-COPY cta_cte TO cc ASSIGN cc.nro_comprob=0.
       DISPLAY cc WITH 2 COLUMNS SIDE-LABELS THREE-D VIEW-AS DIALOG-BOX
               FRAME f-actualiza.
       UPDATE  cc EXCEPT cc.nro_cliente cc.cdg_empresa
               WITH 2 COLUMNS SIDE-LABELS THREE-D VIEW-AS DIALOG-BOX
               FRAME f-actualiza.
...
DO:
  ...
  ELSE DO:
     ...
     THEN DO:                  
          ...
          RUN ocultar_window.
          RUN c-comprobante_cliente.w ( INPUT-OUTPUT act_fac_head , INPUT 2, INPUT Fac_header.cdg_comprobante ).
          RUN mostrar_window.
     END.
     ELSE DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn_compensar B-table-Win
ON CHOOSE OF btn_compensar IN FRAME F-Main /* Compensar */
DO:
