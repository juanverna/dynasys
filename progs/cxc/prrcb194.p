...
PROCEDURE imprimir_orden:
    ...
    DO ncopia = 1 TO 2:
       RUN escribir     ( INPUT "112,15", INPUT "<B>Son " + Moneda.descripcion + ":</B>" + letras, 8, NO).
       RUN escribenumero( INPUT "112,195", INPUT STRING(Rec_header.imp_pesos + Rec_header.imp_difcambio,"->,>>>,>>9.99"), 8, YES).
    END.
    ...
    DO WHILE AVAILABLE Rec_detalle OR AVAILABLE Caj_detalle:
      ...
      THEN DO:
            ...
            DO ncopia = 1 TO 2:
               ...
               RUN escribenumero( INPUT "112,176", INPUT STRING(v-valores,"->,>>>,>>9.99"), 8, YES).
            END.
      ...
      THEN DO:
            ...
            DO ncopia = 1 TO 2:
               ...
               RUN escribenumero( INPUT chr_linea + ",71", INPUT STRING(Rec_detalle.imp_pesos + Rec_detalle.difcambio,"->,>>>,>>9.99"), 8, NO).
            END.                
      END.
...
PROCEDURE encabezado:
    ...
    PUT STREAM Formulario UNFORMATTED f-ref(ncopia) + "<AT=+53,+76><FROM><AT=+57><LINE>". 
    PUT STREAM Formulario UNFORMATTED f-ref(ncopia) + "<AT=+61,+55><FROM><AT=+49><LINE>".  
