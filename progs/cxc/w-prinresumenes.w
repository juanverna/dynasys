...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cliente ( 2.19 , 3.20 ) NO-ERROR.
       ...
       RUN set-position IN h_v-que-fecha ( 6.48 , 34.00 ) NO-ERROR.
...
RUN crearReporte(chReport,"rpt",/*ViewReport*/ TRUE,/*PrinterName*/ impreport(2),
