...
DEFINE FRAME frm-titulo HEADER
  que_empresa
  "Clasificación de Depósito" AT 40 
...
FIND FIRST Clase WHERE Clase.cdg_subclase = p-primer_nodo NO-LOCK.
que_subclase = Clase.cdg_subclase + " - " + Clase.nombre_subclase .
...
FOR EACH Clase WHERE Clase.cdg_clase = p-primer_nodo NO-LOCK:
    ...
    RUN recorrer_clasificacion_depositos.p ( INPUT ROWID(Clase), 
                                             INPUT 0,
