...
&Scoped-Define ENABLED-OBJECTS des_fecha has_fecha btn_consolidado ~
btn_imprimir que_partida que_deposito br_table RECT-7 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 115 BY 16.19
...
DEFINE FRAME F-Main
     des_fecha AT ROW 1.24 COL 8 COLON-ALIGNED
     has_fecha AT ROW 1.24 COL 27 COLON-ALIGNED
     btn_consolidado AT ROW 1.24 COL 78
     btn_imprimir AT ROW 1.24 COL 98
     que_partida AT ROW 2.43 COL 8 COLON-ALIGNED
     que_deposito AT ROW 2.43 COL 52 COLON-ALIGNED
...
/* BROWSE-TAB br_table que_deposito F-Main */
ASSIGN 
