...
Articulo.cdg_articulo Articulo.descripcion Rqs_detalle.cantidad_sol ~
Unidad.abrevia Area.cdg_area Area.denominacion Rqs_header.nro_comprob ~
Rqs_detalle.nro_linea Rqs_header.fecha Rqs_detalle.cdg_estado 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Rqs_header OF Deposito WHERE ~{&KEY-PHRASE} ~
      AND Rqs_header.cdg_estado <> "ZZ" NO-LOCK, ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Articulo.descripcion COLUMN-LABEL "Descripción!del artículo" FORMAT "X(34)"
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 84 BY 6.72
...
"Articulo.descripcion" "Descripción!del artículo" "X(34)" "character" ? ? ? ? ? ? no ?
...
"Rqs_detalle.nro_linea" "Nro.!Línea" ? "integer" ? ? ? ? ? ? no ?
     _FldNameList[10]   > sic.Rqs_header.fecha
"Rqs_header.fecha" "Fecha!Solic." ? "date" ? ? ? ? ? ? no ?
     _FldNameList[11]   > sic.Rqs_detalle.cdg_estado
