...
DEFINE VARIABLE         lista_tipos   AS CHARACTER INITIAL "F*".
...
&Scoped-define INTERNAL-TABLES Valeinv_hd

/* Definitions for BROWSE BROWSE-2                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 Valeinv_hd.tip_comprob Valeinv_hd.prf_comprob Valeinv_hd.nro_comprob Valeinv_hd.estado Valeinv_hd.fecha Valeinv_hd.imp_total Valeinv_hd.leyenda   
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2   
&Scoped-define SELF-NAME BROWSE-2
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH Valeinv_hd                           WHERE Valeinv_hd.cdg_empresa = que_empresa                             AND Valeinv_hd.tip_comprob MATCHES lista_tipos                             AND Valeinv_hd.fecha >= v-des_fecha                             AND Valeinv_hd.fecha <= v-has_fecha                             AND CAN-DO(lista_estados, ~
      Valeinv_hd.estado)
&Scoped-define OPEN-QUERY-BROWSE-2 OPEN QUERY {&SELF-NAME}             FOR EACH Valeinv_hd                           WHERE Valeinv_hd.cdg_empresa = que_empresa                             AND Valeinv_hd.tip_comprob MATCHES lista_tipos                             AND Valeinv_hd.fecha >= v-des_fecha                             AND Valeinv_hd.fecha <= v-has_fecha                             AND CAN-DO(lista_estados, ~
      Valeinv_hd.estado).
&Scoped-define TABLES-IN-QUERY-BROWSE-2 Valeinv_hd
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-2 Valeinv_hd
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 D-Dialog _FREEFORM
  QUERY BROWSE-2 DISPLAY
      Valeinv_hd.tip_comprob    COLUMN-LABEL "Ti-!po"
      Valeinv_hd.prf_comprob    COLUMN-LABEL "Pre-!fijo" FORMAT "9999"
      Valeinv_hd.nro_comprob    COLUMN-LABEL "Número!Compbte" FORMAT "99999999"
      Valeinv_hd.estado         COLUMN-LABEL "S!T"
      Valeinv_hd.fecha          COLUMN-LABEL "Fecha!Emisión"
      Valeinv_hd.imp_total      COLUMN-LABEL "Importe!Total"
      Valeinv_hd.leyenda        COLUMN-LABEL "Observación!Movimiento"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 101 BY 10.91 EXPANDABLE.
...
DEFINE FRAME D-Dialog
     ...
     v-has_fecha AT ROW 1.48 COL 27 COLON-ALIGNED
     BROWSE-2 AT ROW 2.91 COL 2
     RECT-9 AT ROW 1.29 COL 2
     SPACE(32.79) SKIP(11.42)
...
OPEN QUERY {&SELF-NAME}
           ...
           FOR EACH Valeinv_hd
                          WHERE Valeinv_hd.cdg_empresa = que_empresa
                            AND Valeinv_hd.tip_comprob MATCHES lista_tipos
                            AND Valeinv_hd.fecha >= v-des_fecha
                            AND Valeinv_hd.fecha <= v-has_fecha
                            AND CAN-DO(lista_estados,Valeinv_hd.estado).
     _END_FREEFORM
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
