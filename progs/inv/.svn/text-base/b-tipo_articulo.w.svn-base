...
&Scoped-define INTERNAL-TABLES Tipo_articulo
...
&Scoped-define QUERY-STRING-br_table FOR EACH Tipo_articulo WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Tipo_articulo WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table Tipo_articulo
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nro_comprador,dsc_tipoart,cdg_tipoart"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Tipo_articulo.cdg_tipoart FORMAT "X(7)":U WIDTH 10.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 15 BY 11.57.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "sic.Tipo_articulo"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > sic.Tipo_articulo.cdg_tipoart
"Tipo_articulo.cdg_tipoart" ? ? "character" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" ""
