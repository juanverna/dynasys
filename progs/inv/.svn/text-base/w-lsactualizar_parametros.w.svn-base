...
DEFINE FRAME F-Main
     ...
     "  Depósitos a actualizar:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 9.1 COL 13
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-articulo ( 3.86 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-deposito ( 10.29 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.86 , 100.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/INV" "Actualizar parámetros de compra por depósito"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsactualizar_parametros.p ( INPUT des_codart,
                                       INPUT has_codart,
                                       INPUT des_nomart,
                                       INPUT has_nomart,
                                       INPUT ver_por,
