...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Familia_cuenta Familia_articulo
&Scoped-define FIRST-EXTERNAL-TABLE Familia_cuenta


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Familia_cuenta, Familia_articulo.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Familia_cuenta.nro_familia 
&Scoped-define ENABLED-TABLES Familia_cuenta
&Scoped-define FIRST-ENABLED-TABLE Familia_cuenta
&Scoped-Define ENABLED-OBJECTS RECT-11 
&Scoped-Define DISPLAYED-FIELDS Familia_cuenta.nro_familia 
&Scoped-define DISPLAYED-TABLES Familia_cuenta
&Scoped-define FIRST-DISPLAYED-TABLE Familia_cuenta
&Scoped-Define DISPLAYED-OBJECTS v-cdg_imputacion v-dsc_imputacion ~
v-cdg_cuenta v-dsc_cuenta 
...
DEFINE VARIABLE v-dsc_imputacion AS CHARACTER FORMAT "X(35)" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 61.2 BY 1
     BGCOLOR 7 FGCOLOR 15 .
...
DEFINE FRAME F-Main
     v-cdg_imputacion AT ROW 1.29 COL 12 COLON-ALIGNED
     v-dsc_imputacion AT ROW 1.29 COL 27 COLON-ALIGNED HELP
          "Denominacion" NO-LABEL
     Familia_cuenta.nro_familia AT ROW 1.81 COL 72 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 13.2 BY 1
     v-cdg_cuenta AT ROW 2.43 COL 12 COLON-ALIGNED
     v-dsc_cuenta AT ROW 2.52 COL 27 COLON-ALIGNED HELP
          "Denominacion" NO-LABEL
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: sic.Familia_cuenta,sic.Familia_articulo
...
ASSIGN 
       Familia_cuenta.nro_familia:HIDDEN IN FRAME F-Main           = TRUE.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "Familia_cuenta"}
  ...
  {src/adm/template/row-find.i "Familia_cuenta"}
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
   ...
   &SCOPED-DEFINE TABLA-MAESTRA  Familia_cuenta

   {validartabla.i "Imputacion" "cdg_imputacion" "dsc_imputacion" "FACU001"} 
   {validartabla.i "Cuenta" "cdg_cuenta" "nombre_cta" "FACU002"} 
   ...
   IF es_alta
   THEN DO:
        IF CAN-FIND(FIRST Familia_cuenta 
                          WHERE Familia_cuenta.nro_familia    = Familia_articulo.nro_familia
                            AND Familia_cuenta.cdg_imputacion = Imputacion.cdg_imputacion
                            AND Familia_cuenta.cdg_empresa    = Empresa.cdg_empresa)
        THEN DO:
  ...
  /* Code placed here will execute AFTER standard behavior.    */
   ...
   ASSIGN
        Familia_cuenta.nro_familia = Familia_articulo.nro_familia
        Familia_cuenta.cdg_empresa = Empresa.cdg_empresa.
