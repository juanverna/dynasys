...
FIND Proveedor WHERE Proveedor.nro_proveedor = Rem_header.nro_cliente NO-LOCK NO-ERROR.

OUTPUT TO VALUE( dire_tmp + "prprc001.txt" ) PAGE-SIZE 48.
...
RUN PROPRINT.P ( INPUT dire_tmp + "prprc001.txt" ).
