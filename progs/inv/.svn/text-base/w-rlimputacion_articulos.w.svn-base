...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Detalle de Artículos con su Imputación Contable"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.15
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Detalle de Artículos con su Imputación Contable */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Detalle de Artículos con su Imputación Contable */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-articulo ( 6.92 , 13.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/INV" "Detalle de Artículos con su Imputación Contable"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsimputacion_articulos.p ( INPUT des_codart, 
                                      INPUT has_codart, 
                                      INPUT des_nomart,
                                      INPUT has_nomart,
                                      INPUT ver_por).
