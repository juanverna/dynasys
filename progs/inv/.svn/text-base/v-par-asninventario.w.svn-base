...
&Scoped-Define ENABLED-OBJECTS v-fecha_contable v-gen_asiento v-des_ptovta ~
v-has_ptovta v-ver_movim v-ver_resum v-lis_fecha v-lista_tipos RECT-1 
&Scoped-Define DISPLAYED-OBJECTS v-fecha_contable v-gen_asiento ~
v-des_ptovta v-has_ptovta v-ver_movim v-ver_resum v-lis_fecha v-lista_tipos 
...
DEFINE VARIABLE v-gen_asiento AS LOGICAL INITIAL no 
...
DEFINE FRAME F-Main
     v-fecha_contable AT ROW 1.24 COL 45 COLON-ALIGNED
     v-gen_asiento AT ROW 1.24 COL 77
     v-des_ptovta AT ROW 1.29 COL 16 COLON-ALIGNED
     v-has_ptovta AT ROW 2.43 COL 16 COLON-ALIGNED
     v-ver_movim AT ROW 2.43 COL 31
     v-ver_resum AT ROW 2.43 COL 58
     v-lis_fecha AT ROW 2.43 COL 77
     v-lista_tipos AT ROW 3.43 COL 16 COLON-ALIGNED
...
ON MOUSE-MENU-DOWN OF v-fecha_contable IN FRAME F-Main /* Fecha Contable */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DEFINE OUTPUT PARAMETER p-gen_asiento     AS LOGICAL.
...
------------------------------------------------------------------------------*/
  ...
  v-lista_tipos = "FA,FB,CA,CB,DA,DB,RM,TS,TE,VS,VE,AP,AN,RP".
