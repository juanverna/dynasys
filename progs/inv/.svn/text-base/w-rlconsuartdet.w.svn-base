...
DEFINE FRAME F-Main
     ...
     "  Entidades Contables a considerar:" VIEW-AS TEXT
     ...
     "  Artículos a considerar:" VIEW-AS TEXT
          ...
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de Fechas de Consumo:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 10.43 COL 13
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Detalle de Consumos por Artículo"
         HEIGHT             = 22.38
         WIDTH              = 119.4
         MAX-HEIGHT         = 22.38
         MAX-WIDTH          = 119.4
...
ON END-ERROR OF W-Win /* Detalle de Consumos por Artículo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Detalle de Consumos por Artículo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-entidad ( 7.19 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 11.76 , 13.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/INV" "Detalle de Consumos por Artículo"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE des_codent       LIKE Entidad.cdg_entidad.
  DEFINE VARIABLE has_codent       LIKE Entidad.cdg_entidad.
  ...
  RUN dar_rango IN h_v-rng-entidad (  OUTPUT  des_codent,
                                      OUTPUT  has_codent,
                                      OUTPUT  error_rango).
  ...
  THEN DO:
       ...
       RUN lsconsuartdet.p ( INPUT des_codart, 
                             INPUT has_codart, 
                             INPUT des_nomart,
                             INPUT has_nomart,
                             INPUT ver_por,
