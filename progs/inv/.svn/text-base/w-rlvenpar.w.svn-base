...
ON END-ERROR OF W-Win /* Partidas a Vencer */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Partidas a Vencer */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/INV" "Partidas Vencids por Artículo"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsvenpar.p ( INPUT des_codart, 
                        INPUT has_codart, 
                        INPUT des_nomart,
                        INPUT has_nomart,
                        INPUT ver_por,
