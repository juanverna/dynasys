...
Lista_Precios.descripcion Articulo_precio.desde_cantidad ~
Articulo_precio.hasta_cantidad Articulo_precio.fch_desde ~
Articulo_precio.precio Articulo_precio.precio_cf 
...
"Lista_Precios.cdg_lista" "Nro.!Lista" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > sic.Lista_Precios.descripcion
"Lista_Precios.descripcion" "Descripcion!Lista" "X(31)" "character" ? ? ? ? ? ? no ? no no "27.8" yes no no "U" "" ""
     _FldNameList[3]   = sic.Articulo_precio.desde_cantidad
     _FldNameList[4]   = sic.Articulo_precio.hasta_cantidad
     _FldNameList[5]   = sic.Articulo_precio.fch_desde
     _FldNameList[6]   = sic.Articulo_precio.precio
     _FldNameList[7]   > sic.Articulo_precio.precio_cf
"Articulo_precio.precio_cf" "Precio!Vta.C.F." ? "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
