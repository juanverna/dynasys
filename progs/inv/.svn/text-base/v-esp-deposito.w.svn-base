...
DEFINE FRAME F-Main
     des_registro AT ROW 1.71 COL 17 COLON-ALIGNED
     des_nombre AT ROW 1.71 COL 38 COLON-ALIGNED NO-LABEL
...
ON + OF des_registro IN FRAME F-Main /* Depósito */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL des_registro V-table-Win
ON MOUSE-MENU-DOWN OF des_registro IN FRAME F-Main /* Depósito */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL des_registro V-table-Win
ON RETURN OF des_registro IN FRAME F-Main /* Depósito */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DEFINE OUTPUT PARAMETER p-des_codigo   LIKE Deposito.cdg_deposito.
