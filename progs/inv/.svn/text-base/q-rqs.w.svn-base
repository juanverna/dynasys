...
&Scoped-define INTERNAL-TABLES Rqs_header Area Deposito Solicitante

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Rqs_header WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH Area OF Rqs_header NO-LOCK, ~
      EACH Deposito OF Rqs_header NO-LOCK, ~
      EACH Solicitante OF Rqs_header NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Rqs_header Area Deposito ~
Solicitante
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Rqs_header
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "sic.Rqs_header,sic.Area OF sic.Rqs_header,sic.Deposito OF sic.Rqs_header,sic.Solicitante OF sic.Rqs_header"
