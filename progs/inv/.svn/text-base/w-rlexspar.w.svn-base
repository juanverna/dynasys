...
ON END-ERROR OF W-Win /* Existencias por Partida */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Existencias por Partida */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-que-fecha ( 7.52 , 13.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/INV" "Existencias por Artículo/Partida a Fecha"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsexspar.p ( INPUT des_codart, 
                        INPUT has_codart, 
                        INPUT des_nomart,
                        INPUT has_nomart,
                        INPUT ver_por,
