...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Deposito WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Deposito
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Deposito
...
<FOREIGN-KEYS>
nombre|y|y|Deposito.nombre
cdg_deposito||y|Deposito.cdg_deposito
nro_entidad||y|Deposito.nro_entidad
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = "nombre",
     Keys-Supplied = "nombre,cdg_deposito,nro_entidad"':U).
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'nombre':U THEN DO:
       &Scope KEY-PHRASE Deposito.nombre eq key-value
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE refrescar_browse q-tables 
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "nombre" "Deposito" "nombre"}
  {src/adm/template/sndkycas.i "cdg_deposito" "Deposito" "cdg_deposito"}
  {src/adm/template/sndkycas.i "nro_entidad" "Deposito" "nro_entidad"}
