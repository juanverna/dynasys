...
DEFINE VARIABLE h_b-envases AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-envase AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-envases ).
       RUN set-position IN h_b-envases ( 1.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-envases ( 19.12 , 15.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-envase ).
       RUN set-position IN h_v-envase ( 1.27 , 19.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 7.73 , 19.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 1.88 , 80.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-envase. */
       RUN add-link IN adm-broker-hdl ( h_b-envases , 'Record':U , h_v-envase ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-envase ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-envase ,
             h_b-envases , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/INV" "Mantenimiento de Envases"}
