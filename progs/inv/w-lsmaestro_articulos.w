...
ON END-ERROR OF W-Win /* Maestro de Artículos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Maestro de Artículos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/INV" "Maestro de Artículos"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsmaestro_articulos.p ( INPUT des_codart, 
                                   INPUT has_codart, 
                                   INPUT des_nomart,
                                   INPUT has_nomart,
                                   INPUT ver_por).
