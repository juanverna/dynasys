...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Articulos con remanentes por Depósito/Partida"
         HEIGHT             = 22.14
         WIDTH              = 117.4
         MAX-HEIGHT         = 22.14
         MAX-WIDTH          = 117.4
...
ON END-ERROR OF W-Win /* Articulos con remanentes por Depósito/Partida */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Articulos con remanentes por Depósito/Partida */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-articulo ( 2.86 , 13.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/INV" "Articulos con remanentes por Depósito/Partida"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsarticonexistp.p ( INPUT des_codart, 
                               INPUT has_codart, 
                               INPUT des_nomart,
                               INPUT has_nomart,
                               INPUT ver_por,
