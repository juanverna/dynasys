...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Rqs_detalle Deposito Area Rqs_header ~
Articulo
&Scoped-define FIRST-EXTERNAL-TABLE Rqs_detalle


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Rqs_detalle, Deposito, Area, Rqs_header, Articulo.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Rqs_detalle.cantidad_ult ~
Rqs_detalle.granel_ult Rqs_detalle.observacion 
...
&Scoped-Define DISPLAYED-FIELDS Rqs_detalle.cantidad_ult ~
Rqs_detalle.granel_ult Rqs_detalle.observacion 
...
DEFINE FRAME F-Main
     Rqs_detalle.cantidad_ult AT ROW 2.33 COL 15 COLON-ALIGNED
          LABEL "Cantidad"
          VIEW-AS FILL-IN NATIVE 
          SIZE 14 BY .81
          BGCOLOR 15 FGCOLOR 9 
     Rqs_detalle.granel_ult AT ROW 2.43 COL 117 COLON-ALIGNED
          LABEL "Granel"
          VIEW-AS FILL-IN NATIVE 
          SIZE 14 BY .81
          BGCOLOR 15 FGCOLOR 9 
     Rqs_detalle.observacion AT ROW 3.43 COL 2 NO-LABEL
          VIEW-AS EDITOR SCROLLBAR-VERTICAL
          SIZE 131 BY 2.71
          BGCOLOR 15 FGCOLOR 8 
     RECT-3 AT ROW 1 COL 1
     " Cantidades y granel a entregar y observaciones de entrega" VIEW-AS TEXT
          SIZE 131 BY .81 AT ROW 1.29 COL 2
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: sic.Rqs_detalle,sic.Deposito,sic.Area,sic.Rqs_header,sic.Articulo
