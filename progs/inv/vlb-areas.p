...
/*=========================================================================================*/
/*                      VALIDACION DE BAJAS DE LA TABLA:Area                             */
/*=========================================================================================*/
...
PROCEDURE VALIDAR_BAJA:
  ...
  IF CAN-FIND(FIRST Contrato_hd WHERE Contrato_hd.nro_area = Area.nro_area) OR
     CAN-FIND(FIRST Copias_ocompra WHERE Copias_ocompra.nro_area = Area.nro_area) OR
