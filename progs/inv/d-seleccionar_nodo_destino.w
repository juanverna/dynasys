...
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH Clase_de_Articulo ~
      WHERE Clase_de_Articulo.cdg_claseart = que_clase ~
 AND Clase_de_Articulo.cdg_subclaseart <> que_subclase NO-LOCK INDEXED-REPOSITION
...
/* Query rebuild information for BROWSE BROWSE-1
 ...
 AND Clase_de_Articulo.cdg_subclaseart <> que_subclase"
  ...
  THEN DO:  
      ...
      THEN DO:  
          DO j = 1 TO {&BROWSE-NAME}:NUM-SELECTED-ROWS:
              ...
              ASSIGN p-que_destino = p-que_destino + CHR(1) + Clase_de_articulo.cdg_subclase.
         END.
...
v-origen = Clase_de_articulo.nombre_subclase.
