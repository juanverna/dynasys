...
&Scoped-define INTERNAL-TABLES Articulo-deposito

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH Articulo-deposito OF Articulo WHERE ~{&KEY-PHRASE} ~
      AND Articulo-deposito.nro_deposito = Deposito.nro_deposito ~
 AND Articulo-deposito.cdg_empresa = Empresa.cdg_empresa NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Articulo-deposito OF Articulo WHERE ~{&KEY-PHRASE} ~
      AND Articulo-deposito.nro_deposito = Deposito.nro_deposito ~
 AND Articulo-deposito.cdg_empresa = Empresa.cdg_empresa NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Articulo-deposito
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Articulo-deposito
...
nro_deposito||y|sic.Articulo-deposito.nro_deposito
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nro_articulo,nro_deposito"':U).
...
/* Settings for THIS-PROCEDURE
   Type: SmartQuery
   External Tables: sic.Articulo,sic.Deposito
   Allow: Basic,Query
   Frames: 1
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "sic.Articulo-deposito OF sic.Articulo"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "sic.Articulo-deposito.nro_deposito = Deposito.nro_deposito
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "nro_deposito" "Articulo-deposito" "nro_deposito"}
