...
DEFINE VARIABLE h_v-par-asninventario AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 4.50 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-par-asninventario.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-par-asninventario ).
       RUN set-position IN h_v-par-asninventario ( 8.81 , 13.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-par-asninventario ,
...
------------------------------------------------------------------------------*/
  ...
  RUN dar_rango IN h_v-par-asninventario (  OUTPUT  des_ptovta,
                                            OUTPUT  has_ptovta,
                                            OUTPUT  lista_tipos,
                                            OUTPUT  lis_fecha,
                                            OUTPUT  gen_asiento,
  ...
  THEN DO:
       ...
       RUN lsasninv.p ( INPUT des_fecha, 
                        INPUT has_fecha, 
                        INPUT des_ptovta,
                        INPUT has_ptovta,
                        INPUT lista_tipos,
