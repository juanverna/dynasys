...
ON END-ERROR OF W-Win /* Subdiario de Inventario */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Subdiario de Inventario */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 3.10 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-par-asnventas ( 7.57 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-que-expresion ( 13.62 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 18.05 , 13.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/INV" "Subdiario de Inventario"}
