...
DEFINE VARIABLE h_b-movimientos_stock AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b-movimientos_x_deposito AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b-movimientos_x_depypartida AS HANDLE NO-UNDO.
DEFINE VARIABLE h_b-movimientos_x_partida AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-que_articulo ( 1.00 , 28.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.67 , 103.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'En General|Por Depósito|Por Partida|Dep y Partida' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 2.91 , 28.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 23.57 , 127.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-movimientos_stock.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-movimientos_stock ).
       RUN set-position IN h_b-movimientos_stock ( 4.57 , 32.00 ) NO-ERROR.
       RUN set-size IN h_b-movimientos_stock ( 19.05 , 115.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-movimientos_stock. */
       RUN add-link IN adm-broker-hdl ( h_b-articulo , 'Record':U , h_b-movimientos_stock ).

    END. /* Page 1 */

    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-movimientos_x_deposito.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-movimientos_x_deposito ).
       RUN set-position IN h_b-movimientos_x_deposito ( 4.57 , 33.00 ) NO-ERROR.
       RUN set-size IN h_b-movimientos_x_deposito ( 19.05 , 115.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-movimientos_x_deposito. */
       RUN add-link IN adm-broker-hdl ( h_b-articulo , 'Record':U , h_b-movimientos_x_deposito ).

    END. /* Page 2 */

    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-movimientos_x_partida.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-movimientos_x_partida ).
       RUN set-position IN h_b-movimientos_x_partida ( 4.57 , 33.00 ) NO-ERROR.
       RUN set-size IN h_b-movimientos_x_partida ( 19.05 , 115.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-movimientos_x_partida. */
       RUN add-link IN adm-broker-hdl ( h_b-articulo , 'Record':U , h_b-movimientos_x_partida ).

    END. /* Page 3 */

    WHEN 4 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-movimientos_x_depypartida.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-movimientos_x_depypartida ).
       RUN set-position IN h_b-movimientos_x_depypartida ( 4.57 , 34.00 ) NO-ERROR.
       RUN set-size IN h_b-movimientos_x_depypartida ( 19.05 , 115.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-movimientos_x_depypartida. */
       RUN add-link IN adm-broker-hdl ( h_b-articulo , 'Record':U , h_b-movimientos_x_depypartida ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/INV" "Consulta de Movimientos de Articulos"}
