...
Area.n_copias Area.cdg_reporta 
...
Area.reporte Area.n_copias Area.cdg_reporta 
...
DEFINE FRAME F-Main
     Area.cdg_area AT ROW 1.52 COL 15 COLON-ALIGNED
          LABEL "Código"
          VIEW-AS FILL-IN NATIVE 
          SIZE 14 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Area.denominacion AT ROW 2.71 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 58 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Area.reporte AT ROW 4.05 COL 15 COLON-ALIGNED
          LABEL "E-mail" FORMAT "X(60)"
          VIEW-AS FILL-IN NATIVE 
          SIZE 58 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Area.n_copias AT ROW 5.29 COL 66 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 7 BY 1
          BGCOLOR 15 FGCOLOR 9 
     v_nro_entidad AT ROW 5.33 COL 15 COLON-ALIGNED HELP
          "Numero interno de la cuenta de acreditación de valores"
     v-dsc_entidad AT ROW 5.33 COL 26 COLON-ALIGNED NO-LABEL
     Area.cdg_reporta AT ROW 6.48 COL 15 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 46 BY 1
          BGCOLOR 15 FGCOLOR 9 
     btn_elegir AT ROW 6.48 COL 65
...
DO:
   DEFINE VARIABLE v-cdg_subclase LIKE Area.cdg_reporta.
   DEFINE VARIABLE puso_ok AS LOGICAL.
   
   RUN c-abmclasesector.w ( INPUT 4, /* MR_READONLY */
                            OUTPUT v-cdg_subclase , 
                            OUTPUT puso_ok ).
   IF puso_ok
   THEN DO:
       DISPLAY v-cdg_subclase @ Area.cdg_reporta
