...
DEFINE BUFFER B-Clase FOR Clase_de_Deposito.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 76 BY 19.1
...
DEFINE FRAME Dialog-Frame
     que_clase AT ROW 1.48 COL 83 COLON-ALIGNED NO-LABEL
     que_subclase AT ROW 1.52 COL 12 COLON-ALIGNED
     que_nombre AT ROW 1.52 COL 27 COLON-ALIGNED NO-LABEL
     brw_clasificacion AT ROW 2.67 COL 4
     camino AT ROW 2.67 COL 85 NO-LABEL
     Btn_Cancel AT ROW 20.29 COL 119
     Btn_OK AT ROW 20.33 COL 86
     RECT-1 AT ROW 20.05 COL 85
     SPACE(1.99) SKIP(0.32)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 4
         TITLE "Selección de Clasificación de Depósitos"
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: B-Clase B "?" ? sic Clase_de_Deposito
      TABLE: Clase B "?" ? sic Clase_de_Deposito
   END-TABLES.
 */
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB brw_clasificacion que_nombre Dialog-Frame */
ASSIGN 
...
"SUBSTRING(Clase.cdg_subclase,LENGTH(que_clase) + 2)" "Código!Subclase" "X(10)" ? ? ? ? ? ? ? no ? no no "21.2" yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.Clase.nombre_subclase
"Clase.nombre_subclase" "Denominacion!Subclase" "X(40)" "character" ? ? ? ? ? ? no ? no no "49.2" yes no no "U" "" ""
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Selección de Clasificación de Depósitos */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE que_subclase brw_clasificacion camino Btn_Cancel Btn_OK RECT-1 
      WITH FRAME Dialog-Frame.
