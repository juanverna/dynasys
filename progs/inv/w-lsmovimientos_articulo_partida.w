...
DEFINE FRAME F-Main
     v-estado AT ROW 19.52 COL 25 COLON-ALIGNED NO-LABEL
     "  Depósitos a considerar:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 8.62 COL 27
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Artículos a considerar:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 2.91 COL 27
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Listar movimientos del período:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 13.57 COL 27
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-deposito ( 9.67 , 27.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.86 , 100.00 ) */
       ...
       RUN set-position IN h_v-rng-fechas ( 14.67 , 27.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 20.86 , 27.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsmovimientos_articulo_partida.p ( INPUT des_codart, 
                                              INPUT has_codart, 
                                              INPUT des_nomart,
                                              INPUT has_nomart,
                                              INPUT ver_por,
