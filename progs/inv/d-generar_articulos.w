...
&THEN
DEFINE VARIABLE p-que_origen  AS CHARACTER INITIAL ".F.AH.20".   
...
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH Clase_de_Articulo ~
      WHERE Clase_de_Articulo.cdg_claseart  BEGINS que_clase NO-LOCK INDEXED-REPOSITION
...
&Scoped-Define ENABLED-OBJECTS Btn_OK Btn_Cancel v-cdg_articulo BROWSE-1 
&Scoped-Define DISPLAYED-OBJECTS v-origen v-cdg_articulo FILL-IN-2 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      Clase_de_Articulo.cdg_subclaseart FORMAT "X(25)":U
      Clase_de_Articulo.nombre_subclaseart FORMAT "X(40)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 102 BY 20.24 EXPANDABLE.
...
DEFINE FRAME Dialog-Frame
     ...
     FILL-IN-2 AT ROW 2.43 COL 32 COLON-ALIGNED NO-LABEL
     BROWSE-1 AT ROW 3.86 COL 3
...
/* SETTINGS FOR DIALOG-BOX Dialog-Frame
                                                                        */
/* BROWSE-TAB BROWSE-1 FILL-IN-2 Dialog-Frame */
ASSIGN 
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _Where[1]         = "Clase_de_Articulo.cdg_claseart  BEGINS que_clase"
  ...
  THEN DO:  
      ...
      THEN DO:  
          DO j = 1 TO {&BROWSE-NAME}:NUM-SELECTED-ROWS:
              ...
              FIND CURRENT Clase_de_articulo NO-LOCK.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-cdg_articulo Dialog-Frame
ON MOUSE-SELECT-DBLCLICK OF v-cdg_articulo IN FRAME Dialog-Frame /* Artículo Modelo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-cdg_articulo Dialog-Frame
ON RETURN OF v-cdg_articulo IN FRAME Dialog-Frame /* Artículo Modelo */
DO:
...
FIND Clase_de_articulo WHERE Clase_de_articulo.cdg_subclase = p-que_origen NO-LOCK.
que_clase = Clase_de_articulo.cdg_clase.
que_subclase = Clase_de_articulo.cdg_subclase.
v-origen = Clase_de_articulo.cdg_clase.
...
------------------------------------------------------------------------------*/
  DISPLAY v-origen v-cdg_articulo FILL-IN-2 
      WITH FRAME Dialog-Frame.
  ENABLE Btn_OK Btn_Cancel v-cdg_articulo BROWSE-1 
      WITH FRAME Dialog-Frame.
