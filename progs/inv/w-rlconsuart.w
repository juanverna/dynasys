...
DEFINE FRAME F-Main
     ...
     "  Artículos a considerar:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 1.95 COL 13
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
ON END-ERROR OF W-Win /* Consumos por Artículo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Consumos por Artículo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-entidad ( 7.67 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 12.24 , 13.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/INV" "Consumos por Artículo"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsconsuart.p ( INPUT des_codart, 
                          INPUT has_codart, 
                          INPUT des_nomart,
                          INPUT has_nomart,
                          INPUT ver_por,
