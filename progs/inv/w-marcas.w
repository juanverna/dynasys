...
DEFINE VARIABLE h_b-marcas AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-marca AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-marcas ).
       RUN set-position IN h_b-marcas ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-marcas ( 19.14 , 15.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-marca ).
       RUN set-position IN h_v-marca ( 1.00 , 19.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.05 , 52.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 5.33 , 19.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 8.33 , 52.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-marca. */
       RUN add-link IN adm-broker-hdl ( h_b-marcas , 'Record':U , h_v-marca ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-marca ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-marca ,
             h_b-marcas , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/ABA" "Mantenimiento de Marcas Comerciales"}
