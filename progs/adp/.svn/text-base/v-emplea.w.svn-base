...
&Scoped-define FIELD-PAIRS~
 ~{&FP1}nro_legajo ~{&FP2}nro_legajo ~{&FP3}~
...
DEFINE FRAME F-Main
     Empleado.nro_legajo AT ROW 2 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8.56 BY .75
          BGCOLOR 15 FGCOLOR 9 
     Empleado.nombre AT ROW 3 COL 19 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 36.67 BY .75
          BGCOLOR 15 FGCOLOR 9 
     RECT-1 AT ROW 1.53 COL 2
