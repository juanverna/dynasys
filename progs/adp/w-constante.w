...
DEFINE VARIABLE h_b-constante AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-constante AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adp/b-constante.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-constante ).
       RUN set-position IN h_b-constante ( 3.62 , 11.00 ) NO-ERROR.
       RUN set-size IN h_b-constante ( 13.10 , 9.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adp/v-constante.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-constante ).
       RUN set-position IN h_v-constante ( 3.62 , 33.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.48 , 78.40 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 15.05 , 33.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 1.76 , 78.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-constante. */
       RUN add-link IN adm-broker-hdl ( h_b-constante , 'Record':U , h_v-constante ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-constante ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-constante ,
             h_b-constante , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-constante , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/ADP" "Mantenimiento de Constantes de Liquidación -"}
