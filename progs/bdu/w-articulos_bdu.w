...
DEFINE VARIABLE h_v-articulo_otrosdatos AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_b-articulo ( 24.29 , 22.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-articulo ).
       RUN set-position IN h_v-articulo ( 1.00 , 31.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.05 , 118.00 ) */
       ...
       RUN set-position IN h_p-soloedita ( 21.00 , 73.00 ) NO-ERROR.
       RUN set-size IN h_p-soloedita ( 3.10 , 76.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-articulo_otrosdatos.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-articulo_otrosdatos ).
       RUN set-position IN h_v-articulo_otrosdatos ( 22.19 , 31.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.91 , 39.00 ) */

       /* Links to SmartViewer h_v-articulo. */
       RUN add-link IN adm-broker-hdl ( h_b-articulo , 'Record':U , h_v-articulo ).

       /* Links to SmartViewer h_v-articulo_otrosdatos. */
       RUN add-link IN adm-broker-hdl ( h_p-soloedita , 'TableIO':U , h_v-articulo_otrosdatos ).
       RUN add-link IN adm-broker-hdl ( h_v-articulo , 'Record':U , h_v-articulo_otrosdatos ).
