...
DEFINE FRAME F-Main
     v-estado AT ROW 20.52 COL 29 COLON-ALIGNED NO-LABEL
     "  Rango de los artículos de las solicitudes a listar:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 3.86 COL 31
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de fechas de Solicitudes:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 15.29 COL 31
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de destinatarios de Solicitudes:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 9.57 COL 31
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Solicitudes de retiro por artículo"
         HEIGHT             = 27.38
         WIDTH              = 160
         MAX-HEIGHT         = 27.67
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Solicitudes de retiro por artículo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Solicitudes de retiro por artículo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-articulo ( 5.05 , 31.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-destinatario ( 10.76 , 31.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.86 , 100.00 ) */
       ...
       RUN set-position IN h_v-rng-fechas ( 16.43 , 31.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 21.95 , 31.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/BDU" "Listado de Solicitudes de retiro por artículo"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE des_articulo     AS CHARACTER.
  DEFINE VARIABLE has_articulo     AS CHARACTER.
  ...
  RUN dar_rango IN h_v-rng-articulo ( OUTPUT des_articulo, 
                                      OUTPUT has_articulo, 
                                      OUTPUT des_nombre, 
                                      OUTPUT has_nombre, 
                                      OUTPUT ver_por,
  ...
  THEN DO:
       ...
       RUN lssolicitudes_xarticulos.p ( INPUT des_articulo,
                                        INPUT has_articulo,
                                        INPUT des_destinatario,
