...
&Scoped-define INTERNAL-TABLES Transportista

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Transportista.cdg_transportista 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH Transportista WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Transportista WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table Transportista
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Transportista
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Transportista.cdg_transportista FORMAT "X(8)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "sic.Transportista"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = sic.Transportista.cdg_transportista
...
DO:
  ...
  &SCOPED-DEFINE ROWID_TABLA        rid_motivo
  &SCOPED-DEFINE SELECCION          SELTRANS.P
  &SCOPED-DEFINE TABLA              Transportista
  &SCOPED-DEFINE CDG_TABLA          cdg_Transportista
  &SCOPED-DEFINE DSC_TABLA          dsc_Transportista
...
DO:
  ...
  &SCOPED-DEFINE CODIGO cdg_Transportista
