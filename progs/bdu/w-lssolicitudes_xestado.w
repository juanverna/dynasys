...
DEFINE VARIABLE h_v-rng-destinatario AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     TOGGLE-1 AT ROW 3.38 COL 34
     TOGGLE-2 AT ROW 4.33 COL 34
     TOGGLE-3 AT ROW 5.29 COL 34
     TOGGLE-4 AT ROW 6.24 COL 34
     TOGGLE-5 AT ROW 7.19 COL 34
     TOGGLE-6 AT ROW 8.14 COL 34
     TOGGLE-7 AT ROW 9.1 COL 34
     TOGGLE-8 AT ROW 10.05 COL 34
     TOGGLE-9 AT ROW 11 COL 34
     v-estado AT ROW 23.14 COL 29 COLON-ALIGNED NO-LABEL
     RECT-2 AT ROW 3.14 COL 31
     "  Estados de los articulos a listar:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 1.95 COL 31
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de fechas de Solicitudes:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 18.14 COL 31
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de destinatarios de Solicitudes:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 13.14 COL 31
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
ON END-ERROR OF W-Win /* Estados de las Solicitudes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Estados de las Solicitudes */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-rng-destinatario.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng-destinatario ).
       RUN set-position IN h_v-rng-destinatario ( 14.33 , 31.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 19.33 , 31.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 24.57 , 31.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.62 , 100.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-rng-destinatario ,
             TOGGLE-9:HANDLE IN FRAME F-Main , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-rng-fechas ,
             h_v-rng-destinatario , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/BDU" "Listado de Solicitudes de retiro por estados"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE des_destinatario AS CHARACTER.
  DEFINE VARIABLE has_destinatario AS CHARACTER.
  ...
  RUN dar_rango IN h_v-rng-destinatario ( OUTPUT des_destinatario, 
                                          OUTPUT has_destinatario, 
                                          OUTPUT error_rango ).
  IF error_rango 
  THEN DO:
       RUN ver-error-rango ( "Destinatarios" ).
       hay_error = error_rango.
  END.     
  ...
  THEN DO:
       ...
       RUN lssolicitudes_xestado.p ( INPUT des_destinatario,
                                     INPUT has_destinatario,
                                     INPUT lista_estados,
                                     INPUT des_fecha,
                                     INPUT has_fecha
                                    ).
