...
&Scoped-define OPEN-QUERY-BROWSE-2        OPEN QUERY {&SELF-NAME}             FOR EACH Empleado                           WHERE empleado.cdg_empresa = que_empresa.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 52 BY 11.14
         BGCOLOR 15 FGCOLOR 9 
         TITLE BGCOLOR 15 FGCOLOR 9 "Seleccione un empleado".
...
DEFINE FRAME D-Dialog
     ...
     Btn_OK AT ROW 14.1 COL 11
     Btn_Cancel AT ROW 14.1 COL 30
     RECT-10 AT ROW 1.29 COL 2
     SPACE(5.99) SKIP(0.32)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Seleccion de Empleado"
...
/* Query rebuild information for BROWSE BROWSE-2
     _START_FREEFORM
      ...
      OPEN QUERY {&SELF-NAME}
           ...
           FOR EACH Empleado
                          WHERE empleado.cdg_empresa = que_empresa.
     _END_FREEFORM
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME D-Dialog /* Seleccion de Empleado */
DO:  
...
ON MOUSE-SELECT-DBLCLICK OF BROWSE-2 IN FRAME D-Dialog /* Seleccione un empleado */
