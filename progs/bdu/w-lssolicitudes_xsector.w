...
DEFINE FRAME F-Main
     TOGGLE-1 AT ROW 8.38 COL 34
     TOGGLE-2 AT ROW 9.33 COL 34
     TOGGLE-3 AT ROW 10.29 COL 34
     TOGGLE-4 AT ROW 11.24 COL 34
     TOGGLE-5 AT ROW 12.19 COL 34
     TOGGLE-6 AT ROW 13.14 COL 34
     TOGGLE-7 AT ROW 14.1 COL 34
     TOGGLE-8 AT ROW 15.05 COL 34
     TOGGLE-9 AT ROW 16 COL 34
     v-estado AT ROW 23.14 COL 29 COLON-ALIGNED NO-LABEL
     RECT-2 AT ROW 8.14 COL 31
     ...
     "  Estados de los articulos a listar:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 6.95 COL 31
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Solicitudes de retiro por sector"
         HEIGHT             = 27.33
         WIDTH              = 160
         MAX-HEIGHT         = 27.67
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Solicitudes de retiro por sector */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Solicitudes de retiro por sector */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-sector ( 3.14 , 31.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 19.10 , 31.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/BDU" "Listado de Solicitudes de retiro por sector"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lssolicitudes_xsector.p ( INPUT des_sector,
                                     INPUT has_sector,
                                     INPUT lista_estados,
                                     INPUT des_fecha,
                                     INPUT has_fecha
