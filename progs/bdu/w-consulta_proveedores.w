...
ON END-ERROR OF W-Win /* Consulta de Proveedores */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Consulta de Proveedores */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Consulta de Proveedores */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_b-proveedores ( 1.95 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-proveedores ( 24.76 , 18.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_v-proveedor ( 1.95 , 25.00 ) NO-ERROR.
       /* Size in UIB:  ( 21.91 , 129.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXP" "Consulta de Proveedores"}
