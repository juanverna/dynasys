...
&Scoped-define INTERNAL-TABLES Destinatario

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Destinatario.cdg_destinatario 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Destinatario WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table Destinatario
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Destinatario
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Destinatario.cdg_destinatario FORMAT "X(8)":U WIDTH 13.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 18 BY 21.43
...
ASSIGN 
       Destinatario.cdg_destinatario:AUTO-RESIZE IN BROWSE br_table = TRUE.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "sic.Destinatario"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > sic.Destinatario.cdg_destinatario
"Destinatario.cdg_destinatario" ? ? "character" ? ? ? ? ? ? no ? no no "13.2" yes yes no "U" "" ""
...
DO:
  ...
  &SCOPED-DEFINE CODIGO cdg_destinatario
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "Destinatario"}
