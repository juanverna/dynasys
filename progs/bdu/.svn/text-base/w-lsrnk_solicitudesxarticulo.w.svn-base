...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Ranking de artículos con detalle de solicitudes"
         HEIGHT             = 27.33
         WIDTH              = 160
         MAX-HEIGHT         = 34.24
         MAX-WIDTH          = 204.8
...
ON END-ERROR OF W-Win /* Ranking de artículos con detalle de solicitudes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Ranking de artículos con detalle de solicitudes */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/BDU" "Ranking de Artículos con Detalle de Solicitudes"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsrnk_solicitudesxarticulos.p ( INPUT des_articulo,
                                           INPUT has_articulo,
                                           INPUT des_fecha,
                                           INPUT has_fecha
                                          ).
