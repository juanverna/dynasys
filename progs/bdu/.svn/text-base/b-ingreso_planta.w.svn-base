...
&Scoped-define INTERNAL-TABLES Ingresoaplanta
...
&Scoped-define QUERY-STRING-br_table FOR EACH Ingresoaplanta WHERE ~{&KEY-PHRASE} NO-LOCK ~
    BY Ingresoaplanta.num_ingreso DESCENDING
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Ingresoaplanta WHERE ~{&KEY-PHRASE} NO-LOCK ~
    BY Ingresoaplanta.num_ingreso DESCENDING.
&Scoped-define TABLES-IN-QUERY-br_table Ingresoaplanta
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 15 BY 21.43
...
/* Query rebuild information for BROWSE br_table
     ...
     _OrdList          = "sic.Ingresoaplanta.num_ingreso|no"
