...
&Scoped-Define ENABLED-OBJECTS TOGGLE-1 TOGGLE-2 TOGGLE-3 TOGGLE-4 TOGGLE-5 ~
TOGGLE-6 TOGGLE-7 TOGGLE-8 TOGGLE-9 RECT-2 
&Scoped-Define DISPLAYED-OBJECTS TOGGLE-1 TOGGLE-2 TOGGLE-3 TOGGLE-4 ~
TOGGLE-5 TOGGLE-6 TOGGLE-7 TOGGLE-8 TOGGLE-9 v-estado 
...
DEFINE VARIABLE h_v-rng-sector AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     TOGGLE-1 AT ROW 7.91 COL 34
     TOGGLE-2 AT ROW 8.86 COL 34
     TOGGLE-3 AT ROW 9.81 COL 34
     TOGGLE-4 AT ROW 10.76 COL 34
     TOGGLE-5 AT ROW 11.71 COL 34
     TOGGLE-6 AT ROW 12.67 COL 34
     TOGGLE-7 AT ROW 13.62 COL 34
     TOGGLE-8 AT ROW 14.57 COL 34
     TOGGLE-9 AT ROW 15.52 COL 34
     v-estado AT ROW 22.19 COL 29 COLON-ALIGNED NO-LABEL
     RECT-2 AT ROW 7.67 COL 31
     "  Rango de los sectores de las solicitudes a listar:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 1.71 COL 31
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Rango de fechas de Solicitudes:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 17.91 COL 31
          BGCOLOR 5 FGCOLOR 15 FONT 6
     "  Estados de los articulos a listar:" VIEW-AS TEXT
          SIZE 100 BY .81 AT ROW 6.48 COL 31
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Ranking de sectores con detalle de solicitudes"
         HEIGHT             = 27.33
         WIDTH              = 160
         MAX-HEIGHT         = 34.24
         MAX-WIDTH          = 204.8
...
ON END-ERROR OF W-Win /* Ranking de sectores con detalle de solicitudes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Ranking de sectores con detalle de solicitudes */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-rng-sector.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng-sector ).
       RUN set-position IN h_v-rng-sector ( 2.91 , 31.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 19.05 , 31.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 23.62 , 31.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.62 , 100.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-rng-sector ,
             TOGGLE-1:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-rng-fechas ,
             TOGGLE-9:HANDLE IN FRAME F-Main , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/BDU" "Ranking de Sectores con Detalle de Solicitudes"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE des_sector      AS CHARACTER.
  DEFINE VARIABLE has_sector      AS CHARACTER.
  ...
  RUN dar_rango IN h_v-rng-sector ( OUTPUT des_sector, 
                                    OUTPUT has_sector,
                                    OUTPUT error_rango ).
  IF error_rango 
  THEN DO:
  ...
  THEN DO:
       ...
       RUN lsrnk_solicitudesxsector.p ( INPUT des_sector,
                                        INPUT has_sector,
                                        INPUT lista_estados,
                                        INPUT des_fecha,
                                        INPUT has_fecha
