...
Articulo.descripcion Sre_detalle.cantidad Sre_detalle.granel 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      Articulo.descripcion FORMAT "X(40)":U WIDTH 61.2
      Sre_detalle.cantidad COLUMN-LABEL "Cantidad" FORMAT "->,>>>,>>9.99":U
            WIDTH 16.2
      Sre_detalle.granel FORMAT "->>,>>9.99":U WIDTH 15.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 119 BY 10.24
...
"Articulo.descripcion" ? ? "character" ? ? ? ? ? ? no ? no no "61.2" yes no no "U" "" ""
     _FldNameList[3]   > sic.Sre_detalle.cantidad
"Sre_detalle.cantidad" "Cantidad" ? "decimal" ? ? ? ? ? ? no ? no no "16.2" yes no no "U" "" ""
     _FldNameList[4]   > sic.Sre_detalle.granel
"Sre_detalle.granel" ? ? "decimal" ? ? ? ? ? ? no ? no no "15.2" yes no no "U" "" ""
