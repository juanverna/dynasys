...
&Scoped-define INTERNAL-TABLES Motivo_retiro

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Motivo_retiro.cdg_motivo_retiro 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Motivo_retiro WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table Motivo_retiro
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Motivo_retiro
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Motivo_retiro.cdg_motivo_retiro FORMAT "X(4)":U WIDTH 13.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "sic.Motivo_retiro"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > sic.Motivo_retiro.cdg_motivo_retiro
"Motivo_retiro.cdg_motivo_retiro" ? ? "character" ? ? ? ? ? ? no ? no no "13.2" yes no no "U" "" ""
...
DO:
  ...
  &SCOPED-DEFINE SELECCION          SELMOTIV.P
...
DO:
  ...
  &SCOPED-DEFINE CODIGO cdg_motivo_retiro
