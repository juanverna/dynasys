...
DEFINE VARIABLE v-estado AS LOGICAL.
...
&Scoped-define INTERNAL-TABLES Regreso_solicitud

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table Regreso_solicitud.fecha_retorno 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Regreso_solicitud OF Sre_detalle WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table Regreso_solicitud
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Regreso_solicitud
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Regreso_solicitud.fecha_retorno COLUMN-LABEL "Fecha de!Regreso" FORMAT "99/99/9999":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 17 BY 16.19.
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "sic.Regreso_solicitud OF sic.Sre_detalle"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > sic.Regreso_solicitud.fecha_retorno
"Regreso_solicitud.fecha_retorno" "Fecha de!Regreso" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE actualizar-browse B-table-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE actualizar-estado B-table-Win 
