...
&Scoped-Define ENABLED-OBJECTS BUTTON-1 btn_aprobar btn_rechazar v-codigo ~
br_table RECT-3 
...
DEFINE BUTTON BUTTON-1 
     LABEL "&Cumplimiento de Solicitud" 
     SIZE 28.4 BY 1.14.
...
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 119 BY 7.38
         ...
         TITLE BGCOLOR 11 FGCOLOR 9 "Ingresos a Plata Pendientes de Aprobar o Rechazar" EXPANDABLE.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME F-Main
     BUTTON-1 AT ROW 1.24 COL 41
...
ON ROW-ENTRY OF br_table IN FRAME F-Main /* Ingresos a Plata Pendientes de Aprobar o Rechazar */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON ROW-LEAVE OF br_table IN FRAME F-Main /* Ingresos a Plata Pendientes de Aprobar o Rechazar */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_table B-table-Win
ON VALUE-CHANGED OF br_table IN FRAME F-Main /* Ingresos a Plata Pendientes de Aprobar o Rechazar */
DO:
...
ON CHOOSE OF BUTTON-1 IN FRAME F-Main /* Cumplimiento de Solicitud */
DO:
  RUN w-cumplimiento_solicitud.w.
END.
