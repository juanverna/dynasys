...
DEFINE FRAME F-Main
     ...
     "  Rango de los destinatarios de las solicitudes a listar:" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Ranking de destinatarios con detalle de solicitudes"
         HEIGHT             = 27.33
         WIDTH              = 160
         MAX-HEIGHT         = 34.24
         MAX-WIDTH          = 204.8
...
ON END-ERROR OF W-Win /* Ranking de destinatarios con detalle de solicitudes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Ranking de destinatarios con detalle de solicitudes */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-destinatario ( 5.05 , 31.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 10.71 , 31.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/BDU" "Ranking de Destinatarios con Detalle de Solicitudes"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsrnk_solicitudesxdestinatario.p ( INPUT des_destinatario,
