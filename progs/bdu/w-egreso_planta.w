...
DEFINE VARIABLE h_b-ingresos_por_egresar AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Registrar Egresos de Planta de Descargas Rechazadas"
         HEIGHT             = 26.76
         WIDTH              = 160
         MAX-HEIGHT         = 33.29
         MAX-WIDTH          = 204.8
...
ON END-ERROR OF W-Win /* Registrar Egresos de Planta de Descargas Rechazadas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Registrar Egresos de Planta de Descargas Rechazadas */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-ingresos_por_egresar.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-ingresos_por_egresar ).
       RUN set-position IN h_b-ingresos_por_egresar ( 2.19 , 19.00 ) NO-ERROR.
       RUN set-size IN h_b-ingresos_por_egresar ( 24.76 , 123.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/BDU" "Registrar Egresos de Planta de Descargas Rechazadas"}.
