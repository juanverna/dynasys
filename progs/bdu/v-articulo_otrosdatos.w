...
&Scoped-Define ENABLED-FIELDS Articulo.es_registrable 
&Scoped-define ENABLED-TABLES Articulo
&Scoped-define FIRST-ENABLED-TABLE Articulo
&Scoped-Define ENABLED-OBJECTS RECT-1 
&Scoped-Define DISPLAYED-OBJECTS modo_etiquetas 
...
RUN set-attribute-list (
    'Keys-Accepted = "cdg_articulo,nro_articulo",
     Keys-Supplied = "cdg_articulo,nro_articulo,descripcion,cdg_envases,cdg_estado,nro_familia,nro_familimpos,cdg_grupoabasto,cdg_marcacom,cdg_tipoart,cdg_umed,nro_usuario"':U).
/**************************
</EXECUTING-CODE> */
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE VARIABLE modo_etiquetas AS CHARACTER 
...
DEFINE FRAME F-Main
     modo_etiquetas AT ROW 1.24 COL 4 NO-LABEL
     Articulo.es_registrable AT ROW 1.48 COL 17
          LABEL "campo_invisible"
          VIEW-AS TOGGLE-BOX
...
/* SETTINGS FOR TOGGLE-BOX Articulo.es_registrable IN FRAME F-Main
   NO-DISPLAY EXP-LABEL                                                 */
ASSIGN 
       Articulo.es_registrable:HIDDEN IN FRAME F-Main           = TRUE.

/* SETTINGS FOR RADIO-SET modo_etiquetas IN FRAME F-Main
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
      Articulo.modo_etiquetas = modo_etiquetas:SCREEN-VALUE IN FRAME {&FRAME-NAME}.
...
------------------------------------------------------------------------------*/
  ...
  modo_etiquetas:SENSITIVE IN FRAME {&FRAME-NAME} = NO.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE Articulo THEN
        modo_etiquetas:SCREEN-VALUE IN FRAME {&FRAME-NAME} = Articulo.modo_etiquetas.
...
------------------------------------------------------------------------------*/
  ...
  modo_etiquetas:SENSITIVE IN FRAME {&FRAME-NAME} = YES.
