...
v-cdg_cobrador t-Cambio Tnovencidos BROWSE-1 b-acepta b-cancela b-lista ~
b-ninguno B-TODO 
...
v-proxcob h_desde h_hasta h_Duracion t-Cambio Tnovencidos 
...
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 144 BY 21.67
         BGCOLOR 15 FGCOLOR 9 FONT 6 NO-EMPTY-SPACE.
...
DEFINE FRAME fMain
     ...
     b-acepta AT ROW 1.48 COL 133 WIDGET-ID 8
...
/* SETTINGS FOR FRAME fMain
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-1 Tnovencidos fMain */
...
------------------------------------------------------------------------------*/
  DISPLAY v-Pendiente v-importependiente v-hat v-cdg_administrador 
          ...
          h_hasta h_Duracion t-Cambio Tnovencidos 
      WITH FRAME fMain IN WINDOW wWin.
  IF AVAILABLE T-Rendicion_hd THEN 
    DISPLAY T-Rendicion_hd.cant_recibos T-Rendicion_hd.imp_imputado 
      WITH FRAME fMain IN WINDOW wWin.
  ENABLE RECT-4 RECT-7 v-cdg_administrador v-cdg_cobrador t-Cambio Tnovencidos 
         BROWSE-1 b-acepta b-cancela b-lista b-ninguno B-TODO 
      WITH FRAME fMain IN WINDOW wWin.
...
DEFINE VAR i AS INT NO-UNDO.
 ...
 FOR EACH Cta_cte NO-LOCK
                ...
                IF NOT CAN-DO( "F*,DA,DB,DC,CA,CB,CC,DR,CR" , cta_cte.tip_comprob ) THEN NEXT.
