...
DEFINE VARIABLE                p-cdg_comprobante  AS CHARACTER INITIAL "CREDITCLI".
&ELSE
...
DEFINE VARIABLE v-cdg_punto-venta-org           AS INTEGER.
...
DEFINE BUFFER bfac_detalle FOR fac_detalle.
DEFINE TEMP-TABLE afac
    FIELD rid AS ROWID.
...
T-Fac_detalle.cantidad T-Fac_detalle.precio T-Fac_detalle.subtotal_neto ~
...
T-Fac_header.nombre T-Fac_header.nombre_leg T-Fac_header.direccion ~
T-Fac_header.direccion_leg T-Fac_header.cdg_postal T-Fac_header.localidad ~
T-Fac_header.cdg_postal_leg T-Fac_header.localidad_leg ~
T-Fac_header.cdg_provincia T-Fac_header.cdg_provincia_leg T-Fac_header.cuit ~
T-Fac_header.Cod_docu T-Fac_header.cdg_imputacion T-Fac_header.leyenda_cc ~
T-Fac_header.nro_contrato T-Fac_header.imp_neto T-Fac_header.imp_total ~
T-Fac_header.cai T-Fac_header.rige_hasta 
...
T-Fac_header.cdg_provincia T-Fac_header.cdg_provincia_leg T-Fac_header.cuit ~
T-Fac_header.Cod_docu T-Fac_header.cdg_imputacion T-Fac_header.leyenda_cc ~
T-Fac_header.nro_contrato T-Fac_header.imp_total T-Fac_header.cai ~
T-Fac_header.rige_hasta 
...
T-Fac_header.nro_comprob T-Fac_header.fecha T-Fac_header.nombre ~
T-Fac_header.nombre_leg T-Fac_header.direccion T-Fac_header.direccion_leg ~
T-Fac_header.cdg_postal T-Fac_header.localidad T-Fac_header.cdg_postal_leg ~
T-Fac_header.localidad_leg T-Fac_header.cdg_provincia ~
T-Fac_header.cdg_provincia_leg T-Fac_header.cuit T-Fac_header.Cod_docu ~
T-Fac_header.cdg_imputacion T-Fac_header.leyenda_cc ~
T-Fac_header.nro_contrato T-Fac_header.imp_total T-Fac_header.cai ~
T-Fac_header.rige_hasta 
...
BUTTON-1 b-verrem bVer BROWSE-1 
...
&Scoped-Define DISPLAYED-OBJECTS v-comprobante v-pago v-cdg_punto-venta ~
v-anulado v-cdg_cliente v-cdg_condicion_venta v-dsc_condicion_venta ~
v-cdg_vendedor v-dsc_vendedor v-tip_remito v-prf_remito v-nro_remito ~
...
DEFINE BUTTON b-verrem 
     IMAGE-UP FILE "iconos21/view.jpg":U
     IMAGE-INSENSITIVE FILE "iconos21i/view.jpg":U
     LABEL "Ver" 
     SIZE 5 BY 1.

DEFINE BUTTON btn_anular 
     IMAGE-UP FILE "iconos24/delete2.jpg":U
     IMAGE-INSENSITIVE FILE "iconos24i/delete2.jpg":U
     LABEL "&Anular" 
     SIZE 15 BY 1.43.

DEFINE BUTTON btn_cancel 
     IMAGE-UP FILE "iconos24/undo.jpg":U
     IMAGE-INSENSITIVE FILE "iconos24i/undo.jpg":U
     LABEL "&Cancelar" 
     SIZE 15 BY 1.43.
...
DEFINE VARIABLE v-cdg_punto-venta AS INTEGER FORMAT "9999":U INITIAL 0 
     VIEW-AS FILL-IN NATIVE 
     SIZE 8 BY 1
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 C-Win _STRUCTURED
  QUERY BROWSE-1 NO-LOCK DISPLAY
      Articulo.cdg_articulo FORMAT "X(4)":U WIDTH 10.2
      T-Fac_detalle.cantidad FORMAT ">>9.99":U
      T-Fac_detalle.precio FORMAT "->>>>>>9.9999":U
      T-Fac_detalle.subtotal_neto FORMAT "->,>>>,>>>,>>9.99":U
      T-Fac_detalle.detallada COLUMN-LABEL "Descripcion!Detallada" FORMAT "X(200)":U
            WIDTH 91.4
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 156 BY 10.71
         BGCOLOR 15 FGCOLOR 9 FONT 4 ROW-HEIGHT-CHARS .52 FIT-LAST-COLUMN.
...
DEFINE FRAME DEFAULT-FRAME
     ...
     btn_cancel AT ROW 1.48 COL 20
     btn_anular AT ROW 1.48 COL 36
     btn_observ AT ROW 1.48 COL 52
     v-comprobante AT ROW 1.48 COL 69 COLON-ALIGNED NO-LABEL
     v-pago AT ROW 1.48 COL 119 COLON-ALIGNED NO-LABEL WIDGET-ID 52
     Btn_salir AT ROW 1.48 COL 140
     T-Fac_header.tip_comprob AT ROW 3.62 COL 13 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 5 BY 1
          BGCOLOR 7 FGCOLOR 15 
     v-cdg_punto-venta AT ROW 3.62 COL 18 COLON-ALIGNED NO-LABEL
     T-Fac_header.nro_comprob AT ROW 3.62 COL 27 COLON-ALIGNED NO-LABEL FORMAT ">>>>>>>9"
          VIEW-AS FILL-IN NATIVE 
          SIZE 13 BY 1
          BGCOLOR 7 FGCOLOR 15 
     v-anulado AT ROW 3.62 COL 41 COLON-ALIGNED NO-LABEL
     btn_contador AT ROW 3.62 COL 60
     T-Fac_header.fecha AT ROW 3.62 COL 72 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 16 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_header.cta_cte AT ROW 3.62 COL 127 COLON-ALIGNED
          LABEL "Pago"
          ...
          SIZE 29 BY 1
          BGCOLOR 15 FGCOLOR 9 
     BUTTON-1 AT ROW 4.86 COL 146 WIDGET-ID 46
     v-cdg_cliente AT ROW 6 COL 13 COLON-ALIGNED
     T-Fac_header.nombre AT ROW 6 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 28
          VIEW-AS FILL-IN NATIVE 
          SIZE 57 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_header.nombre_leg AT ROW 6 COL 85 COLON-ALIGNED NO-LABEL WIDGET-ID 30
          VIEW-AS FILL-IN NATIVE 
          SIZE 71 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_header.direccion AT ROW 7.19 COL 35 COLON-ALIGNED WIDGET-ID 20
          VIEW-AS FILL-IN NATIVE 
          SIZE 71 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_header.direccion_leg AT ROW 7.19 COL 85 COLON-ALIGNED NO-LABEL WIDGET-ID 22
          VIEW-AS FILL-IN NATIVE 
          SIZE 71 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_header.cdg_postal AT ROW 8.38 COL 13 COLON-ALIGNED WIDGET-ID 12
          LABEL "C. Postal"
          VIEW-AS FILL-IN NATIVE 
          SIZE 13 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_header.localidad AT ROW 8.38 COL 41 COLON-ALIGNED WIDGET-ID 24
          VIEW-AS FILL-IN NATIVE 
          SIZE 43 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_header.cdg_postal_leg AT ROW 8.38 COL 85 COLON-ALIGNED NO-LABEL WIDGET-ID 14
          VIEW-AS FILL-IN NATIVE 
          SIZE 13.6 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_header.localidad_leg AT ROW 8.38 COL 113 COLON-ALIGNED WIDGET-ID 26
          VIEW-AS FILL-IN NATIVE 
          SIZE 43 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_header.cdg_provincia AT ROW 9.57 COL 13 COLON-ALIGNED WIDGET-ID 32
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEM-PAIRS "Item 1","Item 1"
          DROP-DOWN-LIST
          SIZE 71 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_header.cdg_provincia_leg AT ROW 9.57 COL 85 COLON-ALIGNED NO-LABEL WIDGET-ID 34
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEM-PAIRS "Item 1","Item 1"
          DROP-DOWN-LIST
          SIZE 71 BY 1
...
DEFINE FRAME DEFAULT-FRAME
     v-cdg_condicion_venta AT ROW 10.76 COL 13 COLON-ALIGNED
     v-dsc_condicion_venta AT ROW 10.76 COL 27 COLON-ALIGNED NO-LABEL
     T-Fac_header.cuit AT ROW 11.86 COL 29.6 COLON-ALIGNED NO-LABEL WIDGET-ID 48
          VIEW-AS FILL-IN NATIVE 
          SIZE 18.8 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_header.Cod_docu AT ROW 11.95 COL 13 COLON-ALIGNED WIDGET-ID 54
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "Item 1" 
          DROP-DOWN-LIST
          SIZE 16 BY 1 TOOLTIP "Elija un tipo"
          BGCOLOR 15 FGCOLOR 9 
     T-Fac_header.cdg_imputacion AT ROW 11.95 COL 58 COLON-ALIGNED
          LABEL "Conc."
          VIEW-AS COMBO-BOX INNER-LINES 5
     ...
     T-Fac_header.leyenda_cc AT ROW 11.95 COL 85 COLON-ALIGNED NO-LABEL WIDGET-ID 38
          VIEW-AS FILL-IN NATIVE 
          SIZE 71 BY 1
          BGCOLOR 15 FGCOLOR 9 
     v-cdg_vendedor AT ROW 13.14 COL 13 COLON-ALIGNED
     v-dsc_vendedor AT ROW 13.14 COL 27 COLON-ALIGNED NO-LABEL
     v-tip_remito AT ROW 13.14 COL 93.4 COLON-ALIGNED
     v-prf_remito AT ROW 13.14 COL 101.4 COLON-ALIGNED NO-LABEL
     v-nro_remito AT ROW 13.14 COL 109.4 COLON-ALIGNED NO-LABEL
     b-verrem AT ROW 13.14 COL 123 WIDGET-ID 50
     T-Fac_header.nro_contrato AT ROW 13.14 COL 145 COLON-ALIGNED WIDGET-ID 10
          LABEL "Contrato"
          VIEW-AS FILL-IN NATIVE 
          SIZE 11 BY 1
          BGCOLOR 15 FGCOLOR 9 
     v-cdg_administrador AT ROW 14.33 COL 13 COLON-ALIGNED WIDGET-ID 2
     bVer AT ROW 14.33 COL 29 WIDGET-ID 6
     v-dsc_administrador AT ROW 14.33 COL 33 COLON-ALIGNED HELP
     ...
     T-Fac_header.imp_total AT ROW 16.24 COL 135 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 21 BY 1
          BGCOLOR 7 FGCOLOR 14 
     BROWSE-1 AT ROW 17.67 COL 3
     T-Fac_header.cai AT ROW 14.48 COL 95.8 COLON-ALIGNED WIDGET-ID 56
          LABEL "CAI/CAE"
           VIEW-AS TEXT 
          SIZE 27 BY .62
     T-Fac_header.rige_hasta AT ROW 14.48 COL 131.8 COLON-ALIGNED WIDGET-ID 58
          LABEL "Valido"
           VIEW-AS TEXT 
          SIZE 16 BY .62
     "      Datos del Cliente y Domicilio de Prestación del Servicio" VIEW-AS TEXT
          SIZE 58 BY 1 AT ROW 4.81 COL 87 WIDGET-ID 42
          BGCOLOR 9 FGCOLOR 15 
     "   Datos del Cliente y Domicilio para Facturación" VIEW-AS TEXT
          SIZE 71 BY 1 AT ROW 4.81 COL 15 WIDGET-ID 40
          BGCOLOR 9 FGCOLOR 15 
     "   Observaciones de Cuenta Corriente" VIEW-AS TEXT
          SIZE 71 BY 1 AT ROW 10.76 COL 87 WIDGET-ID 36
...
/* DEFINE FRAME statement is approaching 4K Bytes.  Breaking it up   */
DEFINE FRAME DEFAULT-FRAME
     RECT-4 AT ROW 3.38 COL 3.4
     RECT-5 AT ROW 16 COL 3
     RECT-6 AT ROW 1.24 COL 70 WIDGET-ID 44
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 160 BY 30.33.
...
/* SETTINGS FOR BUTTON btn_observ IN FRAME DEFAULT-FRAME
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN T-Fac_header.cai IN FRAME DEFAULT-FRAME
   EXP-LABEL                                                            */
/* SETTINGS FOR COMBO-BOX T-Fac_header.cdg_imputacion IN FRAME DEFAULT-FRAME
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN T-Fac_header.cdg_postal IN FRAME DEFAULT-FRAME
   EXP-LABEL                                                            */
...
/* SETTINGS FOR FILL-IN T-Fac_header.nro_contrato IN FRAME DEFAULT-FRAME
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN T-Fac_header.rige_hasta IN FRAME DEFAULT-FRAME
   EXP-LABEL                                                            */
...
/* SETTINGS FOR FILL-IN v-cdg_condicion_venta IN FRAME DEFAULT-FRAME
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN v-cdg_punto-venta IN FRAME DEFAULT-FRAME
   NO-ENABLE                                                            */
...
"Articulo.cdg_articulo" ? "X(4)" "character" ? ? ? ? ? ? no ? no no "10.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.T-Fac_detalle.cantidad
"T-Fac_detalle.cantidad" ? ">>9.99" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.T-Fac_detalle.precio
"T-Fac_detalle.precio" ? "->>>>>>9.9999" "decimal" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   = Temp-Tables.T-Fac_detalle.subtotal_neto
     _FldNameList[5]   > Temp-Tables.T-Fac_detalle.detallada
"T-Fac_detalle.detallada" "Descripcion!Detallada" ? "character" ? ? ? ? ? ? no ? no no "91.4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
...
DO:
  ...
  IF Tipocomprobante.cdg_comprobante BEGINS "CRE" THEN DO:
    FIND fac_header WHERE  fac_header.cdg_empresa = empresa.cdg_empresa
                             AND  fac_header.tip_comprob = v-tip_remito
                             AND fac_header.prf_comprob = v-prf_remito
                             AND fac_header.nro_comprob = v-nro_remito NO-ERROR.
    IF NOT AVAILABLE fac_header THEN RETURN NO-APPLY.
    act_rem_head = ROWID(fac_header).
    RUN c-pos_cliente.w ( INPUT-OUTPUT act_rem_head , INPUT 2, INPUT Fac_header.cdg_comprobante ).
  END.
  ELSE DO:
        ...
        RUN c-editar_leyenda_comprobante.w ( INPUT-OUTPUT texto,
         ...
         THEN DO:
              DO TRANSACTION:
                  ...
                  ASSIGN Fac_header.observacion = Fac_header.observacion + 
                          CHR(13) + CHR(10) + 
                          "----------------------" +
                          CHR(13) + CHR(10) +
                          texto.
...
ON CHOOSE OF btn_contador IN FRAME DEFAULT-FRAME /* Consultar Contador */
DO:
  RUN d-mostrar_contador.w ( T-Fac_header.cdg_comprobante, v-cdg_punto-venta , T-Fac_header.nro_cliente ).
END.
...
DO:
  ...
  IF Tipocomprobante.cdg_comprobante BEGINS "CRE" THEN DO: /*se realizara la aplicacion de la NC a las facturas si correspondiere*/
    IF t-fac_header.leyenda_cc = "" THEN DO:
        MESSAGE "Escriba la razon de porque realiza el credito" VIEW-AS ALERT-BOX ERROR.
        RETURN NO-APPLY.
    END.
END.   
  ...
  THEN DO:
       ...
       RUN grabar_datos(OUTPUT rok).
       IF NOT rok THEN UNDO,LEAVE.
...
DO:
   ...
   RUN c-edttexto-avanzado.w ( INPUT-OUTPUT T-Fac_header.observacion,
                      INPUT "Observación del Comprobante Actual",
                      INPUT 2, /* en RW siempre */
                      OUTPUT puso_ok).
   IF puso_ok THEN DO:
       FIND Fac_header WHERE Fac_header.nro_remito = t-Fac_header.nro_remito NO-ERROR.
       IF AVAILABLE Fac_header THEN ASSIGN Fac_header.observacion = T-Fac_header.observacion.
   END.
   RETURN NO-APPLY.
...
ON CHOOSE OF BUTTON-1 IN FRAME DEFAULT-FRAME /* Copia */
DO:
    IF cliente.factu_ THEN DO:
            ASSIGN 
            T-Fac_header.cdg_postal_leg    = administrador.cdg_postal
            T-Fac_header.cdg_provincia_leg = administrador.cdg_provincia
            T-Fac_header.direccion_leg     = administrador.direccion
            T-Fac_header.localidad_leg     = administrador.localidad
            T-Fac_header.nombre_leg        = administrador.nom_cliente.
    END.
    ELSE DO:
        ASSIGN  
           T-Fac_header.cdg_postal_leg    =     T-Fac_header.cdg_postal:SCREEN-VALUE  IN FRAME {&FRAME-NAME}
           T-Fac_header.cdg_provincia_leg =     T-Fac_header.cdg_provincia:SCREEN-VALUE  IN FRAME {&FRAME-NAME}
           T-Fac_header.direccion_leg     =     T-Fac_header.direccion:SCREEN-VALUE IN FRAME {&FRAME-NAME}
           T-Fac_header.localidad_leg     =     T-Fac_header.localidad:SCREEN-VALUE IN FRAME {&FRAME-NAME}
           T-Fac_header.nombre_leg        =     T-Fac_header.nombre:SCREEN-VALUE IN FRAME {&FRAME-NAME}.
    END.
        DISPLAY 
...
DO:
  ...
  FIND badminis WHERE badminis.nro_cliente = fac_header.nro_administrador NO-LOCK NO-ERROR.
...
ON VALUE-CHANGED OF T-Fac_header.cdg_imputacion IN FRAME DEFAULT-FRAME /* Conc. */
DO:
...
DO:
  ...
  THEN DO:
     ...
     DISPLAY Fac_header.tip_comprob @ T-Fac_header.tip_comprob 
             Fac_header.prf_comprob @ v-cdg_punto-venta
   ...
   ELSE DO:
       FIND Fac_header 
            WHERE Fac_header.cdg_empresa = Empresa.cdg_empresa
              ...
              AND Fac_header.prf_comprob = INPUT v-cdg_punto-venta
...
DO :
  ...
  THEN DO:
      ...
      DISPLAY contrato_hd.nro_contrato @ t-fac_header.nro_contrato
              WITH FRAME {&FRAME-NAME}.
      sino-msg = NO.
      RUN mensajepregunta.p ( INPUT "",INPUT "CPY006", INPUT-OUTPUT sino-msg ).
      IF sino-msg THEN RUN facturar_anticipo_contrato.
...
DO:
    ...
    THEN DO:
        ...
        RUN poner_cliente.
    END.  
    APPLY "entry" TO v-cdg_punto-venta.
    /*RETURN NO-APPLY.  */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-cdg_punto-venta C-Win
ON ENTRY OF v-cdg_punto-venta IN FRAME DEFAULT-FRAME
DO:
  v-cdg_punto-venta-org = INPUT FRAME {&FRAME-NAME} v-cdg_punto-venta.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-cdg_punto-venta C-Win
ON LEAVE OF v-cdg_punto-venta IN FRAME DEFAULT-FRAME
DO:
   ...
   IF modo =MD_ALTA /* MD_MULTIPLE  MD_DEFINIDA    MD_RELACION   MD_READONLY MD_CAMBIO MD_ANULACION MD_EMISION */ THEN DO:
      IF INPUT FRAME {&FRAME-NAME} v-cdg_punto-venta <> v-cdg_punto-venta-org
      THEN DO:
           FIND Punto-venta WHERE Punto-venta.cdg_empresa  = T-fac_header.cdg_empresa 
                                         AND Punto-venta.cdg_puntovta = INPUT FRAME {&FRAME-NAME} v-cdg_punto-venta NO-LOCK NO-ERROR.
           IF NOT AVAILABLE Punto-venta
           THEN DO:
                RUN ponmensj.p ( INPUT "PVTA001").
                DISPLAY v-cdg_punto-venta-org @ v-cdg_punto-venta
                        WITH FRAME {&FRAME-NAME}.
           END.
           ELSE DO:
                IF NOT CAN-FIND(FIRST Tipo_puntovta WHERE Tipo_puntovta.cdg_empresa  = T-fac_header.cdg_empresa 
                                                      AND Tipo_puntovta.cdg_puntovta = INPUT FRAME {&FRAME-NAME} v-cdg_punto-venta
                ...
                END.
                ELSE DO:
                     ASSIGN FRAME {&FRAME-NAME} v-cdg_punto-venta.
                     RUN asignar_fecha_puntovta.
                END.
         END.
      END.
      IF Cliente.dfl_cdg_puntovta <> int(INPUT FRAME {&FRAME-NAME} v-cdg_punto-venta) THEN DO:
          sino-msg = NO.
      ...
      IF Punto-venta.TP = "M" THEN DO:
         FIND acumulado_punto_venta  WHERE 
             ...
             acumulado_punto_venta.cdg_puntovta = v-cdg_punto-venta:INPUT-VALUE NO-LOCK NO-ERROR .
         ...
         IF AVAILABLE categmono AND AVAILABLE Acumulado_punto_venta THEN DO:
             IF categmono.limitecuatrimestre / 4 + acumulado_punto_venta.importe <= 0 THEN DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-cdg_punto-venta C-Win
ON MOUSE-SELECT-DBLCLICK OF v-cdg_punto-venta IN FRAME DEFAULT-FRAME
...
DO:
  ...
  IF Tipocomprobante.cdg_comprobante BEGINS "CRE" THEN DO:
      ...
      RUN d-selcomprobante_clienteSP.w ( INPUT "Facturas pendiente de cobranza" ,
                                         INPUT "E",
                                         INPUT (IF AVAILABLE Relacion_comprobante THEN Relacion_comprobante.cdg_comproborigen ELSE ? ),
                                         INPUT t-fac_header.nro_cliente,
                                         INPUT-OUTPUT rid_remito).
      IF rid_remito <> ?
      THEN DO:
          FIND bfac_header WHERE ROWID(bfac_header) = rid_remito NO-LOCK.
          FIND contrato_hd WHERE contrato_hd.nro_contrato = bfac_header.nro_contrato NO-LOCK.
          IF Contrato_hd.cant_periodos > 0 THEN
              FIND FIRST evento WHERE evento.origen = "Contrato" AND evento.nro_identificacion = bfac_header.nro_contrato AND
              NOT evento.anulado AND evento.frealizado <> ? NO-ERROR.
          ELSE
              FIND FIRST evento WHERE evento.origen = "Contrato" AND evento.nro_identificacion = bfac_header.nro_contrato AND
                NOT evento.anulado AND evento.frealizado <> ? and
              evento.periodo = year(bfac_header.fecha) * 100 + month(bfac_header.fecha ) NO-ERROR.
          IF AVAILABLE evento THEN DO:
              MESSAGE "Existe un evento realizado para el periodo de la factura" SKIP
                  "Evento: " evento.nro_evento skip
                 "verifique si le corresponde la NC o no antes de continuar" VIEW-AS ALERT-BOX ERROR.
          END.
              DISPLAY bfac_header.tip_comprob @ v-tip_remito
                  bfac_header.prf_comprob @ v-prf_remito
                  bfac_header.nro_comprob @ v-nro_remito
                  WITH FRAME {&FRAME-NAME}.
...
DO:
   IF Tipocomprobante.cdg_comprobante BEGINS "CRE" THEN DO:
       FIND bfac_header 
        WHERE bfac_header.cdg_empresa = T-Fac_header.cdg_empresa
          AND bfac_header.tip_comprob = v-tip_remito:INPUT-VALUE IN FRAME {&FRAME-NAME} 
          AND bfac_header.prf_comprob = v-prf_remito:INPUT-VALUE IN FRAME {&FRAME-NAME} 
          AND bfac_header.nro_comprob = v-nro_remito:INPUT-VALUE IN FRAME {&FRAME-NAME}
              NO-LOCK NO-ERROR.
       IF AVAILABLE bfac_header THEN DO:
            FOR EACH bfac_detalle OF bfac_header:
                CREATE t-fac_detalle.
                BUFFER-COPY bfac_detalle TO T-Fac_detalle ASSIGN
                    ...
                    T-Fac_detalle.detallada = "Sobre " + bfac_header.tip_comprob + "-" + 
                          string(bfac_header.prf_comprob,"9999") + "-" + string(bfac_header.nro_comprob,"99999999").
            END.
            RUN calculos.
        /*    IF ABS( t-fac_header.imp_total - bfac_header.imp_total ) < 1 THEN DO:
                FIND articulo WHERE articulo.cdg_articulo = "REDONDEO" NO-LOCK.
                CREATE t-fac_detalle.
                ASSIGN 
                    t-Fac_detalle.cantidad = 1
                    t-Fac_detalle.nro_articulo = articulo.nro_articulo
                    t-fac_detalle.precio =  bfac_header.imp_total - t-fac_header.imp_total
                    t-Fac_detalle.precio_cf = t-fac_detalle.precio
                    t-Fac_detalle.subtotal_bruto = t-fac_detalle.precio
                    t-Fac_detalle.subtotal_bruto_cf =t-fac_detalle.precio
                    t-Fac_detalle.subtotal_general = t-fac_detalle.precio
                    t-Fac_detalle.subtotal_gral_cf = t-fac_detalle.precio
                    t-Fac_detalle.subtotal_neto = t-fac_detalle.precio
                    t-Fac_detalle.subtotal_neto_cf = t-fac_detalle.precio
                    T-Fac_header.ultima_linea     = T-Fac_header.ultima_linea + 1
                    T-Fac_detalle.nro_factura     = T-Fac_header.nro_factura
                    T-Fac_detalle.nro_linea       = T-Fac_header.ultima_linea
                    T-Fac_detalle.detallada = "Sobre " + bfac_header.tip_comprob + "-" + 
   ...
   ELSE DO:
    ...
    IF AVAILABLE Rem_header
    THEN DO:
        IF Rem_header.estado = "E" OR Rem_header.estado = "-"
        THEN DO:
            FIND FIRST Relacion_comprobante 
            ...
            v-cdg_punto-venta = Rem_header.prf_comprob.
            RUN traer_tablas.
            ...
            ASSIGN
               v-tip_remito:SENSITIVE                    = NO
               v-prf_remito:SENSITIVE                    = NO
               v-nro_remito:SENSITIVE                    = NO
...
REPEAT ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  IF modo <> MD_MULTIPLE AND modo <> MD_DEFINIDA AND modo <> MD_READONLY AND modo <> MD_ANULACION THEN
    RUN crear_registro.
  IF modo = MD_DEFINIDA
...
------------------------------------------------------------------------------*/
     ...
     FIND Punto-venta WHERE Punto-venta.cdg_empresa  = Empresa.cdg_empresa 
                        AND Punto-venta.cdg_puntovta = v-cdg_punto-venta
                            NO-LOCK.
...
------------------------------------------------------------------------------*/
    ...
    THEN DO:
        ...
        IF Tipocomprobante.cdg_comprobante BEGINS "CRE" THEN
            v-tip_remito:LABEL IN FRAME {&FRAME-NAME}= "Facturas".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE copiar_contrato C-Win 
PROCEDURE copiar_contrato :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
       {nommeses.i}
       DEF VAR x-tasa_iva AS DECIMAL NO-UNDO.
       DEF VAR vtanque AS CHARACTER NO-UNDO.
           ...
           WHERE Impuesto_condicion.cdg_condiva = T-Fac_header.cdg_condiva
             ...
             AND CAN-DO(Impuesto_condicion.lista_provincias,T-Fac_header.cdg_provincia) NO-LOCK, 
              ...
              IF NOT AVAILABLE Cliente_excencion
                 THEN x-tasa_iva = Impuesto_condicion.tasa.
                 ELSE x-tasa_iva = Impuesto_condicion.tasa * ( 1 - Cliente_excencion.prc_excencion  / 100.0 ).
        END.
    
        CREATE T-Fac_detalle.
        ASSIGN T-Fac_detalle.a_granel           = NO 
               T-Fac_detalle.cantidad           = Contrato_dt.cantidad
               T-Fac_detalle.costo              = T-Fac_header.imp_total
               T-Fac_detalle.detallada          = "Anticipo por " + IF contrato_dt.detallada = ""  THEN Articulo.descripcion ELSE contrato_dt.detallada
               ...
               T-Fac_header.ultima_linea        = T-Fac_header.ultima_linea + 1
               T-Fac_detalle.precio             = contrato_dt.anticipo
               T-fac_header.nro_contrato        = contrato_hd.nro_contrato.

           /*
        DO j-reemplazo = 1 TO NUM-ENTRIES(v-reemplazos,","):
            T-Fac_detalle.detallada = REPLACE(T-Fac_detalle.detallada,ENTRY(1,ENTRY(j-reemplazo,v-reemplazos,","),"="),ENTRY(2,ENTRY(j-reemplazo,v-reemplazos,","),"=")).
        END.
...
*/
        ...
        T-Fac_detalle.detallada = REPLACE(T-Fac_detalle.detallada,"&MES",nom_mes [ month(today) ] ).
        T-Fac_detalle.detallada = REPLACE(T-Fac_detalle.detallada,"&ANO",string( year(today) ,"9999" )).
        T-Fac_detalle.detallada = REPLACE(T-Fac_detalle.detallada,"&CUOTA", string(Contrato_hd.cant_periodos - Contrato_hd.resto_periodos, ">9") ).
...
------------------------------------------------------------------------------*/
  ...
  DO TRANSACTION:
      FIND Punto-venta WHERE Punto-venta.cdg_puntovta = v-cdg_punto-venta 
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY v-comprobante v-pago v-cdg_punto-venta v-anulado v-cdg_cliente 
          v-cdg_condicion_venta v-dsc_condicion_venta v-cdg_vendedor 
          v-dsc_vendedor v-tip_remito v-prf_remito v-nro_remito 
          v-cdg_administrador v-dsc_administrador v-cdg_articulo 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  IF AVAILABLE T-Fac_header THEN 
    DISPLAY T-Fac_header.tip_comprob T-Fac_header.nro_comprob T-Fac_header.fecha 
          T-Fac_header.cta_cte T-Fac_header.nombre T-Fac_header.nombre_leg 
          T-Fac_header.direccion T-Fac_header.direccion_leg 
          T-Fac_header.cdg_postal T-Fac_header.localidad 
          T-Fac_header.cdg_postal_leg T-Fac_header.localidad_leg 
          T-Fac_header.cdg_provincia T-Fac_header.cdg_provincia_leg 
          T-Fac_header.cuit T-Fac_header.Cod_docu T-Fac_header.cdg_imputacion 
          T-Fac_header.leyenda_cc T-Fac_header.nro_contrato 
          T-Fac_header.imp_neto T-Fac_header.imp_total T-Fac_header.cai 
          T-Fac_header.rige_hasta 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE RECT-2 RECT-3 RECT-4 RECT-5 RECT-6 Btn_salir T-Fac_header.tip_comprob 
         T-Fac_header.nro_comprob T-Fac_header.fecha BUTTON-1 
         T-Fac_header.nombre T-Fac_header.nombre_leg T-Fac_header.direccion 
         T-Fac_header.direccion_leg T-Fac_header.cdg_postal 
         T-Fac_header.localidad T-Fac_header.cdg_postal_leg 
         T-Fac_header.localidad_leg T-Fac_header.cdg_provincia 
         T-Fac_header.cdg_provincia_leg T-Fac_header.cuit T-Fac_header.Cod_docu 
         T-Fac_header.cdg_imputacion T-Fac_header.leyenda_cc b-verrem 
         T-Fac_header.nro_contrato bVer T-Fac_header.imp_total BROWSE-1 
         T-Fac_header.cai T-Fac_header.rige_hasta 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE facturar_anticipo_contrato C-Win 
PROCEDURE facturar_anticipo_contrato :
DO:
    FIND contrato_hd 
        WHERE contrato_hd.cdg_empresa = T-Fac_header.cdg_empresa
          AND contrato_hd.nro_contrato = T-Fac_header.nro_contrato:INPUT-VALUE IN FRAME {&FRAME-NAME} 
    NO-LOCK NO-ERROR.

    IF AVAILABLE contrato_hd
    THEN DO:
        /*quiere facturar el valor del anticipo*/
            RUN copiar_contrato.
            FIND FIRST T-Fac_header.
            v-cdg_punto-venta = contrato_hd.prf_contrato.
            RUN traer_tablas.
  ...
  DO WITH FRAME {&FRAME-NAME}:
     ...
     THEN DO:
          ASSIGN
                ...
                v-cdg_punto-venta:SENSITIVE                     = NO          
                ...
                t-fac_header.cdg_imputacion:SENSITIVE     = NO
                t-fac_header.cuit:SENSITIVE               = NO
                t-fac_header.cod_docu:SENSITIVE           = NO
                t-fac_header.cdg_provincia:SENSITIVE      = NO
                t-fac_header.cdg_provincia_leg:SENSITIVE  = NO
                bVer:SENSITIVE                            = NO.
     END.
     ELSE DO:
            CASE modo:
                ...
                THEN DO:
                  ...
                  /*      v-cdg_punto-venta:SENSITIVE                   = YES*/
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DEFINE VAR tip LIKE fac_header.tip_comprob NO-UNDO.
DEFINE VAR prf LIKE fac_header.prf_comprob NO-UNDO.
DEFINE VAR nro LIKE fac_header.nro_comprob NO-UNDO.
DEFINE VAR ttotal AS DECIMAL DECIMALS 2 NO-UNDO.
DEFINE BUFFER cc_debitan FOR cta_cte.
DEFINE BUFFER cc_acreditan FOR cta_cte.
DEFINE VAR auxi AS CHAR NO-UNDO.
EMPTY TEMP-TABLE afac.
DEFINE OUTPUT PARAMETER rok AS LOGICAL.
ASSIGN FRAME {&FRAME-NAME} v-cdg_punto-venta
           T-Fac_header.cdg_imputacion 
           T-Fac_header.cdg_postal 
           T-Fac_header.cdg_postal_leg 
...
IF Tipocomprobante.cdg_comprobante BEGINS "CRE" THEN DO: /*se realizara la aplicacion de la NC a las facturas si correspondiere*/
    ...
    FOR EACH t-fac_detalle OF t-fac_header:
        IF t-fac_detalle.detallada BEGINS "Sobre " THEN DO:
            tip = SUBSTRING(t-fac_detalle.detallada,7,2).
            prf = int(SUBSTRING(t-fac_detalle.detallada,10,4)) NO-ERROR.
            nro = int(SUBSTRING(t-fac_detalle.detallada,15,8)) NO-ERROR.
            FIND bfac_header WHERE bfac_header.cdg_empresa = empresa.cdg_empresa AND
                bfac_header.tip_comprob = tip AND 
                bfac_header.prf_comprob = prf AND 
                bfac_header.nro_comprob = nro NO-ERROR.
            IF NOT AVAILABLE bfac_header THEN DO: 
                MESSAGE "Error interno al buscar comprobante para aplicar" VIEW-AS ALERT-BOX ERROR.
                NEXT.
            END.
            t-fac_header.nro_contrato = bfac_header.nro_contrato.
            FIND afac WHERE afac.rid = ROWID(bfac_header) NO-ERROR.
            IF AVAILABLE afac THEN NEXT.
            CREATE afac.
            ttotal = ttotal + bfac_header.imp_total.
            ASSIGN afac.rid = ROWID(bfac_header).
        END.
    END.
    
    FIND FIRST afac NO-error.
    IF AVAILABLE afac THEN
        IF abs(ttotal - t-fac_header.imp_total) <> 0 THEN DO:
            MESSAGE "Los totales de las facturas y la nota de credito calculada difieren Fac:" ttotal " NC:" t-fac_header.imp_total
                    "Agregue redondeo o esta operacion realizara compensacion parcial"
                    "o se debe realizar esta operacion manualmente"
    ...
    FIND FIRST afac NO-error.
    IF AVAILABLE afac AND t-fac_header.leyenda_cc = "" THEN DO:
        MESSAGE "Escriba la razon de porque realiza el credito"VIEW-AS ALERT-BOX ERROR.
        RETURN ERROR.
    END.
    FOR EACH afac:
        FIND bfac_header WHERE ROWID(bfac_header) = afac.rid.
        FIND cc_debitan WHERE
            cc_debitan.cdg_empresa = bfac_header.cdg_empresa AND
            cc_debitan.tip_comprob = bfac_header.tip_comprob AND
            cc_debitan.prf_comprob = bfac_header.prf_comprob AND
            cc_debitan.nro_comprob = bfac_header.nro_comprob.
     ...
     CASE modo:
       ...
       THEN DO:
           ASSIGN
               ...
               t-fac_header.cdg_imputacion:SENSITIVE     = YES
               t-fac_header.cuit:SENSITIVE               = YES
               t-fac_header.cod_docu:SENSITIVE           = YES
               bVer:SENSITIVE                            = YES.
               t-fac_header.cdg_provincia:SENSITIVE      = YES.
               t-fac_header.cdg_provincia_leg:SENSITIVE      = YES.
       END.
       WHEN MD_MULTIPLE      
       THEN DO:
           ASSIGN
...
------------------------------------------------------------------------------*/
   ...
   IF modo <> MD_MULTIPLE AND modo <> MD_DEFINIDA AND modo <> MD_READONLY AND modo <> MD_ANULACION THEN
        RUN getptovta_comprobante.p ( INPUT Tipocomprobante.cdg_comprobante, OUTPUT v-cdg_punto-venta ).
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
     {levantacombo.i &TABLA=Provincia &NOMBRE=nombre &CODIGO=cdg_provincia &OBJETO=T-Fac_header.cdg_provincia}
     {levantacombo.i &TABLA=Provincia &NOMBRE=nombre &CODIGO=cdg_provincia &OBJETO=T-Fac_header.cdg_provincia_leg}
     lista = "".
    /* FIND usuario WHERE usuario.cdg_usuario = USERID("sic") NO-LOCK.
     FIND Usuario_funcion OF usuario WHERE Usuario_funcion.cdg_funcion = "EFAC" AND usuario_funcion.permiso =  "A"
                AND Usuario_funcion.cdg_empresa = empresa.cdg_empresa NO-LOCK NO-ERROR.*/
     ...
     t-fac_header.cod_docu:LIST-ITEMS = SUBSTRING(lista,2).
  END.          
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE poner_pagado C-Win 
PROCEDURE poner_pagado :
/*------------------------------------------------------------------------------
...
------------------------------------------------------------------------------*/
    ...
    ELSE DO:
        ASSIGN v-cdg_administrador = "?????"
               v-dsc_administrador = "???????????????????????".
        MESSAGE "Administrador con nro interno " T-Fac_header.nro_administrador "no encontrado"
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN v-cdg_condicion_venta = Condicion_venta.cdg_cndventa
...
------------------------------------------------------------------------------*/
   ...
   v-cdg_punto-venta = T-Fac_header.prf_comprob.
...
/*  {validartabla.i "Deposito"          "cdg_deposito"    "nombre"         "FACT023"}
    ...
    IF t-fac_header.imp_total = 0 OR t-fac_header.imp_total = ? THEN DO:
        MESSAGE "La factura no puede estar en 0" VIEW-AS ALERT-BOX ERROR.
        RETURN.
    END.
    ...
    THEN DO:
       ...
       RETURN.
    END. 
    IF INPUT FRAME {&FRAME-NAME} t-fac_header.cod_docu = "" THEN DO:
        MESSAGE "El tipo de documento esta en blanco" VIEW-AS ALERT-BOX ERROR.
        RETURN.
    END.
    IF INPUT FRAME {&FRAME-NAME} t-fac_header.cod_docu <> "NO"  THEN DO:
    ...
    ELSE DO:
        ...
        FIND punto-venta WHERE Punto-venta.cdg_empresa = empresa.cdg_empresa
                           AND Punto-venta.cdg_puntovta = INPUT v-cdg_punto-venta NO-LOCK.
    ...
    IF T-Fac_header.nro_administrador <> Cliente.nro_administrador
    THEN DO:
        MESSAGE "El administrador asignado al cliente es distinto del asociado a la factura"
...
/*  FIND FIRST Domicilio OF Cliente WHERE Domicilio.nro_domicilio = INPUT FRAME {&FRAME-NAME} v-cdg_domicilio NO-LOCK NO-ERROR.
    ...
    ELSE DO:
        /*IF Punto-venta.TP = "M" THEN DO:
         FIND acumulado_punto_venta NO-LOCK WHERE 
             Acumulado_punto_venta.cdg_empresa = empresa.cdg_empresa AND 
             acumulado_punto_venta.cdg_puntovta = v-cdg_punto-venta:INPUT-VALUE NO-ERROR .
         FIND categmono WHERE categMono.categoria = Punto-venta.categoria NO-LOCK NO-ERROR.
         IF AVAILABLE categmono AND AVAILABLE Acumulado_punto_venta THEN DO:
             IF limitecuatrimestre / 4 + acumulado_punto_venta.importe - T-Fac_header.imp_total <=0 THEN DO:
                 MESSAGE "No puede facturar por este punto de venta" VIEW-AS ALERT-BOX ERROR.
                 RETURN ERROR.        
             END.
         END.  
                ...
                FOR EACH btipocomprobante WHERE btipocomprobante.prefijo_contador = tipocomprobante.prefijo_contador :
                    IF CAN-FIND(FIRST Fac_header
                                      WHERE Fac_header.cdg_empresa = T-Fac_header.cdg_empresa
                                        ...
                                        AND Fac_header.prf_comprob = v-cdg_punto-venta
...
FUNCTION pagado RETURNS CHARACTER
  ( /* parameter-definitions */ ) :
    DEF VAR PAGA AS CHAR NO-UNDO.
      FIND cta_cte WHERE
      cta_cte.cdg_empresa = t-fac_header.cdg_empresa AND
      cta_cte.tip_comprob = t-fac_header.tip_comprob AND
      cta_cte.prf_comprob = t-fac_header.prf_comprob AND
      cta_cte.nro_comprob = t-fac_header.nro_comprob NO-LOCK NO-ERROR.
