...
&Scoped-define FIELDS-IN-QUERY-br_table Cliente.nom_cliente ~
Cliente.nro_cliente 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Cliente.nom_cliente COLUMN-LABEL "Razón Social" FORMAT "X(40)":U
            WIDTH 74.2
      Cliente.nro_cliente FORMAT ">>>>>9":U WIDTH 14.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 95 BY 4.29 ROW-HEIGHT-CHARS .57.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   > sic.Cliente.nom_cliente
"nom_cliente" "Razón Social" ? "character" ? ? ? ? ? ? no ? no no "74.2" yes no no "U" "" ""
     _FldNameList[2]   > sic.Cliente.nro_cliente
"nro_cliente" ? ? "integer" ? ? ? ? ? ? no ? no no "14.2" yes no no "U" "" ""
