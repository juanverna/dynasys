...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Cliente.cdg_cliente COLUMN-LABEL "Código!Admin." FORMAT "X(8)":U
            WIDTH 8.2
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 13 BY 12.14 ROW-HEIGHT-CHARS .67.
...
"Cliente.cdg_cliente" "Código!Admin." ? "character" ? ? ? ? ? ? no ? no no "8.2" yes no no "U" "" ""
