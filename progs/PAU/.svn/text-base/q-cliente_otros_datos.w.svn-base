...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Cliente_otros_datos OF Cliente WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Cliente_otros_datos OF Cliente WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Cliente_otros_datos
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Cliente_otros_datos
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "sic.Cliente_otros_datos OF sic.Cliente"
