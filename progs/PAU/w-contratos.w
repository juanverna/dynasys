  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Clientes|Contratos' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.00 , 4.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 25.71 , 157.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_b-clientes_con_contratos ( 3.38 , 1.00 ) NO-ERROR.
       RUN set-size IN h_b-clientes_con_contratos ( 22.38 , 160.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 15.52 , 33.20 ) NO-ERROR.
       ...
       RUN set-position IN h_b-contratos ( 2.67 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-contratos ( 11.67 , 27.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-dsc_cliente ( 2.67 , 33.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-contrato ).
       RUN set-position IN h_v-contrato ( 4.38 , 33.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updspa-2 ).
       RUN set-position IN h_p-updspa-2 ( 25.38 , 44.40 ) NO-ERROR.
       RUN set-size IN h_p-updspa-2 ( 1.19 , 112.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_b-clientes_con_contratos , 'Record':U , h_v-dsc_cliente ).
       ...
       RUN add-link IN adm-broker-hdl ( h_b-contratos , 'Record':U , h_b-detalle_contrato-2 ).
