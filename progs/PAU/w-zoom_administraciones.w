...
DEFINE VARIABLE h_b-comprobante_rendicion-adm AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_p-soloalta-2 AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_p-updspa-sinborr AS HANDLE NO-UNDO.
...
DEFINE VARIABLE h_v-observacion-clires AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Administrac.|Observaciones|Cta.Cte|Tareas|Evento|Cobranzas' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.48 , 4.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 26.43 , 159.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'fac/q-cliente.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-cliente ).
       RUN set-position IN h_q-cliente ( 2.19 , 4.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-canal ).
       RUN set-position IN h_b-canal ( 4.10 , 120.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-canal ).
       RUN set-position IN h_v-canal ( 4.10 , 141.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-administrador ( 4.33 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.10 , 112.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 6.71 , 141.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 7.62 , 21.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updspa-2 ).
       RUN set-position IN h_p-updspa-2 ( 12.67 , 8.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa-2 ( 1.76 , 110.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-cliente_contacto ( 15.05 , 6.00 ) NO-ERROR.
       RUN set-size IN h_b-cliente_contacto ( 5.71 , 22.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-cliente_contacto ( 15.05 , 29.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updspa-3 ).
       RUN set-position IN h_p-updspa-3 ( 21.00 , 62.00 ) NO-ERROR.
       ...
       RUN set-position IN h_q-domicilio ( 2.67 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.86 , 10.80 ) */

       /* Links to SmartViewer h_v-canal. */
       RUN add-link IN adm-broker-hdl ( h_b-canal , 'Record':U , h_v-canal ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-canal ).

       /* Links to SmartViewer h_v-administrador. */
       RUN add-link IN adm-broker-hdl ( h_p-updspa-2 , 'TableIO':U , h_v-administrador ).
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_v-administrador ).
       ...
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_q-domicilio ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_b-observacion-cli ( 2.67 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-observacion-cli ( 20.48 , 153.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-observacion-clires.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-observacion-clires ).
       RUN set-position IN h_v-observacion-clires ( 23.38 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.81 , 133.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     SmartPanelType = Update-Trans,
                     AddFunction = One-Record':U ,
             OUTPUT h_p-soloalta-2 ).
       RUN set-position IN h_p-soloalta-2 ( 23.38 , 138.00 ) NO-ERROR.
       RUN set-size IN h_p-soloalta-2 ( 3.81 , 19.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-observacion-cli. */
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_b-observacion-cli ).

       /* Links to SmartViewer h_v-observacion-clires. */
       RUN add-link IN adm-broker-hdl ( h_b-observacion-cli , 'Record':U , h_v-observacion-clires ).
       RUN add-link IN adm-broker-hdl ( h_p-soloalta-2 , 'TableIO':U , h_v-observacion-clires ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-observacion-cli ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-observacion-clires ,
             h_b-observacion-cli , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-soloalta-2 ,
             h_v-observacion-clires , 'AFTER':U ).
    END. /* Page 2 */
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
       ...
       RUN set-position IN h_b-consorcios_de_un_administrad ( 2.91 , 7.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-ctacte-cli ( 11.71 , 8.00 ) NO-ERROR.
       RUN set-size IN h_b-ctacte-cli ( 15.24 , 145.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-consorcios_de_un_administrad. */
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_b-consorcios_de_un_administrad ).
    ...
    WHEN 4 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente ( 2.91 , 19.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.43 , 122.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-busc-tarea.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Key-Name = nom_cliente,
                     Layout = ':U ,
             OUTPUT h_b-busc-tarea ).
       RUN set-position IN h_b-busc-tarea ( 4.29 , 6.00 ) NO-ERROR.
       RUN set-size IN h_b-busc-tarea ( 5.62 , 151.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-temp_tarea1 ( 9.95 , 6.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-tarea-red1 ( 20.05 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.71 , 147.00 ) */

       /* Links to SmartViewer h_v-dsc_cliente. */
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_v-dsc_cliente ).

       /* Links to SmartBrowser h_b-busc-tarea. */
       RUN add-link IN adm-broker-hdl ( h_q-cliente , 'Record':U , h_b-busc-tarea ).
    ...
    WHEN 5 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_p-excel ).
       RUN set-position IN h_p-excel ( 2.91 , 143.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-dsc_cliente-2 ( 3.14 , 19.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.43 , 122.00 ) */
       ...
       RUN set-position IN h_b-eventocli ( 5.05 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-eventocli ( 11.19 , 153.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'p-updspa-sinborr.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Edge-Pixels = 2,
                     SmartPanelType = Update-Trans,
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updspa-sinborr ).
       RUN set-position IN h_p-updspa-sinborr ( 16.71 , 4.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa-sinborr ( 10.71 , 8.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-evento ).
       RUN set-position IN h_v-evento ( 16.71 , 14.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_v-administrador , 'Record':U , h_b-eventocli ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa-sinborr ,
             h_b-eventocli , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-evento ,
             h_p-updspa-sinborr , 'AFTER':U ).
    END. /* Page 5 */
    WHEN 6 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-resumen.w':U ,
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-resumen ).
       RUN set-position IN h_v-resumen ( 1.62 , 141.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-rendicion_adm ( 3.14 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-rendicion_adm ( 8.81 , 155.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-comprobante_rendicion-adm.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-comprobante_rendicion-adm ).
       RUN set-position IN h_b-comprobante_rendicion-adm ( 12.19 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-comprobante_rendicion-adm ( 15.33 , 62.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-valores_rendicion ( 12.19 , 68.00 ) NO-ERROR.
       RUN set-size IN h_b-valores_rendicion ( 6.62 , 92.60 ) NO-ERROR.
       ...
       RUN set-position IN h_b-caja_valor ( 18.91 , 68.20 ) NO-ERROR.
       RUN set-size IN h_b-caja_valor ( 8.19 , 92.80 ) NO-ERROR.

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('1':U) NO-ERROR.

       /* Links to SmartViewer h_v-resumen. */
       RUN add-link IN adm-broker-hdl ( h_v-administrador , 'Record':U , h_v-resumen ).

       /* Links to SmartBrowser h_b-rendicion_adm. */
       RUN add-link IN adm-broker-hdl ( h_v-administrador , 'Record':U , h_b-rendicion_adm ).

       /* Links to SmartBrowser h_b-comprobante_rendicion-adm. */
       RUN add-link IN adm-broker-hdl ( h_b-rendicion_adm , 'Record':U , h_b-comprobante_rendicion-adm ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-rendicion_adm ,
             h_v-resumen , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-comprobante_rendicion-adm ,
             h_b-rendicion_adm , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-valores_rendicion ,
             h_b-comprobante_rendicion-adm , 'AFTER':U ).
...
------------------------------------------------------------------------------*/
  ...
  RUN posicionar_query IN h_q-cliente ( INPUT rid_cliente ).
END PROCEDURE.
