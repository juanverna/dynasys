...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Contrato_hd Empresa Cliente
&Scoped-define FIRST-EXTERNAL-TABLE Contrato_hd


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Contrato_hd, Empresa, Cliente.
/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES Contrato_dt

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH Contrato_dt OF Contrato_hd WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Contrato_dt OF Contrato_hd WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Contrato_dt
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Contrato_dt
...
/* Settings for THIS-PROCEDURE
   Type: SmartQuery
   External Tables: sic.Contrato_hd,sic.Empresa,sic.Cliente
   Allow: Basic,Query
   Frames: 1
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "sic.Contrato_dt OF sic.Contrato_hd"
