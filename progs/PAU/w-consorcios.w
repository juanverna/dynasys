...
DEFINE VARIABLE h_b-remitos-cli AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 25.71 , 161.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_b-consorcio_administracion ( 2.91 , 3.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-consorcios ( 11.76 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-canal ).
       RUN set-position IN h_b-canal ( 11.95 , 134.00 ) NO-ERROR.
       RUN set-size IN h_b-canal ( 7.86 , 19.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-canal ).
       RUN set-position IN h_v-canal ( 20.05 , 133.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa-3 ).
       RUN set-position IN h_p-updspa-3 ( 22.67 , 130.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa-3 ( 1.76 , 29.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Key-Name = nro_cliente,
                     Layout = ':U ,
             OUTPUT h_vo-cliente ).
       RUN set-position IN h_vo-cliente ( 24.57 , 141.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 24.81 , 5.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 1.43 , 121.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente-7 ( 2.43 , 22.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-observacion-cli ( 3.62 , 7.00 ) NO-ERROR.
       RUN set-size IN h_b-observacion-cli ( 14.52 , 150.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-observacion-cli ( 18.38 , 7.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-soloalta ).
       RUN set-position IN h_p-soloalta ( 18.38 , 143.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente ( 2.67 , 16.00 ) NO-ERROR.
       /* Size in UIB:  ( 0.95 , 120.40 ) */
       ...
       RUN set-position IN h_v-dsc_domicilio ( 3.86 , 16.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-cliente_contacto ( 5.76 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-cliente_contacto ( 8.57 , 129.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-cliente_contacto ( 14.57 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-3 ).
       RUN set-position IN h_p-updsav-3 ( 14.57 , 138.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-3 ( 11.43 , 22.00 ) NO-ERROR.
    ...
    WHEN 4 THEN DO:
       ...
       RUN set-position IN h_b-contratos ( 2.48 , 5.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-dsc_cliente-2 ( 2.48 , 35.00 ) NO-ERROR.
       /* Size in UIB:  ( 0.95 , 120.40 ) */
       ...
       RUN set-position IN h_v-contrato_consorcios ( 3.62 , 35.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updspa-4 ).
       RUN set-position IN h_p-updspa-4 ( 15.10 , 42.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa-4 ( 1.33 , 116.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-detalle_contrato ( 15.52 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-detalle_contrato ( 10.71 , 35.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-detalle_contrato1linea ( 16.48 , 42.20 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updsav-2 ).
       RUN set-position IN h_p-updsav-2 ( 25.05 , 42.00 ) NO-ERROR.
       RUN set-size IN h_p-updsav-2 ( 1.43 , 114.00 ) NO-ERROR.
       ...
       /* Links to SmartPanel h_p-updspa-4. */
       RUN add-link IN adm-broker-hdl ( h_v-contrato_consorcios , 'State':U , h_p-updspa-4 ).
    ...
    WHEN 5 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente-3 ( 3.14 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 0.95 , 120.40 ) */
       ...
       RUN set-position IN h_b-ctacte-cli ( 4.33 , 10.00 ) NO-ERROR.
    ...
    WHEN 6 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente-4 ( 3.14 , 12.00 ) NO-ERROR.
       /* Size in UIB:  ( 0.95 , 120.40 ) */
    ...
    WHEN 7 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente-8 ( 2.48 , 12.00 ) NO-ERROR.
       /* Size in UIB:  ( 0.95 , 120.40 ) */
       ...
       RUN set-position IN h_b-comprobantes1 ( 3.67 , 12.00 ) NO-ERROR.
    ...
    WHEN 8 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente-6 ( 2.48 , 10.80 ) NO-ERROR.
       /* Size in UIB:  ( 0.95 , 120.40 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ,
                     SortBy-Case = fecha':U ,
             OUTPUT h_b-remitos-cli ).
       RUN set-position IN h_b-remitos-cli ( 3.71 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-remitos-cli ( 22.29 , 155.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_b-remitos-cli. */
       RUN add-link IN adm-broker-hdl ( h_v-dsc_cliente-6 , 'Record':U , h_b-remitos-cli ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-dsc_cliente-6 ,
             h_folder , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-remitos-cli ,
    ...
    WHEN 9 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente-5 ( 2.91 , 11.00 ) NO-ERROR.
       /* Size in UIB:  ( 0.95 , 120.40 ) */
       ...
       RUN set-position IN h_b-eventocli ( 4.57 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updspa-2 ).
       RUN set-position IN h_p-updspa-2 ( 15.29 , 4.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-evento ).
       RUN set-position IN h_v-evento ( 15.29 , 16.00 ) NO-ERROR.
    ...
    WHEN 10 THEN DO:
       ...
       RUN set-position IN h_v-dsc_cliente-9 ( 2.91 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 0.95 , 120.40 ) */
       ...
       RUN set-position IN h_b-busc-tarea ( 4.29 , 4.40 ) NO-ERROR.
       RUN set-size IN h_b-busc-tarea ( 11.19 , 155.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-temp_tarea1 ( 16.14 , 5.60 ) NO-ERROR.
