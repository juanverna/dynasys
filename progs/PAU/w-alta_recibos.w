...
&Scoped-define QUERY-STRING-BROWSE-1 FOR EACH T-comprobante_rendicion OF T-Rendicion_hd NO-LOCK, ~
    ...
    BY Fac_header.direccion ~
       BY Fac_header.fecha INDEXED-REPOSITION
...
&Scoped-define FIELDS-IN-QUERY-fMain T-Rendicion_hd.cant_recibos ~
T-Rendicion_hd.imp_imputado 
&Scoped-define OPEN-BROWSERS-IN-QUERY-fMain ~
    ~{&OPEN-QUERY-BROWSE-1}
&Scoped-define QUERY-STRING-fMain FOR EACH T-Rendicion_hd SHARE-LOCK
&Scoped-define OPEN-QUERY-fMain OPEN QUERY fMain FOR EACH T-Rendicion_hd SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-fMain T-Rendicion_hd
&Scoped-define FIRST-TABLE-IN-QUERY-fMain T-Rendicion_hd


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS b-acepta RECT-4 RECT-7 v-Pendiente ~
v-importependiente v-hat v-cdg_cobrador t-Cambio b-cancela BROWSE-1 b-lista ~
b-ninguno B-TODO bVer-2 
...
v-cdg_cobrador v-fch_rendicion v-cdg_administrador v-dsc_administrador ~
t-Cambio 
...
DEFINE BUTTON bVer-2  NO-FOCUS
     LABEL "&Ver" 
     SIZE 14 BY 1.

DEFINE VARIABLE v-cdg_cobrador AS CHARACTER FORMAT "X(256)":U 
     LABEL "Cobrador" 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 144 BY 18.57
         BGCOLOR 15 FGCOLOR 9 FONT 6 ROW-HEIGHT-CHARS .67 NO-EMPTY-SPACE.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME fMain
     b-acepta AT ROW 1.48 COL 124 WIDGET-ID 8
     T-Rendicion_hd.cant_recibos AT ROW 1.48 COL 13 COLON-ALIGNED WIDGET-ID 16
          LABEL "Recibos" FORMAT ">>9"
          VIEW-AS FILL-IN 
          SIZE 8 BY 1
          BGCOLOR 15 FGCOLOR 9 FONT 6 NO-TAB-STOP 
     T-Rendicion_hd.imp_imputado AT ROW 1.48 COL 32 COLON-ALIGNED WIDGET-ID 18
          LABEL "Importe"
          VIEW-AS FILL-IN 
          SIZE 12 BY 1
          BGCOLOR 15 FGCOLOR 9 FONT 6 NO-TAB-STOP 
     v-Pendiente AT ROW 1.48 COL 55 COLON-ALIGNED WIDGET-ID 4 NO-TAB-STOP 
     v-importependiente AT ROW 1.48 COL 63 COLON-ALIGNED NO-LABEL WIDGET-ID 6 NO-TAB-STOP 
     v-hat AT ROW 1.48 COL 98 COLON-ALIGNED WIDGET-ID 14 NO-TAB-STOP 
     v-cdg_cobrador AT ROW 2.67 COL 13 COLON-ALIGNED WIDGET-ID 42
     v-fch_rendicion AT ROW 2.67 COL 98 COLON-ALIGNED HELP
          "Fecha de la rendición" WIDGET-ID 44
          LABEL "Fecha Cobro"
          BGCOLOR 15 FGCOLOR 9 
     v-cdg_administrador AT ROW 3.86 COL 13 COLON-ALIGNED WIDGET-ID 26
     v-dsc_administrador AT ROW 3.86 COL 28 COLON-ALIGNED HELP
          "Denominacion" NO-LABEL WIDGET-ID 28 NO-TAB-STOP 
     t-Cambio AT ROW 5.52 COL 56 WIDGET-ID 48 NO-TAB-STOP 
     b-cancela AT ROW 3.86 COL 124 WIDGET-ID 12
     BROWSE-1 AT ROW 6.71 COL 1.6 WIDGET-ID 200
     b-lista AT ROW 2.67 COL 124 WIDGET-ID 10 NO-TAB-STOP 
     b-ninguno AT ROW 5.43 COL 22 WIDGET-ID 38
     B-TODO AT ROW 5.43 COL 4.6 WIDGET-ID 34
     bVer-2 AT ROW 3.86 COL 100 WIDGET-ID 32 NO-TAB-STOP 
     RECT-4 AT ROW 1.24 COL 1 WIDGET-ID 20
     RECT-7 AT ROW 1.24 COL 121 WIDGET-ID 22
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 146.4 BY 24.67 WIDGET-ID 100.
...
/* SETTINGS FOR FRAME fMain
   FRAME-NAME                                                           */
/* BROWSE-TAB BROWSE-1 b-cancela fMain */
...
/* SETTINGS FOR FILL-IN T-Rendicion_hd.imp_imputado IN FRAME fMain
   NO-ENABLE EXP-LABEL                                                  */
/* SETTINGS FOR FILL-IN v-cdg_administrador IN FRAME fMain
   NO-ENABLE                                                            */
...
ASSIGN 
       v-importependiente:READ-ONLY IN FRAME fMain        = TRUE.

ASSIGN 
       v-Pendiente:READ-ONLY IN FRAME fMain        = TRUE.
...
/* Query rebuild information for BROWSE BROWSE-1
     ...
     _OrdList          = "sic.Fac_header.direccion|yes,sic.Fac_header.fecha|yes"
...
/* Query rebuild information for FRAME fMain
     _TblList          = "Temp-Tables.T-Rendicion_hd"
     _Query            is OPENED
*/  /* FRAME fMain */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME bVer-2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bVer-2 wWin
ON CHOOSE OF bVer-2 IN FRAME fMain /* Ver */
DO:
...
ON RETURN OF v-cdg_cobrador IN FRAME fMain /* Cobrador */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-cdg_cobrador wWin
ON VALUE-CHANGED OF v-cdg_cobrador IN FRAME fMain /* Cobrador */
DO:
    ASSIGN v-cdg_cobrador.
    IF v-cdg_cobrador = "zzz" THEN RETURN NO-APPLY.
        
    v-cdg_administrador:SENSITIVE = TRUE.
    v-fch_rendicion:SENSITIVE = TRUE.
    /* FFFerver t-Cambio = TRUE. */
END.
...
ON LEAVE OF v-fch_rendicion IN FRAME fMain /* Fecha Cobro */
DO:
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN T-Caj_header.importe         = T-Rendicion_hd.imp_imputado
           T-Caj_header.fecha           = T-Rendicion_hd.fch_rendicion.
...
v-cdg_cobrador = "ZZZ".
v-fch_rendicion = ?.
v-cdg_administrador:SENSITIVE = FALSE.
...
------------------------------------------------------------------------------*/
  ...
  {&OPEN-QUERY-fMain}
  GET FIRST fMain.
  DISPLAY v-Pendiente v-importependiente v-hat v-cdg_cobrador v-fch_rendicion 
          v-cdg_administrador v-dsc_administrador t-Cambio 
      WITH FRAME fMain IN WINDOW wWin.
  IF AVAILABLE T-Rendicion_hd THEN 
    DISPLAY T-Rendicion_hd.cant_recibos T-Rendicion_hd.imp_imputado 
      WITH FRAME fMain IN WINDOW wWin.
  ENABLE b-acepta RECT-4 RECT-7 v-Pendiente v-importependiente v-hat 
         v-cdg_cobrador t-Cambio b-cancela BROWSE-1 b-lista b-ninguno B-TODO 
         bVer-2 
      WITH FRAME fMain IN WINDOW wWin.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      lista = "[Indique Cobrador]|ZZZ".
      v-cdg_cobrador:DELIMITER = "|".
      FOR EACH Cobrador NO-LOCK BY Cobrador.nom_cobrador:
          lista = lista + "|" + TRIM(Cobrador.nom_cobrador) + "|" + Cobrador.cdg_cobrador.
      END.
      v-cdg_cobrador:LIST-ITEM-PAIRS = lista.
      v-cdg_cobrador = "ZZZ".
...
DEFINE BUFFER bT-comprobante_rendicion FOR T-comprobante_rendicion.
  ...
  v-cdg_cobrador = IF AVAILABLE Cobrador THEN Cobrador.cdg_cobrador ELSE "ZZZ".
