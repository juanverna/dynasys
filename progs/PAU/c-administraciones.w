  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             INPUT  {&WINDOW-NAME} ,
             INPUT  'FolderLabels':U + '' + 'FolderTabWidth?FolderFont-1HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_folder ).
       RUN repositionObject IN h_folder ( 2.00 , 3.80 ) NO-ERROR.
       RUN resizeObject IN h_folder ( 4.48 , 165.80 ) NO-ERROR.
