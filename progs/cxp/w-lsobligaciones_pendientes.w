...
DEFINE FRAME F-Main
     ...
     "  Rango de fechas de los movimientos:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 9.33 COL 14
          BGCOLOR 5 FGCOLOR 15 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Obligaciones Pendientes por Proveedor/Fecha"
         HEIGHT             = 23.05
         WIDTH              = 120.2
         MAX-HEIGHT         = 23.05
         MAX-WIDTH          = 120.2
         VIRTUAL-HEIGHT     = 23.05
         VIRTUAL-WIDTH      = 120.2
         RESIZE             = no
         SCROLL-BARS        = no
         STATUS-AREA        = no
...
ON END-ERROR OF W-Win /* Obligaciones Pendientes por Proveedor/Fecha */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Obligaciones Pendientes por Proveedor/Fecha */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-esp-moneda ( 6.67 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 10.43 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXP" "Obligaciones Pendientes por Proveedor/Fecha"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsobligaciones_pendientes.p ( INPUT des_proveedor,
                                         INPUT has_proveedor,
                                         INPUT des_nombre, 
                                         INPUT has_nombre, 
                                         INPUT que_moneda, 
