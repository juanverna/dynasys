...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Obligaciones Canceladas por Fecha"
         HEIGHT             = 22.81
         WIDTH              = 119.2
         MAX-HEIGHT         = 22.81
         MAX-WIDTH          = 119.2
...
ON END-ERROR OF W-Win /* Obligaciones Canceladas por Fecha */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Obligaciones Canceladas por Fecha */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXP" "Obligaciones Canceladas por Fecha"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lspagos_xfecha.p ( INPUT des_proveedor,
                              INPUT has_proveedor,
                              INPUT que_moneda, 
                              INPUT des_fecha,
                              INPUT has_fecha).
