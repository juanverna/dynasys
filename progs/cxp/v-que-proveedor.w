...
DEFINE VARIABLE v-solocyorden AS LOGICAL.
...
DEFINE FRAME F-Main
     des_registro AT ROW 1.81 COL 16 COLON-ALIGNED
     des_nombre AT ROW 1.81 COL 32 COLON-ALIGNED NO-LABEL
...
ON + OF des_registro IN FRAME F-Main /* Proveedor */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL des_registro V-table-Win
ON MOUSE-MENU-DOWN OF des_registro IN FRAME F-Main /* Proveedor */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL des_registro V-table-Win
ON RETURN OF des_registro IN FRAME F-Main /* Proveedor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
        ...
        IF v-solocyorden
        THEN DO:
            FIND Proveedor WHERE Proveedor.cdg_proveedor = des_registro NO-LOCK.
            IF NOT Proveedor.cyorden_sino
            THEN DO:
                MESSAGE "El proveedor indicado no está habilitado para las operaciones por cuenta y orden"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE habilitar_solocyorden V-table-Win 
PROCEDURE habilitar_solocyorden :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  ...
  DEFINE INPUT PARAMETER p-solocyorden AS LOGICAL.

  v-solocyorden = p-solocyorden.
