...
/*------------------------------------------------------------------------------*/
/* CALCULA LA FECHA DE DEPOSITO DE LAS RETENCIONES COMO EL 15 DEL MES SIGUIENTE si es del 15 en adelante sino el mismo mes */
/*------------------------------------------------------------------------------*/

que_ano = YEAR(T-Opg_header.fecha).
IF  DAY(T-Opg_header.fecha) > 15 THEN
    que_mes = MONTH(T-Opg_header.fecha) + 1.
ELSE
    que_mes = MONTH(T-Opg_header.fecha).
IF que_mes = 13 
THEN DO:
    que_ano = que_ano + 1.
    que_mes = 1.
