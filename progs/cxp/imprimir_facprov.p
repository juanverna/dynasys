...
/*==================================================================*/
   ...
   DEFINE INPUT PARAMETER rid_facprov AS ROWID.
   
   {parlocales.i}

   RUN PRFAPRO.P (INPUT rid_facprov).  /* ARREGLAR ACA LA REIMPRESION DE LA FACTURA */
   RETURN.
/*
/*==================================================================*/
/*                             VARIABLES                            */
...
/*==================================================================*/
   ...
   RUN getparametro.p (  INPUT  "NFFAPROV",
                         OUTPUT v-valor_c,
                         OUTPUT v-valor_d,
                         OUTPUT v-valor_l,
                         OUTPUT v-valor_n,
                         OUTPUT v-observacion ).
   que_rutina = "PRFPR" + STRING(v-valor_n, "999") + ".P".

   RUN getparametro.p (  INPUT  "NCOPFAPR",
                         OUTPUT v-valor_c,
                         OUTPUT v-valor_d,
                         OUTPUT v-valor_l,
                         OUTPUT v-valor_n,
   ...
   DO j = 1 TO ncopias:
      ...
      RUN VALUE(que_rutina) (INPUT rid_facprov).
