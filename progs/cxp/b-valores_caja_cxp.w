...
v-des_fecha v-has_fecha v-referencia v-fecha_deposito btn_depositar ~
btn_seltodos btn_desmarcar btn_verlog btn_listar btn_comprobante ~
v-cantcheques v-totdeposito br_table RECT-1 RECT-2 RECT-3 RECT-4 RECT-5 
...
v-fecha_deposito v-cantcheques v-totdeposito 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 133 BY 14.52
         BGCOLOR 15 FGCOLOR 9 
...
DEFINE FRAME F-Main
     ...
     btn_depositar AT ROW 6.95 COL 2
     btn_seltodos AT ROW 6.95 COL 17
     btn_desmarcar AT ROW 6.95 COL 32
     btn_verlog AT ROW 6.95 COL 47
     btn_listar AT ROW 6.95 COL 62
     btn_comprobante AT ROW 6.95 COL 77
     v-cantcheques AT ROW 6.95 COL 99 COLON-ALIGNED
     v-totdeposito AT ROW 6.95 COL 113 COLON-ALIGNED
     br_table AT ROW 8.86 COL 2
     RECT-1 AT ROW 1 COL 1
     RECT-2 AT ROW 4.57 COL 1
     RECT-3 AT ROW 6.71 COL 1
     RECT-4 AT ROW 1 COL 112
     RECT-5 AT ROW 8.62 COL 1
...
"Valor.observacion" "Observación!Cheque" "X(55)" "character" ? ? ? ? ? ? no ? no no "72.8" yes no no "U" "" ""
