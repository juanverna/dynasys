...
DEFINE FRAME F-Main
     v-estado AT ROW 21.48 COL 12 COLON-ALIGNED NO-LABEL
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Total de Compras por Proveedor y Artículo"
         HEIGHT             = 26.1
         WIDTH              = 122.2
         MAX-HEIGHT         = 26.1
         MAX-WIDTH          = 122.2
...
ON END-ERROR OF W-Win /* Total de Compras por Proveedor y Artículo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Total de Compras por Proveedor y Artículo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-proveedor ( 3.62 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 8.00 , 14.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst_atributos_articulo ( 12.19 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-cotiza-moneda.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-cotiza-moneda ).
       RUN set-position IN h_v-cotiza-moneda ( 16.14 , 14.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 22.86 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.62 , 100.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXP" "Total de Compras por Proveedor y Artículo"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lstot_proveedores_articulos.p ( INPUT des_proveedor,
                                           INPUT has_proveedor,
                                           INPUT des_fecha,
                                           INPUT has_fecha,
                                           INPUT YES,
