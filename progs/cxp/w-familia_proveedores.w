...
DEFINE VARIABLE h_b-familia_proveedores AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-familia_proveedores AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Mantenimiento de Familias de Proveedores */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Mantenimiento de Familias de Proveedores */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Mantenimiento de Familias de Proveedores */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-familia_proveedores.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-familia_proveedores ).
       RUN set-position IN h_b-familia_proveedores ( 1.71 , 5.00 ) NO-ERROR.
       RUN set-size IN h_b-familia_proveedores ( 20.00 , 24.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-familia_proveedores.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-familia_proveedores ).
       RUN set-position IN h_v-familia_proveedores ( 1.71 , 31.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 8.14 , 31.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.14 , 90.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-familia_proveedores. */
       RUN add-link IN adm-broker-hdl ( h_b-familia_proveedores , 'Record':U , h_v-familia_proveedores ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-familia_proveedores ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-familia_proveedores ,
             h_b-familia_proveedores , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-familia_proveedores , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXP" "Mantenimiento de Familias de Proveedores"}
