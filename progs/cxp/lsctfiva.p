...
DEFINE QUERY qry_certificados   FOR Certificado_iva, Tipo_retiva, Proveedor.
...
OUTPUT TO VALUE(DIRE_TMP + "lsctfiva.txt") PAGED PAGE-SIZE 72.

GET FIRST qry_certificados.
DO WHILE AVAILABLE Certificado_iva:

   VIEW FRAME frm-titulo.
   DISPLAY Certificado_iva.nro_certifiva FORMAT "ZZZZZ9"
           Proveedor.cdg_proveedor
           Proveedor.nombre FORMAT "X(20)"
           Tipo_retiva.abrevia
           Certificado_iva.fecha_emision
...
UNDERLINE  Certificado_iva.nro_certifiva
           Proveedor.cdg_proveedor
           Proveedor.nombre
           Tipo_actividad.abrevia
           Certificado_iva.fecha_emision
...
RUN PRINFILE.P ( INPUT DIRE_TMP + "lsctfiva.txt", INPUT port).
