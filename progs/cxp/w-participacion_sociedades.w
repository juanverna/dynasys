...
DEFINE VARIABLE h_b-participacion_societaria AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_b-proveedores ( 26.19 , 18.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'cxp/b-participacion_societaria.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-participacion_societaria ).
       RUN set-position IN h_b-participacion_societaria ( 2.91 , 22.00 ) NO-ERROR.
       RUN set-size IN h_b-participacion_societaria ( 24.29 , 97.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-dsc_proveedor. */
       RUN add-link IN adm-broker-hdl ( h_b-proveedores , 'Record':U , h_v-dsc_proveedor ).

       /* Links to SmartBrowser h_b-participacion_societaria. */
       RUN add-link IN adm-broker-hdl ( h_b-proveedores , 'Record':U , h_b-participacion_societaria ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-dsc_proveedor ,
             h_b-proveedores , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-participacion_societaria ,
             h_v-dsc_proveedor , 'AFTER':U ).
    END. /* Page 0 */
