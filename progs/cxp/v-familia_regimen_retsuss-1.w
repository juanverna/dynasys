...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Famretsuss_regimen Familia_retsus
&Scoped-define FIRST-EXTERNAL-TABLE Famretsuss_regimen


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Famretsuss_regimen, Familia_retsus.
...
DEFINE FRAME F-Main
     ...
     Famretsuss_regimen.cdg_condiva AT ROW 2.19 COL 36 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: sic.Famretsuss_regimen,sic.Familia_retsus
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "Familia_retsus"}
  ...
  {src/adm/template/row-find.i "Familia_retsus"}
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
   ...
   IF NEW Famretsuss_regimen
      THEN ASSIGN Famretsuss_regimen.cdg_Famretsuss = Familia_retsus.cdg_Famretsuss.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "Familia_retsus"}
