...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Proveedor WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Proveedor WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Proveedor
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Proveedor
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nro_entidad,nombre,cdg_proveedor"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD que_registro q-tables 
FUNCTION que_registro RETURNS ROWID
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION que_registro q-tables 
FUNCTION que_registro RETURNS ROWID
...
------------------------------------------------------------------------------*/
  ...
  RETURN ROWID(proveedor).   /* Function return value. */
