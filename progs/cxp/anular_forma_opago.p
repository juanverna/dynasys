...
FORM
   ...
   WITH FRAME frm-rango SIDE-LABELS CENTERED ROW 3 FGCOLOR 0 /*f-fg_c*/ BGCOLOR 8 /*f-bg_c*/
        VIEW-AS DIALOG-BOX THREE-D TITLE "Anulación de Formularios de Ordenes de Pago" FONT 6.
...
ENABLE ALL EXCEPT pto_venta des_forma tip_forma WITH FRAME frm-rango.
