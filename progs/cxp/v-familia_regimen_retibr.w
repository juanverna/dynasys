...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Famretibr_regimen Familia_retibr
&Scoped-define FIRST-EXTERNAL-TABLE Famretibr_regimen


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Famretibr_regimen, Familia_retibr.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Famretibr_regimen.cdg_condiva 
&Scoped-define ENABLED-TABLES Famretibr_regimen
&Scoped-define FIRST-ENABLED-TABLE Famretibr_regimen
&Scoped-Define ENABLED-OBJECTS RECT-8 
&Scoped-Define DISPLAYED-FIELDS Famretibr_regimen.cdg_condiva 
&Scoped-define DISPLAYED-TABLES Famretibr_regimen
&Scoped-define FIRST-DISPLAYED-TABLE Famretibr_regimen
&Scoped-Define DISPLAYED-OBJECTS v-cdg_condicion_impos ~
v-dsc_condicion_impos v-cdg_Tipo_retibr v-dsc_Tipo_retibr 
...
DEFINE VARIABLE v-cdg_Tipo_retibr AS CHARACTER FORMAT "X(8)" INITIAL "0" 
     LABEL "Reg.Ibr" 
     VIEW-AS FILL-IN 
     SIZE 13 BY 1
     BGCOLOR 15 FGCOLOR 9 .
...
DEFINE VARIABLE v-dsc_Tipo_retibr AS CHARACTER FORMAT "X(35)" 
     VIEW-AS FILL-IN 
     SIZE 68 BY 1
     BGCOLOR 7 FGCOLOR 15 .
...
DEFINE FRAME F-Main
     ...
     Famretibr_regimen.cdg_condiva AT ROW 2.19 COL 36 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     v-cdg_Tipo_retibr AT ROW 2.67 COL 15 COLON-ALIGNED
     v-dsc_Tipo_retibr AT ROW 2.67 COL 29 COLON-ALIGNED HELP
          "Denominacion" NO-LABEL
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: sic.Famretibr_regimen,sic.Familia_retibr
...
ASSIGN 
       Famretibr_regimen.cdg_condiva:HIDDEN IN FRAME F-Main           = TRUE.
...
ON MOUSE-SELECT-DBLCLICK OF v-cdg_Tipo_retibr IN FRAME F-Main /* Reg.Ibr */
OR "." OF v-cdg_Tipo_retibr IN FRAME {&FRAME-NAME}
OR MOUSE-MENU-DOWN OF v-cdg_Tipo_retibr IN FRAME {&FRAME-NAME}
DO:

   {helptabla.i "Tipo_retibr" "cdg_tiporetibr" "selrtibr.p"}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-cdg_Tipo_retibr V-table-Win
ON RETURN OF v-cdg_Tipo_retibr IN FRAME F-Main /* Reg.Ibr */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "Famretibr_regimen"}
  ...
  {src/adm/template/row-find.i "Famretibr_regimen"}
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
   ...
   &SCOPED-DEFINE TABLA-MAESTRA  Famretibr_regimen

   {validartabla.i "Tipo_retibr" "cdg_tiporetibr" "nom_retibr" "CLIE005"}
  ...
  /* Code placed here will execute AFTER standard behavior.    */
   ...
   IF NEW Famretibr_regimen
      THEN ASSIGN Famretibr_regimen.cdg_famretibr = Familia_retibr.cdg_famretibr.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE Famretibr_regimen
  THEN DO:
