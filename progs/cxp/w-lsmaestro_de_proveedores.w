...
DEFINE FRAME F-Main
     ...
     "  Rango de proveedores a listar:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 3.86 COL 14
...
ON END-ERROR OF W-Win /* Facturas x cliente */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Facturas x cliente */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-proveedor ( 5.52 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
   ...
   RUN habilitar_verpor IN h_v-rng-proveedor ( INPUT YES ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXP" "Reporte de Maestro de Proveedores"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       IF ver_por = 2
         THEN RUN LSMAEPRA.P ( INPUT des_nombre, 
                               INPUT has_nombre).
         ELSE RUN LSMAEPRC.P ( INPUT des_proveedor, 
                               INPUT has_proveedor).
