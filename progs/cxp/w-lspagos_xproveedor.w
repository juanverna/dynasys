...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Obligaciones Canceladas por Proveedor/Fecha"
         HEIGHT             = 23.24
         WIDTH              = 123
         MAX-HEIGHT         = 23.24
         MAX-WIDTH          = 123
...
ON END-ERROR OF W-Win /* Obligaciones Canceladas por Proveedor/Fecha */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Obligaciones Canceladas por Proveedor/Fecha */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXP" "Obligaciones Canceladas por Proveedor/Fecha"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lspagos_xproveedor.p ( INPUT des_proveedor,
                                  INPUT has_proveedor,
                                  INPUT des_fecha,
                                  INPUT has_fecha,
                                  INPUT que_moneda).
