/*=================================================================================*/
/*          LISTA TODOS LOS CERTIFICADOS DE INGRESOS BRUTOS DE UN PERIODO          */
/*=================================================================================*/
...
DEFINE VARIABLE t-retenido            LIKE Certificado_ibr.imp_retenido.
...
FORM
  ...
  Proveedor.nombre
  Certificado_ibr.cdg_tiporetibr
  Tipo_retibr.abrevia
...
CASE ver_pagos:
    WHEN todos
    THEN DO:
         titulo-f = "Certificados de retención de Ingresos Brutos emitidos o no".
    END.
    WHEN ya_emi
    THEN DO:
         titulo-f = "Certificados de retención de Ingresos Brutos ya emitidos".
    END.
    WHEN no_emi
    THEN DO:
         titulo-f = "Certificados de retención de Ingresos Brutos pendientes de emisión".
    END.
    WHEN nulos
    THEN DO:
         titulo-f = "Certificados de retención de Ingresos Brutos anulados".
    END.
END CASE.
RUN ABRE_QUERY.
...
DO WHILE AVAILABLE Certificado_ibr:
   ...
   DISPLAY Certificado_ibr.nro_certifibr
    ...
    t-retenido = t-retenido + Certificado_ibr.imp_retenido.
...
DISPLAY "Total Certificados" @ Proveedor.nombre
        t-retenido           @ Certificado_ibr.imp_retenido
        WITH FRAME frm-listado.
