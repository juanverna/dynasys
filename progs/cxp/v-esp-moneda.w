...
ON + OF des_registro IN FRAME F-Main /* Moneda */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL des_registro V-table-Win
ON MOUSE-MENU-DOWN OF des_registro IN FRAME F-Main /* Moneda */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL des_registro V-table-Win
ON RETURN OF des_registro IN FRAME F-Main /* Moneda */
DO:

    ASSIGN FRAME {&FRAME-NAME} des_registro.
    IF SELF:SCREEN-VALUE IN FRAME {&FRAME-NAME} <> ""
        THEN FIND FIRST Moneda WHERE Moneda.cdg_moneda >= SELF:SCREEN-VALUE IN FRAME {&FRAME-NAME} NO-LOCK NO-ERROR.
        ELSE FIND FIRST Moneda NO-LOCK NO-ERROR.
    
    IF AVAILABLE Moneda 
    THEN DO:
         des_nombre   = Moneda.descripcion.
         des_registro = Moneda.cdg_moneda.
    END.
    ELSE DO:
         des_nombre = "???".
    END.
