...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Famretsuss_regimen Familia_retsuss
&Scoped-define FIRST-EXTERNAL-TABLE Famretsuss_regimen


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Famretsuss_regimen, Familia_retsuss.
/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS Famretsuss_regimen.cdg_condiva 
&Scoped-define ENABLED-TABLES Famretsuss_regimen
&Scoped-define FIRST-ENABLED-TABLE Famretsuss_regimen
&Scoped-Define ENABLED-OBJECTS RECT-8 
&Scoped-Define DISPLAYED-FIELDS Famretsuss_regimen.cdg_condiva 
&Scoped-define DISPLAYED-TABLES Famretsuss_regimen
&Scoped-define FIRST-DISPLAYED-TABLE Famretsuss_regimen
&Scoped-Define DISPLAYED-OBJECTS v-cdg_condicion_impos ~
v-dsc_condicion_impos v-cdg_Tipo_retsus v-dsc_Tipo_retsus 
...
DEFINE VARIABLE v-cdg_Tipo_retsus AS CHARACTER FORMAT "X(8)" INITIAL "0" 
     LABEL "Actividad" 
     VIEW-AS FILL-IN 
     SIZE 13 BY 1
     BGCOLOR 15 FGCOLOR 9 .
...
DEFINE VARIABLE v-dsc_Tipo_retsus AS CHARACTER FORMAT "X(35)" 
     VIEW-AS FILL-IN 
     SIZE 68 BY 1
     BGCOLOR 7 FGCOLOR 15 .
...
DEFINE FRAME F-Main
     ...
     Famretsuss_regimen.cdg_condiva AT ROW 2.19 COL 51 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 4.8 BY 1
     v-cdg_Tipo_retsus AT ROW 2.67 COL 15 COLON-ALIGNED
     v-dsc_Tipo_retsus AT ROW 2.67 COL 29 COLON-ALIGNED HELP
          "Denominacion" NO-LABEL
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: sic.Famretsuss_regimen,sic.Familia_retsuss
...
ASSIGN 
       Famretsuss_regimen.cdg_condiva:HIDDEN IN FRAME F-Main           = TRUE.
...
ON MOUSE-SELECT-DBLCLICK OF v-cdg_Tipo_retsus IN FRAME F-Main /* Actividad */
OR "." OF v-cdg_Tipo_retsus IN FRAME {&FRAME-NAME}
OR MOUSE-MENU-DOWN OF v-cdg_Tipo_retsus IN FRAME {&FRAME-NAME}
DO:

   {helptabla.i "Tipo_retsus" "cdg_tiporetsus" "seltpatv.p"}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL v-cdg_Tipo_retsus V-table-Win
ON RETURN OF v-cdg_Tipo_retsus IN FRAME F-Main /* Actividad */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/row-list.i "Famretsuss_regimen"}
  ...
  {src/adm/template/row-find.i "Famretsuss_regimen"}
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
   ...
   &SCOPED-DEFINE TABLA-MAESTRA  Famretsuss_regimen

   {validartabla.i "Tipo_retsus" "cdg_tiporetsus" "nom_retsus" "CLIE005"}
  ...
  /* Code placed here will execute AFTER standard behavior.    */
   ...
   IF NEW Famretsuss_regimen
      THEN ASSIGN Famretsuss_regimen.cdg_famretsus = Familia_retsus.cdg_famretsus.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE Famretsuss_regimen
  THEN DO:
