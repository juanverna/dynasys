...
&Scoped-define INTERNAL-TABLES Domicilio_prv Provincia

/* Definitions for BROWSE BROWSE-2                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-2 Domicilio_prv.nro_domicilio ~
Domicilio_prv.nombre Domicilio_prv.direccion Provincia.nombre 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-2 
&Scoped-define QUERY-STRING-BROWSE-2 FOR EACH Domicilio_prv ~
      WHERE Domicilio_prv.nro_proveedor = Proveedor.nro_proveedor NO-LOCK, ~
      EACH Provincia OF Domicilio_prv NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-BROWSE-2 OPEN QUERY BROWSE-2 FOR EACH Domicilio_prv ~
      WHERE Domicilio_prv.nro_proveedor = Proveedor.nro_proveedor NO-LOCK, ~
      EACH Provincia OF Domicilio_prv NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-BROWSE-2 Domicilio_prv Provincia
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 Dialog-Frame _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      Domicilio_prv.nro_domicilio COLUMN-LABEL "Nro!Dom" FORMAT ">9":U
      Domicilio_prv.nombre COLUMN-LABEL "Nombre!Domicilio" FORMAT "X(33)":U
      Domicilio_prv.direccion COLUMN-LABEL "Dirección!Domicilio" FORMAT "X(32)":U
      Provincia.nombre COLUMN-LABEL "Provincia!Domicilio" FORMAT "X(15)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 92 BY 10.23
         BGCOLOR 15 FGCOLOR 9 
         TITLE BGCOLOR 15 FGCOLOR 9 "Domicilio_prvs del Proveedor actual".
...
DEFINE FRAME Dialog-Frame
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "Selección de domicilios de Proveedors"
...
/* Query rebuild information for BROWSE BROWSE-2
     _TblList          = "sic.Domicilio_prv,sic.Provincia OF sic.Domicilio_prv"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = "Domicilio_prv.nro_proveedor = Proveedor.nro_proveedor"
     _FldNameList[1]   > sic.Domicilio_prv.nro_domicilio
"Domicilio_prv.nro_domicilio" "Nro!Dom" ? "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > sic.Domicilio_prv.nombre
"Domicilio_prv.nombre" "Nombre!Domicilio" "X(33)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > sic.Domicilio_prv.direccion
"Domicilio_prv.direccion" "Dirección!Domicilio" "X(32)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Selección de domicilios de Proveedors */
DO:
...
ON MOUSE-SELECT-DBLCLICK OF BROWSE-2 IN FRAME Dialog-Frame /* Domicilio_prvs del Proveedor actual */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-2 Dialog-Frame
ON RETURN OF BROWSE-2 IN FRAME Dialog-Frame /* Domicilio_prvs del Proveedor actual */
DO:
   APPLY "CHOOSE" TO Btn_OK IN FRAME {&FRAME-NAME}.    
END.
...
IF NOT AVAILABLE Proveedor THEN FIND Proveedor WHERE cdg_proveedor = "B00012" NO-ERROR.
ASSIGN
