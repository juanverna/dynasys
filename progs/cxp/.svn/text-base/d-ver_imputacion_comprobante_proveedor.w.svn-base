...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 123 BY 8.1
         FONT 2.
...
DEFINE FRAME Dialog-Frame
     BROWSE-10 AT ROW 1.81 COL 4
     RECT-12 AT ROW 1.29 COL 2
...
"sic.Cuenta.nombre_cta" "Nombre!Cuenta" "X(28)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
...
FIND Tipocomprobante OF T-Sub_header_prv NO-LOCK.
...
THEN DO:
    ...
    /*     T-Asn_detalle.nro_obra    = T-Sub_header_prv.nro_obra */
...
FOR EACH T-Sub_detalle_prv:
    CREATE T-Asn_detalle.
    ASSIGN T-Asn_detalle.credito     = T-Sub_detalle_prv.valor
           T-Asn_detalle.debito      = 0
           T-Asn_detalle.nro_cuenta  = T-Sub_detalle_prv.nro_cuenta
           T-Asn_detalle.nro_entidad = T-Sub_detalle_prv.nro_entidad
           T-Asn_detalle.nro_obra    = T-Sub_detalle_prv.nro_obra
           T-Asn_detalle.nro_linea   = nl
           nl                        = nl + 1.
    
    IF Tipocomprobante.debita
       THEN ASSIGN T-Asn_detalle.credito     = T-Sub_detalle_prv.valor
                   T-Asn_detalle.debito      = 0.
...
THEN DO:
    CREATE T-Asn_detalle.
    ASSIGN T-Asn_detalle.credito     = T-Sub_header_prv.imp_total
           T-Asn_detalle.debito      = 0
           T-Asn_detalle.nro_cuenta  = T-Sub_header_prv.nro_cuenta
           T-Asn_detalle.nro_entidad = T-Sub_header_prv.nro_entidad
    /*     T-Asn_detalle.nro_obra    = T-Sub_header_prv.nro_obra */
