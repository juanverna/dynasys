...
DO TRANSACTION:
    ...
    FIND Certificado_sus WHERE ROWID(Certificado_sus) = que_certificado EXCLUSIVE-LOCK.
    
    RUN getparametro.p (  INPUT  "NFRETSUS",
                          OUTPUT v-valor_c,
                          OUTPUT v-valor_d,
                          OUTPUT v-valor_l,
                          OUTPUT v-valor_n,
                          OUTPUT v-observacion ).
    que_rutina = "PRRTSUS" + STRING(v-valor_n, "999") + ".P".
