...
&Scoped-Define ENABLED-OBJECTS RECT-1 v-lis_fecha v-lista_tipos 
&Scoped-Define DISPLAYED-OBJECTS v-lis_fecha v-lista_tipos 
...
DEFINE FRAME F-Main
     v-lis_fecha AT ROW 1.29 COL 18
     v-lista_tipos AT ROW 2.33 COL 16 COLON-ALIGNED
