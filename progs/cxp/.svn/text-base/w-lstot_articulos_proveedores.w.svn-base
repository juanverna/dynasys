...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Total de Compras por Articulo y Proveedor"
         HEIGHT             = 26.19
         WIDTH              = 122.2
         MAX-HEIGHT         = 26.33
         MAX-WIDTH          = 160
...
ON END-ERROR OF W-Win /* Total de Compras por Articulo y Proveedor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Total de Compras por Articulo y Proveedor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-articulo ( 3.43 , 14.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXP" "Total de Compras por Articulo y Proveedor"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lstot_articulos_proveedores.p ( INPUT des_articulo,
                                           INPUT has_articulo,
                                           INPUT des_fecha,
                                           INPUT has_fecha,
                                           INPUT YES,
