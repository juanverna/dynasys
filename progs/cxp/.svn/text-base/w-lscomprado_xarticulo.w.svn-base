...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Total comprado x artículo"
         HEIGHT             = 22.14
         WIDTH              = 123.6
         MAX-HEIGHT         = 22.14
         MAX-WIDTH          = 123.6
...
ON END-ERROR OF W-Win /* Total comprado x artículo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Total comprado x artículo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXP" "Total Comprado x Artículo"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lscomprado_xarticulo.p ( INPUT des_articulo,
                                     INPUT has_articulo,
                                     INPUT des_fecha,
                                     INPUT has_fecha
                                    ).
