...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "ABM Tipo de Actividad de Proveedor"
         HEIGHT             = 20.71
         WIDTH              = 119.8
         MAX-HEIGHT         = 26.62
         MAX-WIDTH          = 159.6
...
ON END-ERROR OF W-Win /* ABM Tipo de Actividad de Proveedor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* ABM Tipo de Actividad de Proveedor */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* ABM Tipo de Actividad de Proveedor */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'cxp/b-tipoactividad.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tipoactividad ).
       RUN set-position IN h_b-tipoactividad ( 1.95 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-tipoactividad ( 19.38 , 12.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'cxp/v-tipoactividad.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-tipoactividad ).
       RUN set-position IN h_v-tipoactividad ( 1.95 , 21.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 7.43 , 21.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 1.76 , 96.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-tipoactividad ,
