...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Obligaciones Pendientes por Fecha"
         HEIGHT             = 23
         WIDTH              = 121.6
         MAX-HEIGHT         = 23
         MAX-WIDTH          = 121.6
...
ON END-ERROR OF W-Win /* Obligaciones Pendientes por Fecha */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Obligaciones Pendientes por Fecha */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/CXP" "Obligaciones Pendientes por Fecha"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN lsobligaciones_xfecha.p ( INPUT des_proveedor,
                                     INPUT has_proveedor,
                                     INPUT que_moneda, 
                                     INPUT ver_por,
                                     INPUT des_fecha,
