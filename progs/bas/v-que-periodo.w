...
&Scoped-Define ENABLED-OBJECTS RECT-1 v-mes v-ano 
&Scoped-Define DISPLAYED-OBJECTS v-mes v-ano 
...
DEFINE FRAME F-Main
     v-mes AT ROW 1.71 COL 41.8 COLON-ALIGNED WIDGET-ID 6
     v-ano AT ROW 1.71 COL 49.8 COLON-ALIGNED WIDGET-ID 4
...
------------------------------------------------------------------------------*/
  ...
  DEFINE OUTPUT PARAMETER p-periodo   AS char.
  DEFINE OUTPUT PARAMETER error_rango       AS LOGICAL.
  error_rango = NO.
  ASSIGN FRAME {&FRAME-NAME} v-mes v-ano.

        p-periodo = STRING(v-mes,"99") + STRING(v-ano,"9999").
  END PROCEDURE.
