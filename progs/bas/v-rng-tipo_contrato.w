...
&Scoped-Define ENABLED-OBJECTS RECT-1 c_nro_tipo_evento dsc_tipo_evento 
...
DEFINE FRAME F-Main
     c_nro_tipo_evento AT ROW 1.71 COL 32 COLON-ALIGNED WIDGET-ID 14
     dsc_tipo_evento AT ROW 1.71 COL 44 COLON-ALIGNED NO-LABEL WIDGET-ID 12
...
------------------------------------------------------------------------------*/
  ...
  DEFINE OUTPUT PARAMETER p-c_nro_tipo_evento   AS integer.
  ...
  DO WITH FRAME {&FRAME-NAME}:
        ...
        IF c_nro_tipo_evento:screen-value = "" then error_rango = YES.
        IF NOT error_rango
        THEN DO:
            p-c_nro_tipo_evento = c_nro_tipo_evento.
        END.
  END.
