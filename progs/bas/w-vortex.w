...
DEFINE BUTTON BUTTON-1 
     IMAGE-UP FILE "c:/dynasys10/imagenes/vortex100.jpg":U
     LABEL "Button 1" 
...
DEFINE FRAME F-Main
     BUTTON-1 AT ROW 1.71 COL 6 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 38.2 BY 8.67 WIDGET-ID 100.
...
DO:
  ...
  REPEAT i = 1 TO self:NUM-DROPPED-FILES:
      ...
      IF vaccion = "G" OR vaccion = "V" THEN do: /*grabar o versionar*/
                              ...
                              COPY-LOB FROM FILE SELF:GET-DROPPED-FILE(i) TO OBJECT vortex.archivo.
      END.
  END.
  self:END-FILE-DROP() .
