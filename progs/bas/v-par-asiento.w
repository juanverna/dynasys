...
&Scoped-Define ENABLED-OBJECTS v-ver_resum v-ver_movim v-gen_asiento ~
v-fecha_contable RECT-1 
&Scoped-Define DISPLAYED-OBJECTS v-ver_resum v-ver_movim v-gen_asiento ~
v-fecha_contable 
...
DEFINE FRAME F-Main
     v-ver_resum AT ROW 1.71 COL 35
     v-ver_movim AT ROW 1.71 COL 55
     v-gen_asiento AT ROW 1.71 COL 78
     v-fecha_contable AT ROW 1.81 COL 16 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  ...
  v-ver_movim:SENSITIVE IN FRAME {&FRAME-NAME} = p-habilitado.
  v-ver_resum:SENSITIVE IN FRAME {&FRAME-NAME} = p-habilitado.
