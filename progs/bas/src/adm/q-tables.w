...
&Scoped-define INTERNAL-TABLES Actividad_proveedor

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH Actividad_proveedor WHERE TRUE /* Join to Acumulado_caja incomplete */ NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Actividad_proveedor WHERE TRUE /* Join to Acumulado_caja incomplete */ NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main Actividad_proveedor
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Actividad_proveedor
...
<FOREIGN-KEYS>
nro_proveedor||y|sic.Actividad_proveedor.nro_proveedor
cdg_tiporetgan||y|sic.Actividad_proveedor.cdg_tiporetgan
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nro_proveedor,cdg_tiporetgan"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "sic.Actividad_proveedor WHERE sic.Acumulado_caja <external> ..."
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "nro_proveedor" "Actividad_proveedor" "nro_proveedor"}
  {src/adm/template/sndkycas.i "cdg_tiporetgan" "Actividad_proveedor" "cdg_tiporetgan"}
