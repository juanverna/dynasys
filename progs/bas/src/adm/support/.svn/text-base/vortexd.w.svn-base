...
DEFINE VAR c_create AS CHAR NO-UNDO INITIAL ?.
DEFINE VAR c_Lock AS CHAR NO-UNDO INITIAL "no-lock".
DEFINE VAR l_Enable AS LOGICAL no-undo.
DEFINE VAR l_View AS LOGICAL NO-UNDO.  
DEFINE VAR c_Layout AS CHARACTER INITIAL "".
...
&Scoped-Define DISPLAYED-OBJECTS c_Key 
...
DEFINE FRAME Attribute-Dlg
     c_Key AT ROW 2.19 COL 1
     "Clave Primaria" VIEW-AS TEXT
          SIZE 39 BY .62 TOOLTIP "Clave con la que se buscaran los registros relacionados" AT ROW 1.29 COL 2
          BGCOLOR 1 FGCOLOR 15 
     SPACE(22.59) SKIP(1.70)
...
/*comentado porque no lo encuentra*/
/* Attach the standard OK/Cancel/Help button bar. 
{ src/adm/adecomm/okbar.i  &TOOL = "AB"
