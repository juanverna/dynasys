...
&Scoped-Define ENABLED-OBJECTS RECT-1 v-fecha_contable v-ver_resum ~
v-ver_movim v-gen_asiento 
&Scoped-Define DISPLAYED-OBJECTS v-fecha_contable v-ver_resum v-ver_movim ~
v-gen_asiento 
...
DEFINE FRAME F-Main
     ...
     v-ver_resum AT ROW 1.81 COL 35
     v-ver_movim AT ROW 1.81 COL 52
     v-gen_asiento AT ROW 1.81 COL 72
