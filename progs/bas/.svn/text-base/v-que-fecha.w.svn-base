...
&Scoped-Define ENABLED-OBJECTS RECT-1 des_fecha 
&Scoped-Define DISPLAYED-OBJECTS des_fecha 
...
ON MOUSE-MENU-DOWN OF des_fecha IN FRAME F-Main /* Fecha */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL des_fecha V-table-Win
ON RETURN OF des_fecha IN FRAME F-Main /* Fecha */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
        ...
        IF NOT error_rango
        THEN DO:
                p-des_fecha = des_fecha:INPUT-VALUE.
        END.        
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE fijar_fecha V-table-Win 
PROCEDURE fijar_fecha :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  ...
  DEFINE INPUT PARAMETER p-que_fecha AS DATE.
  
  des_fecha = p-que_fecha.
