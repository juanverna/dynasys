...
&Scoped-Define ENABLED-OBJECTS Btn-Commit Btn-Update Btn-Reset Btn-Undo 
...
DEFINE FRAME Panel-Frame
     Btn-Commit AT ROW 1.24 COL 20 WIDGET-ID 4
     Btn-Update AT ROW 1.29 COL 2
     Btn-Reset AT ROW 1.29 COL 11
     Btn-Undo AT ROW 1.29 COL 29
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE set-sensitivo2 C-WIn 
PROCEDURE set-sensitivo2 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
