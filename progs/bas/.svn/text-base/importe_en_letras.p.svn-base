...
/*copia de la rutina toletras pero con los controles para imprimir el importe*/
/* en letras desde el cheque                                                 */
/*===========================================================================*/
...
/* {VPERSINM.I} */
   ...
   DEFINE VARIABLE letras    AS CHARACTER FORMAT "X(200)".
...
/*===========================================================================*/
   ...
   IF centavos <> 0
      THEN como_digo = como_digo + " CON " + STRING(centavos,"99") + "/100".
