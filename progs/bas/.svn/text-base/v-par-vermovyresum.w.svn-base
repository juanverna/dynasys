...
&Scoped-Define ENABLED-OBJECTS RECT-1 v-ver_movim v-ver_resum 
&Scoped-Define DISPLAYED-OBJECTS v-ver_movim v-ver_resum 
...
DEFINE FRAME F-Main
     v-ver_movim AT ROW 1.81 COL 18
     v-ver_resum AT ROW 1.81 COL 73
