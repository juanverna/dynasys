...
&Scoped-Define ENABLED-OBJECTS btn_ejecutar RECT-11 btn_salir 
...
DEFINE BUTTON btn_ejecutar  NO-FOCUS
     LABEL "&Ejecutar" 
     SIZE 22 BY 1.33.
...
DEFINE FRAME F-Main
     btn_ejecutar AT ROW 1.33 COL 23.8 WIDGET-ID 12
     btn_salir AT ROW 1.33 COL 55.8
...
DO:
  ...
  END.
  ELSE MESSAGE c_window VIEW-AS ALERT-BOX MESSAGE TITLE "p-CRejecutarSPPAU.w".
