...
&Scoped-Define ENABLED-OBJECTS Btn-Update Btn-Reset Btn-Commit Btn-Undo 
...
DEFINE FRAME Panel-Frame
     ...
     Btn-Commit AT ROW 1.27 COL 20
     Btn-Undo AT ROW 1.27 COL 29
...
ON CHOOSE OF Btn-Commit IN FRAME Panel-Frame /* Cierra */
DO:  
...
ON CHOOSE OF Btn-Update IN FRAME Panel-Frame /* Ingresa */
DO:
    DO WITH FRAME Panel-Frame:
