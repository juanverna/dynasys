...
DEFINE VARIABLE EDITOR-1 AS CHARACTER 
     VIEW-AS EDITOR
     SIZE 63 BY 9.42
     BGCOLOR 2 FGCOLOR 14  NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Dialog-Frame
     EDITOR-1 AT ROW 1.27 COL 2 NO-LABEL
     Btn_OK AT ROW 10.96 COL 2
     Btn_Cancel AT ROW 10.96 COL 50
     SPACE(0.99) SKIP(0.15)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Edición de Leyendas"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Edición de Leyendas */
DO:
