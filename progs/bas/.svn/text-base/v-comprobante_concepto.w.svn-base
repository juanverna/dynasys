...
/* External Tables                                                      */
&Scoped-define EXTERNAL-TABLES Comprobante_concepto Tipocomprobante
&Scoped-define FIRST-EXTERNAL-TABLE Comprobante_concepto


/* Need to scope the external tables to this procedure                  */
DEFINE QUERY external_tables FOR Comprobante_concepto, Tipocomprobante.
...
DEFINE FRAME F-Main
     Comprobante_concepto.codigo_mci AT ROW 1.48 COL 60 COLON-ALIGNED
          LABEL "MCI"
          VIEW-AS FILL-IN NATIVE 
          SIZE 7.6 BY 1
          BGCOLOR 15 FGCOLOR 9 
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: sic.Comprobante_concepto,sic.Tipocomprobante
...
ON LEAVE OF v-cdg_imputacion IN FRAME F-Main /* Concepto */
DO:
  IF SELF:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "0" THEN DO:
      MESSAGE "Se debe ingresar un concepto" VIEW-AS ALERT-BOX.
      APPLY "ENTRY" TO SELF.
      RETURN NO-APPLY.
  END.
END.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
   ...
   IF v-cdg_imputacion:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "0" THEN DO:
       RUN ponmensj.p ("FACU001").
       RETURN ERROR.
   END.
