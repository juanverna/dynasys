...
&Scoped-Define ENABLED-OBJECTS RECT-1 v-lista_tipos 
&Scoped-Define DISPLAYED-OBJECTS v-lista_tipos 
...
DEFINE FRAME F-Main
     v-lista_tipos AT ROW 1.81 COL 16 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  ...
  v-lista_tipos = "FA,FB,FC,FE,FK,CA,CB,CC,CE,CK,DA,DB,DC,DE,DK,RA,RB,RC,RE,RK".
