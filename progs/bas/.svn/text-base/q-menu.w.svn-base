...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Treemenu WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Treemenu WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Treemenu
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Treemenu
