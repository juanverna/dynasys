...
&Scoped-Define ENABLED-OBJECTS RECT-2 btn_copiar v-empresa que_codigo ~
que_dexcrip br_table 
...
DEFINE VARIABLE que_dexcrip AS CHARACTER FORMAT "X(50)":U 
     VIEW-AS FILL-IN NATIVE 
     SIZE 46.6 BY 1 TOOLTIP "Busca el patron en la descripcion"
     BGCOLOR 14 FGCOLOR 12  NO-UNDO.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 153 BY 11.48
...
ON CHOOSE OF btn_copiar IN FRAME F-Main /* Copiar Todos A.... */
DO:
