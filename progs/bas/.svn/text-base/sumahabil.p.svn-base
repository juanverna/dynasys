/*===========================================================================================*/
/*       DADA UNA FECHA LE SUMA UNA CANTIDAD DE DIAS HABILES                                 */
/*===========================================================================================*/

DEFINE INPUT        PARAMETER p-fecha0 AS DATE.
...
END.                                                                                  */
  ...
  /* Va recorriendo los días, sumando los días hábiles hasta alcanzar los días habiles indicados */
