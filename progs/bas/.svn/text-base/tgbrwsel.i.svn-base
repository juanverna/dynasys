ON ".", MOUSE-SELECT-DBLCLICK OF {&TABLA}.{&CODIGO}  IN BROWSE {&BROWSE-INGRESO}
DO:
  ...
  THEN DO:
     ...
     DISPLAY {&TABLA}.{&CODIGO} WITH BROWSE {&BROWSE-INGRESO}.
     APPLY "RETURN" TO {&TABLA}.{&CODIGO} IN BROWSE {&BROWSE-INGRESO}.
  END.  
  RETURN NO-APPLY.
END.   
...
ON F7, F8 OF {&TABLA}.{&CODIGO}  IN BROWSE {&BROWSE-INGRESO}
DO:
  ...
  END.
  ELSE DO:
     APPLY "ENTRY" TO {&TABLA}.{&CODIGO} IN BROWSE {&BROWSE-INGRESO}.
  END.   
  RETURN NO-APPLY.   
END.  
