...
&Scoped-Define ENABLED-OBJECTS Btn-Commit Btn-Copy Btn-Delete Btn-Reset ~
Btn-Undo Btn-Update 
...
DEFINE FRAME Panel-Frame
     Btn-Commit AT ROW 1.33 COL 38
     Btn-Copy AT ROW 1.33 COL 20
     Btn-Delete AT ROW 1.33 COL 29
     Btn-Reset AT ROW 1.33 COL 11
     Btn-Undo AT ROW 1.33 COL 47
