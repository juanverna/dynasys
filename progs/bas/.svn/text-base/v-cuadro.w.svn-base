...
&Scoped-Define ENABLED-OBJECTS tptareas BCRM ttareas 
&Scoped-Define DISPLAYED-OBJECTS tptareas ttareas 
...
DEFINE FRAME F-Main
     tptareas AT ROW 1.1 COL 14.8 COLON-ALIGNED WIDGET-ID 2
     BCRM AT ROW 1.19 COL 40 WIDGET-ID 6
     ttareas AT ROW 3.43 COL 15 COLON-ALIGNED WIDGET-ID 4
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BCRM V-table-Win
ON CHOOSE OF BCRM IN FRAME F-Main /* CRM */
DO:
  RUN w-tareas-red.w.
END.
...
END.
ttareas = cttareas.
DISPLAY ttareas WITH FRAME {&FRAME-NAME}.
END PROCEDURE.
