...
&Scoped-Define ENABLED-OBJECTS RECT-1 Bigual des_fecha has_fecha 
...
DO:
  ASSIGN des_fecha.
  IF DAY(des_fecha) = 1 THEN DO:
      has_fecha =  ultimodia(des_fecha).
      DISPLAY has_fecha WITH FRAME {&FRAME-NAME}.
  END.
