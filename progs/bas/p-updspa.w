...
&Scoped-Define ENABLED-OBJECTS Btn-Add Btn-Commit Btn-Copy Btn-Delete ~
Btn-Reset Btn-Undo Btn-Update 
...
DEFINE BUTTON Btn-Add 
     IMAGE-UP FILE "add.gif":U NO-FOCUS
     LABEL "&Agrega" 
     SIZE 9 BY 1.33 TOOLTIP "Agrega un nuevo registro"
     FONT 4.
...
DEFINE BUTTON Btn-Copy 
     IMAGE-UP FILE "copy.gif":U NO-FOCUS
     LABEL "Co&pia" 
     SIZE 9 BY 1.33 TOOLTIP "Copia el registro actual"
     FONT 4.

DEFINE BUTTON Btn-Delete 
     IMAGE-UP FILE "delete.gif":U NO-FOCUS
     LABEL "&Elimina" 
     SIZE 9 BY 1.33 TOOLTIP "Elimina el registro actual"
     FONT 4.
