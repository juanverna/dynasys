...
&Scoped-Define ENABLED-OBJECTS gen_asiento des_fecha RECT-1 
&Scoped-Define DISPLAYED-OBJECTS gen_asiento des_fecha 
...
DEFINE VARIABLE gen_asiento AS LOGICAL INITIAL no 
...
DEFINE FRAME F-Main
     gen_asiento AT ROW 1.81 COL 14
     des_fecha AT ROW 1.81 COL 56 COLON-ALIGNED
...
ON MOUSE-MENU-DOWN OF des_fecha IN FRAME F-Main /* Fecha Contable */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
        ...
        IF ERROR-STATUS:ERROR OR 
          des_fecha = DATE ("") AND gen_asiento
          THEN error_rango = YES.

        IF NOT error_rango 
           THEN p-has_fecha = des_fecha.
           ELSE p-has_fecha = ?.
           
        p-gen_asiento = gen_asiento.   
