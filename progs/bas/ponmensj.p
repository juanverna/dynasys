...
CASE tipo:
  ...
  THEN DO:
     ...
     MESSAGE texto VIEW-AS ALERT-BOX ERROR BUTTONS OK TITLE titulo.
  END.
  WHEN "A"
  THEN DO:
     titulo = "Aviso:" + cdg_mensaje.
     MESSAGE texto VIEW-AS ALERT-BOX WARNING BUTTONS OK TITLE titulo.
  END.
  WHEN "M"
  THEN DO:
     titulo = "Mensaje:" + cdg_mensaje.
     MESSAGE texto VIEW-AS ALERT-BOX MESSAGE BUTTONS OK TITLE titulo.
  END.
  WHEN "P"
  THEN DO:
     CASE exit_mens:
