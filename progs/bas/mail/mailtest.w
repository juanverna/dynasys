...
&Scoped-Define ENABLED-OBJECTS fiAddress fiCC fiSubject edMessage Btn_Send ~
Btn_Done 
&Scoped-Define DISPLAYED-OBJECTS fiAddress fiCC fiSubject edMessage 
...
DO:
  ...
  Assign
    chsmtp:HostName = "armail.ar.progress.com"
    chsmtp:Recipient = fiAddress:SCREEN-VALUE
    chsmtp:CC = fiCC:SCREEN-VALUE
    chsmtp:Sender = "ferver@progress.com"
...
------------------------------------------------------------------------------*/
  DISPLAY fiAddress fiCC fiSubject edMessage 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE fiAddress fiCC fiSubject edMessage Btn_Send Btn_Done 
      WITH FRAME F-Main IN WINDOW W-Win.
