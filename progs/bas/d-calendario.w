...
btn_prevmes btn_nextmes btn_prevdia btn_nextdia btn_prevano btn_nextano ~
v-ano v-mes v-fecha_actual Btn_hoy Btn_Cancel Btn_OK 
&Scoped-Define DISPLAYED-OBJECTS v-ano v-mes v-fecha_actual 
...
DEFINE FRAME Dialog-Frame
     btn_prevmes AT ROW 1.24 COL 18.4
     btn_nextmes AT ROW 1.24 COL 26.4
     btn_prevdia AT ROW 1.24 COL 38
     btn_nextdia AT ROW 1.24 COL 45
     btn_prevano AT ROW 1.29 COL 3.4
     btn_nextano AT ROW 1.29 COL 9
     v-ano AT ROW 2.62 COL 1 COLON-ALIGNED NO-LABEL
     v-mes AT ROW 2.62 COL 16.4 COLON-ALIGNED NO-LABEL
     v-fecha_actual AT ROW 2.67 COL 36 COLON-ALIGNED NO-LABEL
     BUTTON-1 AT ROW 5.05 COL 3
     BUTTON-2 AT ROW 5.05 COL 10
     BUTTON-3 AT ROW 5.05 COL 17
     BUTTON-4 AT ROW 5.05 COL 24
     BUTTON-5 AT ROW 5.05 COL 31
     BUTTON-6 AT ROW 5.05 COL 38
     BUTTON-7 AT ROW 5.05 COL 45
     BUTTON-8 AT ROW 6.38 COL 3
     BUTTON-9 AT ROW 6.38 COL 10
     BUTTON-10 AT ROW 6.38 COL 17
     BUTTON-11 AT ROW 6.38 COL 24
     BUTTON-12 AT ROW 6.38 COL 31
     BUTTON-13 AT ROW 6.38 COL 38
     BUTTON-14 AT ROW 6.38 COL 45
     BUTTON-15 AT ROW 7.71 COL 3
     BUTTON-16 AT ROW 7.71 COL 10
     BUTTON-17 AT ROW 7.71 COL 17
     BUTTON-18 AT ROW 7.71 COL 24
     BUTTON-19 AT ROW 7.71 COL 31
     BUTTON-20 AT ROW 7.71 COL 38
     BUTTON-21 AT ROW 7.71 COL 45
     BUTTON-22 AT ROW 9.1 COL 3
     BUTTON-23 AT ROW 9.1 COL 10
     BUTTON-24 AT ROW 9.1 COL 17
     BUTTON-25 AT ROW 9.1 COL 24
     BUTTON-26 AT ROW 9.1 COL 31
     BUTTON-27 AT ROW 9.1 COL 38
     BUTTON-28 AT ROW 9.1 COL 45
     BUTTON-29 AT ROW 10.43 COL 3
     BUTTON-30 AT ROW 10.43 COL 10
     BUTTON-31 AT ROW 10.43 COL 17
     BUTTON-32 AT ROW 10.43 COL 24
     BUTTON-33 AT ROW 10.43 COL 31
     BUTTON-34 AT ROW 10.43 COL 38
     BUTTON-35 AT ROW 10.43 COL 45
     BUTTON-36 AT ROW 11.76 COL 3
     BUTTON-37 AT ROW 11.76 COL 10
     BUTTON-38 AT ROW 11.76 COL 17
     BUTTON-39 AT ROW 11.76 COL 24
     BUTTON-40 AT ROW 11.76 COL 31
     BUTTON-41 AT ROW 11.76 COL 38
     BUTTON-42 AT ROW 11.76 COL 45
     Btn_hoy AT ROW 13.62 COL 20 WIDGET-ID 2
     Btn_Cancel AT ROW 13.62 COL 37
     Btn_OK AT ROW 13.67 COL 3
     "Vie" VIEW-AS TEXT
          SIZE 5 BY .62 AT ROW 3.91 COL 39
          FGCOLOR 9 FONT 6
     "Jue" VIEW-AS TEXT
          SIZE 5 BY .62 AT ROW 3.91 COL 33
          FGCOLOR 9 FONT 6
     "Dom" VIEW-AS TEXT
          SIZE 5 BY .62 AT ROW 3.91 COL 4
          FGCOLOR 12 FONT 6
     "Mar" VIEW-AS TEXT
          SIZE 5 BY .62 AT ROW 3.91 COL 18
          FGCOLOR 9 FONT 6
     "Sab" VIEW-AS TEXT
          SIZE 5 BY .62 AT ROW 3.91 COL 46
          FGCOLOR 12 FONT 6
     "Mie" VIEW-AS TEXT
          SIZE 5 BY .62 AT ROW 3.91 COL 25.2
          FGCOLOR 9 FONT 6
     "Lun" VIEW-AS TEXT
          SIZE 5 BY .62 AT ROW 3.91 COL 11.2
          FGCOLOR 9 FONT 6
     RECT-3 AT ROW 13.38 COL 2
     RECT-4 AT ROW 4.76 COL 2
     RECT-5 AT ROW 2.33 COL 2
     RECT-6 AT ROW 3.67 COL 2
     RECT-7 AT ROW 1 COL 2
     SPACE(1.19) SKIP(13.71)
...
&Scoped-define SELF-NAME Btn_hoy
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_hoy Dialog-Frame
ON CHOOSE OF Btn_hoy IN FRAME Dialog-Frame /* Hoy */
DO:
  
   v-fecha_actual  = TODAY.
...
&Scoped-define SELF-NAME btn_nextano
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn_nextano Dialog-Frame
ON CHOOSE OF btn_nextano IN FRAME Dialog-Frame /* btn_nextmes */
DO:
  ASSIGN FRAME {&FRAME-NAME} v-ano.
  v-ano = v-ano + 1.
...
&Scoped-define SELF-NAME btn_prevano
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btn_prevano Dialog-Frame
ON CHOOSE OF btn_prevano IN FRAME Dialog-Frame /* btn_prevmes 3 */
DO:
  ASSIGN FRAME {&FRAME-NAME} v-ano.
  v-ano = v-ano - 1.
  v-fecha_actual = DATE(LOOKUP(v-mes:SCREEN-VALUE IN FRAME {&FRAME-NAME},nombre_meses,","),1,v-ano).
...
------------------------------------------------------------------------------*/
  ...
  p-widget:PRIVATE-DATA  = STRING(p-fecha).
...
------------------------------------------------------------------------------*/
  DISPLAY v-ano v-mes v-fecha_actual 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-3 RECT-4 RECT-5 RECT-6 RECT-7 btn_prevmes btn_nextmes btn_prevdia 
         btn_nextdia btn_prevano btn_nextano v-ano v-mes v-fecha_actual Btn_hoy 
         Btn_Cancel Btn_OK 
      WITH FRAME Dialog-Frame.
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME {&FRAME-NAME}:
       ...
       DO j = year(TODAY - 5) TO year(TODAY + 5):
