...
&Scoped-Define ENABLED-OBJECTS RECT-1 v-ver_movim v-todos_mov v-ver_resum ~
v-consolidado 
&Scoped-Define DISPLAYED-OBJECTS v-ver_movim v-todos_mov v-ver_resum ~
v-consolidado 
...
DEFINE FRAME F-Main
     v-ver_movim AT ROW 1.27 COL 11
     v-todos_mov AT ROW 1.27 COL 59
     v-ver_resum AT ROW 2.35 COL 11
     v-consolidado AT ROW 2.35 COL 59
...
------------------------------------------------------------------------------*/
  ...
  DEFINE OUTPUT PARAMETER p-todos_mov       AS LOGICAL.
  ...
  DO WITH FRAME {&FRAME-NAME}:
     ...
     IF NOT ( v-ver_movim OR v-ver_resum ) THEN error_rango = YES.

     ASSIGN
        p-ver_movim      = v-ver_movim
        p-ver_resum      = v-ver_resum
        p-todos_mov      = v-todos_mov
