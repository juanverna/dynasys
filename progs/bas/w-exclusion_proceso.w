...
DEFINE VARIABLE h_b-exclusion_proceso AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-exclusion_proceso AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-exclusion_proceso.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-exclusion_proceso ).
       RUN set-position IN h_b-exclusion_proceso ( 2.19 , 3.00 ) NO-ERROR.
       RUN set-size IN h_b-exclusion_proceso ( 22.14 , 86.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-exclusion_proceso.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-exclusion_proceso ).
       RUN set-position IN h_v-exclusion_proceso ( 2.19 , 90.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.52 , 68.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 6.95 , 90.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 1.76 , 68.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-exclusion_proceso. */
       RUN add-link IN adm-broker-hdl ( h_b-exclusion_proceso , 'Record':U , h_v-exclusion_proceso ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-exclusion_proceso ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-exclusion_proceso ,
             h_b-exclusion_proceso , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-exclusion_proceso , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/BAS" "Mantenimiento de Procesos de Exclusión Mutua"}
