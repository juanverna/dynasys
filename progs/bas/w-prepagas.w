...
DEFINE VARIABLE h_b-prepagas AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-prepagas AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adp/b-prepagas.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-prepagas ).
       RUN set-position IN h_b-prepagas ( 1.95 , 6.00 ) NO-ERROR.
       RUN set-size IN h_b-prepagas ( 18.57 , 12.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adp/v-prepagas.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-prepagas ).
       RUN set-position IN h_v-prepagas ( 1.95 , 25.00 ) NO-ERROR.
       /* Size in UIB:  ( 15.95 , 82.40 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 18.38 , 24.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.14 , 84.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-prepagas. */
       RUN add-link IN adm-broker-hdl ( h_b-prepagas , 'Record':U , h_v-prepagas ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-prepagas ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-prepagas ,
             h_b-prepagas , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-prepagas , 'AFTER':U ).
    END. /* Page 0 */
