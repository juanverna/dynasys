...
&Scoped-Define ENABLED-OBJECTS Btn-Update Btn-Reset Btn-Add Btn-Delete ~
Btn-Commit Btn-Undo 
...
DEFINE FRAME Panel-Frame
     ...
     Btn-Delete AT ROW 1.27 COL 29
     Btn-Commit AT ROW 1.27 COL 38
     Btn-Undo AT ROW 1.27 COL 47
...
DO:
    ...
    DEFINE VARIABLE puede-modificar AS LOGICAL NO-UNDO.
    ...
    THEN DO:
        h = WIDGET-HANDLE (c).
        RUN dar-estado IN h ( OUTPUT puede-modificar).
    END.
    

    IF NOT puede-modificar
    THEN DO:
         RUN PONMENSJ.P (INPUT "CUPO020").
         RETURN NO-APPLY.
    END.
    ELSE DO:
        DO WITH FRAME Panel-Frame:
