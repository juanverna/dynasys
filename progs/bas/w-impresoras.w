...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-impresoras ( 1.24 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_b-impresoras ( 8.86 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-impresoras ( 7.14 , 66.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 16.24 , 2.00 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-impresoras ,
