...
&Scoped-define QUERY-STRING-Query-Main FOR EACH Area WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Area WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nro_entidad,denominacion,cdg_Area"':U).
...
------------------------------------------------------------------------------*/
  ...
  DEFINE INPUT PARAMETER rid-Area AS ROWID.
  
  REPOSITION {&QUERY-NAME} TO ROWID rid-Area.
  GET NEXT {&QUERY-NAME}.
