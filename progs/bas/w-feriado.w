...
DEFINE VARIABLE h_b-feriado AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-feriado AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Feriados No-laborables */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Feriados No-laborables */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Feriados No-laborables */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-feriado ).
       RUN set-position IN h_b-feriado ( 1.24 , 4.00 ) NO-ERROR.
       RUN set-size IN h_b-feriado ( 6.71 , 77.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-feriado ).
       RUN set-position IN h_v-feriado ( 8.14 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.24 , 77.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 10.29 , 4.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 1.76 , 77.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-feriado. */
       RUN add-link IN adm-broker-hdl ( h_b-feriado , 'Record':U , h_v-feriado ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-feriado ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-feriado ,
             h_b-feriado , 'AFTER':U ).
