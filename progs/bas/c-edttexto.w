...
&THEN
    DEFINE VARIABLE p-texto  AS CHARACTER INITIAL "Texto de prueba".
...
&Scoped-Define ENABLED-OBJECTS v-texto Btn_Cancel 
...
DEFINE FRAME Dialog-Frame
     v-texto AT ROW 1.29 COL 2 NO-LABEL
     Btn_OK AT ROW 11.24 COL 2
     Btn_Cancel AT ROW 11.24 COL 49
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  btn_ok:SENSITIVE IN FRAME {&FRAME-NAME} = ( p-modo = MD_ALTA OR 
                                              p-modo = MD_CAMBIO OR 
                                              p-modo = MD_RELACION OR
                                              p-modo = MD_DEFINIDA).
  v-texto:READ-ONLY = ( p-modo = MD_CAMBIO OR 
                        p-modo = MD_RELACION OR
                        p-modo = MD_DEFINIDA).
