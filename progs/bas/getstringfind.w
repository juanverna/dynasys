...
&Scoped-Define ENABLED-OBJECTS RECT-1 v-que_buscar v-coincidir v-direccion ~
v-redonda Btn_OK Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS v-que_buscar v-coincidir v-direccion ~
v-redonda 
...
DEFINE FRAME Dialog-Frame
     v-que_buscar AT ROW 2.08 COL 9 COLON-ALIGNED
     v-coincidir AT ROW 3.42 COL 11
     v-direccion AT ROW 3.42 COL 49 NO-LABEL
     v-redonda AT ROW 4.5 COL 11
     Btn_OK AT ROW 5.58 COL 11
     Btn_Cancel AT ROW 5.58 COL 48
     RECT-1 AT ROW 1.27 COL 2
     SPACE(1.71) SKIP(0.53)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         FONT 4
         TITLE "Indique texto a buscar"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Indique texto a buscar */
DO:
...
DO:
  ASSIGN FRAME {&FRAME-NAME} v-que_buscar v-coincidir v-direccion v-redonda.
...
------------------------------------------------------------------------------*/
  DISPLAY v-que_buscar v-coincidir v-direccion v-redonda 
      WITH FRAME Dialog-Frame.
  ENABLE RECT-1 v-que_buscar v-coincidir v-direccion v-redonda Btn_OK 
         Btn_Cancel 
      WITH FRAME Dialog-Frame.
