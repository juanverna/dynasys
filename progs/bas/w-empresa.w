...
DEFINE VARIABLE h_b-empresa AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-empresa ).
       RUN set-position IN h_b-empresa ( 1.24 , 14.00 ) NO-ERROR.
       RUN set-size IN h_b-empresa ( 7.38 , 67.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 1.24 , 85.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 18.10 , 20.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_v-empresa ).
       RUN set-position IN h_v-empresa ( 8.81 , 14.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.48 , 67.00 ) */

       /* Links to SmartViewer h_v-empresa. */
       RUN add-link IN adm-broker-hdl ( h_b-empresa , 'Record':U , h_v-empresa ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-empresa ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/BAS" "Mantenimiento de Empresas"}
