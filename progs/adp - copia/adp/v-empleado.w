...
Empleado.telefono Empleado.cdg_postal Empleado.cdg_provincia ~
Empleado.cdg_est_civil Empleado.fecha_ingreso Empleado.fecha_baja ~
Empleado.cdg_estado Empleado.fecha_nac Empleado.lugar_nac Empleado.tipo_doc ~
Empleado.numero_doc Empleado.expedido_por Empleado.e-mail ~
Empleado.cto_nombre1 Empleado.cto_nombre2 
&Scoped-define ENABLED-TABLES Empleado
&Scoped-define FIRST-ENABLED-TABLE Empleado
&Scoped-Define ENABLED-OBJECTS i-foto4x4 RECT-4 RECT-5 RECT-8 RECT-9 bFoto 
...
"Extranjero", "E":U
     ...
     bFoto AT ROW 11.95 COL 93 WIDGET-ID 2
     Empleado.fecha_nac AT ROW 12.1 COL 23 COLON-ALIGNED
          LABEL "Fecha Nacim."
          VIEW-AS FILL-IN 
          SIZE 14 BY 1
          BGCOLOR 15 FGCOLOR 9 
...
DEFINE FRAME F-Main
     Empleado.lugar_nac AT ROW 12.14 COL 48 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 34 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Empleado.tipo_doc AT ROW 13.19 COL 23 COLON-ALIGNED
          VIEW-AS COMBO-BOX INNER-LINES 5
          LIST-ITEMS "DNI","CI","LE","LC","PASAP" 
          DROP-DOWN-LIST
          SIZE 12 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Empleado.numero_doc AT ROW 13.24 COL 45 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 16 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Empleado.expedido_por AT ROW 13.24 COL 74 COLON-ALIGNED
          LABEL "Exp."
          VIEW-AS FILL-IN 
          SIZE 8 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Empleado.e-mail AT ROW 14.43 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 59 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Empleado.cto_nombre1 AT ROW 15.57 COL 23 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 59 BY 1
     Empleado.cto_nombre2 AT ROW 16.67 COL 23 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 59 BY 1
     "                  Sexo  y  Nacionalidad" VIEW-AS TEXT
          SIZE 39 BY 1 AT ROW 1.48 COL 87
          BGCOLOR 5 FGCOLOR 15 
     i-foto4x4 AT ROW 5.1 COL 94
     RECT-4 AT ROW 1.24 COL 5
     RECT-5 AT ROW 2.67 COL 110
     RECT-8 AT ROW 2.67 COL 87
     RECT-9 AT ROW 4.91 COL 93 WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
&Scoped-define SELF-NAME bFoto
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bFoto V-table-Win
ON CHOOSE OF bFoto IN FRAME F-Main /* Foto */
DO:
