...
v-params = "p_ultdepos="        + uldep_fecha        + "~n" +
           ...
           "p_abonado="         + abonado            + "~n" +
           "p_cuando="          + cuando             + "~n" +
           "p_emp-nombre="      + Empresa.nombre     + "~n" +
           "p_emp-direccion="   + Empresa.direccion  + "~n" +
           "p_emp-localidad="   + Empresa.localidad  + "~n" +
           "p_emp-telefono="    + Empresa.telefono   + "~n" +
           "p_emp-actividad="   + Empresa.actividad  + "~n" +
           "p_emp-cuit="        + Empresa.cuit.
           

RUN exreport.p (  INPUT  ".\prl\sic.prl",     /* Librería desde la que se ejecuta   */
                  INPUT  "Recibo de Haberes Duplicado", /* Nombre del reporte a ejecutar      */
                  INPUT  v-filtro,            /* Filtro de registros a imponer      */
                  INPUT  "",                 /* Salida de datos    (ver cPrinter)  */
