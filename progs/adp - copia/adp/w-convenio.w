...
DEFINE VARIABLE h_v-convenio AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adp/v-convenio.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-convenio ).
       RUN set-position IN h_v-convenio ( 3.86 , 36.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-convenio. */
       RUN add-link IN adm-broker-hdl ( h_b-convenio , 'Record':U , h_v-convenio ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-convenio ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-convenio ,
             h_b-convenio , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-convenio , 'AFTER':U ).
    END. /* Page 0 */
