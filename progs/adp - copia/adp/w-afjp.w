...
DEFINE VARIABLE h_b-afjp AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-afjp AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adp/b-afjp.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-afjp ).
       RUN set-position IN h_b-afjp ( 4.81 , 11.00 ) NO-ERROR.
       RUN set-size IN h_b-afjp ( 13.57 , 13.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adp/v-afjp.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-afjp ).
       RUN set-position IN h_v-afjp ( 4.81 , 31.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.91 , 66.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 13.38 , 31.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 2.86 , 66.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-afjp. */
       RUN add-link IN adm-broker-hdl ( h_b-afjp , 'Record':U , h_v-afjp ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-afjp ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-afjp ,
             h_b-afjp , 'AFTER':U ).
