...
&Scoped-define FIELDS-IN-QUERY-br_table rowObject.cdg_supertabla ~
rowObject.cdg_subtabla rowObject.dsc_subtabla 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      cdg_supertabla FORMAT "999":U
      cdg_subtabla FORMAT "999":U
      dsc_subtabla FORMAT "X(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 66 BY 6.65 EXPANDABLE.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.cdg_supertabla
     _FldNameList[2]   = _<SDO>.rowObject.cdg_subtabla
     _FldNameList[3]   = _<SDO>.rowObject.dsc_subtabla
