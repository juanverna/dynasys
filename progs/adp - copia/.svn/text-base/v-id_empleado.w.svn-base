...
&Scoped-Define ENABLED-FIELDS Empleado.nro_legajo Empleado.nombre 
...
&Scoped-Define DISPLAYED-FIELDS Empleado.cdg_estado Empleado.nro_legajo ~
Empleado.nombre 
...
DEFINE FRAME F-Main
     Empleado.cdg_estado AT ROW 1.24 COL 90 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 7.8 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Empleado.nro_legajo AT ROW 1.29 COL 2 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 15 BY 1
          BGCOLOR 15 FGCOLOR 9 
     Empleado.nombre AT ROW 1.29 COL 17.4 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 72.4 BY 1
          BGCOLOR 15 FGCOLOR 9 
...
/* SETTINGS FOR FILL-IN Empleado.cdg_estado IN FRAME F-Main
   NO-ENABLE                                                            */
