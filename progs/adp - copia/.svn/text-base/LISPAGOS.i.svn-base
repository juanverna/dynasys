...
DEFINE VARIABLE des_legajo LIKE Empleado.nro_legajo LABEL "Desde Empleado".
DEFINE VARIABLE has_legajo LIKE Empleado.nro_legajo LABEL "Hasta Empleado".
DEFINE VARIABLE des_nombre LIKE Empleado.nombre.
DEFINE VARIABLE has_nombre LIKE Empleado.nombre.

DEFINE VARIABLE des_liquid  LIKE Liquidacion.sec_liquidacion LABEL "Desde Liquidacion".
DEFINE VARIABLE has_liquid  LIKE Liquidacion.sec_liquidacion LABEL "Hasta Liquidacion".
DEFINE VARIABLE des_liq_nom LIKE Liquidacion.descripcion.
DEFINE VARIABLE has_liq_nom LIKE Liquidacion.descripcion.
...
FORM 
   SKIP(0.5)
   des_fecha     FGCOLOR fe_c BGCOLOR be_c  COLON 12
   SPACE(3) por_fecha     FGCOLOR fg_c 
   SKIP(0.2)
   has_fecha     FGCOLOR fe_c BGCOLOR be_c  COLON 12
   SPACE(3) procesar      FGCOLOR fg_c 
   SKIP(0.2)
   des_fecha     FGCOLOR fe_c BGCOLOR be_c  COLON 12   
   SKIP(0.2)
   des_liquid    FGCOLOR fe_c BGCOLOR be_c  COLON 12   
   des_liq_nom   NO-LABEL FGCOLOR fg_c BGCOLOR bg_c
   SKIP(0.2)         
   has_liquid    FGCOLOR fe_c BGCOLOR be_c  COLON 12
   has_liq_nom   NO-LABEL FGCOLOR fg_c BGCOLOR bg_c        
   SKIP(0.5)
   des_legajo FGCOLOR fe_c BGCOLOR be_c COLON 12
   des_nombre  NO-LABEL FGCOLOR fg_c BGCOLOR bg_c
   SPACE(2)
   SKIP(0.2)
   has_legajo FGCOLOR fe_c BGCOLOR be_c COLON 12
   has_nombre  NO-LABEL FGCOLOR fg_c BGCOLOR bg_c   
   SKIP(0.5)
   {&CAMPOS-EXTRA-FRAME}
   SKIP(0.5)                           
   disp_out  FGCOLOR fg_c COLON 12
   n_lineas      FGCOLOR fe_c BGCOLOR be_c 
   SKIP(0.5)  
   SPACE(10) BTN_PROCESO SPACE(1) BTN_VERDATOS SPACE(1) BTN_IMPRIMIR 
...
&SCOPED-DEFINE FRAME-INGRESO   frm-rango
&SCOPED-DEFINE EVENTO          U8
&SCOPED-DEFINE TABLA           Liquidacion
&SCOPED-DEFINE CODIGO          sec_liquidacion
&SCOPED-DEFINE NOMBRE          descripcion
&SCOPED-DEFINE VAR-CODIGO      des_liquid
&SCOPED-DEFINE VAR-NOMBRE      des_liq_nom
&SCOPED-DEFINE RUTINA          SELLIQUD
&SCOPED-DEFINE ROWID-TABLA     act_liquidacion
&SCOPED-DEFINE INDICE          nro_liquidacion
&SCOPED-DEFINE ALFABETICO      alfabetico
...
&SCOPED-DEFINE CODIGO          sec_liquidacion
&SCOPED-DEFINE NOMBRE          descripcion
&SCOPED-DEFINE VAR-CODIGO      has_liquid
&SCOPED-DEFINE VAR-NOMBRE      has_liq_nom
&SCOPED-DEFINE RUTINA          SELLIQUD
&SCOPED-DEFINE ROWID-TABLA     act_liquidacion
&SCOPED-DEFINE INDICE          nro_liquidacion
&SCOPED-DEFINE ALFABETICO      alfabetico
