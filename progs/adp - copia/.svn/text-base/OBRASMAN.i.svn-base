...
/*---------------------------------------------------------------------------------*/
    ...
    SKIP(0.1)    
    SPACE(1)
    Prepaga.cdg_prepaga             FGCOLOR fe_c BGCOLOR be_c
    Prepaga.nombre               FGCOLOR fe_c BGCOLOR be_c
    SKIP(0.2)    
    SPACE(1)    
    Prepaga.cdg_concepto_empl    FGCOLOR fe_c BGCOLOR be_c
    SKIP(0.2)    
    SPACE(1)    
    Prepaga.cdg_concepto_adic    FGCOLOR fe_c BGCOLOR be_c
    SKIP(0.2)    
    SPACE(1)    
    Prepaga.nro_afiliacion       FGCOLOR fe_c BGCOLOR be_c
    SKIP(0.2)    
    SPACE(1)    
    Prepaga.porc_contribucion    FGCOLOR fe_c BGCOLOR be_c
    SKIP(0.1)    
    brw_convenios     AT ROW  4 COL 35        
    SKIP(0.5)
...
{TRIGMENU.I "Prepagas"     "Listados"      "LSPREPAG" }
