...
DEFINE VARIABLE h_b-aseguradora AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-aseguradora AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adp/b-aseguradora.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-aseguradora ).
       RUN set-position IN h_b-aseguradora ( 3.86 , 14.00 ) NO-ERROR.
       RUN set-size IN h_b-aseguradora ( 12.62 , 13.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adp/v-aseguradora.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-aseguradora ).
       RUN set-position IN h_v-aseguradora ( 3.86 , 36.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.10 , 72.80 ) */
       ...
       /* Links to SmartViewer h_v-aseguradora. */
       RUN add-link IN adm-broker-hdl ( h_b-aseguradora , 'Record':U , h_v-aseguradora ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-aseguradora ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-aseguradora ,
             h_b-aseguradora , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-aseguradora , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/ADP" "Mantenimiento de A.R.T. -"}
