...
DEFINE VARIABLE h_v-rng-centrosmed AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     "     Rango de Centros Médicos" VIEW-AS TEXT
          SIZE 89 BY .62 AT ROW 2.35 COL 10
     ...
     "     Rango de Fechas de Alta" VIEW-AS TEXT
          SIZE 89 BY .62 AT ROW 6.92 COL 10
          BGCOLOR 5 FGCOLOR 14 
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-rng-centrosmed.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng-centrosmed ).
       RUN set-position IN h_v-rng-centrosmed ( 3.15 , 10.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 7.73 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Padrón por Centro Médico"}
...
------------------------------------------------------------------------------*/
  ...
  DEFINE VARIABLE des_centromed     AS CHARACTER.
  DEFINE VARIABLE has_centromed     AS CHARACTER.
  ...
  RUN dar_rango IN h_v-rng-centrosmed ( OUTPUT des_centromed, 
                                      OUTPUT has_centromed, 
                                      OUTPUT error_rango ).
  IF error_rango 
  THEN DO:
       RUN ver-error-rango ( "Centros Médicos" ).
  ...
  THEN DO:
       ...
       RUN centros_medicos.p ( INPUT lista_empresas, 
                               INPUT des_centromed,
                               INPUT has_centromed,
                               INPUT des_fecha,
                               INPUT has_fecha
