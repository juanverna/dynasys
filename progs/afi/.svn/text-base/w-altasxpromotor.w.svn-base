...
ON END-ERROR OF W-Win /* Altas por Promotor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Altas por Promotor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Altas por Promotor"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN altasxpromotor.p ( INPUT lista_empresas, 
                              INPUT des_promotor,
                              INPUT has_promotor,
                              INPUT des_fecha,
                              INPUT has_fecha
...
------------------------------------------------------------------------------*/
    ...
    RUN veresult.w ( INPUT  "altasxpromotor.txt" ,  /* Archivo */
