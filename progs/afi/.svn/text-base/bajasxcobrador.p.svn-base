/*=========================================================================================*/
/*            EMITE EL LISTADO DE BAJAS POR COBRADOR PARA UNA VIGENCIA DADA                */
/*=========================================================================================*/
...
DEFINE INPUT PARAMETER p-motivos          AS CHARACTER.
...
DEFINE FRAME frm-titulo HEADER
       que_empresa
       "Bajas de Grupos Familiares por Cobrador" AT 80
...
FORM
       Grupofam.cdg_cobrador COLUMN-LABEL "Cod!Cobr" FORMAT "X(4)"
       ...
       Grupofam.cdg_motbaja  COLUMN-LABEL "Mo-!tiv"
...
OUTPUT TO VALUE("C:\SIC-TEMP\bajasxcobrador.txt") PAGED.
...
FOR EACH Grupofam USE-INDEX por_cobrador
        WHERE LOOKUP(Grupofam.cdg_empresa,p-que_empresa,",") <> 0
          ...
          AND ( LOOKUP(Grupofam.cdg_motbaja,p-motivos,",") <> 0 OR p-motivos = "*" )
          ...
          AND Grupofam.fecha_alta   <= p-hasta_alta
              NO-LOCK BREAK BY Grupofam.cdg_cobrador 
    ...
    primero = FIRST-OF(Grupofam.cdg_cobrador).
    ...
    FOR EACH Cta_cte NO-LOCK OF Cliente 
        ...
        DISPLAY
                Grupofam.cdg_cobrador WHEN primero
                ...
                Grupofam.cdg_motbaja   WHEN FIRST-OF(Cta_cte.nro_cliente) 
...
RUN VERESULT.W ( INPUT "c:\sic-temp\bajasxcobrador.txt",
                 INPUT 2 ).
