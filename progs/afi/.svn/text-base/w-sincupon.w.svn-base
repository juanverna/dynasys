...
DEFINE FRAME F-Main
     ...
     "     Fechas de Alta" VIEW-AS TEXT
          SIZE 17 BY .62 AT ROW 5.58 COL 43
     "   Fechas de Emisión" VIEW-AS TEXT
          SIZE 20 BY .62 AT ROW 8.27 COL 42
...
ON END-ERROR OF W-Win /* No Facturado */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* No Facturado */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cobrador ( 1.81 , 10.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Grupos Sin Cupón en una Emisión"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN grupos-sin-cupon.p ( INPUT lista_empresas, 
                                INPUT des_cobrador,
                                INPUT has_cobrador,
                                INPUT des_fecha,
                                INPUT has_fecha,
...
------------------------------------------------------------------------------*/
    ...
    RUN veresult.w ( INPUT  "grupos-sin-cupon.txt" ,  /* Archivo */
