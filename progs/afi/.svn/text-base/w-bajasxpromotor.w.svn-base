...
ON END-ERROR OF W-Win /* Bajas por Promotor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Bajas por Promotor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Bajas por Promotor"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN bajasxpromotor.p ( INPUT lista_empresas, 
                              INPUT des_promotor,
                              INPUT has_promotor,
                              INPUT des_fecha,
                              INPUT has_fecha,
...
------------------------------------------------------------------------------*/
    ...
    RUN veresult.w ( INPUT  "bajasxpromotor.txt" ,  /* Archivo */
