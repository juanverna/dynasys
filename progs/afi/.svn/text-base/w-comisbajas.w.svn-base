...
DEFINE FRAME F-Main
     v-estado AT ROW 17.69 COL 8 COLON-ALIGNED NO-LABEL
     "     Fechas de Alta" VIEW-AS TEXT
          SIZE 17 BY .62 AT ROW 5.58 COL 44
     "   Fechas de Baja" VIEW-AS TEXT
          SIZE 17 BY .62 AT ROW 8.27 COL 45
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Bajas por Promotor para comisiones"
         HEIGHT             = 22.35
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.35
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Bajas por Promotor para comisiones */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Bajas por Promotor para comisiones */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 5.85 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
       ...
       RUN set-position IN h_v-rng-emision ( 8.54 , 10.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-empresas ( 12.85 , 10.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-impresora ( 15.27 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.88 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Bajas para Comisiones por Promotor"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN comisbajas.p ( INPUT lista_empresas, 
                          INPUT des_promotor,
                          INPUT has_promotor,
                          INPUT des_fecha,
                          INPUT has_fecha,
...
------------------------------------------------------------------------------*/
    ...
    RUN veresult.w ( INPUT  "comisbajas.txt" ,  /* Archivo */
