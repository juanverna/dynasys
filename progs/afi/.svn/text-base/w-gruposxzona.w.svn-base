...
DEFINE VARIABLE h_v-rng-zonascobro AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Grupos Familiares x Zona"
         HEIGHT             = 22.35
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.35
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Grupos Familiares x Zona */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Grupos Familiares x Zona */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-rng-zonascobro.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng-zonascobro ).
       RUN set-position IN h_v-rng-zonascobro ( 3.42 , 10.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-empresas ( 13.12 , 10.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Grupos Familiares x Zona"}
...
------------------------------------------------------------------------------*/
  ...
  RUN dar_rango IN h_v-rng-zonascobro ( OUTPUT des_zona, 
                                        OUTPUT has_zona, 
                                        OUTPUT error_rango ).
  IF error_rango 
  THEN DO:
  ...
  THEN DO:
       ...
       RUN  gruposxzona.p ( INPUT lista_empresas, 
                            INPUT des_zona, 
                            INPUT has_zona, 
                            INPUT des_fecha, 
                            INPUT has_fecha 
...
------------------------------------------------------------------------------*/
    ...
    RUN veresult.w ( INPUT  "c:\sic-temp\gruposxzona.txt" ,  /* Archivo */
