/*=========================================================================================*/
/*              REALIZA LA EMISION DEL LISTADO DE GRUPOS POR COBRADOR                      */
/*=========================================================================================*/
...
DEFINE FRAME frm-titulo HEADER
       que_empresa
       "Socios Activos por Cobrador" AT 77
...
FORM
        ...
        Grupo-domicilio.nropta         COLUMN-LABEL "Nu-!mero"  FORMAT "X(1)"
        ...
        Grupo-domicilio.cdg_localidad  COLUMN-LABEL "Cod!Loc"  FORMAT "X(4)"
        Grupo-domicilio.cdg_postal     COLUMN-LABEL "Código!Postal"  FORMAT "X(1)"
...
que_archivo = "C:\SIC-TEMP\gruposxcobrador.txt".
...
FOR EACH Cobrador NO-LOCK
    WHERE Cobrador.cdg_cobrador >= p-des_cobrador
      AND Cobrador.cdg_cobrador <= p-has_cobrador 
        ...
        FOR EACH Grupofam NO-LOCK OF Cobrador 
            WHERE LOOKUP(Grupofam.cdg_empresa,p-que_empresa,",") <> 0
              ...
              AND Grupofam.cdg_estado = "A",
                  FIRST Grupo-domicilio NO-LOCK OF Grupofam
            ...
            IF Grupofam.tipo_compbte = "R" OR 
               ...
               THEN RUN valuar_cuota.p ( INPUT ROWID(Grupofam), OUTPUT v-importe ).
               ELSE v-importe = 0.
            ...
            THEN DO:
                ...
                DISPLAY "Total Zona " + Grupo-domicilio.cdg_zonag @ Grupofam.nom_grupofam
                    z-Grupofames @ Grupo-domicilio.cdg_zonag
                         z-pesos @ v-importe
                         WITH FRAME frm-listado.
        ...
        DISPLAY "Total Cobrador " + Cobrador.cdg_cobrador
                         @ Grupofam.nom_grupofam
            t-Grupofames @ Grupo-domicilio.cdg_zonag
                 t-pesos @ v-importe
                 WITH FRAME frm-listado.
        DOWN WITH FRAME frm-listado.          
...
RUN VERESULT.W ( INPUT "c:\sic-temp\gruposxcobrador.txt",
                 INPUT 2 ).
