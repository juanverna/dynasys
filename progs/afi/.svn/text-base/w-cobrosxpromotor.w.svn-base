...
ON END-ERROR OF W-Win /* Cobranzas por Promotor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Cobranzas por Promotor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Cobranzas por Promotor"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN cobrosxpromotor.p ( INPUT lista_empresas, 
                               INPUT des_promotor,
                               INPUT has_promotor,
                               INPUT des_cobrador,
                               INPUT has_cobrador,
