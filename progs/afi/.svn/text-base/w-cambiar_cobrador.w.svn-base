...
DEFINE VARIABLE h_v-dea-cobrador AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     "   Cobrador desde el que se transfieren los Grupos y el que los recibe" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 1.81 COL 10
          BGCOLOR 5 FGCOLOR 14 
     "   Lista de empresas a considerar" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 11.23 COL 10
          BGCOLOR 5 FGCOLOR 14 
     "   Rango de Zonas a transferir" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 6.92 COL 10
          BGCOLOR 5 FGCOLOR 14 
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-dea-cobrador.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-dea-cobrador ).
       RUN set-position IN h_v-dea-cobrador ( 3.15 , 10.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-zonas ( 8.00 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
       ...
       RUN set-position IN h_v-lst-empresas ( 12.31 , 10.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Cambio masivo de Cobrador"}
...
------------------------------------------------------------------------------*/
  ...
  RUN dar_rango IN h_v-dea-cobrador ( OUTPUT des_cobrador, 
                                      OUTPUT has_cobrador, 
                                      OUTPUT error_rango ).
  IF error_rango 
  THEN DO:
...
------------------------------------------------------------------------------*/
    ...
    RUN veresult.w ( INPUT  "c:\sic-temp\cambiacobrador.txt" ,  /* Archivo */
