...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Cobranza x Centro de Cobro"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.35
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Cobranza x Centro de Cobro */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Cobranza x Centro de Cobro */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-lst-empresas ( 8.00 , 10.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-impresora ( 10.69 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.88 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Recaudad por Centro de Cobro"}
...
*/ 
       ...
       RUN  cobroxcentro.p ( INPUT lista_empresas, 
                             INPUT des_cobrador, 
                             INPUT has_cobrador, 
                             INPUT des_fecha, 
                             INPUT has_fecha 
...
------------------------------------------------------------------------------*/
    ...
    RUN veresult.w ( INPUT "cobroxcentro.txt",  /* Archivo */
                     INPUT 8 ).                 /* FONT a utilizar por default */               
