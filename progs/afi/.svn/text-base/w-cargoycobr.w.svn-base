...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Cargo y Cobrado por Cobrador"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.35
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Cargo y Cobrado por Cobrador */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Cargo y Cobrado por Cobrador */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Cargo y Cobrado por Cobrador"}
