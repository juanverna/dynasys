...
&Scoped-Define ENABLED-OBJECTS RECT-1 des_fecha has_fecha lista_tipos ~
v-id_lote 
&Scoped-Define DISPLAYED-OBJECTS des_fecha has_fecha lista_tipos v-id_lote 
...
DEFINE VARIABLE v-id_lote AS CHARACTER FORMAT "X(8)":U 
     LABEL "Lote Id." 
...
DEFINE FRAME F-Main
     des_fecha AT ROW 1.54 COL 16 COLON-ALIGNED
     has_fecha AT ROW 1.54 COL 71 COLON-ALIGNED
     lista_tipos AT ROW 2.62 COL 50 NO-LABEL
     v-id_lote AT ROW 2.88 COL 16 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  ...
  DEFINE OUTPUT PARAMETER p-id_lote         AS CHARACTER.
