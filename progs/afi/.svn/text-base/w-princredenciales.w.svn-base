...
DEFINE FRAME F-Main
     ...
     "  Rango de Fechas de Solicitud" VIEW-AS TEXT
          SIZE 28 BY .62 AT ROW 5.04 COL 34
     RECT-1 AT ROW 5.31 COL 10
...
ON END-ERROR OF W-Win /* Impresión de Credenciales */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Impresión de Credenciales */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 6.12 , 10.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Impresión de Credenciales por Cobrador"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN  princredenciales.p ( INPUT lista_empresas, 
                                 INPUT des_cobrador, 
                                 INPUT has_cobrador, 
                                 INPUT des_fecha, 
                                 INPUT has_fecha 
