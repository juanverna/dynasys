...
ON END-ERROR OF W-Win /* Comisiones de Cobranza */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Comisiones de Cobranza */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Detalle de Comisiones de Cobranza por Cobrador"}
...
*/
  ...
  THEN DO:
       ...
       RUN  detcomision.p ( INPUT lista_empresas, 
                            INPUT des_cobrador, 
                            INPUT has_cobrador, 
                            INPUT des_fecha, 
                            INPUT has_fecha 
