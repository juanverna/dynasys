...
ON END-ERROR OF W-Win /* Cobros x Cobrador */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Cobros x Cobrador */
DO:
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN cobrosxcobrador.p ( INPUT lista_empresas,
                               INPUT des_cobrador, 
                               INPUT has_cobrador, 
                               INPUT des_fecha, 
                               INPUT has_fecha). 
...
------------------------------------------------------------------------------*/
    ...
    RUN veresult.w ( INPUT  "c:\tempdsp\cobrosxcobrador.txt" ,  /* Archivo */
