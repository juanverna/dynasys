...
&Scoped-define INTERNAL-TABLES Rendicion_hd

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Rendicion_hd WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main Rendicion_hd
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Rendicion_hd
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nro_cobrador,cdg_empresa,nro_rendicion"':U).
...
------------------------------------------------------------------------------*/
  ...
  DEFINE INPUT PARAMETER rid_registro AS ROWID.
  
  REPOSITION {&QUERY-NAME} TO ROWID(rid_registro).
