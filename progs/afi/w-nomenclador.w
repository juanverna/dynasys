...
DEFINE VARIABLE h_b-nomenclador AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-nomenclador AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Mantenimiento de Nomenclador"
         HEIGHT             = 21.23
         WIDTH              = 114.29
         MAX-HEIGHT         = 21.23
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Mantenimiento de Nomenclador */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Mantenimiento de Nomenclador */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Mantenimiento de Nomenclador */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-nomenclador.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-nomenclador ).
       RUN set-position IN h_b-nomenclador ( 1.81 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.92 , 18.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-nomenclador.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-nomenclador ).
       RUN set-position IN h_v-nomenclador ( 1.81 , 25.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.69 , 79.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 12.04 , 25.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 1.77 , 79.00 ) NO-ERROR.

       /* Links to SmartViewer h_v-nomenclador. */
       RUN add-link IN adm-broker-hdl ( h_b-nomenclador , 'Record':U , h_v-nomenclador ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_v-nomenclador ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-nomenclador ,
             h_b-nomenclador , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updspa ,
             h_v-nomenclador , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Mantenimiento de Nomenclador"}
