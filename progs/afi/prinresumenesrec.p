...
DEFINE OUTPUT PARAMETER TABLE FOR t-orden.
...
DEFINE VAR tord AS INT NO-UNDO INITIAL 1.
...
/*ver contacto con email*/
       ...
       FOR each Cliente-contacto OF Domicilio where   can-do(Cliente-contacto.canal-email,"COB"), Persona OF Cliente-contacto WHERE persona.email <> "" NO-LOCK  :
       ...
       senal = FALSE.
           ...
           FOR EACH Cta_cte NO-LOCK
                ...
                CREATE t-orden.
                ASSIGN t-orden.rfac = ROWID(fac_header)
                   tord = tord + 1
                   t-orden.orden = tord.
