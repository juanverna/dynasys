...
ON END-ERROR OF W-Win /* Bajas Alfabetico */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Bajas Alfabetico */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Listado Alfabético de Bajas"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN bajasalfabetico.p ( INPUT lista_empresas, 
                               INPUT des_fecha,
                               INPUT has_fecha,
                               INPUT desde_emision,
                               INPUT hasta_emision,
...
------------------------------------------------------------------------------*/
    ...
    RUN veresult.w ( INPUT  "bajasalfabetico.txt" ,  /* Archivo */
