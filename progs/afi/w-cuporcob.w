...
DEFINE FRAME F-Main
     v-estado AT ROW 19.81 COL 8 COLON-ALIGNED NO-LABEL
     "   Rango de cobradores a considerar:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 1.24 COL 10
          BGCOLOR 5 FGCOLOR 15 
     "   Rango de fecha de emmision de los recibos a listas:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 5.52 COL 10
          BGCOLOR 5 FGCOLOR 15 
     "   Empresas a incluir en el proceso:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 9.33 COL 10
          BGCOLOR 5 FGCOLOR 15 
     "   Estado de los recibos a listar:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 13.14 COL 10
          BGCOLOR 5 FGCOLOR 15 
     "   Impresora de salida del listado:" VIEW-AS TEXT
          SIZE 100 BY 1 AT ROW 16 COL 10
          BGCOLOR 5 FGCOLOR 15 
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cobrador ( 2.43 , 10.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-fechas ( 6.71 , 10.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-empresas ( 10.52 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.43 , 100.00 ) */
       ...
       RUN set-position IN h_v-lst-estados ( 14.33 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.38 , 46.00 ) */
       ...
       RUN set-position IN h_v-rng-impresora ( 17.43 , 10.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 21.48 , 10.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/FAC" "Cupones por Cobrador"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN cuporcob.p ( INPUT lista_empresas,
                        INPUT des_cobrador, 
                        INPUT has_cobrador, 
                        INPUT des_fecha, 
                        INPUT has_fecha,
