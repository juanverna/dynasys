...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Detalle de Rendiciones por Cobrador"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.35
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Detalle de Rendiciones por Cobrador */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Detalle de Rendiciones por Cobrador */
DO:
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Detalle de Rendiciones por Cobrador"}
...
*/
  ...
  THEN DO:
       ...
       RUN  detarendcob.p ( INPUT lista_empresas, 
                            INPUT des_cobrador, 
                            INPUT has_cobrador, 
                            INPUT des_fecha, 
                            INPUT has_fecha 
