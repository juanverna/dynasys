...
DEFINE VARIABLE h_b-tipodom AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* Tipos de Domicilio */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Tipos de Domicilio */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* Tipos de Domicilio */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_b-tipodom ).
       RUN set-position IN h_b-tipodom ( 1.54 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 19.12 , 28.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa ).
       RUN set-position IN h_p-updspa ( 1.54 , 34.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa ( 19.12 , 13.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-tipodom. */
       RUN add-link IN adm-broker-hdl ( h_p-updspa , 'TableIO':U , h_b-tipodom ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-tipodom ,
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Mantenimiento de Tipos de Domicilio"}
