...
DEFINE FRAME F-Main
     ...
     "     Fechas de Alta" VIEW-AS TEXT
          SIZE 17 BY .62 AT ROW 2.88 COL 44
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Generación de Disquet Universal"
         HEIGHT             = 22.35
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.35
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Generación de Disquet Universal */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Generación de Disquet Universal */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 3.15 , 10.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-archivo ( 6.92 , 10.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-planes ( 9.88 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.88 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Generación de Disquet Universal"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN genuniversal.p ( INPUT des_fecha,
                            INPUT has_fecha,
