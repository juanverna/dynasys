...
DEFINE FRAME F-Main
     v-estado AT ROW 15.54 COL 8 COLON-ALIGNED NO-LABEL
...
ON END-ERROR OF W-Win /* Cupones Sin Cargo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Cupones Sin Cargo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-fechas ( 5.31 , 10.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-periodo ( 7.19 , 10.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-empresas ( 10.69 , 10.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-impresora ( 13.12 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.88 , 89.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 17.15 , 10.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.15 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Cupones Sin Cargo"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN cuponessincargo.p ( INPUT lista_empresas, 
                               INPUT des_cobrador, 
                               INPUT has_cobrador, 
                               INPUT des_fecha, 
                               INPUT has_fecha, 
...
------------------------------------------------------------------------------*/
    ...
    RUN veresult.w ( INPUT  "cuponessincargo.txt",  /* Archivo */
                     INPUT 8 ).                          /* FONT a utilizar por default */               
