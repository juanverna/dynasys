...
&Scoped-Define ENABLED-OBJECTS RECT-1 v-mes v-ano has_fecha 
&Scoped-Define DISPLAYED-OBJECTS v-mes v-ano has_fecha 
...
DEFINE FRAME F-Main
     v-mes AT ROW 1.27 COL 16 COLON-ALIGNED
     v-ano AT ROW 1.27 COL 23 COLON-ALIGNED NO-LABEL
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
        ...
        IF v-ano < 1999 OR v-ano > 2010 THEN error_rango = YES.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute PRIOR to standard behavior. */
   ...
   v-mes = MONTH(has_fecha) + 1.
   IF v-mes = 13
   THEN DO:
      v-mes = 1.
      v-ano = YEAR(has_fecha) + 1.
   END. 
   ELSE DO:
