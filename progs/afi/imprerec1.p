...
FIND bfac_header WHERE ROWID(bfac_header) = rfac NO-LOCK.
   ...
   RUN AFI/CUP000.p    ( 
    ...
    cPrinter = getPrinterDefinition( impreport(timpre) ).  /*si esta cableado hay que poner segun el tipo en que impresora default*/
