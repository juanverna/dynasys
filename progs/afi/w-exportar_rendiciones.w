...
DEFINE FRAME F-Main
     v-estado AT ROW 18.23 COL 11 COLON-ALIGNED NO-LABEL
     "  Lista de empresas a considerar en el proceso:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 9.88 COL 13
          BGCOLOR 5 FGCOLOR 15 
     "  Rango de cobradores a listar:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 2.08 COL 13
          BGCOLOR 5 FGCOLOR 15 
     "  Rango de fecha de las rendiciones a listar:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 6.12 COL 13
          BGCOLOR 5 FGCOLOR 15 
     "  Archivo de salida para la exportación:" VIEW-AS TEXT
          SIZE 89 BY .81 AT ROW 13.38 COL 13
          BGCOLOR 5 FGCOLOR 15 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW W-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Exportación de Rendiciones de Cobranza"
         HEIGHT             = 22.15
         WIDTH              = 114.29
         MAX-HEIGHT         = 22.35
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF W-Win /* Exportación de Rendiciones de Cobranza */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Exportación de Rendiciones de Cobranza */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-rng-cobrador ( 3.15 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-lst-empresas ( 11.23 , 13.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-rng-archivo ( 14.73 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.88 , 89.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_p-ejecutar ).
       RUN set-position IN h_p-ejecutar ( 19.85 , 13.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.42 , 89.00 ) */
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Exportación de Rendiciones de Cobranza"}
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
       ...
       RUN  exportar_rendiciones.p ( INPUT lista_empresas, 
                                     INPUT des_cobrador, 
                                     INPUT has_cobrador, 
                                     INPUT des_fecha, 
                                     INPUT has_fecha,
