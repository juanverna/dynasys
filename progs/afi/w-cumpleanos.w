...
DEFINE VARIABLE h_v-rng-mesano AS HANDLE NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     "     Indique Mes y Año de Cumpleaños" VIEW-AS TEXT
          SIZE 89 BY .88 AT ROW 3.69 COL 10
...
ON END-ERROR OF W-Win /* Listado de Cumpleaños */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Listado de Cumpleaños */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-rng-mesano.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-rng-mesano ).
       RUN set-position IN h_v-rng-mesano ( 5.04 , 10.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/AFI" "Listado de Afiliados que cambian de Grupo Etario"}
...
------------------------------------------------------------------------------*/
  ...
  RUN dar_rango IN h_v-rng-mesano    ( OUTPUT que_mes, 
                                       OUTPUT que_ano, 
                                       OUTPUT error_rango ).
  IF error_rango 
  THEN DO:
       RUN ver-error-rango ( "Mes y Año" ).
  ...
  THEN DO:
       ...
       RUN lscumpleanos.p ( INPUT lista_empresas, 
                            INPUT que_mes,
                            INPUT que_ano
                          ).
