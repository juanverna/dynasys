...
DEFINE FRAME F-Main
     Empresa.nombre AT ROW 1.24 COL 10 COLON-ALIGNED
          LABEL "Empresa"
...
/* SETTINGS FOR FILL-IN Empresa.nombre IN FRAME F-Main
   EXP-LABEL                                                            */
