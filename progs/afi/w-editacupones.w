...
DEFINE VARIABLE h_b-cupones-cobrador AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-navico AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-updspa-sicopia AS HANDLE NO-UNDO.
DEFINE VARIABLE h_q-cobempresa AS HANDLE NO-UNDO.
DEFINE VARIABLE h_q-cobrador AS HANDLE NO-UNDO.
DEFINE VARIABLE h_v-editacupon AS HANDLE NO-UNDO.
...
ON END-ERROR OF W-Win /* SIC/TES Edita Cupones */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* SIC/TES Edita Cupones */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-MINIMIZED OF W-Win /* SIC/TES Edita Cupones */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_v-id-cobrador ( 1.00 , 6.00 ) NO-ERROR.
       ...
       RUN set-size IN h_p-navico ( 1.35 , 38.00 ) NO-ERROR.
       ...
       RUN set-position IN h_v-id-empresa-2 ( 1.27 , 50.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updspa-sicopia ).
       RUN set-position IN h_p-updspa-sicopia ( 2.88 , 6.00 ) NO-ERROR.
       RUN set-size IN h_p-updspa-sicopia ( 1.88 , 104.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'v-editacupon.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-editacupon ).
       RUN set-position IN h_v-editacupon ( 5.04 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.62 , 104.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'b-cupones-cobrador.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-cupones-cobrador ).
       RUN set-position IN h_b-cupones-cobrador ( 6.92 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 14.81 , 104.00 ) */
       ...
       /* Links to SmartViewer h_v-editacupon. */
       RUN add-link IN adm-broker-hdl ( h_b-cupones-cobrador , 'Record':U , h_v-editacupon ).
       RUN add-link IN adm-broker-hdl ( h_p-updspa-sicopia , 'TableIO':U , h_v-editacupon ).

       /* Links to SmartBrowser h_b-cupones-cobrador. */
       RUN add-link IN adm-broker-hdl ( h_q-cobempresa , 'Record':U , h_b-cupones-cobrador ).
...
------------------------------------------------------------------------------*/
  ...
  {setwintit.i "SIC/TES" "Edición y Modificación de Cupones"}
