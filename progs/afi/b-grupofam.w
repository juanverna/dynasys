...
&Scoped-define FIELDS-IN-QUERY-br_table Grupofam.cdg_grupofam 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Grupofam OF Empresa WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br_table Grupofam
&Scoped-define FIRST-TABLE-IN-QUERY-br_table Grupofam


/* Definitions for FRAME F-Main                                         */

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS RECT-7 que_grupo br_table 
&Scoped-Define DISPLAYED-OBJECTS que_grupo 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Grupofam.cdg_grupofam FORMAT "X(16)" COLUMN-FGCOLOR 9 COLUMN-BGCOLOR 11
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 20 BY 16.15
...
DEFINE FRAME F-Main
     que_grupo AT ROW 1.54 COL 1 COLON-ALIGNED NO-LABEL
...
/* BROWSE-TAB br_table que_grupo F-Main */
ASSIGN 
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "padron.Grupofam OF padron.Empresa"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   > padron.Grupofam.cdg_grupofam
"Grupofam.cdg_grupofam" ? "X(16)" "character" 11 9 ? ? ? ? no ?
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL m_Afiliados B-table-Win
ON CHOOSE OF MENU-ITEM m_Afiliados /* Afiliados */
DO:
  
  RUN c-busafiliado.w ( INPUT Empresa.cdg_empresa,
                        INPUT "",
                        INPUT "",
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL m_Domicilios B-table-Win
ON CHOOSE OF MENU-ITEM m_Domicilios /* Domicilios */
DO:
  RUN c-busdomic.w ( INPUT Empresa.cdg_empresa,
                     INPUT "",
                     INPUT "",
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL m_Grupos B-table-Win
ON CHOOSE OF MENU-ITEM m_Grupos /* Grupos */
DO:

  RUN c-busgrupo.w ( INPUT Empresa.cdg_empresa,
                     INPUT "",
                     INPUT "",
                     INPUT-OUTPUT rid_grupo,
                     OUTPUT puso_ok).   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL que_grupo B-table-Win
ON RETURN OF que_grupo IN FRAME F-Main
DO:
  FIND FIRST Grupofam 
       WHERE Grupofam.cdg_grupofam >= que_grupo:SCREEN-VALUE IN FRAME {&FRAME-NAME}
         AND Grupofam.cdg_empresa = Empresa.cdg_empresa NO-LOCK NO-ERROR.
  IF NOT AVAILABLE Grupofam 
     THEN FIND LAST Grupofam WHERE Grupofam.cdg_empresa = Empresa.cdg_empresa.
  REPOSITION br_table TO ROWID ROWID(Grupofam).
