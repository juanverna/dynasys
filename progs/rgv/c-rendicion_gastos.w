...
T-Rendgastos_hd.imp_anticipo T-Rendgastos_hd.imp_imputado ~
T-Rendgastos_hd.imp_rendicion T-Rendgastos_hd.abierta 
...
T-Rendgastos_hd.imp_imputado T-Rendgastos_hd.imp_rendicion ~
...
T-Rendgastos_hd.cambio T-Rendgastos_hd.imp_imputado ~
T-Rendgastos_hd.imp_rendicion T-Rendgastos_hd.abierta 
&Scoped-define ENABLED-TABLES T-Rendgastos_hd
&Scoped-define FIRST-ENABLED-TABLE T-Rendgastos_hd
&Scoped-Define ENABLED-OBJECTS RECT-2 RECT-3 RECT-5 RECT-6 RECT-7 Btn_salir ~
BROWSE-2 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-2 C-Win _STRUCTURED
  QUERY BROWSE-2 NO-LOCK DISPLAY
      Articulo.cdg_articulo COLUMN-LABEL "Código!Gasto" FORMAT "X(12)":U
            WIDTH 20.2
      Articulo.descripcion COLUMN-LABEL "Descripcion!Gasto" FORMAT "X(50)":U
            WIDTH 50.8
...
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 157 BY 18.1
         TITLE "Rubros que componen esta rendición" FIT-LAST-COLUMN.
...
DEFINE FRAME DEFAULT-FRAME
     ...
     T-Rendgastos_hd.des_fecha AT ROW 4.81 COL 104 COLON-ALIGNED
          ...
          SIZE 16 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Rendgastos_hd.has_fecha AT ROW 4.81 COL 140 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 16 BY 1
          BGCOLOR 15 FGCOLOR 9 
     ...
     T-Rendgastos_hd.cambio AT ROW 6 COL 100 COLON-ALIGNED
          ...
          SIZE 20 BY 1
          BGCOLOR 15 FGCOLOR 9 
     T-Rendgastos_hd.imp_anticipo AT ROW 6 COL 136 COLON-ALIGNED
          VIEW-AS FILL-IN NATIVE 
          SIZE 20.2 BY 1
          BGCOLOR 15 FGCOLOR 9 
     v-cdg_proveedor AT ROW 7.19 COL 19 COLON-ALIGNED
     v-dsc_proveedor AT ROW 7.19 COL 35 COLON-ALIGNED NO-LABEL
     T-Rendgastos_hd.imp_imputado AT ROW 7.19 COL 100 COLON-ALIGNED
          LABEL "Rendido"
          VIEW-AS FILL-IN NATIVE 
          SIZE 20 BY 1
          BGCOLOR 7 FGCOLOR 15 
     T-Rendgastos_hd.imp_rendicion AT ROW 7.19 COL 136 COLON-ALIGNED
          LABEL "Imp.Total"
          VIEW-AS FILL-IN NATIVE 
          SIZE 20.2 BY 1
          BGCOLOR 7 FGCOLOR 15 
...
"Articulo.cdg_articulo" "Código!Gasto" ? "character" ? ? ? ? ? ? no ? no no "20.2" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > sic.Articulo.descripcion
"Articulo.descripcion" "Descripcion!Gasto" ? "character" ? ? ? ? ? ? no ? no no "50.8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.T-Rendgastos_dt.importe_empleado
"T-Rendgastos_dt.importe_empleado" "Pagado!Empleado" ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.T-Rendgastos_dt.importe_empresa
"T-Rendgastos_dt.importe_empresa" "Pagado!Empresa" ? "decimal" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.T-Rendgastos_dt.observacion
"T-Rendgastos_dt.observacion" ? ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-2 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  /*FIND Tipocomprobante WHERE Tipocomprobante.cdg_comprobante = SUBSTRING(ENTRY(1,PROGRAM-NAME(3),"."),5) NO-LOCK NO-ERROR.*/
    FIND FIRST Tipocomprobante WHERE Tipocomprobante.cdg_comprobante = "RENDGAST".
    ...
    ELSE DO:
       ...
       FIND FIRST Tipocomprobante WHERE Tipocomprobante.cdg_comprobante = "FACTUCLI" NO-LOCK NO-ERROR.
       IF AVAILABLE Tipocomprobante
       THEN DO:
           ASSIGN
                  v-nombre_comprobante  = Tipocomprobante.rotulo
...
------------------------------------------------------------------------------*/
  ...
  DO TRANSACTION:
      ...
      ASSIGN T-Rendgastos_hd.cdg_comprobante = Tipocomprobante.cdg_comprobante 
             T-Rendgastos_hd.nro_usuario     = Usuario.nro_usuario 
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE T-Rendgastos_hd THEN 
    DISPLAY T-Rendgastos_hd.tip_comprob T-Rendgastos_hd.prf_comprob 
          ...
          T-Rendgastos_hd.abierta 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE RECT-2 RECT-3 RECT-5 RECT-6 RECT-7 Btn_salir 
         T-Rendgastos_hd.tip_comprob T-Rendgastos_hd.prf_comprob 
         T-Rendgastos_hd.nro_comprob T-Rendgastos_hd.fch_rendicion 
         T-Rendgastos_hd.cdg_tiporendgastos T-Rendgastos_hd.cambio 
         T-Rendgastos_hd.imp_imputado T-Rendgastos_hd.imp_rendicion 
         T-Rendgastos_hd.abierta BROWSE-2 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
