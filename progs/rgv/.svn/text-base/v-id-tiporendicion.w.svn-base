...
Tipo_rendgastos.dsc_rendgastos 
...
DEFINE FRAME F-Main
     Tipo_rendgastos.cdg_tiporendgastos AT ROW 1.24 COL 17 COLON-ALIGNED
          LABEL "Tipo Rendición"
          VIEW-AS FILL-IN NATIVE 
          SIZE 19 BY 1
          BGCOLOR 11 FGCOLOR 9 
     Tipo_rendgastos.dsc_rendgastos AT ROW 1.24 COL 38 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN NATIVE 
          SIZE 66 BY 1
          BGCOLOR 11 FGCOLOR 9 
...
/* SETTINGS FOR FILL-IN Tipo_rendgastos.cdg_tiporendgastos IN FRAME F-Main
   EXP-LABEL                                                            */
