...
C:\Progress102\OpenEdge\bin\prowin32.exe -b -p gen_evento_protocolo.p -db c:\bases\dynasys102  -ld sic  -U BATCH -P batch -T c:\temp -basekey "INI" -ininame c:\dynasys10\procs\dynasys10.ini -s 200 -inp 8192 -bibufs 25co
time /T >>  c:\dynasys10\logs\diario.log
echo "Protocolos" >> c:\dynasys10\logst\diario.log
...
time /T >>  c:\dynasys10\logs\diario.log
echo "EVento Entrega de Facturas" >> c:\dynasys10\logs\diario.log
